...
originally named thus because of an earlier draft for a script\index{Box script} that never made
...
there is no documentation of the Box script\index{Box script} surviving that I know
of.}
...
\index{Tahano Hikamu!hand style (\ayr{spj})} Reproducing the shapes of either
