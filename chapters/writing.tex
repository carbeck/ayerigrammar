...
The order of secondary vowels and subscript diacritics is iconic insofar as the 
ordering precedes in the order of sounds in the syllable. Thus, a 
secondary vowels appear below the consonant-doubling diacritic, \ayr{*F*}, 
while they appear above the always syllable-final homorganic nasal diacritic, 
\ayr{*\_M}:
