...
\item with consonants directly following \ayr{n}~\orth{na}, to avoid a clash 
	...
	if unreduced, \ayr{n}'s swash is not so long as to cross the descender 
	of \ayr{*j} either.}
...
Ayeri's normal position for diacritics is below consonants, but sometimes it is 
nicer to put them on top, especially for the letter \ayr{n}~\orth{na} due to 
...
*Q
	...
	& \rayr{t}{ta} → \ayr{tQ} /taʔ/; \rayr{s}{sa} → \ayr{sQ} /s’a/
	\\
