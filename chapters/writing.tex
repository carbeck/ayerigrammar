...
following I will first describe subscript diacritics, then superscript 
diacritics and then preposed diacritics, which Ayeri also has a number of, both 
as graphemes in their own right and as allographs of other diacritics.
