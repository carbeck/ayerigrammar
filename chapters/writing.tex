...
that is more similar to its `angular' form. \ayr{n}~\orth{na} is also taken
from the `angular' style, which means that it is possibly the acutal basic
shape, rather than the `book' style's \ayr{n}, or both are different
