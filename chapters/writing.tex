...
consonant in writing if a vowel is following:
...
\item in other cases where a clash of subscript diacritics needs to be avoided:
	...
	In terms of Optimality Theory, this would be the least bad 
	candidate. Alternatively, the following, slightly worse solution is 
	also permissible:
