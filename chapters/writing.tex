...
limited to vowel graphemes as in Devanāgarī {\FS ि}~\orth{i} or Javanese 
\smash{\fontspec{Tuladha Jejeg}[Script=Javanese,Scale=MatchLowercase]ꦺ}~%
\orth{e, é/è} 
...
historically derived from a sign that looks like two circles stacked on top of 
each other. \ayr{—}~\orth{---} is also sometimes found at the end of paragraphs 
or texts to mark their end.
