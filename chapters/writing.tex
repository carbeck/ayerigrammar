...
seen of it to Tahano Hikamu at some point.\footnote{For examples, see 
\citet{everson2008}.} As mentioned above as well, there 
are no subscript letters and in Ayeri, and the number of large swirling 
...
curves are broken up into at least two strokes. The characters that differ most 
are \ayr{g}~\orth{ga}, \ayr{r}~\orth{ra}, \ayr{N}~\orth{nga}, and the vowel 
...
\ayr{s}~\orth{sa} gains a descender, as does \ayr{r}~\orth{ra}. Not shown here 
either are changes to the `large' diacritics.
