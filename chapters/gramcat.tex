...
NP dependent. Also consider that for example (b) in the type 3 transitive\index{verbs!transitive}
...
although under a very close understanding of \citet{corbett2006},
...
verb. Example (\ref{ex:posexpect}), on the other hand, indicates that the asker
