...
(\ref{ex:vb-nn}) shows derivations from adjectives to nouns. As 
...
\pex~
	\a \makebox[8.5em][l]{\xayr{\larger bjh/}{bayha-}{rule}}
		→ \xayr{\larger bjhNF}{bayhang}{government}
	\a \makebox[8.5em][l]{\xayr{\larger hp}{hapa}{remaining}}
		→ \xayr{\larger hpNF}{hapang}{remainder}
	\a \makebox[8.5em][l]{\xayr{\larger kd/}{kada-}{collect}}
		→ \xayr{\larger kdNF}{kadang}{committee; alliance}
	\a \makebox[8.5em][l]{\xayr{\larger mim}{mima}{possible}}
		→ \xayr{\larger mimNF}{mimang}{access}
\xe

Agentive nouns can be formed from regular nouns with the prefix 
\rayr{/my}{-maya}, compare the examples in (\ref{ex:mayaregular}). When 
the stem of the word it is attached to ends in a consonant or /Ca/, it is often 
fused with the root, sometimes with the first /a/ of \fw{-Caya} lengthening, 
see (\ref{ex:mayairregular}). Feminine agentive nouns are occasionally derived 
with the related suffix \rayr{/vy}{-vaya}:

\pex\label{ex:mayaregular}
	\a \makebox[7em][l]{\xayr{\larger AnFl/}{anl-}{bring}}
