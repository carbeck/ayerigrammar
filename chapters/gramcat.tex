...
languages use a different base than 10. Ayeri's duodecimal system would be 
similar to the hexal system of Nen described in \citet{evans2009}, quoted in 
\citeauthor{dixon2012}: \textcquote[73]{dixon2012}{In counting, Nen speakers 
`first count off the five fingers with a finger of their other hand, and then on 
the sixth they place their counting finger on the inside of the wrist'}. The 
origin of the number system is explained by the culturally important farming of 
yam fruits, which can be neatly grouped as stars consisting of six fruits each 
\citep[74]{dixon2012}.\footnote{I chose to use 12 as a numerical base because 
I simply wanted to toy around with it. Also, I originally conceived of Ayeri 
speakers as humanoid but not necessarily human, which meant that they would not 
necessarily have evolved to have five fingers on each hand---for an earlier 
...
work reasonably well with human, five-digit hands if you counted not only the 
fingers, but also the hands themselves, or the palms.} Ayeri's number words are 
semantic primes, that is, their meanings cannot be readily recognized as derived 
from body parts or from internal arithmetic like 9 as `ten lacking one', for 
instance (compare \cite[74]{dixon2012}). The numerals \xayr{Iri}{iri}{five} and 
...
The conjunction \xayr{nj}{nay}{and} is used to indicate that further myriad 
