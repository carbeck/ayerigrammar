...
agreement, though attributive adverbs (`run \fw{faster}', `climb \fw{better}') 
may take suffixes for comparison. Adverbs may equally be modified by the usual 
degree suffixes. Generally, there is no rigid distinction between adverbs and 
adjectives, so the latter may easily be used as the former. The following 
...
their heads, that is, verbs:

\pex
\a\begingl
	\gla Rije \textbf{ban} ang Nava. //
	\glb Rig-ye ban ang Nava //
	\glc draw-\TsgF{} well \Aarg{} Nava //
	\glft `Nava draws well.' //
\endgl
