...
though} do all the work; \xayr{d/naarY}{da-nārya}{despite, in spite of} has 
contrastive meaning, though it is used as a postposition (see 
\ref{subsec:postpos}). Like adverbs expressing stance, they may follow the verb 
or be placed at the end of the clause. Example (\ref{ex:naaryaadv}) above 
...
also be used as a contrastive conjunction meaning `but'. Insofar, its placement 
in a clause creates a slight difference in grammar, though not a great one 
meaning, as illustrated by example (\ref{ex:naaryaplcmt}) below.
