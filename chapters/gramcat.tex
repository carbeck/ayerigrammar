...
\autoref{subsec:uncased}. Morever, no distinction is made between singular and 
plural, so that the marker is \rayr{/U}{-u} in either case. Like the other mood 
suffixes, the vowel of the imperative suffix replaces the vowel of the verb 
stem if there is one.
