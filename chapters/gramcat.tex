...
compound follows\index{word order} the conjugated verb and its adjuncts\index{grammatical function!adjunct}, as in
...
construction, that is, \rayr{kYunF/}{cun-} requires a semantically contentful VP as a
complement\index{grammatical function!open complement} rather than an NP. The content/main verb appears in an infinite
