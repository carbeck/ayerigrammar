...
applicable to verbs. \rayr{d/}{da-} can thus act essentially as a pro-verb.
...
\a\begingl
	\gla Ang da-pinyaya {} Yan sa Pila. //
	\glb Ang da=pinya-ya Ø Yan sa Pila //
	\glc \AgtT{} such=ask-\TsgM{} \Top{} Yan \Parg{} Pila //
...
\ex\begingl
	...
	\glc suppose.to one=build-\Neg{}=\Tsg.\M{} //
	\glft `He is not supposed to build one.' //
\endgl\xe

As mentioned above, \rayr{d/}{da-} can also be used basically in an expletive 
way, to express `in this way' or `like that'. It does not encode an anaphoric 
relation in this case, but merely serves as a discourse particle to highlight 
the action.
...
\a\begingl
	...
	\glft `Mr. Hasanjan did not want to give up his right just there.' //
\endgl
