...
yield a convincing result.} \citet[239]{haspelmath1997} still presumes, 
...
the modern language. \rayr{mirnrilF}{miranaril} is a regular formation from 
\xayr{mirnF}{miran}{way, manner} combined with the quantifier (!) for 
indefinite amounts, \xayr{/ArilF}{-aril}{some}.
