...
Ayeri allows adverbs also to modify clauses as a whole, for instance, to express
...
accepts either a NP\index{phrase types!noun phrase} or a complementizer phrase\index{phrase types!complementizer phrase} (CP) as a complement\index{grammatical function!closed complement}.
