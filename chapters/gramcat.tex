...
(Tables \ref{fig:anideclcons}–\ref{fig:inandeclvow}), Ayeri's NPs are marked
...
Tables \ref{fig:anideclcons}–\ref{fig:inandeclvow} above. Names and verbal 
...
are given in \autoref{fig:postpos}. As can be read from the table,
...
\autoref{fig:persinfltypes}. In this table, especially the middle,
