...
fashion  of morphological passives (compare \autoref{subsec:persnumagr}).
...
\a\label{ex:hortmorph_1}\begingl
	\gla Sahu! //
	\glb saha-u //
	\glc go-\Imp{} //
	\glft `Go!' //
...
\a\label{ex:hortmorph_2}\begingl
...
(\ref{ex:hortmorph_1}) again gives an example of an imperative,
\rayr{shu}{sahu}, addressing a second person singular or plural.
(\ref{ex:hortmorph_2}), on the other hand, shows the corresponding hortative
