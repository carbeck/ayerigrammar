...
\rayr{/my}{-maya} (\ref{ex:mayaregular}), though when the stem of the word it 
is attached to ends in a consonant or /Ca/, it is often fused with the root, 
sometimes with the first /a/ of \fw{-Caya} lengthening 
(\ref{ex:mayairregular}). Feminine agentive nouns are occasionally derived with 
the related suffix \rayr{/vy}{-vaya}:
