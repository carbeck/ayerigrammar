...
On the other hand, it is possible to quantify gerunds if the
quantifier\index{quantifiers} does not imply countable quantities of the action.
Moreover, it is possible for gerunds to be modified by possessors\index{semantic
role!possessor}. The two sentences in (\ref{ex:grndmod}) exemplify these uses.
