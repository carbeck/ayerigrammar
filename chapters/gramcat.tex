...
tenses come with three degrees each: immediate, recent/impending, and remote. 
Its distinguishing three degrees for each tense is possibly a little unusual 
with regards to typology \citep[127]{dahl1985}. Generally, tense is marked with 
prefixes on verbs which may once have been auxiliaries. Tense and aspect work 
closely together also in Ayeri, so this section will only cover basic uses of 
the marked categories, and the next section will go deeper into aspectual 
categories and how they interact with tense marking.
