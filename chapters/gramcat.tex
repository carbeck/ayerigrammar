...
with a lexical element or a case marker. \rayr{si/}{si} is, similar to the case 
in English, related to the relativizer \rayr{si}{si}. The interrogative 
pronouns are listed in \autoref{fig:interpro}.
...
the speaker's expectations or knowledge. Thus, there is no dedicated question 
word for `why', since in Ayeri one can simply ask `due to what/whom' by 
inflecting \rayr{sinY}{sinya}:
...
\a\begingl
	\gla Ang prantoyva sinyari? //
	\glb Ang prant-oy=va.Ø sinya-ri //
