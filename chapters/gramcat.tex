...
other common noun, much like English in (\ref{ex:devnouneng}):
...
Similar to English in (\ref{ex:gerundeng}), Ayeri can also derive nouns from 
the participle of a verb to derive a noun that describes the action as 
such---a gerund. For an example, I will again draw on my Ayeri translation of 
Kafka's short story \enquote{Eine kaiserliche Botschaft} \citep[2, 
...
Conveniently, this annotated translation again comments on the grammatical 
...
\rayr{/AnF}{-an}, thus giving the suffix cluster \rayr{/ymnF}{-yaman} for the 
...
The comment on the translation also makes a little not on the gerund being 
...
following example, from my partial translation of Saint-Exupéry's story 
...
(\ref{ex:kafkagerund}) furthermore that gerunds can be modified by adjectives. 
The following example shows a gerund used as an agent---basically a subject---as 
well \citep{benung:scientificmethod}:
...
object of the former verb appears in the genitive case in Ayeri.

% Gerunds can't be pluralized, but can be quantified
