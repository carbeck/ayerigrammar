...
The instrumental may also be employed for comitative meanings where the 
instrumental NP describes an attribute, for example:
...
attribute to \rayr{ksu}{kasu}: the instrumental NP describes what its 
antecedent contains or entails more specifically. Note, however, that this 
different from physical accompaniment. Thus, it is not possible to say
...
\noindent to express `Ajān comes (together) with Pila'. To express 
accompaniment, the preposition \xayr{kjvo}{kayvo}{with, along, beside} has 
to be used instead:
...
\ex\begingl
	\gla Puco mino veney-veneyang. //
	\glb Puk-yo mino veney-veney-ang //
	\glc jump-\TsgN{} happily \Dim{}\til{}dog-\Aarg{} //
	\glft `The little dog is jumping happily.' //
\endgl\xe

If part of a compound, only the diminutive component is reduplicated, however, 
unless the compound is strongly lexicalized or has an idiomatic meaning going 
beyond its components. The following example shows the simple case of a 
transparent endocentric compound:
