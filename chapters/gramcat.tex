...
still be modified by quantifiers\index{quantifiers} and quantifying\index{quantifiers} clitics\index{clitics}; verb agreement\index{agreement} as
...
ambiguity in this. Introducing an adverb\index{adverb} shows that the reflexive--quantifier\index{quantifiers}
...
(\ref{ex:adjsembl}), as well as quantifying\index{quantifiers} and grading suffixes, of which the
...
following discussion. Unlike English, Ayeri does not use agent\index{case!agent} pronouns\index{pronouns} in
...
pronoun\index{pronouns} involved at all, which is why the person suffix in (\ref{ex:vbclt}) was
...
agreement with the agent on the one hand, and agent or patient pronouns\index{pronouns} just
...
(\ref{ex:vbagrengpr}) above. Instead, the suffixed agent pronoun\index{pronouns!personal} replaces any
...
Ayeri displays a full gamut from personal pronouns\index{pronouns!personal} (usually agents\index{case!agent}) glued to
...
\xayr{IknF}{ikan}{completely, wholly} (also as an adjective\index{adjectives}); a quantifier\index{quantifiers} like
...
reduplication\index{reduplication}. The equivalent in English is to use the adverb \fw{again} or the
...
off the pronoun\index{pronouns!demonstrative} and attached to the adjective\index{adjectives} directly to express `the
...
to drop the pronoun\index{pronouns!reflexive} and to place the reflexive prefix\index{prefixes} on the verb instead.
...
the usual quantifying\index{quantifiers} and grading suffixes, which have been analyzed here as
