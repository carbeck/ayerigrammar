...
\emph{does} allow this for recipients, however (compare (\ref{ex:reldat})), 
maybe since by their nature as goals they carry something of a locative 
connotation and are thus less tightly integrated with verbs, occupying a middle 
position between core arguments and adverbials like the locative 
...
\rayr{/y}{-ya} is indeed etymological or just chance.}
