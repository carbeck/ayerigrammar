...
are extremly short and simple words, for instance, \fw{of, at, in} from the 
slightly more complex PIE words \fw{*h₂ep-ó, *h₂ed, *h₁en(-i)}, respectively 
\citep[1, 39, 269]{kroonen2013}. Since adpositions frequently grammaticalize 
into case markers, it may be assumed that the phonologically much more simple 
case affixes of Ayeri constitute an older layer of adpositions. Their 
non-suffixed forms may be remnants of this use.} Since these nouns have ceased 
to function as common nouns, however, it is not possible to inflect them in the 
way described in \autoref{sec:nouns}. Thus, for example, while it is possible to 
...
\xayr{AvnF}{avan}{at bottom}
	& to the bottom; with \Gen{}: down (from)
	\\
...
idiomatic meaning, as displayed by the next example, in which \rayr{s 
AgYaanF}{sa Ajān} does neither serve as the complement of \rayr{lMtYo}{lanco} 
nor as that of \rayr{mNsr}{mangasara}, but of the phrasal verb \rayr{lMtF/ 
mNsr}{lant- mangasara}:
...
Colloquially, \rayr{mNsh}{mangasaha} and \rayr{mNsr}{mangasara} may be 
shortened to just \rayr{sh}{saha} and \rayr{sr}{sara}, respectively.
...
\pex
	\a \xayr{ApMd/}{apand-}{descend, climb down},
...
\xayr{koNF}{kong}{inside}, \xayr{liNF}{ling}{on}, \xayr{lug}{luga}{among}, and 
\xayr{mNsh}{mangasaha}{towards} come to mind as doubling for `within', `while', 
`during' and `in + \emph{time}'.
