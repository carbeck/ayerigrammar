...
whichever NP\index{phrase types!noun phrase} follows\index{word order} it, even if it can be assumed that verb agreement\index{agreement} in Ayeri
...
dative NP\index{phrase types!noun phrase} is fronted to occur after\index{word order} the verb in contrast to regular recipients,
...
well, since verbs always come first\index{word order} in Ayeri sentences, and any other NPs,
...
transitive\index{verbs!transitive} clauses---agents\index{semantic role!agent} and patients\index{semantic role!patient}---cannot precede\index{word order} the embedded verb of
...
subject\index{grammatical function!subject} function. Formally, also, agent NPs usually follow\index{word order} the verb, and it
