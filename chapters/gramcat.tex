...
The particles \xayr{maaj}{māy}{yes} and \xayr{voj}{voy}{no} are a special pair 
of adverbs. They are otherwise used, respectively, for agreement and 
disagreement by the listener in a conversation, however, they can not only 
appear in replies to closed questions, but they also appear as adverbs. 
\rayr{maaj}{māy}, on the one hand, can be used as an intensifier:
...
Besides this use, both \rayr{maaj}{māy} and \rayr{voj}{voy} can also be used as 
adverbs in tag questions, reflecting the expectation of the person asking with 
regards to the answer:

\pex
\a\begingl
	\glpreamble Expectation of affirmation/agreement: //
...
\a\begingl
	\glpreamble Expectation of negation/disagreement: //
...
The most common adverbs expressing degree and quantity (quantifiers) do not 
only follow verbs, nouns, adpositions, adjectives, or other adverbs, but they 
cliticize on them. The word stem---a lexical head which is usually inflected 
except in the case of adjectives---serves as the host for the clitic in all 
these cases. Examples of degree and quantifier suffixes were already given in 
all the relevant sections; an example from each is repeated here for 
convenience.
...
Quantifying expressions which deviate form the pattern of cliticization and 
instead are used as full words are, notably:
...
\xayr{menikneNF}{menikaneng}{another},
...
of the speaker, to concede an argument, or to simply to structure an 
argumentative chain.
...
\subsubsection{Concessive adverbs}

...
\xayr{AreenF}{arēn}{however, anyway},
\xayr{naarY}{nārya}{although, though},
...

\subsubsection{Argument-structuring adverbs}

...
\xayr{drmYmF}{deramyam}{after all},
