...
the dictionary, however, this has never seen any use. Instead, 
...
\rayr{mN}{manga} indicates that their respectively associated motion path is 
intended, thus \rayr{koNF}{kong}{inside} becomes \rayr{mN koNF}{manga 
kong}{into}, for instance. \autoref{fig:preposdyn} repeats the table 
of prepositions above for the most part and gives the respective dynamic 
meanings of the prepositions if there is an equivalent.

\begin{figure}[tp]\centering
\caption{Prepositions (dynamic)}
\begin{tabu} to 0.75\linewidth {I[3] X[6]}
% \tableheaderfont
% \multicolumn{2}{c}{Preposition}
% 	\\
