...
topic agreement are marked with \rayr{n}{na}. There is no animacy distinction in 
the genitive case.
...
Common nouns are marked with \ayr{/y} or \ayr{/*Y} \fw{-ya}; names and verbal 
topic agreement use the marker \rayr{y}{ya}.\footnote{Older texts still exhibit 
...
\a\label{ex:locmit}\begingl
	...
	\glc \textbf{\LocT{}} live-\TsgM{} \Aarg{} Kaman \textbf{\Top{}} 
		\textbf{Visamhinang} //
	\glft `Kaman lives in Visamhinang,' or:\\
		`Visamhinang is where Kaman lives.' //
\endgl
...
case, though it cannot replace it; verbs do not exhibit person agreement with 
causers even though their action logically supersedes or precedes that of 
agents.

... \citet{dixon2000}, \citet[313--314]{schachterotanes1972}, 
\citet{comrie1989} ...
