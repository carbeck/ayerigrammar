...
\autoref{subsubsec:dative}. The cognitive metaphor `time equals space' with the 
...
\begin{tabu} to \linewidth {I[2] X[4] X[6]}
\tableheaderfont
...
kayvo
	& with, along, beside\footnotemark
	& ?
	\\
...
\rayr{kjvo}{kayvo} has come to mean `beside, to the side of'.}
...
from nouns, so they have probably been grammaticalized relatively recently. 
Since these nouns have, however, ceased to function as such, it is not possible 
to inflect them in the way described in \autoref{sec:nouns}. Thus, for example, 
...
\a\label{ex:lingnn}\begingl
	...
	\glc \PatTI{} exist=\TsgI{}.\Aarg{} snow-\Top{} top-\Loc{}
		mountain-\Gen{} //
	\glft `There is snow on the mountain's top.' //
\endgl
...
to chairs,\footnote{In English, of course, you can also sit \emph{in} certain 
kinds of chairs, for example, armchairs.} the preposition can even be dropped.
