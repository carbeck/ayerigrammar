...
In example (\ref{ex:gender1}), the noun in the agent\index{case!agent} NP,
...
verb, since the agent\index{semantic role!agent} NP\index{phrase types!noun phrase} is also topicalized\index{grammatical function!topic}. The verb also agrees\index{agreement} in person\index{person}
...
marking; verbs, then, agree\index{agreement} with agent\index{case!agent} NPs\index{phrase types!noun phrase} in number in the canonical case. 
...
suffixation\index{suffixes}, marking their special status.\footnote{Many common names in Ayeri
...
the suffix\index{suffixes} \rayr{/reNF}{-reng} for inanimate\index{animacy} referents; names and verbal topic\index{grammatical function!topic}
...
agentless\index{semantic role!agent} sentences and the subjects\index{grammatical function!subject} of unaccusative verbs
...
The genitive is marked on common nouns with the suffix\index{suffixes} \rayr{/n}{-na}. If a
...
brought about. The instrumental, thus, marks secondary agents\index{semantic role!agent} in effect. Verbs,
...
marked as an agent\index{semantic role!agent} in that the agent\index{case!agent} suffix\index{suffixes} \rayr{/ANF}{-ang} is appended to
...
Besides the agentive\index{semantic role!agent} suffixes\index{suffixes}, there is also a derivative suffix\index{suffixes} for makers of
...
suffix\index{suffixes} cluster *\rayr{/ymnFymF}{*-yamanyam} basically undergoes haplology to a
...
distribution with pronouns\index{phrase types!determiner phrase}, since pronouns are anaphora for NPs\index{phrase types!noun phrase}. Thus also, an
NP\index{phrase types!noun phrase} which contains an adjective\index{adjectives} is wholly replaced by a personal-pronoun DP 
...
his book is whether there are any correlations between word order typology\index{typology} and
...
typology\index{typology} may have an effect on the formation of indefinites insofar as it
...
transitive clauses---agents\index{semantic role!agent} and patients\index{semantic role!patient}---cannot precede the embedded verb of
...
previously, lexical NPs\index{phrase types!noun phrase} and pronominal suffixes\index{suffixes} on the verb are mutually
...
inflect for tense\index{tense}, aspect\index{aspect}, mood\index{mood}, and modality as grammatical categories of the
...
semantics-based case marking\index{case} which marks patient\index{semantic role!patient}-subjects\index{grammatical function!subject} of passive clauses as
...
even further in the future\index{tense!future}. The English idiom to express this time relation is
...
suffixes\index{suffixes}, which follow aspectual marking.
...
suffix\index{suffixes}, that is, the habitative\index{aspect!habitual} suffix\index{suffixes} \rayr{As/}{-asa}. The following
...
the suffix\index{suffixes} replaces the last vowel of the verb stem, if there is one, so that
...
negative suffix\index{suffixes} deletes the last vowel of the verb stem if present, which is
...
usually follows irrealis\index{mood!irrealis} marking when suffixes\index{suffixes} are stacked: \rayr{/ONF}{-ong} +
...
verbs as well. This may be the case when the patient\index{semantic role!patient} of a transitive sentence
...
agreement\index{agreement}, though attributive adverbs may as well take suffixes\index{suffixes} for comparison\index{comparison}
...
(\ref{ex:andphrases}), then, two agent\index{case!agent} NPs\index{phrase types!noun phrase}, \xayr{ynNF}{yanang}{a/the boy} and
