...
demonstrative pronouns, question and adverbial pronouns, and relative pronouns. 
In the following, each class of pronouns is going to be discussed.
...
\rayr{y/} and \rayr{t/} in the third person pronouns. The same goes for the 
gender-marking thematic vowel in the animate third person pronouns, which is 
retained as a distinctive feature even in the non-core pronouns in spite of 
sometimes heavy modifications. A further interesting property of Ayeri pronouns 
...
\a\label{ex:pronins}\begingl
	\gla Sa harya ang Paradan tandās reri. //
	\glb Sa har-ya ang Paradan tanda-as reri //
...
NPs, with the agent, \rayr{ANF prdnF}{ang Paradan} replaced by the 3rd 
person singular masculine agent pronoun \rayr{yaaNF}{yāng} in 
(\ref{ex:pronagt}); in (\ref{ex:pronpat}) the patient, 
\rayr{tMdaasF}{tandās}, is replaced with the 3rd person singular neuter patient 
pronoun \rayr{yosF}{yos}; in (\ref{ex:pronins}), lastly, the instrument, 
\rayr{kleri}{kaleri} is replaced with the 3rd person singular inanimate 
instrumental pronoun \rayr{rri}{rari}.

Comparing the example sentenes in (\ref{ex:perspron}) with the \Top{} column in 
\autoref{fig:perspron} another important property of personal pronouns shows. 
That is, the `unmarked' (or rather, zero-marked) pronoun forms are also the 
ones showing as verb agreement. The following example is supposed to 
illustrate the parallel more clearly. Compare the person marking on the verb 
in (\ref{ex:verbinfl1}) and the object pronouns in (\ref{ex:verbinfl2}):
...
% 
% \begin{tabu} to .5\textwidth{S[2] X[4c] X[4c]}
% \tableheaderfont\toprule
% 
% Case
% 	& \Prox{}
