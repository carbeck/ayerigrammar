...
also assigned \emph{case}\index{case} by the verb\index{verbs}, which is a third grammatical property
...
marking; verbs\index{verbs}, then, agree\index{agreement} with agent\index{case!agent} NPs\index{phrase types!noun phrase} in number in the canonical case. 
...
the suffix\index{suffixes} \rayr{/reNF}{-reng} for inanimate\index{animacy} referents; names and verbal\index{verbs} topic\index{grammatical function!topic}
...
\rayr{/lej}{-ley}; for names and verbal\index{verbs} topic\index{grammatical function!topic} agreement\index{agreement}, the markers are
...
animate and inanimate\index{animacy} entities. Names and verbal\index{verbs} topic\index{grammatical function!topic} agreement\index{agreement} are marked
...
Tables \ref{tab:anideclcons}--\ref{tab:inandeclvow} above. Names and verbal\index{verbs}
...
\rayr{/yey}{-jya}.} names and verbal\index{verbs} topic\index{grammatical function!topic} agreement\index{agreement} use the marker 
...
when ending in a consonant; names and verbal\index{verbs} topic\index{grammatical function!topic} agreement\index{agreement} are marked by
...
agent\index{case} since it can be understood to refer to the verb
...
Instead, they are technically verbs\index{verbs} combining to form directional adverbs\index{adverb} and
...
not behave like transitive verbs\index{verbs!transitive} as in English. Thus, what would be the object
...
verbs\index{verbs}, it will be dealt with in more detail in the chapter on verbs\index{verbs} proper. 
...
traits---such as verb-initial, verb--object, and noun--genitive word order\index{word order},
also having prepositions\index{prepositions}---for basing indefinite pronouns on generic nouns\index{nouns!generic}.
...
which also occurs with adjectives\index{adjectives} and verbs\index{verbs} (see sections \ref{subsec:adjneg}
...
These verbs\index{verbs} do not govern a prepositional object\index{grammatical function!oblique} in the locative case\index{case!locative} in their
...
verb\index{verbs} is used in Ayeri for both the plain English verb and the one extended by a
...
modification of verbs\index{verbs} and phrases. Like adjectives\index{adjectives}, they do not display
...
label `quantifier' here) do not only follow\index{word order} verbs\index{verbs}, nouns\index{nouns}, adpositions\index{adpositions},
...
transitive verb\index{verbs!transitive}, \xayr{vtYF/}{vac-}{like}. With predicative adjectives, the
