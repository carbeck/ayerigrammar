...
Nouns in Ayeri have \emph{gender}\index{gender} and \emph{number} as their inherent
grammatical properties. Besides common nouns, there are, of course, also proper
nouns (that is, names) and nominalizations\index{nominalization}. Nouns, as the heads of NPs\index{phrase types!noun phrase}, are
also assigned \emph{case}\index{case} by the verb, which is a third grammatical property
...
`paint' on the other. Gender is reified by case marking\index{case} as well as verb
...
which triggers the animate agent topic\index{grammatical function!topic} agreement\index{agreement} marker \rayr{ANF}{ang} on the
verb, since the agent NP\index{phrase types!noun phrase} is also topicalized\index{grammatical function!topic}. The verb also agrees\index{agreement} in person\index{person}
and number with the agent NP\index{phrase types!noun phrase} by way of the person marker \rayr{/y}{-ya} for
...
In (\ref{ex:gender2}), on the other hand, we see an inanimate\index{animacy} agent,
...
\rayr{/yo}{-yo}. The (non-topicalized\index{grammatical function!topic}) NP's\index{phrase types!noun phrase} case marking\index{case} shows that the agent 
of the clause is inanimate\index{animacy}: \rayr{khnF}{kahan} carries the marker
\rayr{/reNF}{-reng}, which marks it as an inanimate\index{animacy} agent. The object of the 
...
agreement\index{agreement} on the verb uses the marker \rayr{s}{sa} according to the NP\index{phrase types!noun phrase} being
...
marking; verbs, then, agree\index{agreement} with agent NPs\index{phrase types!noun phrase} in number in the canonical case. 
...
singular\index{number!singular}, also unlike in English. Uncountable, on the other hand, are materials
...
be reduced to [dʒ] \orth{-j}\index{morphophonology}\index{allomorphy} before case\index{case} suffixes beginning with /j/ or with a
...
nouns as suffixes---or rather, enclitics\index{clitics}. In this case, when plurality is
indicated by the quantifier, the noun is not additionally marked for number;
the verb, however, keeps agreeing\index{agreement} in number. This is illustrated in
(\ref{ex:quantplur}).
...
inflection for case\index{case} by suffixes as common nouns do, and for the purpose of
...
still be modified by quantifiers and quantifying clitics\index{clitics}; verb agreement\index{agreement} as
...
for case, which is governed by the verb or assigned to adjuncts\index{grammatical function!adjunct} freely
...
the suffix \rayr{/reNF}{-reng} for inanimate\index{animacy} referents; names and verbal topic\index{grammatical function!topic}
...
\rayr{/lej}{-ley}; for names and verbal topic\index{grammatical function!topic} agreement\index{agreement}, the markers are
...
form a passive in (\ref{ex:agtnotnom}), the patient NP\index{phrase types!noun phrase} will not be changed to
the agent case\index{case!agent}, since that would reverse the direction of action.
...
the verb will: it now agrees\index{agreement} with the next argument in line, the patient NP\index{phrase types!noun phrase}. It
will not do so, however, if the order of arguments is simply scrambled, as in
(\ref{ex:verbscram}). This is to say that the verb does not simply agree\index{agreement} with
whichever NP\index{phrase types!noun phrase} follows it, even if it can be assumed that verb agreement\index{agreement} in Ayeri
developed along similar lines in-world, which will become especially apparent
in the discussion of pronouns.\footnote{Mismatches in agreement\index{agreement} in connection
...
agreement\index{agreement} with the nearest noun phrase\index{phrase types!noun phrase} or agreement\index{agreement} with all (resolution) is
...
Besides being the default case for direct objects\index{grammatical function!primary object}, the patient case is also 
assigned to predicative\index{grammatical function!predicative complement} nominals, by analogy with transitive sentences and in 
...
The most typical use of the dative is for the recipient NP\index{phrase types!noun phrase} in a ditransitive
...
animate and inanimate\index{animacy} entities. Names and verbal topic\index{grammatical function!topic} agreement\index{agreement} are marked
equally by \rayr{ymF}{yam}. Verbs do not exhibit person\index{person} agreement\index{agreement} with dative
NPs\index{phrase types!noun phrase}, since experiencers are treated as agents.
...
with just the preposition\index{prepositions}, in this case \xayr{liNF}{ling}{on top of}. With the
...
clause. This not only includes syntactic objects, but also patient-subjects\index{grammatical function!subject} of
agentless sentences and the subjects\index{grammatical function!subject} of unaccusative verbs
...
dative NP\index{phrase types!noun phrase} is fronted to occur after the verb in contrast to regular recipients,
beneficiaries, or goals. A clause may thus contain two dative NPs\index{phrase types!noun phrase}. These,
...
verb. It is also the case in which adpositional objects\index{grammatical function!oblique} normally appear,
...
\rayr{/yey}{-jya}.} names and verbal topic\index{grammatical function!topic} agreement\index{agreement} use the marker 
...
with the preposition\index{prepositions} \xayr{koNF}{kong}{inside} would be emphasizing that the
...
Ayeri also has a number of postpositions\index{postposition}. This does not change the fact that
...
postposition\index{postposition} \xayr{pesnF}{pesan}{until}.
...
case\index{case!agent}, though it does not replace it in Ayeri; verbs do not exhibit person\index{person}
...
not agree\index{agreement} with causers even though they have agent-like semantics. There is no
...
however, never show person\index{person} agreement\index{agreement} with instrumental NPs\index{phrase types!noun phrase}. Common nouns are
marked by \rayr{/ri}{-ri} when ending in a vowel and by \rayr{/Eri}{-eri}
when ending in a consonant; names and verbal topic\index{grammatical function!topic} agreement\index{agreement} are marked by
...
{-yēri} may be found as plural\index{number!plural} forms. In passive-like constructions, it is not
...
get around. To express accompaniment, instead, the preposition\index{prepositions}
\xayr{kjvo}{kayvo}{with, along, beside} has to be used; the prepositional
object\index{grammatical function!oblique} appears in the locative case\index{case!locative}, as usual, then, compare
(\ref{ex:comitwith}).
...
with prepositions\index{prepositions} for some kind of prolative meaning. The adposition\index{adpositions} would
...
Imperative\index{mood!imperative} forms have underlying second-person\index{person} agents, so both the `idiot' in
...
predicate, and thus similar to an adverb\index{adverb} (compare \autoref{subsubsec:depict},
...
unusual in that it does not occur after the verb in the position of an adverb\index{adverb}
as depictives usually would.

Nouns may also be unmarked if they act as modifiers in a compound\index{compound} and the head
...
compound\index{compound}, acts in the way of an adjective\index{adjectives} in that `fingernail' is not used as a
syntactic unit as far as case marking goes. Instead, the case marker appears on
the compound's\index{compound} head, \xayr{rlnF}{ralan}{nail}. Compounds\index{compound} will be described in
...
agent\index{case!agent} since it can be understood to refer to the verb
...
Moreover, there is a proclitic\index{clitics} \rayr{me/}{mə-} in complementary distribution
...
of verb and object\index{grammatical function!primary object} and that of noun and genitive \citep[129--133]{gaeta2008}.
...
with adjectives\index{adjectives} are interesting insofar as this is also the normal order for
...
comparison\index{comparison}, for instance. Synthetic compounds exist in Ayeri and produce nouns.
...
and possessive phrases are dependent marking, genitive\index{case!genitive} or other case marking\index{case}
...
adjective\index{adjectives}. In classical Sanskrit terminology, this type is called 
...
as a superlative\index{comparison} form; the suffix modifies the noun--adjective\index{adjectives} compound as a
...
adverb\index{adverb} whose modifier is probably a mangling of \rayr{pluNF}{palung}.
...
least one noun compound which uses a postposition\index{postposition} as an adjectival modifier,
...
well, since verbs always come first in Ayeri sentences, and any other NPs\index{phrase types!noun phrase},
...
\rayr{mripuMtymF}{maripuntayam} is special in that it contains the dative\index{case!dative} 
...
Instead, they are technically verbs combining to form directional adverbs\index{adverb} and
...
is, they receive prefixes\index{prefixes} and suffixes just like the simplexes from which they 
...
marked as an agent in that the agent\index{case!agent} suffix \rayr{/ANF}{-ang} is appended to
...
declension suffix is ungrammatical for the purpose of forming a diminutive\index{diminutive}:
*\rayr{\larger veneyNF/veneyNF}{*veneyang-veneyang}. Likewise, the reduplicated
form is not treated in the way of an endocentric compound\index{compound}, so case\index{case} and
...
compounds\index{compound}, only the head is reduplicated, unless the compound\index{compound} is strongly 
...
the head, \xayr{mehirF}{mehir}{tree}, not of the whole compound\index{compound} 
...
from verbs, and (\ref{ex:adj-nn}) shows derivations from adjectives\index{adjectives} to nouns. 
...
feminine\index{gender} agentive nouns can be derived with the related suffix
...
suffix \rayr{/(E)rYnF}{-(e)ryan}, which is related to the instrumental\index{case!instrumental} suffix
...
as animate nouns. Since they are impersonal, they trigger neuter\index{gender} agreement\index{agreement} on
verbs. They can also be the objects\index{grammatical function!primary object} of sentences. The passage in
...
agent-subject\index{grammatical function!subject} as well \citep{benung:scientificmethod}.
...
of the former verb appears in the genitive case\index{case!genitive} in Ayeri. As in English,
...
\autoref{tab:perspro} declined by adding a case\index{case} suffix (see
...
replaced with the third person singular inanimate\index{animacy} instrumental pronoun
\xayr{rri}{rari}{with it}. Furthermore, complex NPs\index{phrase types!noun phrase} are in complementary
distribution with pronouns, since pronouns are anaphora for NPs\index{phrase types!noun phrase}. Thus also, an
NP\index{phrase types!noun phrase} which contains an adjective\index{adjectives} is wholly replaced by a personal-pronoun DP\index{phrase types!determiner phrase} 
...
illustrate the parallel more clearly---observe the person\index{person} marking on the verb 
...
Another important property of both pronouns and verbs is that agent\index{case!agent} pronouns
...
cliticizing\index{clitics} to the verb stem. Since person\index{person} agreement\index{agreement} morphology is a domain of
verbs, it will be dealt with in more detail in the chapter on verbs proper. 
Example (\ref{ex:agtproclt_1}) again has full subject\index{grammatical function!subject} and object\index{grammatical function!primary object} NPs\index{phrase types!noun phrase}; the verb
displays \rayr{/y}{-ya} as the agreement\index{agreement} suffix for the masculine agent\index{case!agent} NP\index{phrase types!noun phrase}.
...
themselves not in complementary distribution with nominal NPs\index{phrase types!noun phrase}, compare
...
*\xayr{naa/vaa}{*nā-vā}{*myest}). Fronting them in predicative\index{grammatical function!predicative complement} statements like
...
predicative adjective\index{adjectives!predicative} or NP\index{phrase types!noun phrase}, which is the main reason why it occurs so
...
or animacy\index{animacy}, which is a notable difference between demonstrative pronouns and
...
complemented by adjectives\index{adjectives} and possessive pronouns alike. The adjective\index{adjectives} or
...
traits---such as verb-initial, verb--object\index{grammatical function!primary object}, and noun--genitive\index{case!genitive} word order,
also having prepositions\index{prepositions}---for basing indefinite pronouns on generic nouns.
...
(affirmative versus negative\index{negation}) the way English has it. See (\ref{ex:englpol})
for an example.
...
morpheme \rayr{EnF}{en}, either prefixed\index{prefixes} or suffixed, which is related to the 
...
which also occurs with adjectives\index{adjectives} and verbs (see sections \ref{subsec:adjneg}
...
postposition\index{postposition} \xayr{rnF}{ran}{against} is related.
...
Since double negation\index{negation}---that is, agreement\index{agreement} in negation\index{negation} between verbs and
...
agents\index{case!agent} and patients\index{case!patient} are distinguished for animacy\index{animacy}.
...
zero-morpheme topic\index{grammatical function!topic} marker. There is no resumptive pronoun in the relative
...
overt case\index{case} agreement\index{agreement} since it follows its antecedent (*\rayr{sNNF}{*sangang}
...
(\ref{ex:relpat}), the relative pronoun carries case\index{case} marking for the patient of
...
agents\index{case!agent} or patients, and neither can it stand in directly as the agent\index{case!agent} and
patient\index{case!patient} NP\index{phrase types!noun phrase} of the relative clause, respectively. It is interesting in this
regard that Ayeri \emph{does} allow this for recipients, however, maybe since
by their nature as goals they carry something of a locative\index{case!locative} connotation
...
patient---that is, the agent acts on itself---the reflexive prefix\index{prefixes} can also 
...
case\index{case!locative}, even though here as well, the agent and the locative pronoun refer to the
same entity. It may be noted furthermore that the genitive\index{case!genitive}/possessive pronoun
...
the ability of \rayr{sitNF}{sitang} and a non-topic\index{grammatical function!topic} agent pronominal suffix to
...
previously, lexical NPs\index{phrase types!noun phrase} and pronominal suffixes on the verb are mutually
...
answer?}, is \xayr{yNF/nYm}{Yang-nyama}{Even I}, with the quantifier clitic\index{clitics}
leaning on the free pronoun directly, however, since there is no referential
ambiguity in this. Introducing an adverb\index{adverb} shows that the reflexive--quantifier
compound follows the conjugated verb and its adjuncts\index{grammatical function!adjunct}, as in
...
of comparison, Ayeri uses clitic\index{clitics} suffixes on adjectives. The suffixes involved
...
is a patient NP\index{phrase types!noun phrase}; the standard, \rayr{mh}{Maha}, is expressed by an adverbial
...
English \fw{un-}, and \fw{in-}, \fw{il-}, \fw{ir-}, etc.\ for categorial
...
split-off modifiers in noun--noun compounds\index{compound} are thus similar at least
...
Adjectives can also be derived from verbs with the causative\index{case!causative} suffix 
...
suffixes used to express comparative and superlative\index{comparison} are, essentially, a
...
which is likely the reason why Ayeri mostly employs prepositions\index{prepositions}, with 
...
most basic use trigger locative marking\index{case!locative} on the governed NP\index{phrase types!noun phrase}, the adpositional
...
appear in the dative\index{case!dative} and the genitive case\index{case!genitive}, respectively, as described in
...
preposition with the adpositional object\index{grammatical function!oblique} in the locative case\index{case!locative}. In this case,
...
cannot be modified by adjectives\index{adjectives} and relative clauses like regular nouns. Thus,
...
case\index{case} marking makes adpositions derived from nouns, like \rayr{AvnF}{avan}
...
suffixes to prepositions, since these suffixes are clitics\index{clitics} rather than
...
These verbs do not govern a prepositional object\index{grammatical function!oblique} in the locative case\index{case!locative} in their
...
preposition\index{prepositions} meaning `behind, in the back of', though as a postposition it
acquires the related but slightly different meaning `beyond, after, past'. It
might thus better be treated as a homonym of the preposition\index{prepositions} rather than as an
ambiposition \citep[115]{hagege2010}. Example (\ref{ex:pangprep}) illustrates
the use of \rayr{pNF}{pang} as a preposition\index{prepositions}, (\ref{ex:pangpost}) the use of
\rayr{pNF}{pang} as a postposition. This is in contrast to typical
ambipositions such as German \fw{wegen} `because of, due to', 
%in (\ref{ex:wegen}),
...
postpositions are the same as those of prepositions\index{prepositions}. That is, where 
...
clauses. Generally, it is possible for them to be hosts of quantifier clitics\index{clitics} 
...
metaphor for expressing temporal relationships. Notably the prepositions\index{prepositions}
...
\autoref{tab:temppos}). Since postpositions\index{postposition} are not primarily derived from
...
probably still closest to a local preposition\index{prepositions} in that the time span is
...
idiomatic. While the prepositions\index{prepositions} in these two examples each take an NP\index{phrase types!noun phrase}
complement, example (\ref{ex:lingtemp}) shows that it is also possible for
prepositions\index{prepositions} expressing a temporal relationship to govern a subclause. This
ability is even more prominent with temporal postpositions\index{postposition} in that all of the
...
carries inflections. Verbs show person\index{person} and number\index{number} agreement\index{agreement}, but may also
inflect for tense, aspect\index{aspect}, mood\index{mood}, and modality as grammatical categories of the
verb itself. Personal pronouns may furthermore cliticize\index{clitics} to the verb stem, and
...
sentence and the topic\index{grammatical function!topic} NP's\index{phrase types!noun phrase} role in Ayeri's case\index{case} system, which can be
...
canonically in agreement with the agent\index{case!agent} NP\index{phrase types!noun phrase}. Verb conjugation as such is
...
between the stem and the second-person suffix \rayr{/v}{-va} for verbs whose
...
the first person suffixes, hence, the topicalized\index{grammatical function!topic} first-person singular form of
...
fact, a topicalized\index{grammatical function!topic} pronoun clitic, as we will see in the course of the
following discussion. Unlike English, Ayeri does not use agent\index{case!agent} pronouns in
addition to person\index{person} agreement\index{agreement} on verbs. Consider the two examples of English in
(\ref{ex:engpersagr}).
...
shown on the verb by marking for an agent topic\index{grammatical function!topic}. In (\ref{ex:vbagrspapr}),
there is only anaphoric reference to \rayr{AgYaanF}{Ajān}; the full agent NP\index{phrase types!noun phrase} is
...
Ayeri is pro-drop, except that there is also topic\index{grammatical function!topic} marking for an agent there,
...
written language; see \cite[120--122]{lehmann2015}), so topic-marked\index{grammatical function!topic} pronouns
...
illustrated in (\ref{ex:indeppro}). As for case-marked\index{case} person suffixes on
...
grammatical one in absence of an agent NP\index{phrase types!noun phrase} (compare
...
The verb here agrees\index{agreement} with the patient---or is it that person agreement suffixes
on verbs are generally clitics in Ayeri, even where they do not involve case
marking\index{case}? There seems to be a gradient here between what looks like regular verb
...
NP\index{phrase types!noun phrase} dependent. Also consider that for example (b) in the type III transitive
...
one constituent, that is, the agent NP\index{phrase types!noun phrase}. Topic\index{grammatical function!topic} marking should, in my opinion, be
...
Ayeri is in the process of grammaticalizing personal pronouns into person\index{person}
...
part the opposite and uses the case-unmarked\index{case} form of personal pronouns for
...
agreeing\index{agreement} with agents and occasionally patients (but only in absence of agent\index{case!agent}
...
semantics-based case marking\index{case} which marks patient-subjects\index{grammatical function!subject} of passive clauses as
such; the agent case\index{case!agent} is not fully equivalent to a nominative which marks the
subject\index{grammatical function!subject} function. Formally, also, agent NPs\index{phrase types!noun phrase} usually follow the verb, and it
...
can agree with patients as well if the agent NP\index{phrase types!noun phrase} is absent. Taking into account
...
\citep[103]{corbett2006}. Regarding referentiality, the person\index{person} suffixes on the
...
suffix in III needs support from an NP\index{phrase types!noun phrase} in the same clause as a source of
...
agreement as in type III needs support from an NP\index{phrase types!noun phrase} within the verb's scope,
...
ungrammatical: the agreement suffix \rayr{/y}{-ya} itself does not define the
...
subject\index{grammatical function!subject} NP\index{phrase types!noun phrase} is omitted, but plural\index{number!plural} number\index{number} still surfaces in the agreement suffix
...
Ayeri displays a full gamut from personal pronouns (usually agents\index{case!agent}) glued to
...
Of the triad tense--aspect\index{aspect}--mood\index{mood} this section will only cover basic uses of 
...
prefixes\index{prefixes} coalesces with a following /a/ to form a long vowel (see
...
definitely lies in the past and the adverbs\index{adverb} underline this fact. Instead of
...
foremost the adverb\index{adverb} \xayr{Iri}{iri}{already}, which indicates that an action
...
adverbs\index{adverb} or future-tense marking (compare \autoref{subsubsec:future}). Strictly
...
the action is complete, the cessative adverb\index{adverb}
...
use adverbs\index{adverb} like \xayr{myis}{mayisa}{ready, done}, \xayr{Iri}{iri}{already},
\xayr{IknF}{ikan}{completely, wholly} (also as an adjective\index{adjectives}); a quantifier like
\xayr{/henF}{-hen}{all}; verbs like \xayr{smirF/}{samir-}{finish},
\xayr{pN/}{panga-}{end}, and \xayr{rjp/}{raypa-}{stop}; or an indefinite
pronoun expressing entirety, like \xayr{EnY}{enya}{everything, everybody} in
(\ref{ex:entirepfv}).
...
indicate progressive, habitual, and iterative\index{aspect!iterative} actions---by their nature all
...
\rayr{mN}{manga}, which we already saw with directional prepositions\index{prepositions} above
...
Ignoring the constructedness of the above examples, the time adverb\index{adverb} is located 
...
marked with the habitual in Ayeri can be translated by adding the adverb\index{adverb}
...
something \fw{used to} be done in the past, as in (\ref{ex:habvwl}). While the
...
\rayr{mN}{manga} for progressive aspect\index{aspect!progressive} and partial initial reduplication for 
...
way of lexical items, that is, verbs and adverbs\index{adverb}. The relevant words in this
respect are the adverbs\index{adverb} \xayr{sirimNF}{sirimang}{about to} (prospective) and
...
\rayr{myis}{mayisa} (\ref{ex:cessative}) are expressed by adverbs\index{adverb} which are
regularly following verbs as their heads. They precede other adverbs\index{adverb} due to a
higher amount of semantic bondedness, by tendency, than other descriptive
adverbs\index{adverb}. For this reason, as well as for expressing a grammatical function
...
complement\index{grammatical function!open complement} rather than an NP\index{phrase types!noun phrase}. The content/main verb appears in a non-finite
...
the verb and typically follow aspectual\index{aspect} marking where it is expressed by a
suffix, that is, the habitative\index{aspect!habitual} suffix \rayr{As/}{-asa}. The following
...
suffixes may be added, and finally, person\index{person} marking. The same suffix,
...
(\mbox{-\Neg{}=\Fsg{}.\Top{}}). Like the irrealis\index{mood!irrealis} suffix, the
...
usually follows irrealis\index{mood!irrealis} marking when suffixes are stacked: \rayr{/ONF}{-ong} +
...
that is, imperative verbs do not require an overt second person\index{person} agent; if an
...
non-finite forms in that they do not exhibit any agreement\index{agreement} in person\index{person}, number\index{number},
gender\index{gender}, and topic\index{grammatical function!topic}, and also cannot act as hosts for clitic\index{clitics} personal pronouns.
...
intransitive verbs, as well as clitics\index{clitics} which occur in combination with fully
...
progressive\index{aspect!progressive} marker \rayr{mN}{manga}, which is also presumably deverbal
...
in (\ref{ex:modalinvar}), though it carries regular person\index{person} and aspect\index{aspect}
...
(\ref{ex:indirimp}). English may use \fw{shall} here as an equivalent.
...
the subordinate verb is intransitive, like \xayr{mkymF}{makayam}{shining} in
...
latter are dealt with in more detail in the section on adverbs\index{adverb}; only a few
relevant examples will be given here.

\subsubsection{Prefixes}
\label{subsubsec:verbprefixes}

We have already encountered the prefix\index{prefixes} \xayr{d/}{da-}{so, such} in the
...
\xayr{d/}{da-}{such} patterns as a demonstrative with the deictic prefixes\index{prefixes}
...
other inflectional prefixes\index{prefixes}, that is, any tense prefixes\index{prefixes} that may possibly
...
Another possible use of the prefix\index{prefixes} \rayr{d/}{da-} with verbs is related to the
...
off the pronoun and attached to the adjective\index{adjectives} directly to express `the
...
(such.one-\PargI{}), as in (\ref{ex:davb2}), it may also appear prefixed\index{prefixes} to the
verb.
...
proclitic, which we have already seen with both nouns and adjectives\index{adjectives} (compare
...
\xayr{sitNF/}{sitang}{self}, the reflexive clitic, can appear as a prefix\index{prefixes} on
...
person. This means that instead of using the reflexive object\index{grammatical function!primary object} pronoun
\xayr{sitNF/yesF}{sitang-yes}{herself} (self-\TsgF{}.\Parg{}), it is possible
to drop the pronoun and to place the reflexive prefix\index{prefixes} on the verb instead.
...
applicable to nouns, and all of them are also applicable to adjectives\index{adjectives}. As
...
Adverbs in Ayeri are the counterparts of adjectives\index{adjectives} with regards to the
modification of verbs and phrases. Like adjectives\index{adjectives}, they do not display
agreement\index{agreement}, though attributive adverbs may as well take suffixes for comparison\index{comparison}
...
distinction between adverbs and adjectives\index{adjectives}, so the latter may easily be used as
...
carried out, or the circumstances of an event. Like adjectives\index{adjectives}, adverbs follow
...
(\ref{ex:funcadv}), where the attributive adjective\index{adjectives} \xayr{bnF}{ban}{good}
follows the more functional adverb \xayr{Iri}{iri}{already}. In
(\ref{ex:attradv}), on the other hand, the descriptive adjective\index{adjectives}
...
Adverbs do not show agreement\index{agreement}, however, attributive adverbs can be negated.
This makes them very similar to adjectives\index{adjectives}, except that they do not modify
nouns. The negative\index{negation} suffix for attributive adverbs is \rayr{/Oj}{-oy}, which is
...
The adjective\index{adjectives} \xayr{npj}{napay}{spicy} has been seamlessly converted into an
adjective\index{adjectives} here and negated to \xayr{npyoj}{napayoy}{unspicy(ly)}. The semantic
...
possible to compare adverbs in the same way as adjectives\index{adjectives}. Here, however, only 
...
(\ref{ex:voyintens}). The negative\index{negation} intensifier\index{intensifiers} replaces negation\index{negation} on the verb in
...
affirmative particle \rayr{maaj}{māy} after the verb. Example 
...
particle \rayr{voj}{voy} is placed in adverb position after the verb
accordingly.
...
\xayr{d/naarY}{da-nārya}{even though, in spite of, despite} as a postposition\index{postposition}
with a contrastive meaning (see \autoref{subsec:postpos}). As an adposition\index{adpositions} it
...
locative case\index{case!locative} agreement\index{agreement} of the whole CP\index{phrase types!complementizer phrase} with the postposition\index{postposition}, since there is
...
\xayr{dermF}{deram}{matter of fact} declined for dative case\index{case!dative} 
...
however.\footnote{Logical `not' is usually expressed by a negative\index{negation} suffix on
...
reduplication of the verb expresses iterative aspect\index{aspect!iterative}, which in Ayeri is used
...
with \rayr{d/}{da-}, a full-NP\index{phrase types!noun phrase} adverbial with a generic noun has to be used:
*\rayr{dy}{*daya} → \xayr{d/ynoy}{da-yanoya}{in such a place}
(such-place-\Loc{}). Adverbial demonstratives are, like pronouns, in
complementary distribution with full NPs\index{phrase types!noun phrase}, since they are pro-forms. Thus, using
...
be an exception: as a quantifier, \rayr{kj} {kay} means `a little,
...
Cardinal numerals work much like adjectives\index{adjectives} in that they modify nouns. As
...
compounds\index{compound} with lower numerals to fill in the $12^0$ numerals 11, 12, 13, ...,
...
In order to express compound\index{compound} numerals, \rayr{menF/}{men-} is prefixed\index{prefixes} to the
...
elements due to the derivational\index{derivation} suffix \rayr{/AnF}{-an} (compare
...
clause, as (\ref{ex:ordrel}) shows, and an adjective\index{adjectives}, as shown in
...
% \mid 0 < a,b < 12^1\}$.}
behaves like a `tight' noun compound\index{compound}, while ordinals involving unit words for
powers of 12 higher than 1 behave as `loose' compounds\index{compound} (compare
...
as a single unit---a `tight' compound\index{compound}.
...
finger)---a `loose' compound\index{compound}.
...
\autoref{tab:ordinals}) in turn by putting them in the dative case\index{case!dative}: the suffix
...
time', or as an adverb\index{adverb} meaning `$n$ times'. Context helps to disambiguate
between the two, as well as temporal adverbs\index{adverb} like \xayr{Iri}{iri}{already}. An
...
Compound\index{compound} multiplicative numerals are treated as analogous to ordinals, that is,
...
\autoref{tab:ordinals}). The derivative\index{derivation} affix in this case is the instrumental\index{case!instrumental}
...
Ayeri treats cardinal numerals more like adjectives\index{adjectives} than nouns, so using means
of case marking\index{case} is not possible. On the other hand, adpositions\index{adpositions} take both NPs\index{phrase types!noun phrase}
and CPs\index{phrase types!complementizer phrase} as complements\index{grammatical function!closed complement}, so that an adjective\index{adjectives} should be able to act as a
complement to an adposition\index{adpositions} as well. Since the numeral in the PP\index{phrase types!prepositional phrase} is treated
like an adjective\index{adjectives}, it is not marked for locative case\index{case!locative}, since adjectives\index{adjectives} do not
inflect for nominal categories (compare \autoref{sec:adjectives}). Ranges of
cardinal numbers may hence be expressed using the postposition\index{postposition}
...
Context is needed to disambiguate whether the dative\index{case!dative} form of the numeral is a
...
embedded in a PP\index{phrase types!prepositional phrase} headed by the postposition\index{postposition} \rayr{pesnF}{pesan}, it appears in 
...
label `quantifier' here) do not only follow verbs, nouns, adpositions\index{adpositions},
adjectives\index{adjectives}, or other adverbs\index{adverb}, but they cliticize to them, that is, they are
...
Section \ref{subsubsec:conjadv} already dealt with conjunctive adverbs\index{adverb} as
sentence adverbs\index{adverb} and their conjunction-like behavior. The present section is
...
coordination: (\ref{ex:andheads}) combines two adjective-phrase\index{phrase types!adjective phrase} (AP) heads,
\xayr{trnF}{taran}{quiet} and \xayr{stYo}{saco}{cool}, which together make up
the predicative\index{grammatical function!predicative complement} AP\index{phrase types!adjective phrase} that is equated to \xayr{nNaaNF}{nangāng}{a/the house}. In
(\ref{ex:andphrases}), then, two agent NPs\index{phrase types!noun phrase}, \xayr{ynNF}{yanang}{a/the boy} and
\xayr{lyNF}{layang}{a/the girl}, together form the subject\index{grammatical function!subject} of the verb
...
\rayr{soyNF}{soyang}. In (\ref{ex:orheads}), two adjectives\index{adjectives}, 
...
\fw{rather ...\ than}, and
\fw{the ...\ the}.
Ayeri uses the adverb\index{adverb} \xayr{kmo}{kamo}{equally, same, likewise} together with a
...
grains and beans equally', with two NPs\index{phrase types!noun phrase} in alternation, both being objects\index{grammatical function!primary object} of a
...
conjuncts are additionally marked with the comparative\index{comparison} suffix 
...
nor', the verb is negated. \rayr{miry}{miraya} and \rayr{kmyoNF}
