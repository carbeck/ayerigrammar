...
counting in the senary system of Nen described in \citet{evans2009}, quoted in 
\citeauthor{dixon2012}: \textcquote[73--74]{dixon2012}{In counting, Nen 
...
wrist'}.} Ayeri's number words are semantic primes, that is, their meanings 
...
numerals \xayr{Iri}{iri}{five} and \xayr{henF}{hen}{eight} may be an exception, 
since as an adverb, \rayr{Iri}{iri} also means `already', which might refer to 
the fact that a full hand has been counted off; \rayr{henF}{hen} as an adverb 
...
appended to numerals: \rayr{menNF}{menang} (← \rayr{menFnNF}{mennang}), 
\rayr{smNF}{samang} (← \rayr{smFnNF}{samnang}), \rayr{kjnNF}{kaynang}, etc. 
While \rayr{menNF}{menang} is used for 100, the numerals of this series 
...
$n$th full group, thus, 1-\fw{nang} maximally contains \elv\elv\elv\elv; 
2-\fw{nang} maximally contains \elv\elv\elv\elv\,\elv\elv\elv\elv; 3-\fw{nang} 
maximally contains \elv\elv\elv\elv\,\elv\elv\elv\elv\,\elv\elv\elv\elv, etc. 
Furthermore, the myriad-multiples serve as unit words in turn, and thus can be 
modified by numerals again, for instance:
...
\a\begingl
	...
	\glb {1\,0000} {86} {100} {2} {93} //
	\glft 86\,293\tsub{12} = 2\,115\,471\tsub{10} //
\endgl

\xe

Myriad-multiple unit words may also be used as (inanimate) nouns, so it is 
possible to speak of \xayr{menNYe}{menangye}{hundreds}. To express `hundreds of 
people', however, the head of the genitive NP is pluralized exceptionally, even 
if it is a plurale tantum:
...
& $\frac{1}{9}$ & \rayr{menvey}{menveya} \\ [.25\baselineskip]
...
taken as the base and modified by a regular ordinal numeral, as 
...
\ex
	\ayr{\larger menNnF Ito menFlnF/yo nerFnnen kj}\\
	\fw{menangan ito menlan-yo nernanena kay}\\
	`three of the 1\,024th part'
\xe

\noindent using the cardinal form of the denominator.
...
Cardinals are formed by nominalization from ordinal numerals. This may be 
another slightly odd strategy, however, it is at least attested in Classical 
...
office,' cf. \nocite{beyer1992} Beyer 1992: 117). When suffixed to cardinal 
...
firmly treated as nouns due to the derivational suffix \rayr{/AnF}{-an} 
(compare \autoref{subsec:nominalization}).
