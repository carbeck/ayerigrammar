...
function, the semantic component of the modals is still apparent, as is shown by 
(\ref{ex:modalinfl}), which appears in its function as an intransitive verb with 
the same meaning of strong obligation, like in (\ref{ex:modalinvar}), though 
carrying person and aspect inflection. Inflecting the modal in the context of 
cooccurrence with a content verb is, however, considered unacceptable:
