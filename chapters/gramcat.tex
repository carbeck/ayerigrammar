...
Adverbs expressing degree and quantity (quantifiers) do not only follow verbs, 
nouns, adpositions, adjectives, or other adverbs, but they cliticize on them. 
The word stem---a lexical head which is usually inflected except in the case of 
...
an example from each is repeated here for convenience.
...
Quantifying expressions which deviate form the pattern of cliticization are 
\xayr{EkenF}{ekeng}{over-, overly, too} and \xayr{kgnF}{kagan}{far too}. 
