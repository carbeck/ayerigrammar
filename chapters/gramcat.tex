...
function, the semantic component of the modals is still apparent, as is shown 
by (\ref{ex:modalinfl}), which appears in its function as an intransitive verb 
with the same meaning of strong obligation, like in (\ref{ex:modalinvar}), 
though carries regular person and aspect inflection in this context of use. 
Inflecting the modal in the context of cooccurrence with a content verb is, 
however, considered unacceptable:
