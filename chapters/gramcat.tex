...
examples (\ref{ex:vacvaca}) and (\ref{ex:divdiva}). These two verbs in 
particular also stand out, however, by their roots ending in a consonant 
instead of a vowel like in the other cases. This suggests that they may have 
been grammaticalized as modal verbs only relatively recently, and there appears 
to be variation at least for \rayr{vtYF/}{vac-}, for instance:

\ex\begingl
	\gla ... yam vacongyang ilisayam eda-koyās gan ... //
	\glb ... yam vac-ong-yang ilisa-yam eda=koya-as gan ... //
