...
\subsubsection{Concessive and contrastive adverbs}

Ayeri does not have a great number of concessive adverbs, that is, 
\xayr{AreenF}{arēn}{however, anyway}, \xayr{naarY}{nārya}{although, 
though}, and the latter's intesified form, \xayr{d/naarY}{da-nārya}{despite, in 
spite of}, do all the work. \rayr{d/naarY}{da-nārya} may also be used as a 
postposition with NPs (see \autoref{subsec:postpos}). Like adverbs expressing 
stance, they may follow the verb or be placed at the end of the clause. Example 
(\ref{ex:naaryaadv}) above already shows an example of \rayr{naarY}{nārya} being 
used as a sentence adverb. With regards to this word it is important to note 
that \rayr{naarY}{nārya} may also be used as a contrastive conjunction meaning 
`but'. Insofar, its placement in a clause creates a slight difference in 
grammar, though not a great one in meaning, as illustrated by example 
(\ref{ex:naaryaplcmt}) below.
...
Regarding the double function of \rayr{d/naarY}{da-nārya} as both a 
postposition and an adverb, there is an avoidance of placing the word after a 
locative NP if this phrase is not governed by the postposition. In 
(\ref{ex:danaaryapostpos}) below, \rayr{y — sraan yen}{ya … sarān yena} is the 
prepositional object of \rayr{d/naarY}{da-nārya}. On other hand, 
\rayr{d/naarY}{da-nārya} refers to the whole clause in (\ref{ex:danaaryaadv}). 
Placing it after \rayr{rNFy yen}{rangya yena} would wrongly indicate that 
this locative NP, `at (her) home', is the prepositional object when in fact it 
is not supposed to be. Hence, the adverb can only follow the verb in this case.

\pex
\a\label{ex:danaaryapostpos}\begingl
	\gla Ya precang sarān yena da-nārya rangya. //
	\glb Ya pret=yang sarān-Ø yena da-nārya rangya. //
	\glc \LocT{} knock=\Fsg{}.\Aarg{} absence-\Top{} \TsgF{}.\Gen{} 
		in.spite home.\Loc{} //
	\glft `I knocked in spite of her absence at home.' //
\endgl

\a\label{ex:danaaryaadv}\begingl
	\gla Precang, ang yomoyye da-nārya rangya yena. //
	\glb Pret=yang, ang yoma-oy=ye.Ø da-nārya ranya-ang //
	\glc knock=\Fsg{}.\Aarg{}, \AgtT{} exist-\Neg{}=\TsgF{}.\Top{} 
		even.though home-\Loc{} \TsgF{}.\Gen{} //
	\glft `I knocked, even though she wasn't at home.' //
\endgl

\xe

\subsubsection{Argument-structuring adverbs}
...
\xayr{njnj}{naynay}{also, furthermore},
...
... partial overlap with \autoref{subsec:indefpro} ...
