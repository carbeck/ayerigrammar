...
\a\label{ex:nomz-sbj-adj}\begingl
	...
	\glb Lesa-ara sirimang \textbf{vehān-reng} \textbf{tado} //
...
possible for the \rayr{m/}{mə-} prefix to be used to refer to past events from 
a present point of view, context again has to provide the information that the 
frame of reference is past in this case.
...
be used, together with explicit past marking.
...
Of course, it is also possible to refer to actions or events which will already 
have happened before a point in the future. As with future-in-past, there is no 
way in Ayeri to mark this relation morphologically, but lexical means have to 
...
\ex
\begingl
	\glpreamble \textsc{context}: Ajān's traveling to Tasankan tomorrow //
	\gla Ang girenja iri nilay sirutayya pesan. //
...
\begingl
	...
	\glft `He (will) already has/have arrived.' //
\endgl
\xe
