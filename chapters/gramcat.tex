...
place their counting finger on the inside of the wrist'}.} Ayeri's number words 
...
multiplicative numerals are derived from ordinals by putting them in the dative 
case. The resulting multiplicative numeral can thus be used as an adverbial to 
mean `for the $n$th time', or as an adverb to mean `$n$ times'. Context helps 
to disambiguate between the two, as well as temporal adverbs like 
\xayr{Iri}{iri}{already}.
