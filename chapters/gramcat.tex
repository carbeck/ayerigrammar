...
\ex~\label{ex:inchoative}\begingl
	\gla Kəcunreng seyaryam. //
	\glb Kə-cun=reng seyar-yam //
...
complement rather than an NP. The content/main verb appears in an infinite form 
marked by \rayr{/ymF}{-yam}, which is conveniently termed a \emph{participle}, 
