...
person\index{person} is added to this. The individual forms range from completely fused
...
the person\index{person} inflection of the verb, making it structurally closer to type 2.
...
Since person\index{person} marking of the type 1 and 2 is \emph{referential}, as shown in
...
person, number, and gender, and all three types of person\index{person} inflection on verbs
...
inflection on a noun is in agreement like in type 3\,(a), which is
...
they do not exhibit any agreement\index{agreement} in person, number, gender, and topic, and also
