...
the characters, the Finn, \textcquote{christian2017}{makes an offhand 
reference to the \enquote{Act of '53} [\citep[92]{gibson:neuromancer}, 
\textsc{CB}] as a law deals with the citizenship status of artificial 
intelligences}---this is very unlikely to refer to 1953.} Yet, however, 
\citeauthor{gibson:neuromancer} recounts events which are logically happening 
in an imagined future as having already happened in the past: he uses the past 
...
`\citetitle{aesop:northwind}' (compare \cite{aesop:northwind}), illustrates 
