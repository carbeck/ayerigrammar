...
necessarily human, which meant that they would not necessarily have evolved to 
have five fingers on each hand---for an earlier fictional language of mine, 
...
five-digit hands if you counted not only the fingers, but also the hands 
themselves, or the palms. Finger-counting in Ayeri's duodecimal system would 
probably be similar to counting in the senary system of Nen described in 
\citet{evans2009}, quoted in \citeauthor{dixon2012}: 
...
place their counting finger on the inside of the wrist'}. A duodecimal numeral 
system is not unheard of in natural languages, however, so for instance, 
\citeauthor{caingair2000} inform that in Maldivian, the 
\textcquote[21]{caingair2000}{decade plus numeral system is currently in 
fashion, but with some remnants of an older system as well. The numeral \fw{fas 
...
purposes such as counting coconuts.}.} Ayeri's number words 
...
Ranges of cardinal numbers may be expressed using the postposition 
\xayr{pesnF}{pesan}{(up) until}. When counting starts at 
...
Since ordinal numerals are treated as nouns, they may receive case marking, in 
which case it is possible to express a range using a combination of the 
genitive and the dative case, or again \rayr{pesnF}{pesan} with its 
prepositional object in the locative case.
