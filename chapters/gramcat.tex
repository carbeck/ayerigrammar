...
or at least rarely documented in the grammars he surveyed, and in the sample I 
...
In exocentric compounds, the modifier is not a hyponym of its head, which means 
that the modifier is not in a direct semantic relation with the head, so while 
a \fw{dog kennel} is a kennel for a dog, the head of an \fw{egghead} is neither 
for eggs, nor containing eggs, nor made of eggs, or at least not literally so 
\citep[700]{bauer2001}. The sample from the Ayeri dictionary contains a few 
compounds of this type as well, though again, it is not a very productive group:

\pex
	\a \makebox[13em][l]{\xayr{\larger AvnFyonNF}{avanyonang}{artery}}
		← \xayr{\larger AvnF}{avnF}{bottom, down}
		+ \xayr{\larger yonNF}{yonang}{stream}
	\a \makebox[13em][l]{\xayr{\larger bjtMdevo}{baytandevo}{headache}}
		← \xayr{\larger bjtNF}{baytang}{blood}
		+ \xayr{\larger devo}{devo}{head}
	\a \makebox[13em][l]{\xayr{\larger linFyonNF}{linyonang}{vein}}
	...
	\a \makebox[13em][l]{\xayr{\larger siMdjnN}{sindaynanga}{address}}
