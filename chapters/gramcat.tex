...
\fw{n'importe qui} `no matter who'.} This alternation is employed to 
distinguish between the meaning of `sometime', that is, occurring once an 
unspecified point in time, and \xayr{tdYrilF}{tajaril}{sometimes}, that is, 
occurring recurringly at inspecific times. Lastly, the negative series is 
reguarly marked by the negative suffix \rayr{/Oj}{-oy}, which also occurs with 
...
\a specific, known to the speaker:\vspace{.5em} % 1
	\beginsubsub
	\b{a.} \begingl
		\gla Ang sahaya \underline{arilinya}, leku, sinyāng adaley! //
	...
	\b{b.} \begingl
		\gla Le ilta ningyang \underline{linya} vayam. //
