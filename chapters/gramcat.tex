...
The iterative aspect marks actions that are repeated at least once, that is,
\fw{again} by reduplication. This reduplication is, however, only partial, in 
that only the first CV- or, with a lower frequency of occurrence, the first VC- 
of a verb root is repeated:
...
\pex
	...
	\a \makebox[9em][l]{\xayr{\larger AmNF/}{amang-}{happen}}
		→ \xayr{\larger Am/AmNF/}{am-amang-}{happen again}
\xe
