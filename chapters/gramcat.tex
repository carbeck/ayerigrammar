...
\pex
	...
	\a Plurale tantum nouns:\\
		\xayr{burNF}{burang}{lifestock, cattle},\footnotemark 
		\xayr{gneNnF}{ganengan}{siblings}, 
...
For plurale tantum nouns, to express an irregular singular entity, it is always 
possible to use a phrase like \xayr{—/En menF}{…-ena men}{one of …} (…-\Gen{} 
one), for instance:
