...
also having prepositions\index{adpositions!prepositions}---for basing indefinite pronouns on generic nouns\index{nouns!generic}.
...
postposition\index{adpositions!postpositions} \xayr{rnF}{ran}{against} is related.
...
\rayr{mN}{manga}, which we already saw with directional prepositions\index{adpositions!prepositions} above
...
cardinal numbers may hence be expressed using the postposition\index{adpositions!postpositions}
...
embedded in a PP\index{phrase types!prepositional phrase} headed by the postposition\index{adpositions!postpositions} \rayr{pesnF}{pesan}, it appears in 
