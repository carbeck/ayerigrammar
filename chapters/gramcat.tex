...
which triggers the animate agent topic agreement\index{agreement} marker \rayr{ANF}{ang} on the
verb, since the agent NP is also topicalized. The verb also agrees\index{agreement} in person
...
\rayr{/yo}{-yo}. The (non-topicalized) NP's case marking\index{case} shows that the agent 
...
As demonstrated in (\ref{ex:plurals}), the noun plural\index{plural} marker is 
...
the suffix \rayr{/reNF}{-reng} for inanimate\index{animacy} referents; names and verbal topic
...
\rayr{/lej}{-ley}; for names and verbal topic agreement\index{agreement}, the markers are
...
animate and inanimate\index{animacy} entities. Names and verbal topic agreement\index{agreement} are marked
equally by \rayr{ymF}{yam}. Verbs do not exhibit person agreement\index{agreement} with dative
...
dative NPs to appear as topics---person agreement\index{agreement} is unaffected by this,
...
topic agreement\index{agreement} are marked by \rayr{n}{na}. There is no animacy\index{animacy} distinction in
...
an allomorph\index{allomorphy} \rayr{/E\_a}{-ea}, used especially in combination with the plural
suffix \rayr{/ye}{ye}, giving \rayr{/yee\_a}{-yēa}. The modern language uses
\rayr{/yey}{-jya}.} names and verbal topic agreement\index{agreement} use the marker 
...
case\index{case!agent}, though it does not replace it in Ayeri; verbs do not exhibit person
...
verbal topic agreement\index{agreement} use the marker \rayr{saa}{sā}. As stated above, verbs do
...
however, never show person agreement\index{agreement} with instrumental NPs. Common nouns are
marked by \rayr{/ri}{-ri} when ending in a vowel and by \rayr{/Eri}{-eri}
when ending in a consonant; names and verbal topic agreement\index{agreement} are marked by
...
object appears in the locative case\index{case!locative}, as usual, then, compare
(\ref{ex:comitwith}).
...
modified by adjectives\index{adjectives}.
...
grammatical features also found in nouns, that is, number, gender\index{gender}, and case\index{case},
...
third person animate masculine\index{gender} plural pronouns; compare (\ref{ex:prongen}).
...
cliticizing\index{clitics} to the verb stem. Since person agreement\index{agreement} morphology is a domain of
...
*\xayr{naa/vaa}{*nā-vā}{*myest}). Fronting them in predicative statements like
...
\rayr{AdreNF}{adareng} as the dummy agent\index{case!agent} in predicative contexts over the
...
except that as nominal elements they are declined for case\index{case}---but not for number
...
can be marked for case\index{case} and topic like any other nominal element, as
...
be topicalized since they also do not inflect for case\index{case}, which preempts the
...
traits---such as verb-initial, verb--object, and noun--genitive\index{case!genitive} word order,
...
is an old nominalization and very likely related as a morpheme to the locative\index{case!locative}
...
Since double negation---that is, agreement\index{agreement} in negation between verbs and
...
left. Relative pronouns do not agree\index{agreement} in number with their heads, though, and in
...
ungrammatically, forms the controller of topic agreement\index{agreement} on the verb in the 
...
preposition with the adpositional object in the locative case\index{case!locative}. In this case,
...
receive number and case\index{case} marking, which are otherwise typical features of nouns.
...
are not synonymous to an adjunct in the dative\index{case!dative} and the genitive case\index{case!genitive},
...
These verbs do not govern a prepositional object in the locative case\index{case!locative} in their
...
number marking and cannot themselves be modified by adjectives\index{adjectives} or relative 
...
inflect for tense, aspect\index{aspect}, mood, and modality as grammatical categories of the
verb itself. Personal pronouns may furthermore cliticize\index{clitics} to the verb stem, and
the verb phrase is often also marked with a clitic\index{clitics} indicating the topic of the
sentence and the topic NP's role in Ayeri's case\index{case} system, which can be
...
it is a topic; the verb in turn marks the case\index{case} of the topicalized NP with a
...
stay \fw{in-situ}. Which NP constitutes the topic of the phrase is marked on
...
with predicative nominals, as well as other such case-marked\index{case} personal forms, as
...
semantics-based case marking\index{case} which marks patient-subjects of passive clauses as
...
person, number, and gender\index{gender}, and all three types of person inflection on verbs
...
number feature of \rayr{kj}{kay} in (\ref{ex:verbplagr}) coalesces with the
...
Of the triad tense--aspect\index{aspect}--mood this section will only cover basic uses of 
...
and plural second-person addressees, so that the marker is \rayr{/U}{-u} in
...
non-finite forms in that they do not exhibit any agreement\index{agreement} in person, number,
gender\index{gender}, and topic, and also cannot act as hosts for clitic\index{clitics} personal pronouns.
...
in (\ref{ex:modalinvar}), though it carries regular person and aspect\index{aspect}
...
intensifier, as in (\ref{ex:maayintens}). In a similar way, \rayr{voj}{voy} can
...
and CPs as complements, so that an adjective\index{adjectives} should be able to act as a
...
\rayr{pesnF}{pesan} with its prepositional object in the locative case\index{case!locative}.
