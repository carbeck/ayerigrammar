...
into a position behind their head (i.e. Wackernagel's position).
...
\index{tense!past|(}
The past tense indicates completed actions in the past if not further modified. 
...
For the same reason, Ayeri does not employ epic past forms in narrative contexts 
like English, among others, commonly does: 
...
somewhere around the half of the 21st century. Yet, however, 
\citeauthor{gibson:neuromancer} recounts events which are logically happening in 
an imagined future as having already happened in the past: he uses the narrative 
past as the a convention of storytelling. What Ayeri, then, does in contrast to 
...
required. According to \citeauthor{dahl1985}, Ayeri is in good company here, 
since \textcquote[113]{dahl1985}{[m]ore common than marking narrative contexts 
[...] is not marking them—quite a considerable number of languaes use unmarked 
verb forms in narrative contexts}. This, however, is yet different from a 
\emph{narrative present}, that is, the use of present tense within an epic-past 
context, which languages like English may use in narrative contexts to increase 
the feeling of immediacy and thus raise suspense.
...
\subsection{Lexically marked aspectual categories}
... \xayr{mritj}{maritay}{be about to} (prospective) ...
... \xayr{myis}{mayisa}{be done} (cessative) ...
... \xayr{kYunF/}{cun-}{begin to} (inchoative) ...
... \rayr{mN}{manga} + iterative (frequentative) ...
