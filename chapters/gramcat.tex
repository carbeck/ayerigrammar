...
A few instances also exist where a tool of sorts is derived with a suffix that 
is relatable to the instrumental suffix \rayr{/Eri}{-eri} together with the 
nominalizer \rayr{/AnF}{-an}:

\pex
	\a \makebox[11.5em][l]{\xayr{\larger gurF/}{gur-}{turn}}
		→ \xayr{\larger gurFynF}{guryan}{coil, cylinder}
	\a \makebox[11.5em][l]{\xayr{\larger misF/}{mis-}{behave}}
		→ \xayr{\larger miserYnF}{miseryan}{method, strategy}
	\a \makebox[11.5em][l]{\xayr{\larger npF/}{nap-}{burn}}
		→ \xayr{\larger nperYnF}{naperyan}{tinder}
	\a \makebox[11.5em][l]{\xayr{\larger pr/}{pra-}{glitter, gleam}}
