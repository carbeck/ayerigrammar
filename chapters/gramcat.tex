...
\xayr{maav}{māva}{mother}. The remainder falls into the `neuter' category---
...
In (\ref{ex:kukafka}), on the other hand,' \xayr{ku/vipinF}{ku-vipin}{like a
bird} is feasibly interpretable as an adverb, since it follows the verb and
...
\xayr{ku/}{ku-}{like, as though} above, but \rayr{ku/}{ku-} applies not only to nouns themselves. In fact, it rather attaches to whole NPs, which makes it a
...
related indefinite pronoun, \rayr{rnY}{ranya}. The etymologic connections of
the \rayr{r}{ra} part are not presently known, perhaps the postposition
...
indefinite \rayr{me/}{me-} can be used for (3)--(6) in combination with a
(generic) noun to attach to. It needs to be noted that only the indefinite
pronouns with person or thing reference (those including \rayr{nY}{nya})
...
suffixes, an epenthetic \fw{-a-} is inserted between the stem and the second-
