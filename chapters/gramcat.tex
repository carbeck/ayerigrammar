...
mararya
	& next
	& \xayr{mrinF}{marin}{before} + \rayr{/ArY}{-arya} (\Neg{})
	\\
...
postpositions do usually not have a nominal origin but are derived either from 
...
like German \fw{wegen} `because of' in (\ref{ex:wegen}), which has the same 
meaning in either position and the position variant is just a matter of style.
...
\a\label{ex:pangpost}\begingl
	\gla Lesyo pelang si sa nimpisayo penungya pang. //
	\glb Les-yo pel-ang si sa nimp-isa=yo.Ø penung-ya pang //
	\glc fall-\TsgN{} horse-\Aarg{} \Rel{} \PatT{} 
		run-\Caus{}=\TsgN{}.\Top{} stable-\Loc{} back //
	\glft `The horse raced past the barn fell.' //
\endgl
