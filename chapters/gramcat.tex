...
the modifier and the head are various: a \fw{grape} is a berry \emph{used} to 
make wine from \parencite[compare][702]{bauer2001}; \fw{vertigo} is the fear 
\emph{of} height; a \fw{mustache} is a beard \fw{located} over the lips 
\parencite[702]{bauer2001}; and a \fw{sunblind} is a screen \fw{against} the 
...
Thre is a modicum of alteration happening in all of the heads of the example 
...
may form linking elements, though he also quotes languages which allow other 
case markers on the modifying element in languages with head-right order; 
individual languages may allow even more case inflection. However, this appears 
not to happen in Ayeri; the only element that comes up time and again in 
between the two halves of compounds is the nominalizer \rayr{/AnF}{-an}, which 
signifies that the head is being formed by a nominalized root, such as in 
...
from the verb \xayr{niNF/}{ning-}{tell}.
