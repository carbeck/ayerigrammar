...
which a judgement is made about is also assigned the agent case, as
...
anaphora as well. Thus, to express `the \textsc{adjective} one', it may be
necessary to use the full demonstrative pronoun, \rayr{dnY}{danya}, since
adjectives do not decline, and Ayeri largely avoids undeclined NPs. An example
is given in (\ref{ex:danyaadj}).\footnote{See \autoref{subsec:uncased} above
for examples of situations where nouns regularly do not exhibit case marking.}
...
However, it is also possible to abbreviate \rayr{dnY}{danya} to the prefixed
form \rayr{d/}{da-}, which may be complemented by adjectives and possessive
pronouns alike. The adjective or pronoun basically forms a complex anaphora,
then, which in most circumstances can be marked for case and topic like any
other nominal element, as demonstrated in (\ref{ex:redone}).
...
All interrogative pronouns share the property that they are placed
...
Ayeri does not strictly distinguish animate and inanimate referents in its
...
case by the suffix \rayr{/Is}{-isa}. Declension of \rayr{sinY}{sinya} for
different purposes is demonstrated in (\ref{ex:sinyacase}).
