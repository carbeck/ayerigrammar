...
it. \rayr{IpnF}{ipan} can thus also be used to mean `extremely':
...
however.\footnote{Logical `not' is usually expressed by a negative suffix on the 
adjective or the verb, compare sections \ref{subsec:adjneg} and 
...
lack a verb to apply verb morphology to. These two conjunctive adverbs thus 
can convey the most important distinctions otherwise expressed by the verb as a 
...
of adverbial demonstratives is incomplete in that forms with 
