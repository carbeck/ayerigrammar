...
previously, lexical NPs and pronominal suffixes\index{suffixes} on the verb\index{verbs} are mutually
...
suffix\index{suffixes} in 3 needs support from an NP in the same clause as a source of
