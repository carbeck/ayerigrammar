...
from body parts, for instance (compare \cite[74]{dixon2012}). The numeral 
\xayr{Iri}{iri}{five} may be an exception, since as an adverb it also means 
`already', which might refer to the fact that a full hand has been counted off.
