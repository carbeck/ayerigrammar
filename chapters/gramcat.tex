...
is why I try to avoid terminology associated with the nominative--accusative 
alignment system.} Thus, the first NP after the verb in all of the following 
...
\a\begingl
	...
	\glb \textbf{Yam} il-ya Ø Taryan koya-ley \textbf{ayon-Ø} //
...
just agents and patients. Thus, it is possible for dative NPs to appear as 
topics. The following example shows the addressee of a speech act in the dative 
case; the message is treated as the theme which is passed on:
...
(\ref{ex:datlocprep}) implies that the man is going literally to the top of the 
temple, that is, possibly ending up on its roof.
...
The genitive is used to mark the possessor of something; attributive genitives 
follow the possessee. The genitive can also be used to mark movement from a 
place.
