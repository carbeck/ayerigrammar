...
still be modified by quantifiers and quantifying clitics; verb agreement\index{agreement} as
...
agreement\index{agreement} are marked by the clitic case markers \rayr{ANF}{ang} and
...
compound, acts in the way of an adjective\index{adjectives} in that `fingernail' is not used as a
...
as a superlative form; the suffix modifies the noun--adjective\index{adjectives} compound as a
...
form is not treated in the way of an endocentric compound, so case\index{case} and
...
as animate nouns. Since they are impersonal, they trigger neuter agreement\index{agreement} on
...
grammatical features also found in nouns, that is, number, gender, and case\index{case},
...
cliticizing to the verb stem. Since person agreement\index{agreement} morphology is a domain of
...
If incorporated in this way, the adjective\index{adjectives} cannot take comparison morphology:
...
gender only insofar as it is relevant to nominal case\index{case} inflection, that is,
...
answer?}, is \xayr{yNF/nYm}{Yang-nyama}{Even I}, with the quantifier clitic
...
agreement\index{agreement}, though attributive adverbs may as well take suffixes for comparison
...
superlative carries the enclitic \rayr{/vaa}{-vā} as a marker, as in
(\ref{ex:advsupl}).
...
The discourse particles \xayr{maaj}{māy}{yes} and \xayr{voj}{voy}{no} can also
...
In order to express compound numerals, \rayr{menF/}{men-} is prefixed to the
...
elements due to the derivational suffix \rayr{/AnF}{-an} (compare
...
\autoref{tab:ordinals}). The derivative affix in this case is the instrumental\index{case!instrumental}
...
multiplicative derivation or an actual ordinal numeral in the dative case\index{case!dative}.
