...
nominals. Animate patients are marked by \rayr{/AsF}{-as}, inanimate ones by
...
like adjectives, they need \rayr{d/}{da-} as a supporting particle in order to
...
adjectives, namely, they cannot be compared (*\xayr{naa/ENF}{*nā-eng}{*myer},
...
conjunction for many of these. \index{conjunctions!kamonay@\fw{kamo ... nay}|(}
\xayr{kmo—nj}{kamo ...\ nay}{equally ...\ and} is equivalent to `both
...
\rayr{kmo}{kamo} as well here; compare (\ref{ex:bothand}). Alternatively, it is
possible to use a construction with \xayr{njnj}{naynay}{(and) also}, as in 
(\ref{ex:andaswell}).
