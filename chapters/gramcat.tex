...
\draw (8) -- (9);
%
\node[haspanno] (l1) at (1,3) {specific known};
\node[haspanno] (l2) at (2,3) {specific unknown};
\node[haspanno] (l3) at (3,3) {irrealis non-specific};
\node[haspanno] (l4) at (4,4) {question};
\node[haspanno] (l5) at (4,2) {conditional};
\node[haspanno] (l6) at (5,4) {indirect negation};
\node[haspanno] (l7) at (6,5) {direct negation};
\node[haspanno] (l8) at (5,2) {comparative};
\node[haspanno] (l9) at (6,1) {free choice};
\end{tikzpicture}
