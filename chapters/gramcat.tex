...
nouns (that is, names) and nominalizations\index{nominalization}. Nouns, as the heads of NPs, are
...
verb, since the agent NP is also topicalized\index{grammatical function!topic}. The verb also agrees\index{agreement} in person\index{person}
...
\rayr{/yo}{-yo}. The (non-topicalized\index{grammatical function!topic}) NP's case marking\index{case} shows that the agent 
...
agreement\index{agreement} on the verb uses the marker \rayr{s}{sa} according to the NP being
...
the verb will: it now agrees\index{agreement} with the next argument in line, the patient NP. It
...
whichever NP follows it, even if it can be assumed that verb agreement\index{agreement} in Ayeri
...
however. \citet{corbett2006}, notes that with regards to agreement\index{agreement} in NP
conjuncts, \textcquote[62]{corbett2006}{distant agreement\index{agreement} is rare, and that
agreement\index{agreement} with the nearest noun phrase or agreement\index{agreement} with all (resolution) is
...
dative NPs to appear as topics\index{grammatical function!topic}---person\index{person} agreement\index{agreement} is unaffected by this,
...
however, never show person\index{person} agreement\index{agreement} with instrumental NPs. Common nouns are
...
with prepositions for some kind of prolative meaning. The adposition\index{adpositions} would
...
sentence with full subject\index{grammatical function!subject} and object\index{grammatical function!primary object} NPs; (\ref{ex:pronagt}) shows a variation
...
NP which contains an adjective\index{adjectives} is wholly replaced by a personal-pronoun DP 
...
Example (\ref{ex:agtproclt_1}) again has full subject\index{grammatical function!subject} and object\index{grammatical function!primary object} NPs; the verb
displays \rayr{/y}{-ya} as the agreement\index{agreement} suffix for the masculine agent\index{case!agent} NP.
Example (\ref{ex:agtproclt_2}), then, replaces the agent\index{case!agent} NP with a pronoun.
...
predicative adjective\index{adjectives!predicative} or NP, which is the main reason why it occurs so
...
role of the NP it replaces, and it can also be topicalized\index{grammatical function!topic}, since the element
...
patient\index{case!patient} NP of the relative clause, respectively. It is interesting in this
...
is a patient NP; the standard, \rayr{mh}{Maha}, is expressed by an adverbial
genitive\index{case!genitive} NP. The example in (\ref{ex:sfxsupl}) similarly expresses a quality
...
hosts, are the prefix \rayr{ku/}{ku-}, expressing semblance as in
...
most basic use trigger locative marking\index{case!locative} on the governed NP, the adpositional
...
the verb phrase is often also marked with a clitic\index{clitics} indicating the topic\index{grammatical function!topic} of the
sentence and the topic\index{grammatical function!topic} NP's role in Ayeri's case\index{case} system, which can be
...
canonically in agreement with the agent\index{case!agent} NP. Verb conjugation as such is
...
there is only anaphoric reference to \rayr{AgYaanF}{Ajān}; the full agent NP is
...
we need to consider, namely that the topic\index{grammatical function!topic} morpheme on noun phrases is zero.
...
one constituent, that is, the agent NP. Topic\index{grammatical function!topic} marking should, in my opinion, be
...
subject\index{grammatical function!subject} function. Formally, also, agent NPs usually follow the verb, and it
...
no agent\index{case!agent} NP that could serve as a controller if the verb inflection in type II
...
subject\index{grammatical function!subject} NP is omitted, but plural\index{number!plural} number\index{number} still surfaces in the agreement suffix
...
agreement is thus with the whole agent\index{case!agent} NP rather than just with
...
\rayr{m/}{mə-} prefix to be used to refer to `regular' past events from a
...
the past prefix \rayr{m/}{mə-} with a partially reduplicated verb, the example
...
complement\index{grammatical function!open complement} rather than an NP. The content/main verb appears in a non-finite
...
accepts either a noun phrase or a complementizer phrase (CP) as a complement\index{grammatical function!closed complement}.
In the latter case, which is shown in (\ref{ex:danaarya2}), there is no
locative case\index{case!locative} agreement\index{agreement} of the whole CP with the postposition, since there is
...
numeral is thus normally sufficient to mark the whole NP as plural\index{number!plural}.
...
In order to express compound\index{compound} numerals, \rayr{menF/}{men-} is prefixed to the
...
of case marking\index{case} is not possible. On the other hand, adpositions\index{adpositions} take both NPs
and CPs as complements\index{grammatical function!closed complement}, so that an adjective\index{adjectives} should be able to act as a
complement to an adposition\index{adpositions} as well. Since the numeral in the PP is treated
...
the predicative\index{grammatical function!predicative complement} AP that is equated to \xayr{nNaaNF}{nangāng}{a/the house}. In
...
phrasal heads making up a predicative\index{grammatical function!predicative complement} AP. Then, in (\ref{ex:orphrases}), the
...
grains and beans equally', with two NPs in alternation, both being objects\index{grammatical function!primary object} of a
