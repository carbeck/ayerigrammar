...
\ex\labels
	\begin{tabular}[t]{@{\tl\quad} l @{\enspace←\enspace} l @{\smallskip}}
	\xayr{\larger AnFlaagonnF}{anlāgonan}{pronunciation}
...
\ex\labels
	...
	\xayr{\larger simileno}{simileno}{horizon}
		...
		\\
	\xayr{\larger sitemFrugonF}{sitemrugon}%
		{thunderstorm}
...
marking, in means that, in contrast to cardinal numerals, it is possible to 
