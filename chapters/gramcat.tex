...
(complement phrases) as complements, and thus an adjective should not be 
problematic as a complement either, since it is embedded in an NP. Thus, ranges 
of cardinal numbers may be expressed using the postposition 
