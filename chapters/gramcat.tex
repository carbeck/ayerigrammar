...
In example (\ref{ex:gender1}), the noun in the agent noun-phrase (NP),
...
the verb phrase is often also marked with a clitic indicating the topic\index{grammatical function!topic} of the
...
construction, that is, \rayr{kYunF/}{cun-} requires a semantically contentful verb phrase (VP) as a
