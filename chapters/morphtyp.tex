...
One case of analytic morphology is compound prepositions\index{adpositions!prepositions} like \xayr{mN
lug}{manga luga}{through} in (\ref{ex:dyn}), but verbs\index{verbs} as well show analytic
...
Note, though, that pre-\index{prefixes} and suffixes\index{suffixes} proper also have a fixed order in Ayeri,
...
\rayr{d/}{da-} is also used with nouns\index{nouns}, forming part of the series of deictic
...
Of the deictic prefixes\index{prefixes}, \rayr{d/}{da-} is not only available to verbs and
...
Reversing the order of the prefixes\index{prefixes} is not possible, as is shown in
...
While in Ayeri, there is no defaulting to a certain person\index{person} in the presence of
...
affixes do not default to some form, and verbs\index{verbs} cannot be unmarked either, that
...
totally unambiguously so. Thus, in (\ref{ex:clitics_59a}), while \rayr{koyaasF
...
morphology on the verb\index{verbs}. Dependent marking is exhibited, for instance, in the 
...
The only instance of head-marking there is in Ayeri is person-marking\index{person} on the
