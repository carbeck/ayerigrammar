...
\rayr{/lej}{-ley} (the latter, however, conflates animacy\index{animacy} and case\index{case}). Strictly 
...
encodes the person\index{person} features third person, feminine\index{gender}, singular\index{number}, and agent\index{case}. 
...
Ayeri's personal pronouns\index{pronouns!personal} were indeed agglutinative\index{agglutination} as well, so 
...
conjunctions\index{conjunctions} as well can appear with them. Some of these are likely clitics\index{clitics};
...
despite} where \rayr{d/}{da-} combines with the conjunction\index{conjunctions}
...
As a largely agglutinative\index{agglutination} language, most grammatical marking in Ayeri happens
to be done by means of suffixes. These occur mainly with nouns\index{nouns} and verbs\index{verbs},
however, some basic quantifiers\index{quantifiers} take the shape of suffixes as well, but behave
more like enclitics\index{clitics}. Quantifiers may modify content words almost regardless of
their part of speech---noun\index{nouns}, verb\index{verbs}, adjective\index{adjectives} or adverb\index{adverbs}. The most pervasive
examples of suffixation are certainly those of case\index{case} marking on nouns\index{nouns} and of
person\index{person} marking on verbs, as exemplified in (\ref{ex:conjdecl}).
...
provide instances of the exceedingly common markers for agent\index{case!agent} and patient case\index{case!patient},
...
whether an agent\index{case!agent} NP\index{phrase types!noun phrase} proper is present or not for the verb\index{verbs} to agree\index{agreement} with. In
...
reduplication of the imperative\index{mood!imperative} form to create a hortative\index{mood!hortative} statement
...
iterative\index{aspect!iterative}, compare (\ref{ex:iter}). The imperative\index{mood!imperative} iterative\index{aspect!iterative}, then, has a
hortative\index{mood!hortative} function as well in (\ref{ex:hort+iter}).
...
\rayr{mN}{manga} equally has scope\index{scope} over both verb\index{verbs} conjuncts,
...
any of the intrinsic morphological categories of the verb\index{verbs} (tense\index{tense}, aspect\index{aspect}, mood\index{mood},
modality, finiteness\index{verbs!finite}), just as the topic\index{grammatical function!topic} marker marks for none of the verb's
...
Generally, \rayr{ku/}{ku-} fulfills the function of the preposition\index{adpositions!prepositions} \fw{like}
in English\index{English} in (\ref{ex:clitics_30}). However, if it were a preposition\index{adpositions!prepositions} in
...
predicative\index{grammatical function!predicative complement} NPs\index{phrase types!noun phrase} are otherwise wont to do. Moreover, while prepositions\index{adpositions!prepositions} like
...
Ayeri's very regular agglutinating\index{agglutination} nature makes splitting composed words very
...
The comparative\index{comparison} suffixes on adjectives\index{adjectives}, \rayr{/ENF}{-eng} (\Comp{}) and
...
In this example, the verb exhibits canonic agreement\index{agreement} with the agent, 
\rayr{AgYaanF}{Ajān}, in person, gender, and number. It is additionally marked 
for a patient topic, \rayr{pil}{Pila}, and thus serves as an agreement\index{agreement} target
