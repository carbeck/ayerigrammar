...
\rayr{mN}{manga} is treated there as being part of things the verb inflects
for, that is, progressive aspect, in spite of appearing superficially as a
function word. The topic marker \rayr{ANF}{ang} does not reflect a
...
\ups{\Sbj{}} and \ups{\Oblq{loc}} indicate that the verb, `come', governs two 
...
\rayr{mN}{manga} is thus a functional morpheme and it always appears before the
adposition itself. Adpositions do not otherwise inflect, but \rayr{mN}{manga},
