...
With nouns, full reduplication is used to create a diminutive form, though 
some reduplications are also lexicalized and use stems from other parts of 
speech as well to form nouns:
...
\pex
	...
	\a \makebox[8em][l]{\tayr{kusang}{double (adj.)}} → 
		\tayr{kusang-kusang}{model}
	\a \makebox[8em][l]{\tayr{veh-}{build}} → \tayr{veha-veha}{tinkering}
\xe

There are also a number of adjectives for which there exists a lexical 
reduplication with an intensifying meaning; this, however, is not a productive 
derivation strategy:

\pex
	\a \makebox[6em][l]{\tayr{apan}{wide}} → \tayr{apan-apan}{extensive}
	\a \makebox[6em][l]{\tayr{ikan}{complete}} → \tayr{ikan-ikan}{entire, 
		total}
	\a \makebox[6em][l]{\tayr{kebay}{alone}} → \tayr{kebay-kebay}{all alone}
	\a \makebox[6em][l]{\tayr{pakas}{special}} → \tayr{pakas-pakas}{gay}
	\a \makebox[6em][l]{\tayr{pisu}{tired}} → \tayr{pisu-pisu}{exhausting}
\xe
