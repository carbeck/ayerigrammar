...
parallels the English progressive construction (\ref{ex:ripprog}). However, at 
least in my own variety of colloquial Standard German, it is still at a stage 
where its use is optional rather than obligatory.
...
is \xayr{ku/nsYr}{ku-nasyara}{as follows}, \rayr{nsY/}{nasy-} meaning 
`follow'. What is curious here is that this fossilized form has 
third-person agreement but is lacking agent case marking. The expected form 
would be *\,\rayr{ku/nsYreNF}{*ku-nasyareng} (like=follow=\TsgI{}.\Aarg{}).
