...
which can inflect; nouns, adjectives\index{adjectives}, and the relativizer can do
so as well.
...
orthography, but can modify verbs and adpositions\index{adpositions}---heads of verb phrases (VPs)
...
Personal pronouns,\index{pronouns!personal} of which the person clitics\index{clitics} on 
...
structures not only with the progressive\index{aspect!progressive} marker, but also with modals, as
...
these modal particles behave more like clitics\index{clitics} than function words. Consider,
...
Prefixes in Ayeri apply mainly to verbs, but nouns, pronouns, adjectives\index{adjectives} and
...
though} (also a proclitic\index{clitics}) can be used with both adjectives\index{adjectives} and nouns, as well
...
their part of speech---noun, verb, adjective\index{adjectives} or adverb\index{adverbs}. The most pervasive
examples of suffixation are certainly those of case\index{case} marking on nouns and of
...
\rayr{/ANF}{-ang} and \rayr{/AsF}{-as}, respectively. Besides case\index{case}, nouns can
also be marked for plural with the suffix \rayr{/ye}{-ye}, and verb roots may
be extended by the mood and aspect\index{aspect} markers \rayr{/ONF}{-ong} (\Irr{}),
...
whether an agent\index{case!agent} NP proper is present or not for the verb to agree with. In
...
iterative\index{aspect!iterative}, compare (\ref{ex:iter}). The imperative iterative\index{aspect!iterative}, then, has a
...
the agreement\index{agreement} of the relativizer with the preceding NP. Which grammatical role
...
patients\index{case!patient}---the animacy\index{animacy} value of the topicalized noun phrase (NP), so the
...
Besides verbs, nouns as well have preposed modifiers\index{word order}. This is the
case with proper nouns specifically, where the name is preceded by a case\index{case}
...
as agents in both cases. The case\index{case} marker is missing when the NP is topicalized,
...
NP in a conjunct, preposed\index{word order} case\index{case} markers as that in (\ref{ex:clitics_7c}) may be
...
case\index{case} markers are clitics. It should be noted furthermore that a single NP
...
The case\index{case} markers of proper nouns are necessarily proclitics rather than
...
The fact that case\index{case} particles attach always to a proper noun very specifically
...
coordinated\index{coordination} NPs, we can see in (\ref{ex:clitics_mangacoord2}) that there is no
...
any of the intrinsic morphological categories of the verb (tense, aspect\index{aspect}, mood,
...
its prefixes reversed, so \rayr{md/pinYy}{məda-pinyaya} is not acceptable.
...
Given the evidence from Turkish\index{Turkish}, the categorization of deictic prefixes as
...
As described above, proper nouns are case-marked by clitic case\index{case} markers
preceding the noun. In fact, these markers must be located somewhere at the
left periphery of the NP, so the deictic prefixes stand in between the case\index{case}
...
The question now is, what happens to coordinated\index{coordination} proper nouns? Since the
suffixed case\index{case} markers on common nouns have the distributional properties of
...
(\ref{ex:clitics_20}). For proper nouns it ought to be possible for both a case\index{case}
marker and a deictic prefix to have scope over coordinated\index{coordination} proper nouns, as in
...
\rayr{ku/}{ku-}. This prefix is also applicable to adjectives\index{adjectives}, and is maybe
...
in English in (\ref{ex:clitics_30}). However, if it were a preposition\index{adpositions!prepositions} in
...
predicative NPs are otherwise wont to do. Moreover, while prepositions\index{adpositions!prepositions} like
...
over coordinated\index{coordination} NPs. As (\ref{ex:clitics_30c}) shows, narrow scope is possible
...
conjunct---if the NP is preceded by a case\index{case} marker, as shown in
...
complement of \xayr{silFvYeNF}{silvyeng}{she looks} which is analyzed here as
...
examples from Breton\index{Breton} and Irish where the person marking on the verb is in
complementary distribution\index{complementary distribution} with full NPs, as illustrated in
...
complementary distribution\index{complementary distribution} with full subject pronouns at least for some parts
...
person suffix as its person-inflection agreement\index{agreement} target. The agreement\index{agreement} suffix
\rayr{/y}{-ya} thus reflects that the subject NP needs to have a certain set of
person features. The NP which controls verb agreement\index{agreement} (in canonical cases the
agent\index{case!agent} NP) needs to match these features in order to establish an agreement\index{agreement}
...
like in (\ref{ex:clitics_41b}), where person agreement\index{agreement} is triggered by a
...
topic-marked forms of pronouns are also underspecified for case\index{case}, and they
happen to be the same as those of the person-agreement\index{agreement} suffixes, as exemplified
by \rayr{/y}{-ya} in (\ref{ex:clitics_40a}). Thus, a topic-marked pronominal
suffix on the verb will look exactly like ordinary agreement\index{agreement} with a full NP,
...
a person-agreement\index{agreement} suffix from a homophonous topicalized pronominal suffix is a
premature conclusion. In fact, the verb always agrees with its subject, which
is most often the agent\index{case!agent} NP. The topic may consist of any NP, also oblique ones.
...
underspecified for case\index{case}. In absence of an NP to agree with, it follows from
...
Instances of other case-unmarked\index{case} nouns can be ruled out as being also part of
...
case-unmarked\index{case} noun in question is also part of the agent NP, discard it as a
...
reasons. Thus, in coordination\index{coordination}, every conjunct has to be inflected for person
...
syntactic domain. Adjuncts can also be coordinated\index{coordination} with other adjuncts in the
...
quantifiers with intensifiers like \xayr{EkenF}{ekeng}{too} and
...
suffixes as predicative adverbs\index{adverbs} pose a difficulty in that quantifier suffixes
...
the locative case\index{case!locative}, which is marked on the prepositional object while the 
preposition\index{adpositions!prepositions} itself, as the head of the PP, does not receive marking:
...
The relativizer, likewise, may agree in case\index{case} with the NP in the matrix clause
...
in topicality, since topic and case\index{case} are no categories the verb normally
