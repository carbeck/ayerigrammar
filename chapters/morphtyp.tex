...
interpreted as distributing to the constituent parts of whole verb complex, so
that they just generally add the feature [\Mood{} \Irr{}] to the
verb's feature list in analogy to [\Asp{} \Prog{}] in (\ref{ex:clitics_2}):
...
The fact that case particles attach always to a proper noun very
specifically makes them unlike `typical' clitics, however, since according to
