...
which can inflect; nouns\index{nouns}, adjectives\index{adjectives}, and the relativizer can do
so as well.
...
Besides prefixes\index{prefixes} and suffixes, Ayeri also possesses at least one element in
both the verb cluster and cooccurring with adpositions\index{adpositions} which straddles the
...
orthography, but can modify verbs and adpositions\index{adpositions}---heads of verb phrases\index{phrase types!verb phrase} (VPs)
and prepositional phrases\index{phrase types!prepositional phrase} (PPs), re\-spec\-tive\-ly. It is unstressed and
...
As we have seen in the examples above, person\index{person} suffixes on verbs are single 
...
Ayeri's personal pronouns were indeed agglutinative\index{agglutination} as well, so 
...
Prefixes in Ayeri apply mainly to verbs, but nouns\index{nouns}, pronouns, adjectives\index{adjectives} and
...
every conjunct in coordination\index{coordination} \citep[139]{spencerluis2012}---are the tense
...
are counted as parts of the IP\index{phrase types!inflectional phrase} but do not interact with it regarding stress
assignment (topic\index{grammatical function!topic} particles are always unstressed) while they are consistently
...
to be done by means of suffixes. These occur mainly with nouns\index{nouns} and verbs,
...
their part of speech---noun\index{nouns}, verb, adjective\index{adjectives} or adverb\index{adverbs}. The most pervasive
...
also be marked for plural\index{plural} with the suffix \rayr{/ye}{-ye}, and verb roots may
...
is realized as agreement\index{agreement} suffixes or of clitic\index{clitics} personal pronouns depending on
whether an agent\index{case!agent} NP\index{phrase types!noun phrase} proper is present or not for the verb to agree with. In
(\ref{ex:conjdecl}), a cliticized agent pronoun \xayr{/yNF}{-yang}{I}
(\Fsg{}.\Aarg{}) appears.

As mentioned above, quantifiers appear as enclitics\index{clitics} on almost any type of
...
circumstances and is replaced by compensatory stress on the secondary case\index{case}
...
the agreement\index{agreement} of the relativizer with the preceding NP\index{phrase types!noun phrase}. Which grammatical role
the relativizer's head represents an agreement\index{agreement} controller is essentially
...
\rayr{mN}{manga} equally has scope over both verb conjuncts,
...
things the verb inflects for, that is, progressive aspect\index{aspect!progressive}, in spite of
...
inflection, so in (\ref{ex:clitics_1c}) the irrealis\index{mood!irrealis} suffix \rayr{/ONF}{-ong}
...
the verb can be negated\index{mood!negative}, but not the modal particle\index{modals}. Possibly, it would be
...
acts differently from English\index{English} here in that the content verb is not a complement\index{grammatical function!open complement}
of the modal element. This assumption is supported by the fact that in Ayeri,
the verb inflects, but not the modal particle\index{modals}. Furthermore, modal particles\index{modals}
cannot be modified by adverbs\index{adverbs} in the way regular verbs can, see
(\ref{ex:clitics_5}).
...
case with proper nouns\index{nouns} specifically, where the name is preceded by a case\index{case}
particle instead of receiving a case-marking suffix like common nouns\index{nouns!common} do. This
case\index{case} marker is phonologically weak in that its phonological make-up is similar
to that of affixes, and unstressed, with the exception of the causative case\index{case!causative}
marker \rayr{saa}{sā}, which bears at least secondary stress since it contains
a long vowel. We already saw case\index{case} particles preceding names in
...
\rayr{diy}{Diya}, not \rayr{ANF diy}{ang Diya}. While case\index{case} suffixes have narrow
...
used with wide scope if both conjuncts are proper nouns\index{nouns}. Narrow scope with
...
material, special positioning, and wide scope---one may argue that the preposed\index{word order}
...
closer to affixes---just like the suffixed case\index{case} markers. On the other hand, as
...
functional morpheme and it always appears before the adposition\index{adpositions} itself.
...
of the verb \xayr{mN/}{manga-}{move} to appear in is as a non-finite complement\index{grammatical function!open complement}
...
above, there is also what is spelled as a prefix\index{prefixes} on the verb which appears to
...
any of the intrinsic morphological categories of the verb (tense, aspect\index{aspect}, mood\index{mood},
...
not possibly a prefix\index{prefixes}. Furthermore, while the tense prefixes\index{prefixes} undergo crasis,
...
function, is unstressed, and may have wide scope over conjoined NPs\index{phrase types!noun phrase}, unless an
...
diagnostic of scope is devalued by the Turkish\index{Turkish} examples. On the other hand,
suffixes on nouns\index{nouns} do not behave this way in Ayeri, as demonstrated in
...
suffixed case\index{case} markers on common nouns\index{nouns!common} have the distributional properties of
...
marker and a deictic prefix\index{prefixes} to have scope over coordinated\index{coordination} proper nouns\index{nouns!proper}, as in
...
adjectives\index{adjectives} follow their heads, the original order of
...
should be possible for the prefix\index{prefixes} to take wide scope as in
(\ref{ex:clitics_29b}). However, it seems better to me to instead rephrase the
coordinated\index{coordination} adjective\index{adjectives} as a relative clause like in (\ref{ex:clitics_28c}), for
...
\rayr{d/}{da-} with adjectives\index{adjectives} and possessive pronouns seems to be most like a
...
which appear as free words or phrases (adjectives\index{adjectives}, relative clauses, nominal
adjuncts\index{grammatical function!adjunct}) follow nouns and cannot appear in the position of \rayr{ku/}{ku-}.
...
over coordinated\index{coordination} NPs\index{phrase types!noun phrase}. As (\ref{ex:clitics_30c}) shows, narrow scope is possible
...
also have scope over two individuated noun phrase\index{phrase types!noun phrase} conjuncts. Besides nouns,
...
suffix at the right edge of an NP\index{phrase types!noun phrase}---or at the right edge of the first NP\index{phrase types!noun phrase}
...
whatever modifies adjectives\index{adjectives} usually trails after them.

\label{clitics_preverb_ku}
Besides attaching to words, \rayr{ku/}{ku-} is furthermore able to subordinate
non-finite CPs\index{phrase types!complementizer phrase}. Since \rayr{ku/}{ku-} leans on a whole phrase in
...
one, part of the person\index{person} suffixes on the verb. Especially tricky in this regard
...
the person\index{person} suffix itself realizes the \Subj{} function of the verb's argument
...
\rayr{/yaaNF}{-yāng} on the verb is redundant in the presence of a full NP\index{phrase types!noun phrase}
...
for predication, like a pronoun. Pronouns and full NPs\index{phrase types!noun phrase} necessarily exclude\index{complementary distribution} each
other, however.
...
such an incorporated pronoun is also eligible for topicalization\index{grammatical function!topic}. As we have
...
topic-marked\index{grammatical function!topic} forms of pronouns are also underspecified for case\index{case}, and they
...
premature conclusion. In fact, the verb always agrees with its subject\index{grammatical function!subject}, which
...
The verb generally does not agree with non-agent or non-patient NPs\index{phrase types!noun phrase}, however.}
...
this definitional lack that the person\index{person} marking on the verb itself is to be
...
possibilities of word order change and coordination\index{coordination} between different
...
correctly achieved by ordinarily placing the adjective after the coordinated\index{coordination}
...
The relativizer, likewise, may agree in case\index{case} with the NP\index{phrase types!noun phrase} in the matrix clause
...
the clause---if the relativizer cannot be immediately adjacent to the NP\index{phrase types!noun phrase} which
the relative clause modifies, for example, when an adjective\index{adjectives} or a possessive
pronoun is following the noun\index{nouns}:
...
verb, which manifests when the NP\index{phrase types!noun phrase} following the verb (agent or patient) is not
...
Sentences containing more than one NP\index{phrase types!noun phrase} also have topic\index{grammatical function!topic} marking on the verb, so
that morphologically the verb may be analyzed as agreeing with one of the NPs\index{phrase types!noun phrase}
in topicality, since topic\index{grammatical function!topic} and case\index{case} are no categories the verb normally
inflects for. Syntactically, however, the topicalized NP\index{phrase types!noun phrase} depends on the verb,
