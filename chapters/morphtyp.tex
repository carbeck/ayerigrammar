...
position, preceding any other preverbal elements, compare (\ref{ex:topclt}).
...
instead of relying on your own intuition---which is often tainted by
interference from your native language---in order not to carry over all too
familiar patterns into your creation.} The example in (\ref{ex:clitics_27c}) is
