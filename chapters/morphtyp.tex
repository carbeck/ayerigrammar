...
\pex~\label{ex:adjredup}
	\a \makebox[4em][l]{\tayr{apan}{wide}} → \tayr{apan-apan}{extensive}
	%\a \makebox[4em][l]{\tayr{ikan}{complete}} → \tayr{ikan-ikan}{entire, 
	%	total}
	\a \makebox[4em][l]{\tayr{kebay}{alone}} → \tayr{kebay-kebay}{all alone}
	%\a \makebox[4em][l]{\tayr{pakas}{special}} → \tayr{pakas-pakas}{gay}
	\a \makebox[4em][l]{\tayr{pisu}{tired}} → \tayr{pisu-pisu}{exhausting}
\xe
