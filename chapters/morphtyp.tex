...
demonstrative prefixes\index{prefixes} on nouns, however. In the following example, the prefix\index{prefixes} 
...
in the verb\index{verbs} cluster and cooccurring with adpositions\index{adpositions} which straddles the
border between inflection and a function word. This is the clitic\index{clitics}
marker \rayr{mN}{manga}, which is treated as an independent word in
orthography, but can modify verbs\index{verbs} and adpositions\index{adpositions}---heads of verb phrases (VPs)
and prepositional phrases (PPs), re\-spec\-tive\-ly. It is unstressed\index{stress} and
...
over several words, though it does not incorporate object\index{grammatical function!primary object} noun phrases (NPs) 
...
\rayr{sitNF/}{sitang-}, that is, as a reflexive modifier of pronouns\index{pronouns!reflexive}. Moreover,
...
also be marked for plural\index{number!plural} with the suffix \rayr{/ye}{-ye}, and verb\index{verbs} roots may
...
is realized as an agreement\index{agreement} suffix or as a clitic\index{clitics} personal pronoun\index{pronouns!personal} depending on
...
the agreement\index{agreement} of the relativizer\index{pronouns!relative} with the preceding\index{word order} NP. Which grammatical role
...
also the emphatic affirmative and negative discourse particles\index{discourse
...
patients\index{case!patient}---the animacy\index{animacy} value of the topicalized\index{grammatical function!topic} noun phrase (NP), so the
...
acts different from English\index{English} here in that the content verb\index{verbs} is not a complement\index{grammatical function!open complement}
...
case with proper nouns\index{nouns!proper} specifically, where the name is preceded\index{word order} by a case\index{case}
particle instead of receiving a case-marking suffix\index{suffixes} like common nouns\index{nouns} do. This
...
used with wide scope\index{scope} if both conjuncts are proper nouns\index{nouns!proper}. Narrow scope\index{scope} with
...
The case\index{case} markers of proper nouns\index{nouns!proper} are necessarily proclitics rather than
...
The fact that case\index{case} particles attach always to a proper noun\index{nouns!proper} very specifically
...
of the main verb in the sentence, \xayr{sr/}{sara-}{go}. While not
...
{da-}, since it also abbreviates a reflexive DP, for instance,
...
headed by common and proper nouns\index{nouns}; the picky nature of the deictic prefixes\index{prefixes}
...
suffixed\index{suffixes} case\index{case} markers on common nouns have the distributional properties of
...
altogether by making the names an apposition to the demonstrative\index{pronouns!demonstrative}
...
\rayr{dnY}{danya} as a demonstrative pronoun\index{pronouns!demonstrative}. Thus, it can be case-\index{case} and 
...
be reduplicated for diminution, and can also not be pluralized\index{number!plural}. Since
...
With proper nouns\index{nouns!proper}, the same distributional properties as with common nouns
...
prefix\index{prefixes} here, as with common nouns, compare (\ref{ex:clitics_35}).
...
the \Pred{} feature of \xayr{/yaaNF}{-yāng}{he} is \Lfg{}'s\index{Lexical-functional grammar} (\cite{bresnan1982} onwards; also see \autoref{sec:lfg}) way to
...
non-core roles, though it may be assumed\index{desiderata} that oblique\index{grammatical function!oblique} arguments are less likely
...
\xayr{/IknF kgnF}{-ikan kagan}{far too many} constitutes a clitic cluster
...
to this test, it looks indeed as though \rayr{kejnmF/IknF kgnF}{keynam-ikan
kagan} forms a syntactic unit, in that \rayr{/IknF kgnF}{-ikan kagan} cannot be
split up internally and also cannot be divided from \rayr{/IknF}{-ikan}'s head,
\xayr{kejnmF}{keynam}{people}. On the other hand, it is also possible to use
other adverbs\index{adverbs} like \xayr{ptu}{patu}{surprisingly} with
...
\rayr{/IknF}{-ikan} or to \rayr{kejnmF/IknF}{keynam-ikan}. Replacing
\rayr{kejnmF}{keynam} with a pronoun produces a grammatical outcome
...
\xayr{koMd/}{kond-}{eat}, \xayr{/m}{\mbox{-ma}}{enough} appears suffixed to the verb
...
Since Ayeri possesses a zero copula\index{copula}, equative phrases\index{copular clause} which treat quantifier
...
maps' (nouns\index{nouns} do not mark plural\index{number!plural} if modified by a quantifier which indicates
plurality\index{number!plural}), another possible reading is `a book and many maps'. Ways to force
...
All examples in (\ref{ex:clitics_comp}) show that in principle, an
interpretation of \rayr{/ENF}{-eng} as a quantifier and as a
comparative\index{comparison} suffix are both legitimate. Thus, it is difficult
to distinguish between an inflectional affix and a clitic here. A clear
distinction also cannot be made on phonological grounds in that even in the
reading as a quantifier clitic, \rayr{/ENF}{-eng} (\Comp{}) and \rayr{/vaa}{-vā}
(\Supl{}) are stressed\index{stress}
...
adjective\index{adjectives} stem ending in \rayr{/E}{-e}. As we have seen,
however, this is not a fully reliable metric either in that deictic
prefixes show clitic-like behavior but may still phonologically
meld with the stem they attach to. The only adjective\index{adjectives} ending
in \rayr{/E}{-e} currently listed in the dictionary is
...
the locative case\index{case!locative}, which is marked on the prepositional object\index{grammatical function!adpositional object} while the 
...
The relativizer\index{pronouns!relative}, likewise, may agree in case\index{case} with the NP in the matrix clause
...
the clause---if the relativizer\index{pronouns!relative} cannot be immediately adjacent to the NP which
...
verb\index{verbs}, which manifests when the NP following\index{word order} the verb\index{verbs} (agent\index{semantic role!agent} or patient\index{semantic role!patient}) is not
