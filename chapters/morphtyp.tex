...
\xayr{dikapis}{dikapisa}{respective} is derived from \rayr{d/}{da-} + 
\rayr{Ikpis}{ikapisa}{bound, dependent}, which is an example for a combination 
with an adjective. There is also a fixed adverbial expression using one of thse 
prefixes, \xayr{Ed/tdjymF}{eda-tadayyam}{for the time being, for now} 
(this=time-\Dat{}).
...
\rayr{AgYaanF}{Ajān}, in person and number. It is additionally marked for 
a patient topic, \rayr{pil}{Pila}, and thus serves as an agreement topic for 
