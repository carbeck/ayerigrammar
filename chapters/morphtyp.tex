...
% might be best analyzed as inflection, actually!
...
\xayr{mN/}{manga-}{move; remove} as well, which presumably served as the origin 
of both the progressive and the dynamic marker.\label{fn:mangaverb}} 
Consider also the following example in which \rayr{miNF}{ming} is inflected like 
a regular verb:
...
may be extended by the mood and aspect markers \rayr{/ONF}{-ong} (\Irr{}), 
