...
coordinated\index{coordination} adjective\index{adjectives} as a relative clause like in (\ref{ex:clitics_29c}), for
...
verb\index{verbs}, which manifests when the NP following\index{word order} the verb\index{verbs} (agent or patient) is not
