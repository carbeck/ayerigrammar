...
With regards to the dichotomy head--dependent marking, Ayeri is dependent 
marking. This is exhibited, for instance, in the expression of possessive 
relationships, where the dependent is marked for genitive 
...
\a\label{ex:genprn}\begingl
	...
	\end{forest} //
	\gla kasu barieri nā //
	\glb kasu bari-eri nā //
	\glc basket meat-\Ins{} \Fsg{}.\Gen{} //
...
\begingl
	\gla agonan minkayya //
	\glb agonan minkay-ya //
	\glc outside village-\Loc{} //
...
[PP
	[P° [{agonan},name=head]]
	[NP
		[N' [{minkayya},name=dependent,roof]]
	]
]
\node at (current bounding box.south) [below=0pt of head]
	{\textsc{\tiny head}};
