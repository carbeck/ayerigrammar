...
presumably served as the origin of both the progressive and the directional
marker. \label{fn:mangaverb}} As we will see later (\autoref{subsec:clitics}),
though, these modal particles behave more like clitics than function words.
Consider, on the other hand, the following example in which \rayr{miNF}{ming}
is inflected like a regular verb:
...
and \rayr{p/}{pa-} (\NFut{}) and \rayr{ni/}{ni-} (\RFut{}). Besides this set of
...
content word, like on the adverb \xayr{pr}{para}{fast} in the following
example:
...
directional marker \rayr{mN}{manga} is thus a functional morpheme and it always
...
\a\label{ex:clitics_mangacoord1}\begingl
	...
	\glc \AgtT{} go-\TsgM{} Ajān \Dir{} around house-\Loc{} and \Dir{} inside
		house-\Loc{} //
...
\a\label{ex:clitics_mangacoord2}\begingl
	...
	\glc \AgtT{} go-\TsgM{} Ajān \Dir{} around and inside house-\Loc{} //
