...
the prefix \rayr{d/}{da-} can as well be used with NPs\index{phrase types!noun phrase} and is part of
...
the agreement\index{agreement} of the relativizer\index{pronouns!relative} with the preceding\index{constituent order} NP. Which grammatical role
...
The behavior of the pronominal person\index{person} marking on the verb is thus rather
...
with both kinds of \rayr{/ENF}{-eng} is given in (\ref{ex:clitics_nake}).
