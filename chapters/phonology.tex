...
however, as consonant codas after a diphthong are largely avoided.%
\footnote{This would make diphthongs in /ɪ/ analyzable as /Vj/ sequences, 
essentially.} Thus, we can make a feature matrix:
...
syllable. If there were, they would group with (\ref{ex:firstheavy}).
