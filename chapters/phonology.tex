...
for instance, \rayr{AMkYu}{ankyu} /ˈaŋ.kju/ `really' is realized as [ˈaŋ.kju], 
not as *[ˈaŋ.tʃu]. The plural marker \rayr{/ye}{-ye} is also commonly 
...
\xayr{bbuu}{babū}{barbarian} were coined, as \rayr{pFrMkye}{prankaye}---things 
`that you put in specifically to make things fit': another new coining this 
decision resulted in.\label{fn:ū}}
...
\xe
\footnotetext{In the dictionary as \rayr{liMk/}{linka-}, possibly an entry 
changed at a later point, or simply an error in the text (Sugar Fairies).}
...
nominalizing \rayr{/AnF}{-an}, so there may be a verb involved, but it is not 
\rayr{til/}{tila-}. I cannot reconstruct which other verb could have been used 
here either, though. Ayeri allows noun--verb compounds to have a nominalized 
verb in the second position in spite of it being the head---noun--noun 
compounds mostly come in a head-initial order---probably due to an 
avoidance of placing a derivative suffix in the middle of a word.}

As charted in \autoref{tab:syltype} above, Ayeri very strongly favors CV 
...
grammatical purposes. Hence it is no surprise that combinations with /j/ are 
especially common, since this is also what a number of very common suffixes 
start with, for example the plural marker \rayr{/ye}{-ye}, the locative marker 
\rayr{/y}{-ya} as well as third person animate pronoun agreement suffixes, and 
first person and third person animate pronominal clitics---\autoref{fig:verbsyll}
above showed exemplarily how verbs resyllabify when suffixes are attached.
