...
Regarding allophony\index{allophony}, /tj kj/ and /dj gj/ are usually realized as [tʃ] and [dʒ], 
...
\orth{c} and \orth{j} for allophonic\index{allophony} cases of [tʃ] and [dʒ] as well.}
...
The lax vowels [ɪ ɛ ɔ ʊ] occur as allophones\index{allophony} of their tense counterparts 
...
as an allophone\index{allophony} of /e/ in final unstressed position, for instance, in the word 
...
to, must'. [w] may also be an allophone\index{allophony} of /uj/, as in \rayr{Adauyi}{adauyi} 
...
As mentioned above, lax vowels are counted here as allophones\index{allophony} of tense ones as 
...
As [eːɪ] only occurs due to allophony\index{allophony}, it should not be counted as a phoneme for
