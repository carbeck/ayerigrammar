...
\ex
	\rayr{miNojAj}{ming\textbf{oy}ay → ming\textbf{u}ay} [mɪŋˈwaɪ] (can-\Neg{}-\Fsg{})
\xe
...
\pex
	\a \rayr{nYaanFye\_aNF}{nyān\textbf{ye}ang → nyān\textbf{j}ang} [ˈnjaːndʒaŋ] (person-\Pl{}-\Aarg{}) `persons.\Aarg{}'
	\a \rayr{netuye\_asF}{netu\textbf{ye}as → netu\textbf{j}as} [neˈtudʒas] (brother-\Pl{}-\Parg{}) `brothers.\Parg{}'
\xe
...
\ex
	\rayr{nivyey}{niva\textbf{ye}ya → niva\textbf{j}ya} [niˈvadʒja] (eye-\Pl{}-\Loc{}) `at the eyes'
\xe
...
\pex
	\a \rayr{tvFvaanF}{ta\textbf{vv}āng} [taˈvaːŋ] (get=\Ssg{}.\Aarg{}) `you get'
	\a \rayr{diʲsyNF}{dis\textbf{yy}ang} [dɪsˈjaŋ] (fasten=\Fsg{}.\Aarg{}) `I fasten'
\xe
...
\xayr{niis}{nīsa}{wanted}, \xayr{psiis}{pasīsa}{interesting}, 
\xayr{AreenF}{arēn}{anyway, however}, \xayr{leer}{lēra}{whore}, and 
\xayr{noonF}{nōn}{wish}. Otherwise, long vowels result from two same vowels 
next to each other, for instance:
