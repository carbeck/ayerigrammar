...
words in Ayeri. Altogether, the corpus comprises 5,502 words, of which 3,050 
are unique.
...
\autocite{strasser:freq}. For the purpose of gathering statistics on phonemes, 
...
\ref{tab:syllength}). The higher the syllable count, the more likely it is for 
them to be compounds or inflected words.

\begin{table}[hp]\centering
\caption[Relative frequency of words with different numbers of syllables]{Relative frequency of words with different numbers of syllables (n\,=\,5502)}
