...
language, and the latter the secondary language I studied formally for over a 
decade, including a stay-abroad in the beautiful Pacific Northwest.}

\subsubsection{Statements}

Regular statements have a gradually and gently falling pitch contour based 
...
Since Ayeri does not use a particle to mark yes–no questions as such, 
intonation is used to mark the difference from a regular statement. To achieve 
a strong contrast to statements, questions exhibit gently rising intonation:
