...
\blockcquote[12]{becker:kafka:imperial}{As far as 
morphophonology\index{morphophonology} is concerned, the relative pronoun 
complex \textit{sijya} `in/at/on which.\Loc{}' is interesting in so far as it 
is a contraction of \textit{*siyaya} `\Rel{}-\Loc{}-\Loc{}' that I introduced 
here [...] Since this feature does not occur in previous texts, let's assume 
...
\phantomsection
Morphophonologically\index{morphophonology}, long vowels also occur in 
double-marked relative pronouns\index{relative pronouns} where the agreement 
marker for the relative clause's head has been omitted, for instance, 
\xayr{sinaa}{sinā}{of which, about which}, as in the following example:%
\label{doublerel}
...
allophones\index{allophony!vowels} of tense ones as their distribution is 
...
allophony\index{allophony!vowels}, it should not be counted as a phoneme for
...
marked by two horizontal lines \orth{||}.}
