...
fit', another new coining this decision resulted in.\label{fn:ū}} Otherwise,
long vowels result from two same vowels after another, for instance as in
(\ref{ex:longvwls}).
...
there is possbily also a nominalizing \rayr{/AnF}{-an}. Ayeri exceptionally
