...
why some of the fields in \autoref{fig:heavysyl} are marked with two plus
...
\textsc{[–\,heavy, –\,long]} in all positions (\autoref{fig:3sylheavy}).
...
clear from \autoref{fig:3sylheavy} that the rules stated at the end of the
