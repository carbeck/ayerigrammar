...
primary stress, except if two long syllables collide, in which case both are 
stressed.
...
\textsc{[–\,heavy, –long]} in all positions. Finding words that fit the 
associated iterations is not too much of a problem, especially in cases where 
there is only one heavy syllable.
