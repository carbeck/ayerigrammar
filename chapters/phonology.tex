...
\mbox{}\vfill
\captionof{table}[Consonant inventory]{Consonant inventory (divergent 
...
fit', another new coining this decision resulted in.
...
entries \autocite{becker:frequency}. The previous study had its focus on 
...
which is a very small figure for such a study, but there are only so many 
texts available unfortunately. Words may occur more than once.
...
are function words like the ones cited below. In the following, I will quote a
few examples for each number of syllables per word:
...
clitics. \autoref{tab:verbsyll} above shows exemplarily how verbs resyllabify 
...
\begin{landscape}\centering
\mbox{}\vfill
\captionof{table}{Examples of stress patterns in compounds}
~\\
