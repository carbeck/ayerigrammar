...
however, other words following this syllalbe pattern, like 
...
To summarize the above findings for bisyllabic words:
...
Carrying out the same analysis as above using the feature \textsc{[±\,long]}, 
...
(p.~\pageref{2sylsumm}), the example words will contain both of these syllable 
types. It was not too hard finding examples for all the slots in this case 
either. Only the case \textsc{[–\,long] [+\,long] [+\,long]} and that of three 
long syllables must remain unattested.\footnote{It would be possible to 
