...
which is otherwise avoided in Ayeri, as we will see later. Combining each 
syllable pattern with itself give the following outcome, again with the 
combinatorical restrictions mentioned above:
