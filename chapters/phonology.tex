...
sequences /iː/ and /ʊɪ/ also only occur one and twice, respectively, namely in 
the following words:
...
The word in (\ref{ex:pasīsa}), \xayr{psiis}{pasīsa}{interesting}, should be 
counted as a lexeme in its own right, since it has idiomatic meaning, but it is 
nonetheless rather transparently a causative derivation of the verb 
\xayr{psY/}{pasy-}{wonder, be curious, be interested}, essentially meaning 
`making one wonder/be curious'---the causative suffix \rayr{/Is}{-isa} can be 
used to derive adjectives with a causative or resultative meaning as well.
