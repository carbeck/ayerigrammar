...
Complement clauses are characterized by the short spike at the end of the 
preceding main clause followed by a short break which together mark the 
beginning of a new syntactic unit, which is broadly similar to list statements. 
Otherwise, statements with complement clauses as well bear the overall 
downward-sloping contour of statements.
...
but are treated the same as regular statements; they display a continuous 
downward slope if part of a statement, or a continuous upward slope if part of 
a question:
