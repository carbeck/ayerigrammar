...
nuclei and codas have been matched by regular expressions:

\begin{verbatim}
C = (?:tʃ|dʒ|[ptkbdgmnŋvshrljw])
V = (?:[aeɔʊ]ːɪ|[aeɔʊ]ɪ|aʊ|[ieaou]ː|[ieaouɪɛɔʊə])
\end{verbatim}

The command-line tools \texttt{grep}, \texttt{sort}, and \texttt{uniq}, were 
used to aggregate all occurring variants for each syllable segment as well as 
