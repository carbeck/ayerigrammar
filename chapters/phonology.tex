...
\fw{record} /ˈɹɛkərd/ (noun) and /ɹɪˈkɔɹd/ (verb), does a similar thing, as 
(\ref{ex:engvarstress}) shows. Ayeri has no such minimal pairs.
...
that if \textcquote[66]{peterson2015}{you're creating a language on your own and
you're the only speaker, intonation is usually not high on the list of features
to focus on, but intonational flavoring is well worth it (read: crucial) when it
comes to making an authentic language}. There must be intonational patterns that
I have been subconsciously applying.} Yet, of course, the spoken words in these
recordings do not sound like robot speech either, so there must be intonational
patterns. Since intonation contours are notoriously difficult to display in
...
would require more detailed gradations, but for the time being, I will only try
to briefly describe those that are most prominent.
