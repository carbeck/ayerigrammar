...
\citeauthor{wiese1996} observes that in monomorphemic German words, stress 
falls on the \textcquote[277]{wiese1996}[;]{right-most non-light syllable in a 
word, but will not go beyond the third syllable from the right edge of the 
...
this sense, they are skipped in stress rules} Another rule he postulates is 
...
must fall on /reː/. Following the rules postulated by \citeauthor{wiese1996}, 
\fw{überreden} one might expect \fw{über} to carry primary stress, since /yː/
constitutes the right-most non-light syllable, but \fw{überreden} belongs to 
the class of particle verbs with inseperable prefixes, where the preposition 
part---here \fw{über-} `over-' never assumes primary stress 
\citep[compare][295--296]{wiese1996}. \citeauthor{wiese1996} suggests the 
following analysis for seperable and inseperable particle verbs:

\pex \citet[296]{wiese1996}
	\a[] \tsub{V\tsup{1}}[\tsub{PP}[über] \tsub{V\tsup{0}}[setzen]] \quad (ˈübersetzen)
	\a[] \tsub{V\tsup{1}}[\tsub{P\tsup{0}}[über] \tsub{V\tsup{0}}[setzen]] \quad (überˈsetzen)\label{ex:insep}
\xe

I take \textquote{P\tsup{0}} in (\ref{ex:insep}) to mean that this \fw{über-} is 
merely an incorporated preposition, not a prepositional phrase anymore---%
compare \citet[106--107]{lehmann2015} on the grammaticalization of preverbs.}
