...
In fact, English, which also has phonemic stress in pairs such as \fw{record} 
...
in the first syllable (syllables of the type /C(C)Vːŋ/ or /C(C)Vɪŋ/). 
...
\ex
	(\fw{*dépang} → \fw{depáng}) + \fw{cā́ti} → 
		$\left.\Big\{\right.$\parbox{4cm}{*\fw{depàng} + \fw{cā́ti} \\
		\fw{dèpang} + \fw{cā́ti}}
\xe
...
first component \rayr{malinF}{maling} contains a heavy syllable, stress will not 
