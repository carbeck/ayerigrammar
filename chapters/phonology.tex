...
occur in double-marked relative pronouns where the agreement\index{agreement} marker for the
...
be used to derive adjectives\index{adjectivization} with a causative or resultative\index{adjectives!resultative} meaning.
...
syllable. For one, however, this does not make it heavy\index{syllables!heavy}, and second, even if it
...
Ayeri uses a kind of topic system\index{grammatical function!topic} for
