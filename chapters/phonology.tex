...
sucking.\footnote{\citet{kroonen2013} identifies PGmc
\textit{*sūgan-, *sūkan-} `to suck' as derived from the iterative form PGmc
\textit{*sukkōn-, *sugōn-} `to suck', which in turn he gives as originating from 
PIE \smash{\textit{*souḱ-neh₂-}}. However, he does not say anything about the 
word being particularly onomatopoetic \citep[489--490]{kroonen2013}.}
\index{syllable!final|)}%
