...
while quasi-regular results are produced when they are in penlutimate position 
...
well as final \textsc{[–\,long, +\,diph, +\,ŋ]} do not occur, thus, there 
...
There is only one pattern possible here, which is very little to make a 
...
\noindent As we will see in the in the next section, however, another rule needs to be added to this set:
