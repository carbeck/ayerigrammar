...
Complement-taking predicators, such as verbs or adpositions\index{adpositions}, are also presented
...
A discussion of subject\index{grammatical function!subject}, topic, and configurationality\index{configurationality} is interesting also in
...
verb's arguments: subject\index{grammatical function!subject} (agent\index{cases!agent}), direct object\index{grammatical function!primary object} (patient\index{cases!patient}), indirect object\index{grammatical function!secondary object}
...
form a unit of some kind. The verb canonically agrees with S\index{phrase types!small clause} by default;
...
verb at least for the purpose of copula clauses\index{copula clause}. Furthermore, the verb in the
...
non-configurational\index{configurationality}, that is, while XP may contain a non-finite verb, the
...
carrying pragmatic focus\index{grammatical function!focus} specifically. He finds that rather, nominative marking
...
Kroeger rather than Schachter. Either way, we will have to test verb agreement\index{agreement},
...
these notions. As we will see, all of subject\index{grammatical function!subject}, topic, and focus\index{grammatical function!focus} relate to
different ways in which the relative prominence of certain NPs\index{phrase types!noun phrase} is raised;
subject\index{grammatical function!subject} and topic are also closely related to each other. It ought to be noted
that while \Lfg{}\index{Lexical-functional grammar} treats topic and focus\index{grammatical function!focus} as grammaticalized discourse functions
outside of the argument-structure frame of a verb, it treats the subject\index{grammatical function!subject} as
both a discourse function and an argument function; topic and focus\index{grammatical function!focus}, on the
...
NP\index{phrase types!noun phrase} and the IP\index{phrase types!inflectional phrase} here. Unlike \textsc{gg}, \Lfg{}\index{Lexical-functional grammar} treats tense as a semantic
...
statements, the semantic macrorole of a definite NP\index{phrase types!noun phrase} is marked on the verb. This
...
Ayeri's system, basically, besides then also mixing up focus\index{grammatical function!focus} and topic.}
...
Like Tagalog, Ayeri marks a privileged NP\index{phrase types!noun phrase} on the verb, however, in Ayeri, this
...
of the topic NP\index{phrase types!noun phrase} appears as a clitic\index{clitics} in the shape of the corresponding NP's\index{phrase types!noun phrase} case
...
Ayeri, on the other hand, non-topic animate\index{animacy} agents\index{cases!agent} are marked on NPs\index{phrase types!noun phrase} by
\rayr{/ANF}{-ang} or \rayr{ANF}{ang}, and animate\index{animacy} agent-topics are marked on
...
patient argument is the topic, while the verb still displays masculine person\index{person}
...
instead continues to agree with the agent NP\index{phrase types!noun phrase} in spite of not being the topic of
...
theme/object\index{grammatical function!primary object}, \rayr{pFrbr}{prabara}. This may be explained by topicalization:
...
however, to conclude that what was called `topic'\index{grammatical function!topic} so far is the subject after
...
(\ref{ex:ayrpivot3}) presents sentences of differently case-marked topic NPs\index{phrase types!noun phrase}
each, but in every case, the agent NP\index{phrase types!noun phrase} and the topicalized NP\index{phrase types!noun phrase} consist of a human
referent. Both referents share the same person\index{person} features so that the verb in the
...
In each of the sentences in (\ref{ex:ayrpivot3}), it is the topicalized NP\index{phrase types!noun phrase}
...
the verb in the coordinated clause could theoretically pick either the agent NP\index{phrase types!noun phrase}
or the topicalized NP\index{phrase types!noun phrase} of the first conjunct as its subject. Things look
...
\rayr{IlonF}{ilon} is inanimate\index{animacy}, as shown by the topic marker \rayr{le}{le}.
...
remaining non-topic NPs\index{phrase types!noun phrase}, Ayeri considers the agent to rank higher as a
...
\rayr{sryaaNF}{sarayāng}. In cases where the topic in the first conjunct can
...
coherent NP\index{phrase types!noun phrase}. In most cases, Ayeri will therefore group the intransitive subject
...
pronominal clitic\index{clitics} in the intransitive clause, as indicated above. The affix on
...
the VP\index{phrase types!verb phrase}, are understood to modify the verb as an intensifier\index{intensifiers} and are thus
...
referring to the verb instead of the pronoun\index{pronouns}. With free quantifiers, such as
...
verb. This is also possible for the purpose of quantification of pronouns\index{pronouns} with
...
Ayeri, however, has no such restrictions. Non-topic NPs\index{phrase types!noun phrase} may be relativized, and
...
pronominal clitic\index{clitics}, since verbs must not go uninflected. Since all NPs\index{phrase types!noun phrase} are
...
verb morphology. The topic marker on the verb identifies the person\index{person} suffix on
the verb as the clause's topic. In (\ref{ex:ayrrel2_2}), it is likewise not the
topic NP\index{phrase types!noun phrase} which is relativized, but the patient NP\index{phrase types!noun phrase} \xayr{InunFlej}{inunley}
{fish}. This NP\index{phrase types!noun phrase}, however, is not represented in the relative clause because the
verb does not inflect for the role of the patient, which the relativized NP\index{phrase types!noun phrase}
carries in the relative clause as well. There is no morphology to alter the
voice of the verb in such a way that the matrix clause's patient NP\index{phrase types!noun phrase} becomes the
...
cases, there is no case-marked noun\index{nouns} or topic contained in the relative clause.
...
(\ref{ex:ayrsecpred1_1}), the topic NP\index{phrase types!noun phrase}, \rayr{migFrj}{Migray}, happens to be
...
between adjective\index{adjectives} and noun\index{nouns}. The marking on the verb is thus not used for
...
non-actor topics in the complement clause\index{complement clause} in the (a) examples which we attempt
...
As with raising verbs, the complement\index{complement clause} verbs appear in a non-finite form, the
...
person\index{person} features. If the topic marking on the finite verb is altered as in
...
with intransitive complement clauses\index{complement clause}, as illustrated by (\ref{ex:ayrctrl5}),
...
finite verb. Thus, even if we reverse the order of subject and object\index{grammatical function!primary object}, the
...
Even though the verb and the object\index{grammatical function!primary object} are not adjacent, it appears that together
...
would mean that the verb carried not simply the third-person\index{person} agreement\index{agreement} suffix
...
subject NP\index{phrase types!noun phrase}, while there are idioms consisting of a set combination of a verb
...
Conversely, in subject control (sections \ref{subsec:control},
