...
As we have seen above, the modification of subject pronouns with clitic\index{clitics}
...
\xayr{sitNF}{sitang}{self} as an indeclinable dummy pronoun to carry the clitic\index{clitics}
...
realized as a resumptive pronoun, \fw{niya}, co-indexed with the raised NP\index{phrase types!noun phrase}.
...
these sentences, the pronoun is supposed to bind the NP\index{phrase types!noun phrase} containing the name in
...
with which it is co-indexed, \xayr{yesF}{yes}{her}. This pronoun is also free
...
core f-structures, $g$ and $f$. The object\index{grammatical function!primary object} pronoun, \xayr{yesF}{yes}{her}, is
