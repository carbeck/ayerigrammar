...
patient\index{semantic role!patient}/theme\index{semantic role!theme} or the recipient\index{semantic role!recipient}. The actor of the Tagalog sentence is also
...
\xayr{prlF}{paral}{cat}. Seeing as Tagalog switches the subject\index{grammatical function!subject} around by
...
the verb\index{verbs} in the coordinated clause could theoretically pick either the agent\index{semantic role!agent} NP\index{phrase types!noun phrase}
...
secondary topic\index{grammatical function!topic} on the thematic hierarchy than the recipient\index{semantic role!recipient}, compare 
...
clause's subject\index{grammatical function!subject} appears as a gap in English. The raised subject\index{grammatical function!subject} is not
semantically an argument of the matrix clause's verb. The matrix clause's
subject\index{grammatical function!subject} may also be a dummy `it' or `there' in English; see (\ref{ex:engrais})
...
marks its patient argument as the subject. Yet, the non-subject agent\index{semantic role!agent},
\fw{Charlie}, is raised to occupy the patient role in the matrix clause. The
position of the non-subject agent\index{semantic role!agent} in the complement clause is subsequently
...
\emph{agent}\index{semantic role!agent} here for consistency) for traits usually associated with subjects\index{grammatical function!subject},
...
of a few irregularities like patient\index{semantic role!patient} agreement\index{agreement} in agentless\index{semantic role!agent} clauses and using
...
hypothesis that Ayeri is configurational\index{configurationality}. Since it clearly prefers agent\index{semantic role!agent} NPs\index{phrase types!noun phrase}
...
agent\index{semantic role!agent} topic\index{grammatical function!topic} were marked as a logical continuation of the first conjunct, it
...
\xayr{/y}{-ya}{he}. The conjunct, then, would have a separate subject\index{grammatical function!subject},
