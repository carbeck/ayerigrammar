...
\subsection{Assymetric influence on thematic roles}
...
As discussed in \autoref{subsec:raising} and \autoref{subsubsec:raisvb}
...
Conversely, in subject control (\autoref{subsec:control},
p.~\pageref{subsec:control} and \autoref{subsubsec:ctrlvb},
...
\ljudge*\begingl
	...
	\glft `Her$_{*i/j}$ father, he likes Mali$_i$.' //
\endgl\medskip
