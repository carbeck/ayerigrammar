...
all; Ayeri is merely not completely unambiguous in this context. Since Tagalog\index{Tagalog}
...
Secondary predicates in Tagalog\index{Tagalog} are interesting insofar as depictive adjectives\index{adjectives!depictive}
...
over other NPs\index{phrase types!noun phrase}, not all arguments of a verb are on equal footing. Tagalog\index{Tagalog}, on
...
school bus} is not acceptable in English\index{English} even though all adjectives\index{adjectives} equally
