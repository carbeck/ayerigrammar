...
abstractions of noun phrase (NP), VP, \xhead{V}, etc.\ \citep[42]{bresnan2016}.
...
containing the arguments of the verb. In the cases of Irish\index{Irish} and Welsh\index{Welsh}, however,
...
As with raising verbs, the complement\index{complement clause} verbs appear in an infinite form, the
...
with an infinite clause with object control (\ref{ex:ayrctrl3_3}). However,
...
\posscite{kroeger1991} thesis---which critically reviews and updates
\posscite{schachter1976} survey by leaning on \Lfg{} theory---Tagalog\index{Tagalog} prefers
the argument which corresponds to the marking on the verb for most of the
traits usually associated with subjects. According to \posscite{kroeger1991}
...
the various effects described in \posscite{kroeger1991} survey. Ayeri, in
...
As mentioned above, Ayeri's unmarked constituent order is VSO, and unlike Tagalog\index{Tagalog}, it
mostly displays correlations between the agent and syntactic traits usually
associated with subjects. I will assume, therefore, that the agent\index{semantic role!agent} argument is,
...
obligatorily require a subject. While the agent\index{case!agent} of a transitive verb\index{verbs!transitive} may be
dropped, the patient\index{case!patient} argument triggers verb agreement\index{agreement} which is canonically with
