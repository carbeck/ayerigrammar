...
Ayeri's unmarked word order is VSO with predicate and predication not adjacent
...
as an argument-value matrix (\Avm{}) which maps the relations between `subject'\index{grammatical function!subject}
(\Subj{}), `object'\index{grammatical function!primary object} (\Obj{}), `predicator' (\Pred{}), etc.\ as functional
abstractions of NP\index{phrase types!noun phrase}, VP\index{phrase types!verb phrase}, \xhead{V}, etc.\ \citep[42]{bresnan2016}.
Complement-taking predicators, such as verbs\index{verbs} or adpositions\index{adpositions}, are also presented
...
(\Case{}), person\index{person} (\Pers{}), number\index{number} (\Num{}), which are abstract features and
...
concerned. However, due to VSO word order, it is not obvious whether verb\index{verbs} and
...
As mentioned above, Ayeri's unmarked word order gives the verb\index{verbs} first, and then,
in decreasing order of bondedness to the verb\index{verbs}, the phrases which make up the
verb's\index{verbs} arguments: subject\index{grammatical function!subject} (agent\index{cases!agent}), direct object\index{grammatical function!primary object} (patient\index{cases!patient}), indirect object\index{grammatical function!secondary object}
(dative\index{cases!dative}), followed by adverbials in the genitive\index{cases!genitive}, locative\index{cases!locative}, instrumental\index{cases!instrumental}, and
causative case\index{cases!causative}. Ayeri's basic word order is thus VSO, a trait it has in common
...
object\index{grammatical function!primary object}---like English, thus, Ayeri is a VO language. In addition to this,
...
form a unit of some kind. The verb\index{verbs} canonically agrees with S\index{phrase types!small clause} by default;
...
containing the arguments of the verb\index{verbs}. In the cases of Irish and Welsh, however,
...
contains the object\index{grammatical function!primary object} NP\index{phrase types!noun phrase} as a complement. In the case of Tagalog, S is
...
make it use the Tagalog concept of a \enquote{trigger}}. By his definition,
this entails that
...
example above. While he characterizes the prototypical subject\index{grammatical function!subject} as the
intersection of agent and topic\index{grammatical function!topic} as far as cross-linguistic evidence is
concerned \citep[107]{comrie1989}, he also points out that subjects\index{grammatical function!subject} do not
...
patients, which is why actors are far more likely also to be pragmatic topics\index{grammatical function!topic}
...
resultative\index{adjectives!resultative} constructions. On the other hand, dominantly \Erg{}--\Abs{}
...
a single clause. It is not necessary for the focussed NP\index{phrase types!noun phrase} to be coordinated with
...
The answer to a \fw{wh}-question\index{questions!open} is considered focused, so \fw{Rosie} in
...
Like Tagalog, Ayeri marks a privileged NP\index{phrase types!noun phrase} on the verb\index{verbs}, however, in Ayeri, this
is the topic\index{grammatical function!topic}, not the subject\index{grammatical function!subject} (this will be subject to further scrutiny below).
Unlike in Tagalog, the marked NP\index{phrase types!noun phrase} is not marked by a particle, but by the very
...
on the verb\index{verbs} is thus related to nominal case markers in Ayeri, Tagalog uses a
...
Ayeri, on the other hand, non-topic\index{grammatical function!topic} animate\index{animacy} agents\index{cases!agent} are marked on NPs\index{phrase types!noun phrase} by
\rayr{/ANF}{-ang} or \rayr{ANF}{ang}, and animate\index{animacy} agent-topics\index{grammatical function!topic} are marked on
...
relation to subjects is verb agreement with third-person\index{person} NPs\index{phrase types!noun phrase}. This was already
...
Person\index{person} agreement in Ayeri is fixed to the agent NP\index{phrase types!noun phrase} in canonical cases, whether
it is the topic\index{grammatical function!topic} of the clause or not. In (\ref{ex:ayragr_1}), we can see the
verb determine that the agent argument is also the topic\index{grammatical function!topic}, with the verb
agreeing itself in person\index{person} with the agent: \rayr{AgYaanF}{Ajān} is a male name;
...
patient argument is the topic\index{grammatical function!topic}, while the verb still displays masculine person\index{person}
...
have feminine agreement if it were to agree with the patient NP\index{phrase types!noun phrase}. The verb
instead continues to agree with the agent NP\index{phrase types!noun phrase} in spite of not being the topic\index{grammatical function!topic} of
the clause. Topicalization appears to have no influence on the distribution of
person\index{person} agreement on the verb; the agent NP\index{phrase types!noun phrase} remains the subject. This is a very
\Nom{}--\Acc{} trait.
...
constant as a subject is essentially preempted by Ayeri's use of a topic\index{grammatical function!topic}
...
This is indeed the case in the examples of Dyirbal in (\ref{ex:dyirpivot}),
...
are treated both as animate\index{animacy} neuters. Anaphoric reference is thus potentially
...
subject pronoun\index{pronouns} of the clause. In (\ref{ex:ayrpivot_4}) at least, this pronoun\index{pronouns}
...
theme/object\index{grammatical function!primary object}, \rayr{pFrbr}{prabara}. This may be explained by topicalization:\index{grammatical function!topic}
...
each, but in every case, the agent NP\index{phrase types!noun phrase} and the topicalized\index{grammatical function!topic}NP\index{phrase types!noun phrase} consist of a human
referent. Both referents share the same person\index{person} features so that the verb\index{verbs} in the
coordinated intransitive clause\index{verbs!intransitive} can theoretically license either of them as its
subject.
...
the verb\index{verbs} in the coordinated clause could theoretically pick either the agent NP\index{phrase types!noun phrase}
or the topicalized\index{grammatical function!topic} NP\index{phrase types!noun phrase} of the first conjunct as its subject. Things look
slightly different, however, if the reference of the verb\index{verbs} is unambiguous, for
instance, because the topicalized\index{grammatical function!topic} argument cannot logically be the agent of the
...
specifies that the topic\index{grammatical function!topic} of the clause is the patient (P), which is embodied by
\xayr{IlonF}{ilon}{present}. This NP\index{phrase types!noun phrase}, however, is not a very typical agent for
the verb\index{verbs} in the second conjunct, \xayr{sr/}{sara-}{leave}. Besides, this verb\index{verbs}
is conjugated so as to require an animate\index{animacy} masculine controller, whereas
\rayr{IlonF}{ilon} is inanimate\index{animacy}, as shown by the topic\index{grammatical function!topic} marker \rayr{le}{le}.
...
suitable antecedents on behalf of being animate\index{animacy} masculine as required: the
agent (A) \rayr{AknF}{Akan} and the recipient (R) \rayr{mrnF}{Maran}. Of the
remaining non-topic\index{grammatical function!topic} NPs\index{phrase types!noun phrase}, Ayeri considers the agent to rank higher as a
secondary topic\index{grammatical function!topic} on the thematic hierarchy than the recipient, compare 
...
coherent NP\index{phrase types!noun phrase}. In most cases, Ayeri will therefore group the intransitive\index{verbs!intransitive} subject
...
clause\index{verbs!intransitive}, which is reminiscent of Tagalog's syntax, is essentially a strategy to
...
of the subject of the intransitive\index{verbs!intransitive} conjunct at the same time, A and P are
...
{sarayāng}{he leaves} is marked for a masculine third-person\index{person} subject. The only
...
referring to the subject NP\index{phrase types!noun phrase} to `float' into the VP\index{phrase types!verb phrase}. This is possible also in
...
subject, meaning does not significantly change when the topic\index{grammatical function!topic} of a sentence
...
\xayr{ynNF}{yanang}{boy(s)} as the agent NP\index{phrase types!noun phrase} remains the subject, and the
floated \rayr{sno}{sano} still refers to this NP\index{phrase types!noun phrase} rather than the locative\index{cases!locative} NP\index{phrase types!noun phrase},
...
As we have seen above, the modification of subject pronouns\index{pronouns} with clitic\index{clitics}
...
subject pronoun\index{pronouns} due to semantic coherence.
...
relative clauses not uncommonly contain their own agent NP\index{phrase types!noun phrase}. The relativized NP\index{phrase types!noun phrase}
...
topic\index{grammatical function!topic} NP\index{phrase types!noun phrase} which is relativized, but the patient NP\index{phrase types!noun phrase} \xayr{InunFlej}{inunley}
{fish}. This NP\index{phrase types!noun phrase}, however, is not represented in the relative clause because the
verb\index{verbs} does not inflect for the role of the patient, which the relativized NP\index{phrase types!noun phrase}
carries in the relative clause as well. There is no morphology to alter the
voice of the verb\index{verbs} in such a way that the matrix clause's patient NP\index{phrase types!noun phrase} becomes the
...
Secondary predicates in Tagalog are interesting insofar as depictive adjectives\index{adjectives!depictive}
...
to the agent. If what was identified as the topic\index{grammatical function!topic} would be the subject like in
Tagalog, thus, the reference of the adjective\index{adjectives} should change in the way shown in
...
verb which determines whether the postverbal predicative adjective\index{adjectives!predicative} refers to
...
Depictives\index{adjectives!depictive} and resultatives\index{adjectives!resultative} are dealt with in more detail in
...
structural subject or object\index{grammatical function!primary object} position of its matrix clause; the complement
...
be a resumptive pronoun\index{pronouns!resumptive}---basically, an overt pronominal `trace' in terms of
...
English, one would speak of to-object\index{grammatical function!primary object} raising, though here the patient of
\fw{gusto}, \fw{sila}, is in its nominative form, so syntactically, \fw{ng
Nanay} `mother', the actor, is the object\index{grammatical function!primary object} in this clause. In
...
realized as a resumptive pronoun\index{pronouns!resumptive}, \fw{niya}, co-indexed with the raised NP\index{phrase types!noun phrase}.
...
NP\index{phrase types!noun phrase} other than the agent NP\index{phrase types!noun phrase} was also judged questionable. Thus, we would expect
...
is very dissimilar to Tagalog with regards to the promotion of a non-actor NP\index{phrase types!noun phrase}
...
Ayeri cannot have two agent arguments, yet the raised object\index{grammatical function!primary object} is an agent,
albeit an external one. It is still salient enough as an agent to preclude
assigning it patient case\index{cases!patient}, though.
...
The example sentences in (\ref{ex:ayrrais5}) show that to-object\index{grammatical function!primary object} raising is not
possible with verbs of wanting---here using \xayr{glmF/}{galam-}{expect} by way
of example. That is, the subject of the complement clause\index{complement clause} in
...
(\ref{ex:ayrrais5_3}). Other verbs which allow to-object\index{grammatical function!primary object} raising in English
...
to-object\index{grammatical function!primary object} raising with verbs of perception and verbs of cognition either.
...
clause---subject or object\index{grammatical function!primary object}---and this argument acts as a controller for the
...
a VP\index{phrase types!verb phrase} niece of the subject NP\index{phrase types!noun phrase} (\ref{ex:ayrctrl1_2}), or a VP\index{phrase types!verb phrase} sister of \xhead{I}
...
agent in the clause to agree with, and agreement\index{agreement} with the patient does not make
...
the agent is the grammatical subject, and that topic\index{grammatical function!topic} marking has no influence
...
not allow to-object\index{grammatical function!primary object} raising, since it is not possible to assign patient case\index{cases!patient} to
...
coordinated main clauses, topicalization\index{grammatical function!topic} is not a strategy for disambiguation
of several possible controllers for the pronominal agent of the complement
clause\index{complement clause} or the non-finite VP\index{phrase types!verb phrase} niece of the subject NP\index{phrase types!noun phrase} here. Due to the
...
\citet{schachter1976}'s survey by leaning on \Lfg{}\index{Lexical-functional grammar} theory---Tagalog prefers
...
Verb agreement\index{agreement}
...
adverbials in the way of \fw{by} agents in English passive clauses. Linguists
...
is the topic\index{grammatical function!topic} which is marked on the verb\index{verbs}, not the nominative argument. In spite
of a few irregularities like patient agreement\index{agreement} in agentless clauses and using
...
hypothesis that Ayeri is configurational\index{configurationality}. Since it clearly prefers agent NPs\index{phrase types!noun phrase}
over other NPs\index{phrase types!noun phrase}, not all arguments of a verb are on equal footing. Tagalog, on
...
school bus} is not acceptable in English even though all adjectives\index{adjectives} equally
...
the relation between subject and object\index{grammatical function!primary object} from a structuralist perspective. I
...
difference between subject and object\index{grammatical function!primary object} gained by the various tests in
...
finite verb\index{verbs!finite}. Thus, even if we reverse the order of subject and object\index{grammatical function!primary object}, the
subject NP\index{phrase types!noun phrase} still c-commands the object\index{grammatical function!primary object} NP\index{phrase types!noun phrase} and case marking unambiguously tells
...
English's strategy to emphasize a verb\index{verbs} with the equivalent of \fw{do}, it is
...
However, we can exclude that the subject NP\index{phrase types!noun phrase} and V/I group together in that
...
sentence in the second conjunct, but no topic\index{grammatical function!topic} is marked on the verb. If an
agent topic\index{grammatical function!topic} were marked as a logical continuation of the first conjunct, it
would mean that the verb\index{verbs} carried not simply the third-person\index{person} agreement\index{agreement} suffix\index{suffixes}
\xayr{/y}{-ya}{-s}, but the topic-marked pronominal clitic\index{clitics}
\xayr{/y}{-ya}{he}. The conjunct, then, would have a separate subject,
rendering our test futile. Switching the topic to the object\index{grammatical function!primary object} of each conjunct
would produce an awkward result as well, though, since topic continuity can be
reasonably expected in this case. The verb\index{verbs} in the second conjunct would be
obliged to carry the third-person\index{person} pronominal clitic\index{clitics} \xayr{/yaaNF}{-yāng}{he}
...
grammatical outcome, there is no pro-verb\index{verbs} in this clause, but the missing
...
subject NP\index{phrase types!noun phrase}, while there are idioms consisting of a set combination of a verb\index{verbs}
...
obligatorily require a subject. While the agent of a transitive verb\index{verbs!transitive} may be
dropped, the patient argument triggers verb agreement\index{agreement} which is canonically with
...
agent NP\index{phrase types!noun phrase} regarding most of the characteristics usually associated with
