...
appear not in place, but floated. Furthermore, note that the analyses 
following hereafter are likely neither complete nor flawless; they are merely first
steps.} Since Ayeri is a verb-initial language\index{constituent order}, it is probably rather
...
\Lfg{}\index{Lexical-functional grammar} does not require complicated derivations below the surface structure of
...
unmarked constituent order\index{constituent order} is VSO with predicate and predication not
adjacent to each other, it is configurational\index{configurationality} in that there is
a verb phrase (VP) which c-commands a number of other constituents as complements and
