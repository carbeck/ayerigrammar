...
form a unit of some kind. The verb\index{verbs} canonically agrees\index{agreement} with S\index{phrase types!small clause} by default;
...
Ayeri, on the other hand, non-topic\index{grammatical function!topic} animate\index{animacy} agents\index{case!agent} are marked on NPs\index{phrase types!noun phrase} by
...
floated \rayr{sno}{sano} still refers to this NP\index{phrase types!noun phrase} rather than the locative\index{case!locative} NP\index{phrase types!noun phrase},
...
not allow to-object\index{grammatical function!primary object} raising, since it is not possible to assign patient case\index{case!patient} to
