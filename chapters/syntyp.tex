...
causative case\index{cases!causative}. Ayeri's basic word order\index{word order} is thus VSO, a trait it has in common
...
As mentioned above, Ayeri's unmarked word order\index{word order} is VSO, and unlike Tagalog, it
