...
s peNlYNF Asno \quad similen tdo, ANF \\
nry – nmaaNF smF \quad kaarYo nj trYnFkj \\
beNYonF AdaahlY. \quad y hemyoNF kiyis \\
nsj AdanFyF/, AhlY, \quad mrinsF Avnu/NsF. \\
ANF niNYonF IgaanF nj \quad nMdiNF diʲgisuF yon \\
nosaansF kilisrY \quad nj sgoymnsF – \\
s lyy bn/IknF \quad tiynYaaNF d/dikunF \\
si telugFtoNF trel, \quad y spFrtosF linYye – \\
spysF si sgoyoNF – \quad pdNsF si koMdis/yoNF. \\
nj s thnYo Ed/ \quad nraanF beNYmnY – \\
grnNF naa \textbf{simMdYsF}, \quad bjhi\_aNF bjhiyen \\
s silvu gumo naa, \quad nj pFrisu, vaaNF si lit! \\
hNr rnYreNF pluNF. \quad le ApnisreNF \\
AhlF/nm kebj, pFrj, \quad soy, litoy kjvj, \\
midj nerFnnYee\_a \quad Ed/kiynen nke. \\
\end{flushleft}
\bigskip
...
\noindent Sa pengalyang asano \quad similena tado, ang \\ 
naraya: Namāng sam \quad kāryo nay taryankay \\ 
bengyon adāhalya. \quad Ya hemayong kiyisa \\ 
nasay adany', ahalya, \quad marinas avanu-ngas. \\ 
Ang ningyon igān nay \quad nanding dijisu yona \\ 
nosānas kilisarya \quad nay sagoyamanas: \\ 
Sa layaya ban-ikan \quad tiyanyāng da-dikun \\ 
si telugtong tarela, \quad ya sapratos linyaye: \\ 
sapayas si sagoyong; \quad padangas si kondis'yong. \\
Nay sa tahanyo eda- \quad narān bengyamanya: \\ 
Garanang nā \textsc{simanjas,} \quad bayhiang bayhiyena: \\ 
Sa silvu gumo nā, \quad nay prisu, vāng si lita! \\ 
Hangara ranyareng palung. \quad Le apanisareng \\ 
ahal-nama kebay, pray, \quad soya, litoya kayvay, \\ 
miday nernanyēa \quad eda-kiyanena nake. \\
}
...
\ex~\begingl
	...
	\glft `in the near of that, in the sand, an almost-sunken face.' //
\endgl
