...
value modified by appending \astruct{...-of}{\ups{\Poss}}---at least in their
English examples \citep[315] {bresnan2016}. I will, however, omit the \fw{-of}
and more generally indicate nouns taking a possessor as \astruct{noun}{\Poss}
with the embedded NP marked for genitive case. Presumably, we want instrumental
...
Example (\ref{ex:npembedfull_2}) shows that it is no problem for the topic
marker to select an NP which is not part of the a-structure of the verb, but
simply an NP within the clause.
