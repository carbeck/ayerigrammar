...
relative clauses; \cite{bresnan2016} do not say anything about the f-structure
of relative clauses.} This topic is not marked on the verb as such, though, but
a different argument of the verb often is. In order to indicate the kind of
pronoun I will use the \Prontype{} feature for consistency with other kinds of
pronouns discussed previously. The general morpholexical specification for
relative pronouns is given in (\ref{ex:relpromorphlex}).
