...
\xayr{shyoNF}{sahayong}{it comes} in (\ref{ex:ayrpivot_4}) displays a
cliticized resumptive subject pronoun, \xayr{/yoNF}{-yong}{it}. In
(\ref{ex:ayrpivot_4}) at least, this pronoun is coreferential with the subject
in the first conjunct, \xayr{prlF}{paral}{cat}. Seeing as Tagalog switches the
subject around by altering the voice marking on the verb, it is certainly
illustrative to check how Ayeri fares if the topic is swapped to \xayr{pFrbr}
{prabara}{mouse}.
...
\a\label{ex:ayrpivot5_1}\begingl[aboveglftskip=1.75em]
	\gla Ang @ tinisaya Lita {sa Kumang} nay sarayāng. //
	\glb ang= tinisa-ya Ø=Lita sa=Kumang nay sara=yāng //
	\glc \AgtT{}= hug-\TsgM{}
		$\underbrace{\text{\Top{}=Lita}}_{\text{A}\tikzmark{ayrpivot5_ctrl1}}$
		$\underbrace{\text{\Parg{}=\smash{Kumang}}}_{\text{P}}$
		and 
		leave=$\underbrace{\text{\smash{\TsgM{}}.\Aarg{}}}_%
			{\text{S}\tikzmark{ayrpivot5_targ1}}$ //
	\glft `Lita hugs Kumang and he leaves.' //
\endgl
\begin{tikzpicture}[remember picture, overlay]
\draw [-latex]
	([xshift=-.125em,yshift=-.75ex]{pic cs:ayrpivot5_ctrl1}) 
	|- ++ (south:.75em) -|
	([xshift=-.25ex, yshift=-.75ex]{pic cs:ayrpivot5_targ1});
\end{tikzpicture}

\a\label{ex:ayrpivot5_2}\begingl[aboveglftskip=1.75em]
	\gla Ang @ tinisaya Lita {sa Kumang} nay sarayeng. //
	\glb ang= tinisa-ya Ø=Lita sa=Kumang nay sara=yeng //
	\glc \AgtT{}= hug-\TsgM{}
		$\underbrace{\text{\Top{}=Lita}}_{\text{A}}$
		$\underbrace{\text{\Parg{}=\smash{Kumang}}}_%
			{\text{P}\tikzmark{ayrpivot5_ctrl2}}$
		and 
		leave=$\underbrace{\text{\smash{\TsgF{}}.\Aarg{}}}_%
			{\text{S}\tikzmark{ayrpivot5_targ2}}$ //
	\glft `Lita hugs Kumang and she leaves.' //
\endgl

\begin{tikzpicture}[remember picture, overlay]
\draw [-latex]
	([xshift=-.125em,yshift=-.75ex]{pic cs:ayrpivot5_ctrl2}) 
	|- ++ (south:.75em) -|
	([xshift=-.25ex, yshift=-.75ex]{pic cs:ayrpivot5_targ2});
\end{tikzpicture}
\xe
