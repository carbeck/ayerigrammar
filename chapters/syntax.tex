...
semantic features a non-finite verb marks; (\ref{ex:vpcompl}) gives examples of
the different complements of a verb (for simplicity, all examples have agent
topics and none are ditransitive or complex transitive).
...
\[
	...
	\Top	&	\[
		\Pred	&	'...' \\
	\] \tikzmark{vpcomplap_top} \\

	\Subj	&	\tikzmark{vpcomplap_subj} \\
...
\end{avm}
\begin{tikzpicture}[remember picture, overlay]
\draw [rounded corners=1ex] ([yshift=1ex]{pic cs:vpcomplap_top})
	-- ++(east:1em) |- ([yshift=1ex]{pic cs:vpcomplap_subj});
\end{tikzpicture}
...
\[
	...
	\Top	&	\[
		\Pred	&	'...' \\
	\] \tikzmark{vpcomplvp_top} \\

	\Subj	&	\tikzmark{vpcomplvp_subj} \\
...
\end{avm}
\begin{tikzpicture}[remember picture, overlay]
\draw [rounded corners=1ex] ([yshift=1ex]{pic cs:vpcomplvp_top})
	-- ++(east:1em) |- ([yshift=1ex]{pic cs:vpcomplvp_subj});
\end{tikzpicture}
...
\[
	...
	\Top	&	\[
		\Pred	&	'...' \\
	\] \tikzmark{vpcomplcp_top} \\

	\Subj	&	\tikzmark{vpcomplcp_subj} \\
...
\end{avm}
\begin{tikzpicture}[remember picture, overlay]
\draw [rounded corners=1ex] ([yshift=1ex]{pic cs:vpcomplcp_top})
	-- ++(east:1em) |- ([yshift=1ex]{pic cs:vpcomplcp_subj});
\end{tikzpicture}
