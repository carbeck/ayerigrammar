...
presented for control and raising verbs\index{verbs!raising}, compare (\ref{ex:ctrlstruct}) and
...
for resultatives in analogy to control and raising verbs\index{verbs!raising}. She proposes, thus,
...
superficial similarity to control and raising verbs\index{verbs!raising} (compare 
