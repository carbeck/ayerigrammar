...
example is given as questionable; what would be preferred in Ayeri is to
introduce this sentence with \xayr{AdreNF}{adareng}{that} (that-\AargI{}). This
way, the relative clause is provided with a head in the way of `that which'.
Also note that Ayeri does not distinguish between restricted and unrestricted
relative clauses the way English does.
