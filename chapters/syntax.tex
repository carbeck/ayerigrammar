...
\footnote{This unfortunately slightly violates the rules for co-heads in
\citet[105]{bresnan2016}, since in my understanding, only functional categories
are f-structure co-heads of lexical ones. On the other hand, an earlier analysis
by which the CP was adjoined to an AP as a sister of the AP carrying the
adjective violated \Lfg{}'s annotation algorithm. The analysis presented
here may be subject to future revision\index{desiderata}.} Example
