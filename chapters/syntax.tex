...
\footnote{This unfortunately slightly violates the rule for co-heads in
\citet[105]{bresnan2016}, since in my understanding of it, only functional
categories are f-structure co-heads of lexical ones. On the other hand, an
earlier analysis by which the complement CP was adjoined to an AP as a sister of
the AP carrying the adjective violated \Lfg{}'s annotation algorithm. The
analysis presented here may be subject to future revision\index{desiderata}.}
Example (\ref{ex:intrusivequant_cstruct}) attempts to illustrate the c-structure
for an extended adjective head. The corresponding f-structure in
