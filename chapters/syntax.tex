...
p.~\pageref{subsubsec:raising}), Ayeri has verbs like \rayr{surFpF/}{surp-}
{seem}, which can make a subordinate verb's subject their own
(\ref{ex:subjrais_1}). That is, the matrix verb's subject receives its semantic
role from the subordinate verb (\ref{ex:subjrais_2}). The matrix verb's subject
may also be a dummy pronominal (\ref{ex:subjrais_3}). Omitting subject
