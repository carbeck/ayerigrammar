...
the language is said to have \Erg{}--\Abs{} alignment
(\ref{ex:subject_ergabs}). \citet{comrie1989} illustrates this difference with
...
\citet{kroeger1991} such an interpretation is problematic due to non-nominative
agents keeping their status as an argument of the verb---which also
distinguishes Tagalog from an ergative languages like Dyirbal, where
