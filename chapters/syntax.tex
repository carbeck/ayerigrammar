...
The term `trigger language' came up in discussions on \citet{conlangl} as early
as 1995 \citep{cowan1995}, where it may well have originated as an established
term for what will be described below. That is, I have not been able to find
...
the \citet{zbb} were established only about a decade later. In this message,
John Cowan writes that he wants \textquote{to propose a reform of Radilu, to
...
\enquote{accusative} to \enquote{actor} and \enquote{patent}, since there is no
longer a \enquote{subject} or \enquote{object} as such. Of course, word order
is free, so:
...
have articles).} One of the verb's relations being marked on the verb is
basically what we also see in Tagalog, though things are more complicated in
reality, of course. The term `trigger' seems to have currency in that, for
