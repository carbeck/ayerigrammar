...
alignment. In contrast to control verbs, the subject of the matrix verb is not
semantically an argument of it, but of the subordinated verb. The subject of
the matrix verb may thus also be a dummy \fw{it} or \fw{there} in English.
Ayeri seems to only have \xayr{surFpF/}{surp-}{seem} as a raising
...
adverbials or adverbs like \xayr{mmNeri}{mamangeri}{coincidentally},
\fw{kraaneri}{krāneri}{by tendency} and
