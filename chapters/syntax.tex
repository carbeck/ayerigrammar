...
\pex
\a \itshape Yang mino yayam.
\a \itshape Yang valuy, yomavāng edaya.
\xe

\pex~
\a \itshape Yang mino \_$_i$ ankyu yayam$_i$.
\a \itshape Yang valuy \_$_i$ ankyu, $[$yomavāng edaya$]_i$.
\xe
...
only be modified by other adverbs, but not by 
%NP, DP, or 
CP.\footnote{For adjectives, compare (\ref{ex:adjpstruct}),
