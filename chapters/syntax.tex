...
\pex\label{ex:tagrel}%
Tagalog (\cite[24]{kroeger1991}, from \citep[141--142]{foleyvanvalin1984}):
...
\a\label{ex:ayrrais3_2}\ljudge*\begingl
	...
	\glc seem-\TsgI{} know-\AargI{} know-\Ptcp{} \Aarg{}= Pila {} //
...
also includes topic marking, it would not be possible for the infinite verb to
mark the assignment of grammatical roles to its complements, overt or covert.
...
following set of example sentences:
...
matrix clause is the subject or not does not matter. \citet{kroeger1991} mostly
gives examples of subject control, though (\ref{ex:tagctrl2}) is an interesting
example of (`obligatory') object control:
