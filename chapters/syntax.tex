...
been added. Even though quantifiers are not adjectives, they have been analyzed
here as adjuncts of NP, since modifiers of quantifiers are values of \Quant{}'s
\Adjc{}. If quantifiers were treated as heads of DP with NP as a complement of
\xhead{D}, due to \xhead{D} being a co-head of \xhead{N}, both adjectives
pertaining to \xhead{N} and adverbs pertaining to \xhead{D} would write into
the \Adjc{} list of the f-structure predicated by \xhead{N}. Thus, in order for
DP not to be a co-head of NP, and to have its own modifiers, it must be
subordinated to NP. This way, also, the quantifier DP and other modifiers of
nouns, like APs, can switch places as required.

For (\ref{ex:nounquantavm}), this means that it needs to be ensured that
\rayr{ekeNF}{ekeng}, as a part of $g$, does not modify not the head of NP, 
\xayr{ErFsy}{ersaya}{cook}, which is part of $f$, but the head of the DP. This
head is an empty node here, whose information content is provided functionally
by the clitic \rayr{/IknF}{-ikan} on the noun. Moreover, since
\Lfg{} restricts specifiers of functional categories to the grammaticalized
discourse functions \citep[106--107]{bresnan2016}, \rayr{EkeNF}{ekeng} cannot
be analyzed as a specifier of \xhead{D}. Instead, it has been analyzed here as
an adverb for lack of a better understanding.
...
(\ref{ex:soreplacement}), however, keeps those \xbar{A} nodes which would
