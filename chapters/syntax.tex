...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Argument of \citet{schachter1976} that Tagalog all but lacks
		syntactic subjects is reaffirmed \citep[1676]{schachter2015}.
		\item Handbook article, of course cannot go into all detail; more
		detailed information in \citet{schachter1976}. Does not acknowledge
		\citet{kroeger1991} at all, nor any other research more recent than
		1985!\footnote{Schachter may reasonably have retired in the early 90s
		given he was born in 1929.}
	\end{itemize}

	\item \citet[19--52]{kroeger1991}:
	\begin{itemize}
		\item Chooses `subject' to refer to NP marked by \fw{ang} in accordance
		...
		salient for topicality \cite[56\psqq]{kroeger1991}.
		...
		{kroeger1991}.
		\item \textquote{Tagalog has a well-defined grammatical subject},
		however, \textquote{grammatical relations are defined indepently of
		phrase structure. [...] Neither can grammatical relations be defined in
		terms of pragmatic functions}; \textcquote[225]{kroeger1991}{patients
		can become subjects even when the agent is expressed as a direct
		(non-oblique) argument of the verb}.
		\textcquote[226]{kroeger1991}{Subject selection in Tagalog does not
