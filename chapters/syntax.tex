...
have \Erg{}--\Abs{} alignment (\ref{ex:subject_abserg}).
...
prominent available role of a verb's argument structure, \Erg{}--\Abs{}
...
\Nom{}--\Acc{} languages) or of antipassivization (in
...
\a\label{ex:ayrmarking_at}\begingl
	...
	\glft `The man, he bought fish at the store.' //
\endgl
...
\a\label{ex:ayrmarking_pt}\begingl
	...
	\glft `The fish, the man bought it at the store.' //
\endgl
...
\a\label{ex:ayrmarking_loct}\begingl
	...
	\glft `The store, the man bought fish there.' //
\endgl
...
\a\label{ex:ayrmarking_inst}\begingl
	...
	\glft `The money, the man bought fish with it.' //
\endgl
...
% 	\glft `The child, the man bought fish for it.' //
% \endgl
...
and animate actor-topics are marked by \rayr{ANF}{ang} as well.
