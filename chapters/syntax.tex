...
\pex\label{ex:ayrvconst}
\a\label{ex:ayrvconst_1}\begingl
...
\a\label{ex:ayrvconst_2}\begingl
...
would probably be assumed that the sentence in Ayeri actually has \xayr{lyye
koyaasF}{layaye koyās}{(she) reads the book} underlying the sentences in
(\ref{ex:ayrvconst}), though it should also be possible to analyze this in
terms of f-structure.
