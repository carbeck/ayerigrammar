...
lexical rule that recategorizes predicative\index{grammatical function!predicative complement} adjectives\index{adjectives} and prepositions\index{prepositions} so that
...
In Ayeri, the depictive adjective\index{adjectives}, whether it refers to the subject\index{grammatical function!subject} or the
