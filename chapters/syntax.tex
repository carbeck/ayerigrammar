...
case, wrapping an adjective into a CP to explicitly subordinate it is always a
permissible strategy of clarification. This also means in turn that
adpositions cannot be modified by CPs, however, this should rarely be
necessary.
