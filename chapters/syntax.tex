...
\a DP → \anno*{\xbar{D}} \anno*[\pass{\Spec}]{DP}
...
\rayr{/IknF}{-ikan} on the noun. Intensifiers like \rayr{EkeNF}{ekeng} need a
rule which specifies that they only operate within their immediate head's
functional domain.
