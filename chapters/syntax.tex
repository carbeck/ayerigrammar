...
for agent or patient, which would otherwise be required of NPs.\footnote{If
this is actually an adjective, the \rayr{d/}{da-} prefix ought to be located in 
the specifier position of the AP projected by the possessive pronoun/adjective.
It would appear that possessive pronouns are a transitory category between 
pronoun and adjective.} This is the reason why in \autoref{fig:da-s}, the 
\Pers{} and \Def{} values are in parenthesis---these features are not encoded 
by adjectives.
