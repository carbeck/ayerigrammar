...
specifies that the topic of the clause is the patient, which is embodied by 
...
the agent \rayr{AknF}{Akan} and the recipient \rayr{mrnF}{Maran}. Of the
...
marker as the A of a transitive clause: \rayr{/ANF}{-ang}/\rayr{ANF}{ang} for
animate referents, and \rayr{/reNF}{reng}/\rayr{ENF}{eng} for inanimate
