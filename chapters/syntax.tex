...
\a\label{ex:adjmod_cp}%
	...
	\begingl
		...
		\gla Yāng petau padangya yana. //
		\glb yāng petau padang-ya yana //
		\glc \TsgM{} stupid mind-\Loc{} \TsgM{}.\Gen{} //
		\glft `He is stupid in his mind.' //
	\endgl
	\end{minipage}
	~
	\begin{forest} narrower nodes, shorter edges, italic leaves,
...
\citep[??]{bresnan2016}; the functional annotation provides information about
whether a sister node to \xhead{X} is a complement or an adjunct instead.
...
might be better motivated scientifically}. As described in
\autoref{sec:adverbs}, the only morphology attributive adverbs take in Ayeri is
comparison morphology and negation. This is the same as adjectives, hence the
functional specifications indeed look the same:
