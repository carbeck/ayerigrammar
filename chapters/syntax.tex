...
agent (A)---as the entity that prototypically acts in some way---or the
patient/undergoer (P)---as the entity which is prototypically affected by the
...
Chukchi (adapted from \cite*[104]{comrie1989}):
...
first-person objects of the verb, but not for subjects of transitive clasues.
...
languages show a bias towards a nominative--accusative treatment, for instance,
of addressees of imperatives \citep[116--119]{comrie1989}.

According to \citep{carnie2013}, from the point of view of constituent
structure (which is key in Generative Grammar), a subject is normally
...
sentences, this surfaces in the specifier of [the tense phrase]}, which is also
what we already saw in (\ref{ex:basicsvo}), which is repeated here for
convenience:
...
What \citep{carnie2013} calls `tense phrase' (TP) for reasons of how
generative grammar treats verb inflection is essentially what is labeled `VP'
for `verb phrase' above. However, as we have learned above, this notion is
challenged by languages such as Tagalog \citep[225]{kroeger1991}.
