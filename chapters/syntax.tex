...
predicate is co-indexed with an element of the argument structure of the
primary predicate}. He suggests for \textsc{hpsg} \textquote{a lexical rule
that recategorizes predicative adjectives and prepositions so that they can
modify verbal elements} as a way to \textcquote[196]{mueller2002}{capture the
adjunct properties of depictive secondary predicates}. I tried to cast this in
...
adjective is expressed by $i$ as an index which marks that they are co-indexed.
