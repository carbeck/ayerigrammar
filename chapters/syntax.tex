...
the a-structure of transitive clauses with unaccusative verbs to that of
...
resultative. My interpretation is that this suggests a structure as described
for copula clauses (\autoref{subsec:eqs}), so there should be a \fw{null-be}
requiring a subject and a predicative element as its arguments here as well.
This f-structure $g$ forms an open complement of the verb in $f$, so I have
also included an S daughter of VP as an equivalent for the \XCompl{} function.
