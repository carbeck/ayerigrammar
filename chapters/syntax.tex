...
\begin{description}
	...
	It is also used for the goal\index{semantic role!goal} (\textsc{goal}) of verbs of motion when they
...
prepositions as well as postpositions\index{adpositions!postpositions}. With regards to word order\index{word order} typology\index{typology}, we
can thus note:
...
(\ref{ex:ppcstruct}). PPs, if not subcategorized for by the
verb\index{verbs}, are optional information and thus not governed by the verb\index{verbs}; the
respective PP is thus part of the set of adjuncts\index{grammatical function!adjunct}. Some verbs, like
