...
the nominative argument can be formed by either NP in (\ref{ex:tagpivot}) with
the voice marked accordingly on the verb.\footnote{Thus, compare the English
passive sentence \fw{Marvin$_i$ was asked by Derek$_j$ before he$_i$ left} with
(\ref{ex:tagpivot_1}). In English, the reference of \fw{he} is ambiguous
between the syntactic subject \fw{Marvin} and the agent \fw{Derek}, however. As
we have seen above, though, Tagalog would also be able to make a subject of
an oblique argument, not just of the patient/theme or the recipient. The actor
of the Tagalog sentence is also basically an object, not demoted to an
adverbial as in English \citep[38--44]{kroeger1991}.}
...
\a\label{ex:tagpivot_1}%
	\begingl[aboveglbskip=1.5em, aboveglftskip=1.75em]
		...
		\glb \Pfv{}-ask-\Ov{}\tikzmark{tagpivot1_vc}
			...
			before \Pfv{}.\Av{}\tikzmark{tagpivot1_vc2}-leave
...
\a\label{ex:tagpivot_2}%
	\begingl[aboveglbskip=1.5em, aboveglftskip=1.75em]
		...
		\glb \Pfv{}.\Av{}\tikzmark{tagpivot2_vc}-ask
			...
			before \Pfv{}.\Av{}\tikzmark{tagpivot2_vc2}-leave
...
\draw [-latex] 
	([xshift=-.5*width{"pfv.av"},yshift=+2.25ex]{pic cs:tagpivot1_vc2})
	|- ++ (north:.75em) -|
...
\draw [-latex] 
	([xshift=-.5*width{"pfv.av"},yshift=+2.25ex]{pic cs:tagpivot2_vc2})
	|- ++ (north:.75em) -|
...
\a\label{ex:ayrpivot_4}%
	\begingl[aboveglftskip=1em]
		\gla Ang kimbyo paral prabarās nay sahayo {} edaya. //
		\glb ang kimb-yo paral-Ø prabara-as nay saha-yo {} edaya  //
		\glc \AgtT{} hunt-\TsgN{}
			$\underbrace{\text{cat-\Top{}}}_{\text{A}\tikzmark{ayrpivot_ctrl}}$
			$\underbrace{\text{mouse-\Parg{}}}_{\text{P}}$
			and come-\TsgN{}.\Aarg{}
			$\underbrace{}_{\text{S}\tikzmark{ayrpivot_targ}}$
			here //
		\glft `The cat, it hunts the mouse and [the cat] comes here.' //
	\endgl
...
\draw [-latex]
	...
	|- ++ (south:.75em) -|
	([yshift=-.75ex]{pic cs:ayrpivot_targ});
\end{tikzpicture}
\xe

...

% THIS IS A NEWLY INTRODUCED IDEA RIPPED STRAIGHT OFF TAGALOG TO MAKE THINGS A
% BIT MORE INTERESTING WITH REGARDS TO ADDING SOME SLIGHT
% AMBIGUITY/IRREGULARITY TO SUBJECTHOOD. DUNNO IF I'M GONNA KEEP IT BUT IT'S
% WORTH A TRY.
\pex\ljudge\ques\label{ex:ayrpivot2}
\begingl[aboveglcskip=1.5em, aboveglftskip=1em]
		\gla Sa kimbyo paralang prabara nay sahayo {} edaya. //
		\glb sa kimb-yo paral-ang prabara-Ø nay saha-yo {} edaya  //
		\glc \PatT{}\tikzmark{ayrpivot2_ctrl1} hunt-\TsgN{}
			$\underbrace{\text{cat-\Aarg{}}}_{\text{A}}$
			$\underbrace{\text{mouse-\Top{}}\tikzmark{ayrpivot2_targ1}}_%
				{\text{P}\tikzmark{ayrpivot2_ctrl2}}$
			and come-\TsgN{}
			$\underbrace{}_{\text{S}\tikzmark{ayrpivot2_targ2}}$
			here //
		\glft `The mouse, the cat hunts it and [the mouse] comes here.' //
	\endgl

\begin{tikzpicture}[remember picture, overlay]
\draw [-latex] 
	([xshift=-1ex,yshift=+2.25ex]{pic cs:ayrpivot2_ctrl1})
	|- ++ (north:.75em) -|
	([xshift=-.5*width{"mouse-top"}, yshift=2.25ex]{pic cs:ayrpivot2_targ1});

\draw [-latex] 
	([xshift=-.25em,yshift=-.75ex]{pic cs:ayrpivot2_ctrl2})
	|- ++ (south:.75em) -|
	([xshift=-.25ex, yshift=-.75ex]{pic cs:ayrpivot2_targ2});
\end{tikzpicture}
\xe
