...
complementary distribution\index{complementary distribution} for most combinations. The only exception to this is
...
complementary distribution\index{complementary distribution} of determiners---which also holds true for
...
quantifiers were adjectives\index{adjectives}, they would also have to coordinate\index{coordination} with them.
...
{ku-}{like (a)}, which precedes\index{word order} common nouns, and which precedes\index{word order} proper nouns
if no overt case\index{case} marker is present and follows\index{word order} them if there is. At least in
...
In cases like (\ref{ex:likeavmpropercase}), if there are adjectives\index{adjectives} following\index{word order}
...
Adjectives\index{adjectives} and adverbs are in complementary distribution\index{complementary distribution}, which, he writes,
...
precede\index{word order} the subject\index{grammatical function!subject} NP\index{phrase types!noun phrase} with proper names, as in (\ref{ex:ayreqstmt_1}) and (b),
...
after\index{word order} verbs like adverbs\index{adverbs}, and may also appear between the two parts of a copula
...
from both English and German, Ayeri puts recipients\index{semantic role!recipient} after\index{word order} themes\index{semantic role!theme}\index{word order}, irrespective
