...
\fw{throws a party} does not act out the same semantic role as someone who 
\fw{throws a stone}, and someone who \fw{kills time} is not guilty of murder.
This also reaches into the idiomatic use of certain verbs. A few examples (to
various degrees of idiom-ness) in Ayeri are:

\pex\label{ex:ayrvbidm1}%
\xayr{triNFy}{taringaya}{the minister}
...
\a \xayr{ANF phy — telbaanFlej}{ang pahya ... telbānley}{... removes a sign}
\a \xayr{ANF phy — pegmyaasF}{ang pahya ... pegamayās}{... arrests a thief}
\xe
...
(\ref{ex:ayrvbidm2}) removing something or arresting someone?
...
and a complement which is attributed to a subject, for instance:

\pex\label{ex:ayridms}
\a \xayr{bFrs/ tihNy}{bras- tihangya}{bathe in knives}\\
	(be in terrible distress)
\a \xayr{petig/ inunsF spyeri/nm}{petiga- inunas sapayeri-nama}{catch a fish
	with bare hands} \\
	(make a futile attempt)
\a \xayr{sikY- koyyelej}{sic- koyayeley}{spit books} \\
	(be smartassing)
...
Just stating a subject and a verb like, for instance, \xayr{sikYy ANF tpnF}
{sicya ang Tapan}{Tapan spits} would just be understood as that, literally. The
idiomatic meaning of showing off knowledge in an annoying way depends on the
object, \xayr{koyyelej}{koyayeley}{books}.
