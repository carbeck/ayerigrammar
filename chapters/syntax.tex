...
necessary, since there is no preposition to indicate the relation of the
...
Prepositional phrases proper in Ayeri are locative adverbials, that is, they
are not subcategorized by a verb as required arguments but they add additional
information about the literal site or time frame (most prepositions) of an
action, or about its logical connection (some postpositions). In the following,
proper PPs will be described in more detail.
