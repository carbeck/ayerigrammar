...
morphemes. Possessive adjecties thus also do not share all the morphological
...
further modified by modifiers adjoined to \xbar{A}; \xbar{A} repeats for the
adjunction of multiple modifiers. Since modifiers follow their heads here as
well, APs are also a right-branching constituent. Modifiers of adjectives are
subsumed under the label XP here, which here stands for AdvP, NP, DP, and CP.
An example of each modifying an adjective is given in (\ref{ex:adjmod}).
...
\a\label{ex:adjmod_dp}%
	...
	\begingl
		...
		\gla Yang mino kalam yana. //
		\glb yang mino kalam yana //
		\glc \Fsg{}.\Aarg{} happy really \TsgM{}.\Gen{} //
		\glft `I am really happy about you.' //
	\endgl
	\end{minipage}
	~
	\begin{forest} narrower nodes, shorter edges, italic leaves,
...
\a\label{ex:adjmod_cp}%
	...
	\begingl
		...
		\glft `It is good that I hear this.' //
	\endgl
	\end{minipage}
	~
	\begin{forest} narrower nodes, shorter edges, italic leaves,
