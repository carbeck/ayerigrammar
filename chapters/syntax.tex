...
behaves untypical in not making causers subjects
...
rather than to \Subj{}. The agent remains the logical subject, \thetaroof{},
and is not demoted to an object or oblique function, and neither is the patient
demoted to a secondary object. Ayeri instead topicalizes causers to express the
sense of \fw{Z makes X verb Y}. An example is provided by
(\ref{ex:causstruct}).
