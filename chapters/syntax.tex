...
Instead of case\index{cases} marking on the DP or NP, there is a marker before the verb
...
host a number of clitics\index{clitics}, among which are deictic prefixes and quantifiers, as
...
relationships to the noun: complement (instrumental\index{cases!instrumental} nominal, NP/DP; complement
clause, CP), and adjunct (adjective\index{adjectives} phrase, AP; relative clause, CP;
...
marker is always present for untopicalized NPs, whether a demonstrative clitic\index{clitics}
...
and marks the NP simply for agent case\index{cases!agent}, irrespective of other elements.
...
plural; semantic agreement has been triggered, and gender\index{gender} and number resolution\index{resolution!gender}\index{resolution!number}
...
adjectives\index{adjectives}, they have been analyzed here as adjuncts of NP, since modifiers of
quantifiers are values of \Quant{}'s \Adjc{} list. That is, if quantifiers were
treated as heads of DP with NP as a complement of \xhead{D}, due to \xhead{D}
...
\rayr{ekeNF}{ekeng}, as a part of $g$, does not modify the head of NP, 
...
in the plural, and demonstrative pronouns. A clitic\index{clitics} quantifier can also still
...
adjective--adverb\index{adverbs} combination can be complemented by an NP, as shown in
...
the genitive case\index{cases!genitive}: the NP complement expresses an oblique theme about which the
...
appears as an NP complement in the (ethical) dative\index{cases!dative} in (\ref{ex:adjmod_dp}).
Instrumental\index{cases!instrumental} and causative\index{cases!causative} NP complements instead of PPs may be found as well
...
AdvP.\footnote{Since in \Lfg{}\index{Lexical-functional grammar}, non-branching \xbar{X} nodes are omitted for
...
not possible here, since CPs cannot be marked for case\index{cases}.
...
classify both adjectives\index{adjectives} and adverbs as heads of AP with reference to
...
adverbs may modify any other lexical category: verbs, adjectives\index{adjectives}, prepositions,
...
\begin{description}
	...
	corresponds to English `to', `for'. NPs may be marked with dative case\index{cases!dative}
	...
	(\textsc{source}). NPs may be marked with genitive case\index{cases!genitive} freely to indicate
...
English, often uses an NP complement marked with one of the cases\index{cases} in the list
above, compare (\ref{ex:naracstruct}). In the case of \xayr{nr/}{nara-}{speak,
talk}, the complement appears in the locative case\index{cases!locative}, but as an NP, not as a PP.
...
of the clause shows that there is a corresponding dative\index{cases!dative} NP. Strictly speaking,
...
case, wrapping an adjective\index{adjectives} into a relative clause CP to explicitly subordinate
...
Ayeri marks predicative NPs with the patient case\index{cases!patient} as a further quirk, as shown
...
This equation describes that if no VP is specified, a \Pred{} is introduced
...
may be an NP, DP, AP, CP, and colloquially a PP; \fw{null-be} is basically a
...
adverb\index{adverbs} usually appears between the subject and the predicative NP, as
...
adverb\index{adverbs} phrases (AdvP), but also adjective\index{adjectives} phrases (AP), and even noun phrases
...
agreement\index{agreement} with full third-person NPs and pronominal clitics\index{clitics}. For this reason,
...
of \xhead{I}, functioning as an \XCompl{}. This VP exists for the purpose of
...
clause's topic by a clitic\index{clitics} corresponding to the NP's case\index{cases} marker in its clitic\index{clitics}
...
the verb agrees in case\index{cases} with the topicalized NP. Thus, on morphological
grounds, the topicalized NP is a controller and the verb is its agreement\index{agreement}
...
(\Aarg{}), topic can be marked. This is because the causative\index{cases!causative} NP, even though
...
embedded NP marked for genitive case\index{cases!genitive}. Presumably, we want instrumental\index{cases!instrumental}
...
NPs with a genitive\index{cases!genitive} attribute and with a nominal complement, respectively, have
...
imperatives. They imply a second person singular or plural subject (number\index{number} is
...
complement of \xhead{I} in order to be able to topicalize NPs subcategorized by
...
which the subject DP contains is that of the quantifier clitic\index{clitics},
...
scattered over \xhead{I} and the subject DP.
...
of the adjective\index{adjectives} is generated in its canonical position as a daughter of the AP
...
lexical rule that recategorizes predicative adjectives\index{adjectives} and prepositions so that
...
does not assign case\index{cases} to these NPs.\footnote{One might be tempted to analyze
\rayr{ku/}{ku-} as a case\index{cases} marker used for essive and equative functions.
NPs marked with \rayr{ku/}{ku-} may be regularly case-marked\index{cases} in other contexts,
...
a goal NP, a resultative dative\index{cases!dative} NP also normally occurs after the verb.
...
words, the modifier is not an argument but an adjunct. The NP with an adjective\index{adjectives}
...
\begin{description}
	...
	be included as either an NP in the locative case\index{cases!locative} or a PP.
	...
	\emph{optionally} with the addressee NP in the locative case\index{cases!locative} and the theme
	...
	material may be \emph{optionally} stated as an instrumental\index{cases!instrumental} NP. Especially
...
optional genitive\index{cases!genitive} NPs, one for the theme and another as a locative adverbial.
...
attempts to coordinate an instrumental\index{cases!instrumental} DP with an instrumental\index{cases!instrumental} NP to express
...
locative\index{cases!locative} and an instrumental\index{cases!instrumental} NP, respectively. This means that there are no
...
If we treat the PPs, locative\index{cases!locative} NPs, and instrumental\index{cases!instrumental} NPs of the surveyed verbs
...
or \textit{source} for PPs and locative\index{cases!locative} NPs, and \mbox{\textit{instr}} for the
...
regard, except that case\index{cases} marking on the theme/patient NP does not change to
...
as a dative\index{cases!dative} NP in Ayeri. Since open complements (labeled \textsc{proposition})
...
permit dative\index{cases!dative} NPs to be subjects of passive verbs, this is not possible in
...
subject, which \xayr{tehsFyelej}{tehasyeley}{cups} satisfies. If both NPs were
...
verbal phrase type---IP or VP, but also plain S in the case of a copula clause.
...
the subordinate clause is formed by a participle\index{participles}. Even if there is a
...
It has been mentioned initially that complement clauses\index{complement clause} may also have S
