...
\a\label{ex:ayrctrl3_1}\begingl[aboveglcskip=1.5em,] % aboveglftskip=1.75em]
	...
	\glc ask-\TsgM{}%
		...
		{}
		//
	\glft `Amān asks that, as for Kagan, he close the door.' //
\endgl
\begin{tikzpicture}[remember picture, overlay]
\draw [-latex]
...
(\ref{ex:ayrctrl3_2}) whether the coreferential argument is the topic in both
...
VP of the complement clause, containing all its arguments, to the IP of the
...
possible, however, to use the VP adjunction strategy with intransitive
