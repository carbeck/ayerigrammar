...
c-structure but by the relation between its complements. This way, do have a
to-one relationship, though on a more abstract level.

Furthermore, with the economy of expression principle of \Lfg{} in mind, it
maybe reasoned that since the resultative XP is also a complement of the verb
...
[–\,r] marking on the passive subject refers to its thematic role in the
argument structure as unrestricted \citep[324\psqq]{bresnan2016}.
...
The \Obj{} function in (\ref{ex:fakerefl}) has been added to the argument
...
\ex\label{ex:runtranswrong}\ljudge*\begingl
	\glpreamble \astruct{run}{\ups{\Subj} \ups{\Obj}} //
