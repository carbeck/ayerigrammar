...
Nominal adjuncts\index{grammatical function!adjunct} of nouns which specify what the noun consists of appear in the
...
possessive determiners, as well as relative clauses\index{relative clause} and nominal adjuncts\index{grammatical function!adjunct}. These
...
clause, CP\index{phrase types!complementizer phrase}), and adjunct\index{grammatical function!adjunct} (adjective\index{adjectives} phrase, AP\index{phrase types!adjective phrase}; relative clause\index{relative clause}, CP\index{phrase types!complementizer phrase};
...
The complement does not become an adjunct\index{grammatical function!adjunct}, however, as (\ref{ex:complnoadjc})
...
these person features, pronouns also encode person\index{person} as a deictic category. The
...
pronouns do not mark person\index{person}; a third-person\index{person} reference is implied like with
...
the \Adjc{}\index{grammatical function!adjunct} off a functional head with deictic features (formerly \rayr{dnYlej}
...
encode person\index{person} and number\index{number}, though at least \rayr{sinY}{sinya} inflects for case\index{cases}
...
adjuncts\index{grammatical function!adjunct}. If they were, it should be possible for there to be more than one
...
adjectives\index{adjectives}, they have been analyzed here as adjuncts\index{grammatical function!adjunct} of NP\index{phrase types!noun phrase}, since modifiers of
...
\fw{on the pile} is not an adjunct\index{grammatical function!adjunct} here because \fw{She does so on the pile}
...
fashion of (\ref{ex:adpadv}) would attach in the adjunct\index{grammatical function!adjunct} position, following
...
adjuncts\index{grammatical function!adjunct} actually follow the verb so that the complement shifts to the right,
...
be negated. However, they do not mark person\index{person} and topic\index{topic}, and they do not encode
...
However, the recipient is not an adjunct\index{grammatical function!adjunct}---it must be an argument. That is, it
...
and the recipient, or the recipient and an adjunct\index{grammatical function!adjunct} with \xayr{nj}{nay}
{and}---only non-arguments can be coordinated this way \citep[181]{carnie2013}.
Likewise, it is not possible for patient, recipient, and adjuncts\index{grammatical function!adjunct} like 
...
markers.} Nominal depictives may appear right after the verb or as adjuncts\index{grammatical function!adjunct} of
...
words, the modifier is not an argument but an adjunct\index{grammatical function!adjunct}. The NP\index{phrase types!noun phrase} with an adjective\index{adjectives}
...
certain verb, the more likely it is to mark an adjunct\index{grammatical function!adjunct}}. All of the verbs in
...
example of such coordination where both adverbials clearly are adjuncts\index{grammatical function!adjunct}. As
...
potentially a complement. However, like an adjunct\index{grammatical function!adjunct}, it appears optionally.
As with typical adjuncts\index{grammatical function!adjunct}, \xhead{P} provides contentful information about
...
complements and typical traits of adjuncts\index{grammatical function!adjunct}.
...
definitely higher than that of a free PP\index{phrase types!prepositional phrase} adjunct\index{grammatical function!adjunct}. The score is also 6 to 2 in
...
subject\index{grammatical function!subject}: the verb shows agreement\index{agreement} with a third person\index{person} masculine\index{gender} referent, which
