...
the following lexicocentric conditions operate \emph{canonically} on both DP 
and NP as exponents of case:
...
\tl\quad & \downs{\Case} = \Dat		& \pass{\SObj} \logor{}
						\pass{\Oblq{to}} \\
\tl\quad & \downs{\Case} = \Gen		& \pass{\Oblq{gen}} \logor{} 
						\pass{\Oblq{from}} \\
...
(\xhead{N}'s sister node) can consist of different phrase types (AP, NP, CP), 
