...
quantifiers. Enclitic quantifiers seem to even be able to be modified
themselves, as demonstrated in (\ref{ex:clitics_55}) from 
\autoref{clitics_quant} (p.~\pageref{ex:clitics_55}), which is repeated again
here, abbreviated:
...
\a\ljudge*\label{ex:quantadvcomptest_2}\begingl
	\gla keynam-ikan kagan diring //
	\glb keynam=ikan kagan diring //
	\glc people=many far.too several //
	\glft `several far too many people' //
\endgl
