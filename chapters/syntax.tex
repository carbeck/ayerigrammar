...
establish why they are clitics rather than affixes or words.
...
the clitic should be adjoined to a bar level higher than the adjective in
(\ref{ex:postkucstruct}). Thus, we need to invoke the inside-out functional
uncertainty principle again, in that we require postposed \rayr{/ku}{-ku} to
fill in not the AP's \Adjc{}, but that of the next higher \GF{} (or \DF{}, for
that matter). Example (\ref{ex:postkuconst}) demonstrates how the positioning
variants of \rayr{ku/}{ku-} and \rayr{/ku}{-ku} differ in meaning and
grammaticality.
...
distinguished by the lack of postposed \rayr{/ku}{-ku}'s possibility to
modify the adjective, since adjectives only take \rayr{ku/}{ku-} as a
proclitic, but never as an enclitic. Regarding functional annotations---as
already suggested by (\ref{ex:postkucstruct})---for the two kinds of \rayr{ku}
{ku}, we can posit:
...
definition: the phrase's \Adjc{} is filled with an instance of [\Pred{}
...
the modifier it leans on phonetically. There thus has to be some phrase $x$
