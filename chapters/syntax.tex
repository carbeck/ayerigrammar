...
case\index{cases} marking and grammatical functions\index{grammatical function}, which are not always unambiguous. As
...
the animacy\index{animacy} of the topicalized\index{topic} phrase. Grammatical information about the topic\index{topic}
...
(\DF{}) or a grammatical function\index{grammatical function} (\GF{}). Besides, nouns may be modified by
...
\begin{enumerate}[noitemsep]
	...
	\item quantifiers\index{quantifiers} and cardinal numerals\index{numerals!cardinal}
...
(compare \autoref{subsec:postpos}). In the light of word order\index{word order} typology, we can
...
imply a third-person reference; they distinguish number\index{number}, gender\index{gender} and animacy\index{animacy}, as
...
which need to agree in animacy\index{animacy} with the lexical head they attach to. An example
...
\xayr{gnF}{gan}{child}, is animate\index{animacy}, hence the case\index{cases} marker also needs to be 
animate\index{animacy}---the case\index{cases} marker must thus be \rayr{/ANF}{-ang} to be coherent. In
contrast to this, example (\ref{ex:animcaseagr}b) is not well-formed in that
the noun is animate\index{animacy} but the case\index{cases} marker, \rayr{/reNF}{-reng}, signals that it
...
all grammatical categories of nouns\index{nouns}---number\index{number}, gender\index{gender}, animacy\index{animacy}, and case\index{cases}; they
agree with their antecedents in number\index{number}, gender\index{gender}, and animacy\index{animacy}. In addition to
...
features as personal pronouns\index{pronouns!personal}: person, number\index{number}, gender\index{gender}, animacy\index{animacy}, and
...
the NP\index{phrase types!noun phrase} as the subject\index{grammatical function!subject}.
...
is marked for patient case\index{cases!patient}, which identifies it as an object\index{grammatical function!primary object}. Thus, I propose
...
only inflect for case\index{cases} and distinguish animacy\index{animacy} in agreement\index{agreement} with their
...
pronoun is marked for case\index{cases}, and thus also encodes animacy\index{animacy} for agents and
...
we are asking for the subject\index{grammatical function!subject}/agent in this case, not for the object\index{grammatical function!primary object}/patient as
...
and thus also encodes animacy\index{animacy} for agents and patients. Other pronouns, like
...
various oblique\index{grammatical function!oblique} arguments (\Possr, \Oblq{loc}, \Oblq{ins}, \Oblq{caus}).
...
decline for case\index{cases}, and thus also for animacy\index{animacy} with agent and patient antecedents;
...
analyzed as a depictive\index{adjectives!depictive} secondary predicate referring to \xayr{EnYlej}{enyaley}
...
In (\ref{ex:eachotheravm}), the two coordinated subject\index{grammatical function!subject} NPs\index{phrase types!noun phrase} do not share the
...
pronoun to use. In either case, an animacy\index{animacy} hierarchy operates in that animate\index{animacy}
referents outweigh inanimate\index{animacy} ones. Mixed animate\index{animacy} groups often default to
masculine\index{gender}, though not in all cases\index{cases}. The rules which operate are the following:
...
masculine\index{gender} form as the default for sexed entities; use neuter\index{gender} otherwise.
...
It is possible that the preference for the masculine\index{gender} form as a default is in
...
no syncretism in Ayeri's third-person plural\index{number!plural} pronouns which would render
...
\TplF{}.\Gen{} and \TplI{}.\Gen{}. They all unambiguously indicate plural\index{number!plural}.}
...
{yena} refers to a non-present feminine\index{gender} third person, the owner of the toy and
...
subject\index{grammatical function!subject} pronoun \xayr{tNF}{tang}{they} as well as the pronominal suffix of the
verb \xayr{gireMdFtNF}{girendtang}{they arrive}---switch to animate\index{animacy} masculine\index{gender}
plural\index{number!plural}; semantic agreement has been triggered, and gender\index{gender} and number resolution\index{resolution!gender}\index{resolution!number}
thus occur. The pronoun of choice is masculine\index{gender}, since this is the default
...
predicative complements (\Plink{}\index{grammatical function!predicative complement}) in copula clauses\index{copula clause}, compare
...
the genitive case\index{cases!genitive}: the NP\index{phrase types!noun phrase} complement expresses an oblique\index{grammatical function!oblique} theme about which the
experiencing subject\index{grammatical function!subject} becomes happy. This, however, should not be conflated with
a possessor, \Possr{}, but should be labeled separately as an oblique\index{grammatical function!oblique}
complement, \Oblq{theme}. Similarly, the recipient of the subject's\index{grammatical function!subject} happiness
...
that adverbs\index{adverbs} cannot serve as \XCompl{}\index{grammatical function!open complement} in equative statements; they also can
...
\Lfg{}\index{Lexical-functional grammar} categorizes the object\index{grammatical function!primary object} of an adposition as an oblique\index{grammatical function!oblique} argument 
...
adpositions in Ayeri usually allow adpositional objects\index{grammatical function!primary object} to be either marked for
locative\index{cases!locative} or dative case\index{cases!dative}:

\begin{description}
	\item[Locative:] Standard case\index{cases} for adpositional objects\index{grammatical function!primary object}, indicates a
...
Which oblique\index{grammatical function!oblique} case\index{cases} the complement appears in is determined by the a-structure
...
prepositions as well as postpositions\index{postpositions}. With regards to word order\index{word order} typology, we
can thus note:
...
a whole complement clause\index{complement clause}. The nominal complements are objects\index{grammatical function!primary object} governed by the
adposition.
...
as \Oblique{}\index{grammatical function!oblique} with $\theta$ replaced by the proper semantic macrorole
...
adpositional object's\index{grammatical function!primary object} case\index{cases} in (\ref{ex:adpmorphlex_1}) excludes
...
marking also does not influence the case\index{cases} of the adpositional object\index{grammatical function!primary object}.
...
the prepositional object\index{grammatical function!primary object} is \Loc{} in both versions of the sentence.
...
object\index{grammatical function!primary object}. However, Ayeri does not possess separate adpositions to express `up'
...
prepositional object\index{grammatical function!primary object} is to be put in the dative case\index{cases!dative}.
...
the adpositional phrase or as an adjective\index{adjectives} modifying the prepositional object\index{grammatical function!primary object}.
...
statement in which a property is attributed to a subject\index{grammatical function!subject} in the fashion of 
(\ref{ex:engeqstmt}).
...
While English connects the predicative\index{grammatical function!predicative complement} phrase to the subject with a copula,
...
Regarding predicative\index{grammatical function!predicative complement} adjectives\index{adjectives}, Ayeri permits them to either follow or to
precede the subject\index{grammatical function!subject} NP\index{phrase types!noun phrase} with proper names, as in (\ref{ex:ayreqstmt_1}) and (b),
...
Ayeri marks predicative\index{grammatical function!predicative complement} NPs\index{phrase types!noun phrase} with the patient case\index{cases!patient} as a further quirk, as shown
...
\blockcquote[105]{attia2008}{the closed complement\index{grammatical function!closed complement} analysis is the default
...
an \Adjc{} within \Plink{}\index{grammatical function!predicative complement}. This is illustrated by (\ref{ex:copadv}).
...
subject\index{grammatical function!subject} and the predicate of a simple copula clause\index{copula clause} to be reversed, for
...
adverb\index{adverbs} usually appears between the subject\index{grammatical function!subject} and the predicative NP\index{phrase types!noun phrase}, as
...
transitive\index{verbs!transitive} finite verbs\index{verbs!finite} are obligatorily marked for the case\index{cases} and animacy\index{animacy} of the
...
secondary-predicative\index{grammatical function!predicative complement} AP\index{phrase types!adjective phrase} may as well appear in this position, as discussed in
...
object\index{grammatical function!primary object} \rayr{Agu\_asF}{aguas}.
...
occurs in the VP\index{phrase types!verb phrase} complement after the subject\index{grammatical function!subject} NP\index{phrase types!noun phrase}. Raising\index{verbs!raising} is required to make
an embedded argument part of the matrix verb's argument structure. However, as
described in \autoref{subsec:raising}, only to-subject\index{grammatical function!subject} raising\index{verbs!raising} is permitted in
Ayeri.
...
the verb. In (\ref{ex:npembedfull}), the object\index{grammatical function!primary object} NP\index{phrase types!noun phrase} has been topicalized and
...
imperatives. They imply a second person singular\index{number!singular} or plural\index{number!plural} subject\index{grammatical function!subject} (number\index{number} is
...
a subject\index{grammatical function!subject} by inflection or clitics\index{clitics} either. \rayr{IlF/IlFymF} {il-ilyam} in
...
(\ref{ex:doubleobj}) illustrates such a double-object\index{grammatical function!primary object} construction.
...
In (\ref{ex:doubleobj}), the object\index{grammatical function!primary object}/recipient is \rayr{diy}{Diya}, and the
secondary object\index{grammatical function!secondary object}/theme is \rayr{koyaasF}{koyās}. Functionally, the verb
...
where the object\index{grammatical function!primary object} expresses the recipient and the secondary object\index{grammatical function!secondary object} expresses the
...
dependent on the superordinate verb for the subject\index{grammatical function!subject} function: control verbs
...
proclitic\index{clitics} before the verb, which here encodes an inanimate\index{animacy} patient topic\index{topic},
...
raising-to-object\index{grammatical function!primary object} mechanism and instead requires a complement clause\index{complement clause}.
...
it does not allow \xayr{pronF/}{paron-}{believe} to be a raising-to-object\index{grammatical function!primary object}
verb. Note again, however, that even raising-to-subject\index{grammatical function!subject} is only common in Ayeri
...
daughter of the VP sister of the subject\index{grammatical function!subject} NP\index{phrase types!noun phrase}, \rayr{ANF AgYaanF}{ang Ajān}. This
VP, in turn, has an NP\index{phrase types!noun phrase} complement carrying the object\index{grammatical function!primary object} of the subordinate verb,
\xayr{UmNF}{umang}{beach}. The subordinate VP is discontinuous here as well, so
both parts are marked \XCompl{}\index{grammatical function!open complement}. The subordinate verb's object\index{grammatical function!primary object} is also the
...
comparison\index{comparison!of adjectives} verbs\index{verbs!comparative} \xayr{km/}{kama-}{be as} \xayr{ENF/}{eng-}{be more} and
...
comparison\index{comparison!of adjectives}\index{verbs!comparative} as listed initially. Ayeri behaves differently in this from what
...
standard NP\index{phrase types!noun phrase} is constructed as the direct object\index{grammatical function!primary object} of a transitive verb\index{verbs!transitive} with the
...
a modifier, essentially in the way of an adverb\index{adverbs}. Nonetheless, the subject\index{grammatical function!subject} forms
...
The way \Lfg{}\index{Lexical-functional grammar} handles comparison\index{comparison!of adjectives} of adjectives\index{adjectives} in predicative\index{grammatical function!predicative complement} contexts is
sketched out in \citet[122]{butt1999}, see (\ref{ex:lfgpredcomp}). As expected,
the predicative\index{grammatical function!predicative complement} complement is contained within a \Plink{}\index{grammatical function!predicative complement} function. Comparison\index{comparison!of adjectives}
...
information on the comparison\index{comparison!of adjectives} status of the predicative\index{grammatical function!predicative complement} complement as well as
...
allows for \xhead{A} to be fronted if it does not modify a predicative\index{grammatical function!predicative complement} nominal.
The sentence in (\ref{ex:comppredn_1}) is thus ungrammatical because the
adjective\index{adjectives}, \xayr{bnF}{ban}{good}, modifies a predicative\index{grammatical function!predicative complement} noun,
...
predicative\index{grammatical function!predicative complement} adjectives\index{adjectives} and nominals over the subject\index{grammatical function!subject} in order to illustrate a
very common basic type of statement. There are also secondary predicates,
however, which can be subdivided further into depictive\index{adjectives!depictive} and resultative\index{adjectives!resultative}
...
(\ref{ex:engsecpred2_obj}) does not refer to the state of the subject\index{grammatical function!subject} or the
object\index{grammatical function!primary object} at the moment of wiping, but the state of the table as a result of being
wiped.

Unfortunately, \citet[347]{bresnan2016}, while mentioning resultatives\index{adjectives!resultative}, do not
go into detail about an \Lfg{}\index{Lexical-functional grammar} analysis of them, and do not say anything at all
about depictives\index{adjectives!depictive}. While they give a few references about \Lfg{}-based\index{Lexical-functional grammar} surveys
of resultatives\index{adjectives!resultative} in English, a cursory web search does not bring up papers on
depictive\index{adjectives!depictive} predicates in terms of \Lfg{}\index{Lexical-functional grammar}. One has to assume that this topic
...
resultatives\index{adjectives!resultative}. As far as \Lfg{}\index{Lexical-functional grammar} analyses of resultatives\index{adjectives!resultative} go, \citet{simpson1983}
and \citet{christie2013} were used to inform the below discussion.
\textcites{mueller2002} provides analyses of both depictives\index{adjectives!depictive} and resultatives\index{adjectives!resultative}
...
Nonetheless, his analyses informed the below discussion of depictives\index{adjectives!depictive}.
...
lexical rule that recategorizes predicative\index{grammatical function!predicative complement} adjectives and prepositions\index{prepositions} so that
...
object\index{grammatical function!primary object}, follows the verb. This nicely fits the analysis fashioned after
...
distinction between adjectives and adverbs\index{adverbs}, but context should clarify under
...
As with other secondary predicates, the normal place for a depictive\index{adjectives!depictive} to appear
...
requiring a subject\index{grammatical function!subject} and a predicative\index{grammatical function!predicative complement} element as its arguments here as
...
resultative element should be annotated \pass{\XCompl{} \Plink}.\index{grammatical function!predicatve complement} This way,
...
subject\index{grammatical function!subject} of the intransitive verb\index{verbs!intransitive} be semantically a patient, that is, not in
...
in terms of semantics. Likewise, it is possible for the patient-subject\index{grammatical function!subject} of a
...
patient case\index{cases!patient} marking for subjects\index{grammatical function!subject} of passive\index{voice!passive} verbs. The [–\,r] marking on the
...
adjective\index{adjectives} \rayr{pisu}{pisu} in the \XCompl{}\index{grammatical function!open complement} function, however. This way, the
...
syntactic subject\index{grammatical function!subject} of an unergative verb is non-objective\index{grammatical function!primary object} [–\,o] since it acts
...
unaccusative verb is patient-like \mbox{[–\,r]}; the same goes for the subject\index{grammatical function!subject}
...
\begin{description}
	...
	entails that an object\index{grammatical function!primary object} is transferred from one location or position to
...
{needhamtoivonen2011}, roles which encode neither patientlike\index{grammatical function!primary object} nor secondary
patientlike\index{grammatical function!secondary object} roles are mapped to [–\,o], thus embody the \Oblique{}\index{grammatical function!oblique} function.
...
subject\index{grammatical function!subject} slot, for one. This function is acted out by Ayeri's topic\index{topic} marking,
...
statement in active\index{voice!active} voice,\footnote{The topicalized\index{topic} argument is marked with an
...
languages like English the former object\index{grammatical function!primary object} appears in the nominative case\index{cases}, Ayeri
...
patient subject\index{grammatical function!subject} and to reintroduce the agent as an oblique\index{grammatical function!oblique} in either the agent\index{cases!agent}
...
the active\index{voice!active} phrasing and choose to topicalize\index{topic} the patient argument as
...
means that the direct object\index{grammatical function!primary object}---marked with the patient case\index{cases!patient} since it is a
patient or a theme---is mapped to [–\,r], while the indirect/secondary
object\index{grammatical function!secondary object}---marked with the dative case\index{cases!dative} since it is a recipient or
...
passivized. According to \citet{bresnan2016}, in English, the subject\index{grammatical function!subject} function,
as the syntactic equivalent of [–\,o], may be dropped. The [–\,r] role, that
is, the recipient or beneficiary, becomes the new subject\index{grammatical function!subject} while the patient or
...
\SObj{} function to the recipient. The primary object\index{grammatical function!primary object} thus maps onto [–\,r] and
the secondary object\index{grammatical function!secondary object} onto [+\,o]. This is the reverse of what English does. If
we assign the subject\index{grammatical function!subject}---and thus nominative case\index{cases}---to the recipient and let the
...
argument serves as the subject\index{grammatical function!subject} in both languages but is associated with
different functions.
...
As we have seen in the previous section, subjects\index{grammatical function!subject} of monotransitive\index{verbs!intransitive} passive
...
possibility of having a recipient subject\index{grammatical function!subject} in the dative case\index{cases!dative}. As we will see,
...
subject\index{grammatical function!subject}: the verb shows agreement\index{agreement} with a third person masculine\index{gender} referent, which
...
Reversing verb agreement\index{agreement} to mark the theme as a subject\index{grammatical function!subject} in
...
verbs: make the patient-marked argument the subject\index{grammatical function!subject}. Ayeri can then mark the
...
subjects\index{grammatical function!subject} in Ayeri. This precludes recipients from acting as subjects\index{grammatical function!subject} even if
...
apply intransitivization to either the active\index{voice!active} ditransitive argument structure
...
of the objects\index{grammatical function!primary object} in active\index{voice!active} voice (\ref{ex:intrnzn_act}) and in passive voice\index{voice!passive}
...
recipient subjects\index{grammatical function!subject}.
...
experiencer as an oblique\index{grammatical function!oblique} function, which is realized in English as a PP\index{phrase types!prepositional phrase}, and
as a dative\index{cases!dative} NP\index{phrase types!noun phrase} in Ayeri. Since open complements\index{grammatical function!open complement} (labeled \textsc{proposition})
...
experiencer becoming the subject\index{grammatical function!subject} (*\fw{I am seemed}). Since Ayeri does not
permit dative\index{cases!dative} NPs\index{phrase types!noun phrase} to be subjects\index{grammatical function!subject} of passive verbs, this is not possible in
...
to be in passive voice, raising the patient subject\index{grammatical function!subject} in (\ref{ex:passraise}bc)
...
case\index{cases} marking of the subject\index{grammatical function!subject} argument. The verb \rayr{vlYFymF}{valyyam} in
...
patient subject\index{grammatical function!subject}. This is comparable to *\fw{The beach is seemed to be enjoyed}
in English.
...
keeps the case\index{cases} marking of patient subjects\index{grammatical function!subject} of passive verbs intact for semantic
reasons, the subject\index{grammatical function!subject} in this example has genitive\index{cases!genitive} marking. We know form verb
agreement\index{agreement} with a singular\index{number!singular} third person that \xayr{selesF}{seles} {shelf} is
supposed to be the subject\index{grammatical function!subject} here. However, as we have seen above, Ayeri only
permits agent and patient subjects\index{grammatical function!subject}. Hence, in contrast, (\ref{ex:derargpass_3})
...
inanimate\index{animacy} singulars\index{number!singular}, the sentence would be ambiguous between the passivization
...
behaves in an untypical way in not making causers subjects\index{grammatical function!subject}
(\autoref{subsubsec:causative}, p.~\pageref{subsubsec:causative}).
\citet[342]{bresnan2016} give the annotation for causers as
Ø~→~\thetaroof\tsub{causer}: a primary causer-subject\index{grammatical function!subject} is added to the argument
structure. Causers are given as mapping to [–\,o] and to the \Subj{}\index{grammatical function!subject} function.
In Ayeri, causers are also mapped to [–\,o], but to the \Oblique{}\index{grammatical function!oblique} function
rather than to \Subj{}\index{grammatical function!subject}, that is, basically like a derived argument which is
added to the a-structure of a verb. The agent remains the logical subject\index{grammatical function!subject},
...
is the patient demoted to a secondary object\index{grammatical function!secondary object}. Ayeri instead topicalize\index{topic}s causers
...
animate\index{animacy} masculine\index{gender} plural\index{number!plural} NP\index{phrase types!noun phrase}, which refers to \rayr{pFrlnFye}{pralanye}. This
also means that the agent NP\index{phrase types!noun phrase} in both cases is the syntactic subject\index{grammatical function!subject}. In
...
subject\index{grammatical function!subject}. A weaker kind of causation may be expressed by putting the causer in
...
headed by a relative pronoun which may agree with its head in case\index{cases} and animacy\index{animacy}
...
{sas}, that is, marked for an animate-patient\index{animacy} controller outside of the
...
the copula clause's\index{copula clause} subject\index{grammatical function!subject} to which the quality \xayr{hginF}{hagin}{heavy} is
...
may mark both possessors and oblique\index{grammatical function!oblique} themes, the construction
