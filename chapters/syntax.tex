...
{eda-} in (\ref{ex:inspecdeix}cd) results in a grammatical sentence because 
\rayr{Ed/}{eda-} defines [\Def{}~$+$, \textsc{specific}~$+$] while \rayr{me/}
{mə-} defines [\Def{}~$-$, \textsc{specific} $-$]. Attempting to assign
opposing values to the same feature must fail.
