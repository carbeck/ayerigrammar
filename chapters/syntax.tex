...
function of the small clause.
% Relatedly, we may want to analyze a predicative adjective expressing the
% state of the subject as in \fw{Bill started the project enthusiastic} so that
% the subject is formed by a small clause. The subject of the small clause and
% the subject of the matrix clause are shared in this case. The adjective
% occurs after the verb as well in this case, that is, there is no clear
% distinction between an adverb and an adjective here.
