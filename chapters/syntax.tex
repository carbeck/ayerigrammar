...
athematic object cannot become a subordinate thematic subject. Hence,
\xayr{nelF/}{nel-}{help} works in Ayeri as an O-control verb, but
\xayr{pronF/}{paron-}{believe} does not work as a raising-to-O verb.

Note, however, that even raising-to-subject is only common in Ayeri with
...
of the matrix verb's f-structure. Again, the subordinated verb is non-finite
and thus cannot carry topic marking.
