...
\a\label{ex:ayrrais1_2}\begingl
	\gla Surpye ang @ Pada$_i$ koronyam \_$_i$ guratanley. //
...
\a\label{ex:ayrrais3_2}\ljudge*\begingl
	\gla Surpara guratanreng$_i$ koronyam ang @ Pila \_$_i$. //
	\glb surp-ara guratan-reng koron-yam ang= Pila {} //
	\glc seem-\TsgI{} answer-\AargI{} know-\Ptcp{} \Aarg{}= Pila {} //
...
\a\label{ex:ayrrais4_2}\ljudge*\begingl
	\gla Silvye ang @ Apitu$_i$ latayam ang @ Maran disaley \_$_i$. //
	\glb silv-ye ang= Apitu lata-yam ang= Maran disa-ley //
	\glc look-\TsgF{} \Aarg{}= Apitu sell-\Ptcp{} \Aarg{}= Maran 
		soap-\PargI{} //
...
\pex
\a \fw{John$_i$ tries that John$_i$ gets a job}\\
	= \fw{John$_i$ tries \textsc{\upshape pro}$_i$ to \textup{t$_\textsc{pro}$}
	get a job}
\a \fw{The officer ordered Mary$_i$ that Mary$_i$ turn back}\\
...
\a\label{ex:ayrctrl2_1}\begingl[aboveglcskip=1.5em, aboveglftskip=1.75em]
	\gla Linkaya {ang Maran}, \textup{[} {le kondisayāng} aguye. 
		\textup{]}. //
	...
	\glc try-\TsgM{}
		...
		{}
		//
	\glft \textit{Literally:} `Maran tried that, as for the the chicken, he
		feeds them.' //
\endgl
\begin{tikzpicture}[remember picture, overlay]
\draw [-latex]
