...
\a\label{ex:restrns_np}%
	\begingl
		...
		\gla Ang @ visaya \textbf{nernanjyam} \textbf{kivo} {} @ Amān
			seygoley. //
		\glb ang= visa-ya nernan-ye-yam kivo Ø= Amān seygo-ley //
...
subject of the intransitive verb be semantically a patient. This becomes
evident in (\ref{ex:resitrns}).
% FIXME: WHICH CASE OR OTHER KIND OF MARKING SHOULD RESULTATIVE NOMINALS HAVE?

\begin{figure}
\pex\label{ex:resitrns}
\a\label{ex:resitrns_unerg}\ljudge\excl\begingl
	\gla Nimpya pisu ang @ Tipal. //
	\glb nimp-ya pisu ang= Tipal //
	\glc run-\TsgM{} tired \Aarg{}= Tipal //
	\glft `John ran tiredly.' \\
		\textit{Intended:} `John ran tired.' (John became tired by running) //
\endgl

\a\label{ex:resitrns_unacc}\begingl
	\gla Napāra mihanreng napisān.... //
	\glb ... //
	\glc ... //
	\glft `...' //
\endgl
