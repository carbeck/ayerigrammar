...
repercussions on case-\index{cases} and topic\index{grammatical function!topic} marking, compare \autoref{subsec:comptr}. Even
...
\xayr{AgonnF}{agonan}{outside of}, however, the topic marker\index{grammatical function!topic} at the beginning
...
Regarding predicative adjectives\index{adjectives!predicative}, Ayeri permits them to either follow or to
...
clause's topic\index{grammatical function!topic}. Ayeri's system of verb agreement\index{agreement} moreover alternates between
...
verb. For simplicity, all examples have agent topics\index{grammatical function!topic} where it is relevant, and
...
proclitic\index{clitics} before the verb, which here encodes an inanimate\index{animacy} patient topic\index{grammatical function!topic},
...
subordinate verbs in order to enable topicalization\index{grammatical function!topic} of their dependents by
...
predicative adjectives\index{adjectives!predicative} and nominals over the subject\index{grammatical function!subject} in order to illustrate a
...
lexical rule that recategorizes predicative adjectives\index{adjectives!predicative} and prepositions\index{prepositions} so that
...
may be noted again here that topicalization\index{grammatical function!topic} has no impact on the argument of
...
the order of the focused\index{grammatical function!focus} VP and the rest of the sentence is inverted to match
...
its agent argument. In English, passivization is a way to keep a topic\index{grammatical function!topic} in the
subject\index{grammatical function!subject} slot, for one. This function is acted out by Ayeri's topic\index{grammatical function!topic} marking,
...
the active\index{voice!active} phrasing and choose to topicalize\index{grammatical function!topic} the patient argument as
...
recipient as a topic\index{grammatical function!topic} instead. Essentially, Ayeri works like German in this
...
is the patient demoted to a secondary object\index{grammatical function!secondary object}. Ayeri instead topicalize\index{grammatical function!topic}s causers
...
argument and topicalized\index{grammatical function!topic}, basically for the reason of being the logical
...
with a resumptive pronoun which appears as topicalized\index{grammatical function!topic}. As discussed
previously, it is grammatical in Ayeri to make a possessor the topic\index{grammatical function!topic} of its
