...
\begingl
	...
	\glft `Happy Amān laughs.' \\
		\textit{Intended:} `Amān laughs happily.' //
\endgl
\end{minipage}
\hfill
\begin{forest} shorter edges, narrower nodes, italic leaves,
...
structure. However, as described in \autoref{subsec:raising}, only to-subject
...
\textsc{pro} element in c-structure trees. VP complements of control verbs are
simply treated as \XCompl{}s, that is, open complements. These \XCompl{}s lack
f-structure subjects and are thus dependent on the superordinate verb: control
verbs share their semantic subject or object with the semantic subject of a
(non-finite) subordinate verb \citep[289\psqq]{bresnan2016}.% , also compare the English examples in (\ref{ex:engctrlstruct})
