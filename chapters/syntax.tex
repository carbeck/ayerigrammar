...
assume AP as the governing category for the extended head as well. Example
...
remains the same: the extended-head \xhead{A} predicates the f-structure $f$
and the CP $g$ is a complement of \textit{f}'s predicator; the original AP's
head position is empty.
