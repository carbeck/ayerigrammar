...
\ex\label{ex:welshvpfr}\begingl
	...
	\gla $[_\text{VP}$ adeiladu tai ym Mangor $]$ a wnaeth o //
...
would also need two distinct building plans for clauses. If we analyse Ayeri's
clause structure as in (\ref{ex:welshcstruct2}), VP would conveniently be just
another phrase type permitted for XP.
