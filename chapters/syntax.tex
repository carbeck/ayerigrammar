...
\rayr{si}{si} and its declined forms cannot be quantified. Combinations of
pronouns and quantifying clitics are illustrated in (\ref{ex:proquant}).
...
features cannot be easily unified, which an example is given of in
(\ref{ex:mfayeri}).
