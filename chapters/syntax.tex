...
though Ayeri is configurational\index{configurationality} and case\index{case} is in part
...
case\index{case} marking and grammatical functions\index{grammatical function}, which are not always unambiguous. As
...
Instead of case\index{case} marking on the DP\index{phrase types!determiner phrase} or NP, there is a marker before the verb\index{verbs}
...
well as case\index{case}. Clitics\index{clitics}, however, may also add information about deixis
...
and marks the NP\index{phrase types!noun phrase} simply for agent case\index{case!agent}, irrespective of other elements.
...
inflectable for case\index{case}. How to represent this in terms of a feature matrix,
...
gives an example from Warlpiri which contains a noun with double case\index{case} marking.
...
is marked for patient case\index{case!patient}, which identifies it as an object\index{grammatical function!primary object}. Thus, I propose
...
decline for case\index{case}, and thus also for animacy\index{animacy} with agent\index{case!agent} and patient\index{case!patient} antecedents;
...
It is notable that \rayr{sitnY}{sitanya} cannot appear in agent case\index{case!agent}, since
...
masculine\index{gender}, though not in all cases\index{case}. The rules which operate are the following:
...
relative-clause internal case\index{case}, however, may be modified by a quantifier:
...
if no overt case\index{case} marker is present and follows them if there is. At least in
...
Instrumental\index{case!instrumental} and causative\index{case!causative} NP\index{phrase types!noun phrase} complements instead of PPs\index{phrase types!prepositional phrase} may be found as well
...
\begin{description}
	\item[Locative:] Standard case\index{case} for adpositional objects\index{grammatical function!primary object}, indicates a
...
case\index{case} markers are proclitics\index{clitics} (see \autoref{clitics_prenoun_case}, 
...
adpositional object's\index{grammatical function!primary object} case\index{case} in (\ref{ex:adpmorphlex_1}) excludes
...
Since nouns in German always carry case\index{case}, the \PSem{} attribute needs to be
...
marking also does not influence the case\index{case} of the adpositional object\index{grammatical function!primary object}.
...
prepositional object\index{grammatical function!primary object} is to be put in the dative case\index{case!dative}.
...
of the clause shows that there is a corresponding dative\index{case!dative} NP\index{phrase types!noun phrase}. Strictly speaking,
...
habitual\index{aspect!habitual}, and iterative aspect\index{aspect!iterative} (\autoref{subsec:aspect}), as well as various
...
transitive\index{verbs!transitive} finite verbs\index{verbs!finite} are obligatorily marked for the case\index{case} and animacy\index{animacy} of the
...
(\Aarg{}), topic can be marked. This is because the causative\index{case!causative} NP\index{phrase types!noun phrase}, even though
...
express causative relationships by case\index{case} marking, though (see
...
a goal\index{semantic role!goal} NP\index{phrase types!noun phrase}, a resultative dative\index{case!dative} NP\index{phrase types!noun phrase} also normally occurs after the verb.
...
Most transitive\index{verbs!transitive} verbs in Ayeri take a complement in the patient case\index{case!patient}, and
possibly also a second complement in the dative case\index{case!dative}. However, there are a
number of verbs as well which take arguments marked for different cases\index{case} and
...
The verbs in (\ref{ex:comptr}a--d) permit a locative\index{case!locative} argument;
(\ref{ex:comptr_4}) may also take an argument in the genitive\index{case!genitive} to express the
...
\begin{description}
	...
	be included as either an NP\index{phrase types!noun phrase} in the locative case\index{case!locative} or a PP\index{phrase types!prepositional phrase}.
	...
	\emph{optionally} with the addressee NP\index{phrase types!noun phrase} in the locative case\index{case!locative} and the theme\index{semantic role!theme}
	in the genitive case\index{case!genitive}.
...
or locative\index{case!locative} marking are thus semantically contentful, while case\index{case} marking for
...
attempts to coordinate an instrumental\index{case!instrumental} DP\index{phrase types!determiner phrase} with an instrumental\index{case!instrumental} NP\index{phrase types!noun phrase} to express
...
locative\index{case!locative} and an instrumental\index{case!instrumental} NP\index{phrase types!noun phrase}, respectively. This means that there are no
prepositions\index{prepositions} involved which could provide any contentful information, however,
the case\index{case} markers for these adverbials themselves are to be taken literally as
expressing a location\index{semantic role!location} and a material or means. There is no free choice about
these case\index{case} markers, even though the degree of grammaticalization of these
adverbial cases\index{case} is possibly not as high as with the core cases\index{case}---although it
was noted before how Ayeri's core cases\index{case} do not just express function, but that
...
verbs in Ayeri retain their patient case\index{case!patient} marking. The question is, thus, what
...
as a dative\index{case!dative} NP\index{phrase types!noun phrase} in Ayeri. Since open complements\index{grammatical function!open complement} (labeled \textsc{proposition})
...
case\index{case} marking of the subject\index{grammatical function!subject} argument. The verb \rayr{vlYFymF}{valyyam} in
...
but yet it appears in the agent case\index{case!agent}. The closest grammatically permissible way
...
keeps the case\index{case} marking of patient\index{semantic role!patient} subjects\index{grammatical function!subject} of passive verbs intact for semantic
reasons, the subject\index{grammatical function!subject} in this example has genitive\index{case!genitive} marking. We know form verb
...
headed by a relative pronoun which may agree with its head in case\index{case} and animacy\index{animacy}
...
external controller \xayr{koyaasF}{koyās}{book}, which is a patient\index{case!patient} form, as
