...
though Ayeri is configurational\index{configurationality} and case is in part
...
first, as it were. That is, they need the proclitic \rayr{d/}{da-} or full
...
(\ref{ex:nomzposs}) shows, these forms may be case marked---\xayr{d/naa}
...
encode person and number, though at least \rayr{sinY}{sinya} inflects for case
...
join modifiers like adjectives or relative clauses to \xbar{D}, compare 
(\ref{ex:itradj}).
...
\xayr{sno}{sano}{both} or \xayr{EkeNF}{ekeng}{over-, overly, too}, and clitic
...
\xayr{kgnF}{kagan}{excessively, far too}, but they may occur with adverbs like
...
enclitic quantifier \xayr{/IknF}{-ikan}{much, many; very}. In order to
...
adverbs pertaining to \xhead{D} would write into the \Adjc{} list of the
...
functionally by the clitic \rayr{/IknF}{-ikan} on the noun.\footnote{Empty
...
predicated by \xhead{N}. The definitions for enclitic quantifiers are shown in
...
\fw{-ly} or French \fw{-ment}. Since adverbs and adjectives are functionally
...
alternatively, \xayr{EkeNF}{ekeng}{too} also work with regular adjectives, and
...
particle \rayr{mN}{manga} which has been analyzed as a clitic. This particle
...
between locational `in' and directioanl `into' is represented here. The case of
...
around, or with \rayr{mN}{manga} becoming zero, since the cases are already
...
habitative, and iterative aspect (\autoref{subsec:aspect}), as well as various
...
adverb to be interpreted as an adjective modifying \rayr{ANF AmaanF}{ang Amān},
...
NPs with a genitive attribute and with a nominal complement, respectively, have
...
a subject by inflection or clitics either. \rayr{IlF/IlFymF} {il-ilyam} in
...
adverbials or adverbs like \xayr{mmNeri}{mamangeri} {by coincidence},
...
adjective, \xayr{bnF}{ban}{good}, modifies a predicative noun,
\xayr{kromyaasF}{karomayās}{doctor}. Since the adjective itself has a
...
as a dative NP in Ayeri. Since open complements (labeled \textsc{proposition})
...
case marking of the subject argument. The verb \rayr{vlYFymF}{valyyam} in
...
reasons, the subject in this example has genitive marking. We know form verb
agreement with a singular third person that \xayr{selesF}{seles} {shelf} is
...
may fulfill different grammatical functions: closed complement as well as
adjunct.
...
topicalized in the example. As discussed previously, it is grammatical in Ayeri
to make a possessor the topic of its superior f-structure, so a construction
using \xayr{sinaa}{sinā}{whose} as in (\ref{ex:relc_siintcase}) should not be a
problem. However, since the genitive case may mark both possessors and oblique
themes with the latter being well within the scope of possible arguments of
\xayr{ly/}{laya-}{read}, the construction with the resumptive pronoun may be
used to disambiguate between reading someone's book and reading a book about
someone.
