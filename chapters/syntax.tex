...
\XCompl{} has no structural equivalent in the c-structure tree in
(\ref{ex:adjresstr}), however, the XP node of the resultative element should be
annotated \pass{\XCompl{} \Plink}. This way, \XCompl{} is represented
functionally.
