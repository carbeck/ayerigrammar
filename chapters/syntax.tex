...
subordinate verb stands in between the matrix verb and the subordinate verb.
Thus, the \xayr{nyiNsF}{nayingas}{roof} in both (\ref{ex:ctrlstruct}ab) cannot
be the topic of the verb in the respective matrix clauses,
\xayr{liMky}{linkaya}{(he) tries} and \xayr{nelFye}{nelye}{(she) helps}.
Since topicalization does not apply to non-finite verbs, the subordinate verb
in both sentences, \xayr{sidegYmF}{sidejam}{repairing}, cannot be marked for
topic within its own f-structure cores either.
...
functional uncertainty and annotate the NP with \uncertain{\GF}{\Top}~=~↓ to
signal that \Top{} is an attribute of the f-structure containing \GF{}. An
example is given in (\ref{ex:ctrlinc}).
