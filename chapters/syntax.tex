...
constitute topic and focus (\Top{}, \Foc{}). Which DP\index{phrase types!determiner phrase} or NP receives which
function is controlled by the a-structure of the verb---this also has
repercussions on case-\index{cases} and topic marking, compare \autoref{subsec:comptr}. Even
...
function of the verb, which is what (\ref{ex:topicrule}) describes.
...
Instead of case\index{cases} marking on the DP\index{phrase types!determiner phrase} or NP, there is a marker before the verb
...
case-marked\index{cases} arguments of the verb is greater than one.
...
host a number of clitics\index{clitics}, among which are deictic prefixes\index{prefixes!on nouns} and quantifiers, as
...
clause, CP\index{phrase types!complementizer phrase}), and adjunct (adjective\index{adjectives} phrase, AP\index{phrase types!adjective phrase}; relative clause, CP\index{phrase types!complementizer phrase};
quantifier, DP\index{phrase types!determiner phrase}). Furthermore, there can be a possessor expressed as a the
...
relative clauses precede DPs\index{phrase types!determiner phrase} embedding the NP, like possessive NPs and DPs\index{phrase types!determiner phrase}.
...
is a complement of \xayr{limu}{limu}{shirt}. Extraposed relative clauses are
...
modified by quantifiers, whether these are clitic\index{clitics} suffixes
...
marker is always present for untopicalized NPs\index{phrase types!noun phrase}, whether a demonstrative clitic\index{clitics}
...
topicalized and it is required, then, that the verb mark the topicalized NP's\index{phrase types!noun phrase}
...
a quantifier which  be further specified by an intensifier\index{intensifiers}. \xhead{D} may also
...
quantifier clitic\index{clitics} is only possible for personal pronouns when they are free
morphemes; pronominal clitics\index{clitics} cannot be modified by quantifiers directly, as
...
{da-nā}{mine} is the nominal corresponding to the topic marker \rayr{le}{le}.
...
is marked for patient case\index{cases!patient}, which identifies it as an object. Thus, I propose
...
adjectives\index{adjectives} either. Instead, questions like `how large' or `how common' must be
...
join modifiers like adjectives\index{adjectives} or relative clauses to \xbar{D}, compare 
(\ref{ex:itradj}).
...
feature here, I am simply connecting the focus NP\index{phrase types!noun phrase} with the \Q{} attribute to
...
with the respective marking on the verb with which the subject NP\index{phrase types!noun phrase} proper
...
In (\ref{ex:eachotheravm}), the two coordinated subject NPs\index{phrase types!noun phrase} do not share the
...
is unstressed, which makes it a bad host for a clitic\index{clitics}. A relativizer\index{pronouns!relative} marked for
...
the genitive case\index{cases!genitive}: the NP\index{phrase types!noun phrase} complement expresses an oblique theme about which the
...
Moreover, according to \citet{carnie2013}, quantifiers or intensifiers\index{intensifiers} of
...
quantifiers like \xayr{AMkYu}{ankyu}{really} cause a complement of an adjective
...
adverbs may modify any other lexical category: verbs, adjectives\index{adjectives}, prepositions\index{prepositions},
...
modifiers are often quantifying/intensifying adverbs, whether clitic\index{clitics} ones or
...
Clitic\index{clitics} quantifiers, as in (\ref{ex:advmod_clitic}), attach immediately to the
...
Quantifiers of adjectives\index{adjectives} and adverbs are also able to be modified in turn, as
...
\Lfg{}\index{Lexical-functional grammar} categorizes the object of an adposition as an oblique argument 
...
\begin{description}
	\item[Locative:] Standard case\index{cases} for adpositional objects, indicates a
...
preposition to indicate the relation of the complement to the verb because case\index{cases}
marking accomplishes this function.

Which oblique case\index{cases} the complement appears in is determined by the a-structure
...
In Ayeri, PPs proper may either be locative\index{cases!locative} complements of the verb as in
...
a whole complement clause\index{complement clause}. The nominal complements are objects governed by the
adposition.
...
adpositional object's case\index{cases} in (\ref{ex:adpmorphlex_1}) excludes
...
marking also does not influence the case\index{cases} of the adpositional object.
...
bottom of} there is another alternation, based on case\index{cases}, for verbs which do not
...
prepositional object is to be put in the dative case\index{cases!dative}.
...
the adpositional phrase or as an adjective\index{adjectives} modifying the prepositional object.
...
case, wrapping an adjective\index{adjectives} into a relative clause CP\index{phrase types!complementizer phrase} to explicitly subordinate
...
precede the subject NP\index{phrase types!noun phrase} with proper names, as in (\ref{ex:ayreqstmt_1}) and (b),
...
Another question related to copula clauses is how to treat adverbs\index{adverbs}, since there
...
perform the role of a copula, but it seems to be more similar to a clitic\index{clitics} in
...
proclitic\index{clitics} in the context of copula clauses. The same applies, \fw{mutatis
...
adverb\index{adverbs} usually appears between the subject and the predicative NP\index{phrase types!noun phrase}, as
...
contains the subject and a headless VP\index{phrase types!verb phrase} which in turn carries the verb's
objects; compare \autoref{subsec:eqs} for a discussion of S\index{phrase types!small clause}. The phrase
...
The subject NP\index{phrase types!noun phrase} is instead treated as a daughter of S\index{phrase types!small clause}. As we will see, not only
...
transitive finite verbs are obligatorily marked for the case\index{cases} and animacy of the
clause's topic. Ayeri's system of verb agreement\index{agreement} moreover alternates between
...
arguments of a verb, making a clause transitive, the discussion of VP's\index{phrase types!verb phrase} setup
is deferred to the next section, \ref{subsec:vps}. The present section will
mainly deal with intransitive clauses. Besides the VP\index{phrase types!verb phrase} in S\index{phrase types!small clause} which is not listed
...
a governing category for the subject NP\index{phrase types!noun phrase} and VP\index{phrase types!verb phrase}, since in place of VP\index{phrase types!verb phrase}, one may
...
full NP\index{phrase types!noun phrase} (then the subject NP\index{phrase types!noun phrase} will take this place) or with transitive verbs if
...
is limited to finite verbs of clauses containing more than one NP\index{phrase types!noun phrase}. Thus, even
...
occurs in the VP\index{phrase types!verb phrase} complement after the subject NP\index{phrase types!noun phrase}. Raising is required to make
...
have person agreement\index{agreement} and also do not regularly mark topic, except for emphatic
imperatives. They imply a second person singular or plural\index{plural} subject (number\index{number} is
...
do occur, namely, in clausal complements\index{complement clause} from which a subject has been raised
...
shows that non-finite verbs may nonetheless be marked for aspect\index{aspect}; they can also
be negated. However, they do not mark person and topic, and they do not encode
a subject by inflection or clitics\index{clitics} either. \rayr{IlF/IlFymF} {il-ilyam} in
...
secondary object/theme is \rayr{koyaasF}{koyās}. Functionally, the verb
...
transitive verbs: the same case\index{cases} which marks the patients (P) of monotransitive
...
dependent on the superordinate verb for the subject function: control verbs
...
Topicalization of NPs\index{phrase types!noun phrase} in subordinate VPs by matrix verbs is not possible in
...
complement of \xhead{I} in order to be able to topicalize NPs\index{phrase types!noun phrase} subcategorized by
...
proclitic\index{clitics} before the verb, which here encodes an inanimate patient topic,
...
to use inside-out functional uncertainty and annotate the topicalized NP\index{phrase types!noun phrase} with
...
raising-to-object mechanism and instead requires a complement clause\index{complement clause}.
...
\pass{\XCompl}, and the topicalized NP\index{phrase types!noun phrase} has to be marked with
...
subject pronouns which are realized as pronominal clitics\index{clitics}, compare 
...
quantifiers as intensifiers\index{intensifiers} which modify the verb. Ayeri otherwise uses the
...
content and that of the subject DP\index{phrase types!determiner phrase}, \rayr{sitNF/IknF}{sitang-ikan}, onto the
\Subj{} function in the partial f-structure diagram. The only lexical content
which the subject DP\index{phrase types!determiner phrase} contains is that of the quantifier clitic\index{clitics},
...
scattered over \xhead{I} and the subject DP\index{phrase types!determiner phrase}.

Going by classic, structuralist binding theory, \rayr{sitNF}{sitang} should be
able to bind the subject clitic\index{clitics} because \rayr{tYaanFnNF}{cānnang} as a unit
...
enclitic\index{clitics} suffixes described in \autoref{subsec:adjcomp}. By extension, the verb
...
(\ref{ex:yomaplace}). The copula-clause strategy comes at the slight
...
a modifier, essentially in the way of an adverb\index{adverbs}. Nonetheless, the subject forms
...
other hand, shows the grammatical solution with the relative clause. Here, the
term under comparison\index{comparison!of adjectives}, being a \xayr{kromyaasF}{karomayās}{doctor}, is
constructed as a copula clause while the comparison\index{comparison!of adjectives} in quality between
\rayr{ApitYnF}{Apican} and \rayr{hiro}{Hiro} is moved into the relative clause.
...
predicative adjectives\index{adjectives} and nominals over the subject in order to illustrate a
...
\citet{mueller2002}'s analysis, \textcquote[196]{mueller2002}{the subject of
...
In Ayeri, the depictive adjective\index{adjectives}, whether it refers to the subject or the
...
p.~\pageref{manga}). Examples with transitive adpositions where the PP\index{phrase types!prepositional phrase} is not
...
\a\label{ex:restrns_ap}%
	\begingl
		\glpreamble object NP\index{phrase types!noun phrase} + resultative AP\index{phrase types!adjective phrase}: //
...
\a\label{ex:restrns_np}%
	\begingl
		\glpreamble object NP\index{phrase types!noun phrase} + resultative NP\index{phrase types!noun phrase}: //
...
\a\label{ex:restrns_pp1}%
	\begingl
		\glpreamble object NP\index{phrase types!noun phrase} + resultative PP\index{phrase types!prepositional phrase} (intransitive): //
...
\a\label{ex:restrns_pp2}%
	\begingl
		\glpreamble object NP\index{phrase types!noun phrase} + resultative PP\index{phrase types!prepositional phrase} (transitive): //
...
not want it to be included inside an S\index{phrase types!small clause} sister of the object NP\index{phrase types!noun phrase} if there is
...
patient case\index{cases!patient} marking for subjects of passive verbs. The [–\,r] marking on the
...
reflexives'\index{pronouns!reflexive} \citep[145]{simpson1983} by which the subject NP\index{phrase types!noun phrase} is basically
...
structure; compare (\ref{ex:runtranswrong}). Adding the reflexive\index{pronouns!reflexive} as an object
...
controller of the reflexive\index{pronouns!reflexive}, the subject \rayr{tiplF}{Tipal}.
...
Most transitive verbs in Ayeri take a complement in the patient case\index{cases!patient}, and
...
question word relating to the PP\index{phrase types!prepositional phrase} is conjoinable with the question word for
...
Moreover, the question word for the PP\index{phrase types!prepositional phrase} expressing the locative adverbial cannot
...
and is thus mapped to [–\,r], forming the object. Since \rayr{niysF}{Niyas} is
...
languages like English the former object appears in the nominative case\index{cases}, Ayeri
...
patient subject and to reintroduce the agent as an oblique in either the agent\index{cases!agent}
...
means that the direct object---marked with the patient case\index{cases!patient} since it is a
patient or a theme---is mapped to [–\,r], while the indirect/secondary
object---marked with the dative case\index{cases!dative} since it is a recipient or
...
conflating accusative and dative case\index{cases!dative} into one objective case\index{cases}. This will be
...
we assign the subject---and thus nominative case\index{cases}---to the recipient and let the
...
possibility of having a recipient subject in the dative case\index{cases!dative}. As we will see,
...
subject: the verb shows agreement\index{agreement} with a third person masculine referent, which
...
Reversing verb agreement\index{agreement} to mark the theme as a subject in
...
syntactic subject of \fw{seem} is not its logical subject, hence this argument
is given as [–\,r] instead of [–\,o]. This annotation is instead chosen for the
experiencer as an oblique function, which is realized in English as a PP\index{phrase types!prepositional phrase}, and
...
permit dative\index{cases!dative} NPs\index{phrase types!noun phrase} to be subjects of passive verbs, this is not possible in
...
case\index{cases} marking of the subject argument. The verb \rayr{vlYFymF}{valyyam} in
...
patient subject. This is comparable to *\fw{The beach is seemed to be enjoyed}
in English.
...
keeps the case\index{cases} marking of patient subjects of passive verbs intact for semantic
reasons, the subject in this example has genitive\index{cases!genitive} marking. We know form verb
...
subject, which \xayr{tehsFyelej}{tehasyeley}{cups} satisfies. If both NPs\index{phrase types!noun phrase} were
...
also means that the agent NP\index{phrase types!noun phrase} in both cases is the syntactic subject. In
...
verbal phrase type---IP\index{phrase types!inflectional phrase} or VP\index{phrase types!verb phrase}, but also plain S\index{phrase types!small clause} in the case of a copula clause.
...
occurring clausal complements\index{complement clause} or adjuncts of verbs. The respective c- and
...
attributed. Since there is no other NP\index{phrase types!noun phrase} which could be a secondary topic, the
...
Since Ayeri uses a zero-copula, there is no verb to mark for irrealis\index{mood!irrealis} in
conditions containing a copula clause. An adverb\index{adverbs} expressing a potential action
...
expressed by negation of the verb\index{negation!of verbs} and the juxtaposition of clauses. \rayr{bt}
{bata} may also be used together with a verb in negative mood\index{mood!negative}.
