...
for synthetic comparison\index{comparison} of adjectives are grammaticalized clitics\index{clitics} literally
...
constructed as a copula clause\index{copula clause} while the comparison\index{comparison} in quality between
