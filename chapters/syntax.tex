...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Argument of \citet{schachter1976} that Tagalog does not have
		syntactic subjects at all is reaffirmed \citep[1676]{schachter2015}.
		\item Handbook article, of course cannot go into all detail; does not
		consider \citet{kroeger1991} at all.\footnote{Which is somewhat
		strange, since \citet{kroeger1991} is a published Ph.\,D. thesis, so
		unless it is utter garbage it should be acknowledged at least, even if
		you don't share the other person's opinion?}
	\end{itemize}
