...
Quantifiers can be modified by intensifiers and degree adverbs. However,
exceptionally, independent quantifiers happen not to be semantically compatible
with intensifiers such as \xayr{EkeNF}{ekeng}{over-, overly, too} or
...
related to quality or degree in such a way as to emphasize the head. An
overview of correspondences between basic quantifiers and intensifiers is given
in \autoref{tab:quantifiers}. Besides enclitic intensifiers, there are also
independent morphemes which can act as intensifiers, like
\xayr{IknF/IknF}{ikan-ikan}{altogether, totally}, or \xayr{IpnF}{ipan}
{extremely}.
