...
Unfortunately, \citet{kroeger1991} only gives examples of subject-to-object
raising \citep[430]{carnie2013}, but not of subject-to-subject raising. As we
...
\fw{hulihin}, is reflected in its being marked for objective voice. The English
translation is consequently given with the subordinate clause phrased in the
passive voice and an oblique actor NP. Similarly, in (\ref{ex:tagrais3_2}), the
subordinate verb, \fw{sinuhulan}, is marked for directional voice. According to
this, \fw{ang pangulo} `the president' is a non-actor subject of the
subordinate verb here as well. So it is in the matrix clause as well, however,
as the matrix verb, \fw{napagbintangan}, is marked for directional voice as
well.
