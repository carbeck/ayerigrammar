...
control verb meaning `have a tendency' rather than `look after, care for'.}
Instead of using verbal expressions like \fw{happen}, \fw{tend}, and
\fw{be likely}, one may rather use adverbials or adverbs like
\xayr{mmNeri}{mamangeri}{by coincidence}, \xayr{kraaneri}{krāneri}{by tendency}
and \xayr{nilj}{nilay}{probably}. English has raising verbs like
