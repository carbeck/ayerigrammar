...
SVO sentence in English thus very generally looks like in (\ref{ex:basicsvo})
...
more complicated in reality, though, of course. Especially the claim that
Tagalog lacks subjects and objects is problematic. The term `trigger' seems to
...
mine). Further effects will be discussed in more detail below.
