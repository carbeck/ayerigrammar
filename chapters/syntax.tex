...
Just in the way of the previous sections, I will try in this section to
describe the way verbs operate with regards to morphosyntax. Verbs are the part
of speech which governs the relations of the various phrase types to each other
and are thus central to the formation of clauses. It comes as no surprise,
thus, that \Lfg{} always lists a verb with its argument structure first in
...
is not obvious whether verb and object actually form a constituent. Since Ayeri
marks topics in terms of morphology, it will also be necessary to discuss how
this mechanism works and how it relates to the notion of the subject.
...
\begin{itemize}
	\item Ayeri as a so-called `trigger language'
