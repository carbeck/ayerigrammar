...
accusative/objective case to the secondary actor NP \citep[445,
451]{carnie2013}. The raised subject is not semantically an object of the
matrix verb, however, but an external agent:
...
permissively, case marking is nonetheless based in semantic roles. Due to the
principle of functional uniqueness, a verb in Ayeri cannot have two agent
arguments (causative verbs nonwithstanding), yet the raised object is an agent,
albeit an external one, which precludes assigning it patient case.
