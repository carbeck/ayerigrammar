...
assume AP as the governing category for the extended head as well.%
\footnote{This analysis may violate the rule on co-heads in
\citet[105]{bresnan2016}, since it says that functional categories are
f-structure co-heads of lexical ones, but here we have a lexical category acting
as a co-head of the same lexical category. On the other hand, an earlier
analysis by which the complement CP was adjoined to an AP as a sister of the AP
carrying the adjective violated \Lfg{}'s annotation algorithm. The analysis
presented here may be subject to future revision\index{desiderata}.} Example
