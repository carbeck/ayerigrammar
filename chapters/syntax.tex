...
APs have an adjective as their lexical head. This head may be
...
Example (\ref{ex:adjmod_adv}) gives the f- and c-structures for the AP
to show that \Adjc{}\index{grammatical function!adjunct} may be recursive: an adjective which serves as one
...
to be pushed further to the right. This may be treated as extraposition\index{constituent order} of the
