...
intransitive adpositions, with the exception of some particle verbs where the
adposition is a lexicalized particle, for instance,
\xayr{tpY/ djrinF}{tapy- dayrin}{save (assets)}, with the fossilized, now
defunct preposition \rayr{djrinF}{beside, next to} (modern \rayr{kjvo}{kayvo}).
`Up' and `down' thus refer to their transitive uses as in \fw{up the stairs}
and \fw{down the hill}, respectively.
