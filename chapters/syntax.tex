...
The fact that topic marking operates only within a verb's nucleus prevents
...
for a possessor: the noun's \Pred{} value is modified by appending
\astruct{...-of}{\ups{\Poss}} at least in their English examples. I will,
however, omit the \fw{-of} and more generally indicate nouns taking a possessor
as \astruct{noun}{\Poss} with the NP marked for genitive case. Presumably, we
