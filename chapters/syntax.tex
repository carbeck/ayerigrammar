...
is valid unless a condition is fulfilled. Ayeri does not possess a dedicated
conjunction expressing `unless'. It has \rayr{naarY}{nārya} as a
general-purpose negative conjunction, however, and it also can use negation as
a morphological means.
...
however, rather serves the purpose of `except' or `unless'. Example
