...
modified by quantifiers\index{quantifiers}, whether these are clitic\index{clitics} suffixes
...
modified by relative clauses as well as quantifiers\index{quantifiers}. Modification by a
...
which the subject DP\index{phrase types!determiner phrase} contains is that of the quantifier\index{quantifiers} clitic\index{clitics},
