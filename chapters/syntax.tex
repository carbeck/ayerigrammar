...
have lexical content for a predicator, but only `pro', that is, they express
anaphoric reference. Pronouns distinguish, of course, all grammatical
categories of nouns---number, gender and animacy, and case. In addition to
this, there is person. The reflexive clitic \rayr{sitNF/}{sitang-} also adds
reflexivity as a semantic feature.
