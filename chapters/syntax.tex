...
indefinite pronouns, quantifiers are somewhat redundant, though it is feasible
in this regard to use them for emphasis. The relativizer \rayr{si}{si} and its
declined forms cannot be quantified. Combinations of pronouns and quantifying
clitics are illustrated in (\ref{ex:proquant}).
...
\a\label{ex:proquant_dempro}\begingl
	\gla Kalam adanyana-kay //
	\glb kalam adanya-na=kay //
	\glc true that.one-\Gen{}=little //
