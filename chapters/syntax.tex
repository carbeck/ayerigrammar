...
forms---the difference is instead in the case marking of the subject argument.
At least the verb \xayr{vlYymF}{valyyam} in (\ref{ex:passraise_2}b) is thus not
readily recognizable as a passive form. Both sentences are odd in that 
\xayr{surFpF/}{surp-}{surp-} is complemented by a patient subject. This is
