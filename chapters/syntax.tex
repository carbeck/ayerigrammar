...
\begin{itemize}
	\item \textcquote[225]{kroeger1991}{Tagalog has a well-defined grammatical
		...
		basically applies the the notion of a logical subject to some
		constructions, though the syntactic subject is more important overall
