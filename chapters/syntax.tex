...
in spite of VSO constituent order\index{constituent order}. The present chapter,
...
Noun phrases (NPs), and determiner phrases (DPs\index{phrase types!determiner
phrase}) as their functional counterpart, fulfill the functions of
subject\index{grammatical function!subject} (\Subj{}), object\index{grammatical
function!primary object} (\Obj{}), secondary object\index{grammatical
function!secondary object} (\SObj{}), or embody various
oblique\index{grammatical function!oblique} constituents (\Oblique). They can
also be adjuncts\index{grammatical function!adjunct} (\Adjc{}), and constitute
topic\index{grammatical function!topic} and focus\index{grammatical
function!focus} (\Top{}, \Foc{}). Function assignment to NPs and DPs is
controlled by the a-structure of the verb\index{verbs}---this also has
repercussions on case- and topic-marking, compare \autoref{subsec:comptr}. Even
though Ayeri is configurational and case\index{case} is in part assigned on the
grounds of constituent structure, semantics also play a part in case\index{case}
assignment. Taking the opposite perspective, case\index{case} marking also
provides information on the semantics and function of NPs and DPs\index{phrase
types!determiner phrase}; compare (\ref{ex:dpnpcasemap}).
...
case\index{case} marking and grammatical functions, which are not always
unambiguous\index{ambiguity}. As explained above (compare
\autoref{subsec:case}), the dative case\index{case!dative} does not only
...
case\index{case!genitive} does not only indicate possession\index{semantic
role!possessor}, but also origin, and motion from this referent. Nominal
complements\index{grammatical function!closed complement} of nouns which specify
what the noun consists of appear in the instrumental
case\index{case!instrumental}, besides the instrumental\index{case!instrumental}
being used to indicate the means or the circumstance by which an action comes
about. Nominals may also lack case\index{case} marking, which normally indicates
that the respective phrase is (a part of) the topic\index{grammatical
function!topic} function of the verb\index{verbs}, which is what the
...
Instead of case\index{case} marking on the DP\index{phrase types!determiner
phrase} or NP, there is a marker before\index{word order} the verb\index{verbs}
which provides information on the case\index{case} and, if \AgtT{} or \PatT{},
also about the animacy\index{animacy} of the topicalized\index{grammatical
function!topic} phrase. Grammatical information about the
topic\index{grammatical function!topic} of a clause is spread over two
discontinuous sites this way. This issue does not pose a problem to an
\Lfg{}-based\index{Lexical-functional grammar} analysis, however, since both
...
topics\index{grammatical function!topic} in the following; `\elem{\Top}' only
finds application with relative clauses\index{relative clause}, since these may
have secondary topics\index{grammatical function!topic} in addition to the
relativized NP. Note that otherwise, only one NP among the arguments of a verb
may be the topic\index{grammatical function!topic} of the clause. Moreover, a
topic\index{grammatical function!topic} can only be marked if the
verb\index{verbs} is finite and the number of normally case-marked\index{case}
...
% 	\xbar{N} → \anno*{\xbar{N}} \anno*[{\elem{\Adjc}}]{YP}
	NP → \anno*{\xbar{N}} \anno*[{\elem{\Adjc}}]{XP}
...
The ruleset in (\ref{ex:npstruct}) defines that NPs have a lexical head which is
on the left side, followed\index{word order} optionally by modifiers which may
have various relationships to the noun: complement
(instrumental\index{case!instrumental} nominal, NP/DP\index{phrase
types!determiner phrase}; complement clause, CP\index{phrase
types!complementizer phrase}), and adjunct\index{grammatical function!adjunct}
(adjective phrase, AP\index{phrase types!adjective phrase}; relative
clause\index{relative clause}, CP\index{phrase types!complementizer phrase};
quantifier\index{quantifiers}, DP\index{phrase types!determiner phrase}).
% Furthermore, there can be a possessor\index{semantic role!possessor} expressed
% as a the specifier of NP (NP or DP\index{phrase types!determiner phrase}).
Altogether, these rules can be represented as a constituent-structure tree as
described in (\ref{ex:npcstruct}). The maximal projection of \xhead{N} (that is,
...
(\GF{}). Besides, nouns may be modified by possessors\index{pronouns!possessive}
and quantifiers\index{quantifiers}. These, however, may better be analyzed as
forming DPs\index{phrase types!determiner phrase} which embed the NP as a
...
phrase. However, for instance, relative clauses\index{relative clause} trail
whenever possible, presumably since they tend to contain whole subclauses and
therefore a lot of information. It seems advisable not to put an element with
much less information content after them, especially when it refers to a
different head than all the things inside the relative clause\index{relative
clause}.
...
complements as following \xhead{N} before adjectives\index{adjectives}, while
the list above indicates the reversed order\index{constituent order}.
Furthermore, the c-structure tree indicates that relative clauses\index{relative
clause} precede\index{constituent order} DPs\index{phrase types!determiner
phrase} embedding the NP, like possessive NPs and DPs\index{phrase
types!determiner phrase}. This is no mistake, however, but part of the caveat
mentioned earlier with regards to the phrase structure rules for NPs. That is,
due to information structure and modifier scope\index{scope}, Ayeri makes good
use of extraposition. For instance, (\ref{ex:adjscope}a) is theoretically
ambiguous as to whether the shirt is new or the wool its is made of---in
practice, it would be assumed that the shirt is made of new wool. The problem of
ambiguity is solved in (\ref{ex:adjscope}b) by inverting the order of complement
and adjective\index{adjectives}: the shirt is now unmistakeably characterized as
new, and being made of wool.
% The sentence in (\ref{ex:adjscope}a) theoretically
% allows both c-structure interpretations given in (\ref{ex:adjscopecstruct}),
% however, as mentioned above, the second one is actually the preferred one in
% such cases.
...
\begingl
	\gla limu sapari hiro //
	\glb limu sapa-ri hiro //
...
The complement does not become an adjunct\index{grammatical function!adjunct},
as (\ref{ex:complnoadjc}) shows: \xbar{X} branches can be replaced by
\fw{pro}-forms such as `one' or `so'. This, however, produces an odd-sounding
result when replacing \xayr{limu hiro}{limu hiro}{new shirt} with
\xayr{dnY}{danya}{one}.\footnote{\citet{carnie2013} notes that replacing a
nominal head with \fw{one} in English is acceptable at least to some speakers
\citep[181]{carnie2013}. Let us assume that Ayeri speakers consider it odd,
however.} An solution to the problem of how to analyse NPs including a
complement NP in the `wrong' position will be proposed in the next section,
\autoref{subsec:dps}.
...
% In order to produce correct c- and f-structures for (\ref{ex:adjscope}b), we may
% want to analyze the complement NP, \rayr{spri}{sapari}, as modifying an NP
% which jointly holds the nominal head, \rayr{limu}{limu} as well as its
% adjunct\index{grammatical function!adjunct} adjective\index{adjectives},
% \rayr{hiro}{hiro}. The NP has thus been `extended' so that one NP is nested
...
% (\ref{ex:functions}) of \autoref{ch:syntyp}). \Compl{}\index{grammatical
% function!closed complement} is an argument function, though. The possibility of
% lexocentric specification of an argument function remains open, however. Due to
% Ayeri's consistent use of case\index{case} marking, I see no problem in invoking
...
% is a complement of \xayr{limu}{limu}{shirt}; see an example in
% (\ref{ex:complextrapos}). Extraposed relative clauses\index{relative clause} are
% less problematic since they are adjuncts\index{grammatical function!adjunct},
...
head--dependent word order\index{word order} at least for its NPs. As
illustrated by previous examples, both adjuncts\index{grammatical
function!adjunct} and complements are mostly appended to the right of their
...
Regaring word order\index{word order} typology\index{typology}, we can state
...
[\anno{\xhead{N}}
	[\anno{N\tsub{$stem$}}
		[{%
			\textit{gan} \\
			\mysn{animclash_1}\ups{\Anim} = $+$ \\
		}]
	]
	[\anno{N\tsub{$infl$}}
		[{%
			\textit{-reng} \\
			\ups{\Anim} = $-$\mysn{animclash_2} \\
			\ups{\Case} = \Aarg{} \\
		}]
	]
]
...
\coordinate (1) at ([yshift=-0.5ex]{pic cs:animclash_1});
\coordinate (2) at ([yshift=+1.5ex]{pic cs:animclash_2});
\coordinate (judge) at ([xshift=3ex, yshift=1ex]{pic cs:animclash_2});
\node[draw,fit=(1) (2)] {};
\draw (judge) node {\err};
\end{tikzpicture}
\end{minipage}
...
[\anno{\xhead{N}}
	...
	[\anno{\xhead{N}}
		[{%
			\textit{Dita} \\
			\ups{\Anim} = $+$\mysn{animclashname_2} \\
		}]
	]
]
\end{forest}
\begin{tikzpicture}[remember picture, overlay]
\coordinate (1) at ([yshift=-0.5ex]{pic cs:animclashname_1});
\coordinate (2) at ([yshift=+1.5ex]{pic cs:animclashname_2});
\coordinate (judge) at ([xshift=3ex, yshift=1ex]{pic cs:animclashname_2});
\node[draw,fit=(1) (2)] {};
\draw (judge) node {\err};
\end{tikzpicture}
\end{minipage}
...
or enclitics\index{clitics} (see sections \ref{sec:numerals} and \ref{sec:quantifiers}). In these
...
Here, the noun \xayr{kejnmF}{keynam}{people} marks plural\index{number!plural}
additionally with the suffix \rayr{/ye}{-ye} in spite of being a \fw{plurale
tantum} and in spite of the presence of the numeral\index{numerals}
\xayr{menNF}{menang}{hundred}. Without plural\index{number!plural} marking,
the meaning of \rayr{kejnmF menNF}{keynam menang} would be `a hundred people',
...
DPs are the functional equivalent of NPs\index{phrase types!noun phrase}. Determiners
...
The German\index{German} examples in (\ref{ex:germandetdist}) show that
determining elements 
% such as a definite article (\fw{der} `the'), a demonstrative pronoun
% (\fw{dieser} `this'), and a possessive pronoun (\fw{mein} `my')
...
German\index{German} \citep[173]{demske2001}.} On this phenomenon of
...
only be one of them in an NP\index{phrase types!noun phrase}}, at least in
English. \citet[9--22]{demske2001} discusses this point for German\index{German}
...
Ayeri, however, behaves different from either German\index{German} or
Romanian\index{Romanian} in treating case markers and demonstrative elements as
clitics\index{clitics}. The case marker is always present for
untopicalized\index{grammatical function!topic} NPs\index{phrase types!noun
phrase}, whether a demonstrative clitic\index{clitics} is also present as a
modifier or not. The demonstrative clitic\index{clitics} merges with the head
noun to the point where it is not certain whether it is still a
clitic\index{clitics} or already an inflectional prefix\index{prefixes}
...
Romanian\index{Romanian}, but they are not heads of DP like the prenominal
determiners of Romanian\index{Romanian} either \citep[299]{dindelegan2013}, due
to their status as clitics\index{clitics}.
...
modifier in this case, the embedded nominal phrase precedes\index{constituent order} \xhead{D} rather
than following\index{constituent order} it. The constituent structure resulting from the phrase
...
\phantomsection\label{npcompinv}
In the previous section, it was mentioned that analyzing NPs which contain both
an adjective and a nominal complement are problematic in that the complement
appears in the `wrong' position\index{constituent order} due to scope
\index{scope} effects. In terms of \Lfg{}\index{Lexical-functional grammar},
this can probably best be explained with an extended head (\cite[136]
{bresnan2016}; also compare \autoref{sec:verbtypo}). We analyzed transitive
sentences earlier as having their content verb and its adjuncts as daugthers of
\xbar{I}, while \xhead{V} is an empty node, though the verb's complements are
still found as daughters of VP. Similarly, we may analyze the heads of such NPs
to actually reside in \xhead{D}, with adjuncts of the noun adjoined to
\xbar{D}, and the complement remaining as a daugther of NP; the head position
of this NP remains empty. The structure formula in (\ref{ex:dpstruct}) and the
c-structure tree in (\ref{ex:dpcstruct}) thus only describe the makeup of DP for
the situation where \xhead{D} is a modifier of some \xhead{N}. As a supplement
to the above rules, we can construct the respective structures for the situation
of extended noun heads as in (\ref{ex:dpstruct2}) and (\ref{ex:dpcstruct2}).

\begin{figure}
\pex\label{ex:dpstruct2}
\a DP → \anno*{\xbar{D}} \anno*{NP}
\a \xbar{D} → \anno*{\xhead{D}} \anno*[\elem{\Adjc}]{AP}
\a NP → \anno*[\pass{\Compl}]{NP}
\xe
\end{figure}

\begin{figure}
\ex\label{ex:dpcstruct2}
\begin{forest}
[{\anno[\pass{\DF} $\vee$ \pass{\GF}]{DP}}
	[\anno{\xbar{D}}
		[\anno{\xhead{D}}]
...
As pointed out, (\ref{ex:dpstruct}) constructs \xhead{D} as following its
complement even though Ayeri is overwhelmingly head-first. This is because this
phrase structure rule describes the use of \xhead{D} as a modifier of some
\xhead{N}. The rule in (\ref{ex:dpstruct2}) deviates from this in constructing 
\xhead{D} as preceding its complement because it contains the functional head of
the noun phrase, thus warranting being placed first\index{constituent order}.
Example (\ref{ex:npext}) picks up (\ref{ex:adjscope}) to illustrate the analysis
of `misplaced' nominal complements proposed above.

\begin{figure}
\ex\label{ex:npext}
\begin{minipage}[t]{.33\remaining}
\begingl
	\gla limu hiro sapari //
	\glb limu hiro sapa-ri //
	\glc shirt new wool-\Ins{} \Fsg{}.\Gen{} //
	\glft `new shirt of wool' //
\endgl
\end{minipage}
\hfill
...
Since \textcquote[105]{bresnan2016}{complements of functional categories are
f-structure coheads}, all of the heads in (\ref{ex:npext}) actually map into the
same f-structure predicated by \xayr{limu}{limu}{shirt} as
(\ref{ex:npextfstruct}) shows. Even though the analysis of (\ref{ex:npext})
becomes rather elaborate in c-structure, \Lfg{}\index{Lexical-functional
grammar} allows us to capture it in terms of f-structure in a very
straightforward manner.

\begin{figure}
\ex\label{ex:npextfstruct}
\begin{avm}
\[
	% \Pred	&	\astruct{shirt}{\ups{\Compl} \ups{\Possr}} \\
	\Pred	&	\astruct{shirt}{\ups{\Compl}} \\
	\Compl	&	\[
		\Pred	&	`wool' \\
		\Case	&	\Ins \\
	\] \\
...
reflexive clitic\index{clitics} \rayr{sitNF/}{sitang-} additionally defines the personal pronoun as
...
The whole paradigm of possessive pronouns is listed in the genitive\index{case!genitive} column of
...
reflexivity. Their case\index{case} is fixed to gentive, however. Possessors\index{semantic role!possessor} are
...
adjectives\index{adjectives}, however, this appears incorrect in that if they
were adjectives\index{adjectives}, they should coordinate\index{coordination}
with other adjectives. As illustrated in (\ref{ex:possnoadj}a), this is not the
case. If possessive pronouns were adjectives\index{adjectives}, it should also
be possible for there to be more than one of them in a clause, just as \fw{new
blue car} is possible, with two adjectives modifying \fw{car}. Example
(\ref{ex:possnoadj}b) illustrates that there can only be one
possessor\index{semantic role!possessor}, though. According to
\citet{bresnan2016}, \textcquote[100]{bresnan2016}{[s]ubjects and
possessors\index{semantic role!possessor} have some properties in common},
though they are variably treated as specifiers of NP\index{phrase types!noun
phrase} or heads of DP with an NP\index{phrase types!noun phrase} complement
throughout the book. Let us assume here that like in Welsh\index{Welsh}, there
...
Nominalized\index{nominalization} possessive pronouns are anaphora to a
third-person\index{person} form, while they additionally refer to a
possessor\index{semantic role!possessor}: \rayr{d/naa}{da-nā} in
...
\xayr{ddNFlej naa}{dadangley nā}{my pen}; example (\ref{ex:mypen}b)
shows the corresponding expression with an\-a\-pho\-ric reference,
\xayr{d/naalej}{da-nāley}{mine}.
...
the an\-a\-pho\-ric reference is indicated by a $pro$ requiring a genitive\index{case!genitive} complement
...
It has been argued in \autoref{clitics_preadj_da} (p.~\pageref{clitics_preadj_da}) that \rayr{d/}{da-} in this
...
suffix being \fw{-(e)st}. Both c- and f-structure should therefore look different
...
the \Adjc{}\index{grammatical function!adjunct} of a functional head with deictic\index{deixis} features (formerly \rayr{dnYlej}
...
clause-initial position\index{constituent order} but \fw{in situ}, they probably should not be analyzed
as heading a complementizer phrase (CP)\index{phrase types!complementizer phrase} like in English \parencites[359--369]{carnie2013}[405--408]
...
queries for is both the implied object\index{grammatical function!primary object} of the question and new
information---the sentence's focus\index{grammatical function!focus} (compare
...
[CP \mysn{engqcstruct_CP}
	[NP \mysn{engqcstruct_NP}
		[\xhead{N}
			[Who]
		]
	]
...
\Q{}\index{pronouns!interrogative} and the \Obj{} of the clause. That is, \Q{}
...
\fw{who}. XP corresponds to any phrase type which can contain a question
word,\index{pronouns!interrogative} that is, NP\index{phrase types!noun phrase},
adpositional phrase (PP)\index{phrase types!prepositional phrase}, adverb phrase
(AdvP)\index{phrase types!adverb phrase}, and AP\index{phrase types!adjective
phrase} \citep[407] {dalrymple2001}. The rather intricate annotation for XP is
...
annotation basically says that XP is the focus\index{grammatical function!focus}
of the clause and specifies that the corresponding information must be found in
a location accessible to the \fw{wh}-word (that is, the \fw{wh}-word must
c-command it), and there is a requirement that a \fw{wh}-word exist. Since Ayeri
does not front\index{constituent order} interrogative
pronouns\index{pronouns!interrogative} like English does, the functional
...
\fw{Le tinkaya sinyāng kunang?}\\
`Who opened the door?' \medskip

\begin{tabu} to \linewidth [t] {@{} X X}

\begin{forest} italic leaves, shorter edges, for tree={l=0},
[IP \mysn{ayrqcstruct_IP}
%	[\xbar{I}
		[\xhead{I}
			[Cl
				[Le]
...
and thus also encodes animacy\index{animacy} for agents\index{case!agent} and patients\index{case!patient}. Other pronouns, like
...
\footnote{I could not find any information\index{desiderata} about how to
analyze \fw{which} and \fw{how} in terms of \Lfg{}\index{Lexical-functional
grammar}. I am assuming that \fw{which}'s function, as an interrogative
...
pronouns\index{pronouns!interrogative} to change the sentence type to
\fw{wh-question} or similar. Since I am not using such a feature here, I am
simply connecting the focus\index{grammatical function!focus} NP\index{phrase
types!noun phrase} with the \Q{} attribute to mark that the clause is supposed
to be a question. The problem, then, is what to do with the \Prontype{}
feature.} The pronoun\index{pronouns!interrogative} asking for
...
subject\index{grammatical function!subject} NP proper controls in terms of
...
\xayr{linY}{linya}{thing} instead of \xayr{EnY}{enya}{everything} and \xayr{yno}
...
neuter---are grouped together as animate\index{animacy}, in opposition to inanimate\index{animacy}
...
agreement, it is to be expected that the person\index{person} features of whatever the verb
...
gender resolution is necessary, since the features of the conjuncts
coincide.

	\quad%
	\begin{tabular}[t]{@{} c @{ \& } c @{ $\implies$ } c}
	\M{} & \M{} & \M{} \\
	\F{} & \F{} & \F{} \\
	\N{} & \N{} & \N{} \\
	\Inan{} & \Inan{} & \Inan{} \\
...
\item If a conjunct referring to an animate\index{animacy} referent is present,
use the masculine\index{gender} form as the default\index{default}. Resolution
to the animate\index{animacy} conjunct's gender more generally is also possible.
...
\item For resolution of only animate\index{animacy} referents, again, use the
masculine\index{gender} form as the default\index{default}. Resolution to the
sexed conjunct's gender (\M{} and \F{} versus \N{}) is possible here as well.
...
While coordinated\index{coordination} NPs\index{phrase types!noun phrase} may be
a very obvious case in which resolution occurs, there are even cases where
simplex NPs\index{phrase types!noun phrase} trigger it. This is the case for
lexical hybrids, for one. Hybrid nouns are nouns whose outward, morphological
form encodes a gender different from their empirically observable gender---there
is a mismatch between form and meaning, grammatical and apparent gender.
...
distinguish grammatical gender, but for instance, \fw{child} may refer to
both boys and girls, potentially triggering masculine \fw{he} or feminine
\fw{she} rather than \fw{it} in anaphoric recourse.

Ayeri's nouns are mainly distinguished by animacy\index{animacy};
masculine\index{gender} and feminine\index{gender} only plays a role for those
nouns which refer to beings (compare \autoref{sec:nouns}). For \Gend{} there is
no cross-categorization as such, however, there is for the \Anim{} feature.
Thus, for instance, \xayr{subej} {subey}{slave} is listed in the dictionary as
...
\xayr{piyu}{piyu}{grain} are all listed as animate\index{animacy} in spite of
not referring to beings, but to things, tangible or abstract. It may also be
noted that it is a lot easier to find `miscategorized' semantic
inanimates\index{animacy} than semantic animates\index{animacy}. However, as
noted before, Ayeri is rather generous about what it allows to be categorized as
animate\index{animacy}. Thus, not only beings count as animate\index{animacy},
but also things closely associated with living things, such as events, concepts,
or activities executed or connected to them; likewise things giving some
semblance of life by growing or moving are often animate\index{animacy}.
...
For committee nouns in Ayeri, canonical agreement is
singular\index{number!singular}, since the body denoted by the word as such is
taken as the unit of reference. This is illustrated by
(\ref{ex:ayrcommitteenoun}). The canonical gender\index{gender} of the words is
thus also animate\index{animacy} neuter\index{gender}.
...
\xayr{pMdh}{pandaha}{family} as expected. However, \citet{corbett2006} points
...
agreement hierarchy\index{hierarchy}.\footnote{\citet{wechslerzlatic2003} try
to capture \citeauthor{corbett2006}'s agreement hierarchy in terms of
constraints on the \Index{} (semantic/referential) and \Concord{} (formal)
features of NPs \parencites[83--94]{wechslerzlatic2003}[186--192]{bresnan2016}.
Essentially, within an NP, they predict agreement
according to \Concord{} while \Index{} or pragmatic agreement should be more
common for anaphora beyond. Moreover, \citet{kingdalrymple2004} argue that
\Index{} is a non-distributive feature, while \Concord{} is distributive. A
detailed survey into how Ayeri fares according to these categories has not been
attempted yet.\index{desiderata}}
...
\citet{corbett2006} notes furthermore that for \textcquote[207]
{corbett2006}{any controller that permits alternative agreements, as we move
rightwards along the Agreement Hierarchy\index{hierarchy}, the likelihood of
agreement with greater semantic justification will increase monotonically (that
is, with no intervening decrease)}. That is, agreement of a target according to
the syntactic features of its agreement controller becomes increasingly likely
as we go from right to left, vice versa for agreement according to semantics.
\citet{fleischer2012} finds that, at least with regards to agreement triggered
by the German\index{German} lexical hybrid \fw{weib} `woman' as surveyed under
a diachronic perspective, the distance between a controller and its target also
plays some role in semantic agreement being triggered. This effect is also to
be expected in Ayeri, and, according to \posscite{corbett2006} agreement
hierarchy\index{hierarchy}, especially so for personal
pronouns\index{pronouns!personal}, which we have discussed in this subsection.
Thus, (\ref{ex:ayrcommitteenoun}) might be followed up with the sentence in
(\ref{ex:ayrcommitteenoun_2}).
...
enclitic\index{clitics} quantifier \xayr{/IknF}{-ikan}{much, many; very}. To
further illustrate modification by an intensifier as mentioned above, \xayr{EkeNF}
...
own modifiers, it must be subordinate to NP\index{phrase types!noun phrase}. This way, also, the quantifier DP
...
here for illustration.} Moreover, since \Lfg{}\index{Lexical-functional grammar} restricts specifiers
...
the noun, the clitic actually follows\index{constituent order} the whole NP\index{phrase types!noun phrase} like the \fw{'s} possessive
...
\ex\label{ex:thiswhichever}\adjustbox{valign=t}{
	\begin{tikzpicture}
		...
		\node (fig_1)	at (2-0.25 , 3+0.00)	{\includegraphics{images/faicon-tree-300dpi.png}};
		\node (fig_2)	at (4+0.25 , 3-0.25)	{\includegraphics{images/faicon-tree-300dpi.png}};
		\node (fig_3)	at (2-0.25 , 1+0.00)	{\includegraphics{images/faicon-tree-300dpi.png}};
		\node (fig_4)	at (4+0.00 , 1-0.25)	{\includegraphics{images/faicon-tree-300dpi.png}};
		\node (fig_5)	at (3-0.00 , 2+0.00)	{\includegraphics{images/faicon-tree-300dpi.png}};
...
(\ref{ex:inspecdeix}): both combinations of \rayr{me/}{mə-} and \rayr{Ed/}
...
though they are probably still better classified as DP\index{phrase
types!determiner phrase} heads. The basic phrase-structure rule in
(\ref{ex:adjpstruct}) and the c-structure trees in (\ref{ex:adjpcstruct}) show
how an AP is constructed.
...
modifiers adjoined to \xbar{A}; \xbar{A} repeats for the
adjunct\index{grammatical function!adjunct}ion of multiple modifiers. Since
modifiers follow\index{word order} their heads here as well, APs are also a
right-branching constituent. Complements of adjectives are subsumed under the
label XP in the phrase structure rules, which here stands for NP\index{phrase
types!noun phrase}, DP\index{phrase types!determiner phrase}, PP\index{phrase
types!adpositional phrase}, and CP\index{phrase types!complementizer phrase}. An
...
Example (\ref{ex:adjmod_adv}) gives the f- and c-structures for the AP to show
that \Adjc{}\index{grammatical function!adjunct} may be recursive: an adjective
which serves as a modifiers of a noun can itself be modified by an
adverb\index{adverbs}. Likewise, an adjective--adverb\index{adverbs} combination
can be complemented by an NP\index{phrase types!noun phrase}, as shown in
(\ref{ex:adjmod_dp}). Especially in (\ref{ex:adjmod_np}) and
(\ref{ex:adjmod_dp}) we can see Ayeri's propensity for using cases\index{case}
...
the genitive case\index{case!genitive}: the NP\index{phrase types!noun phrase}
complement expresses an oblique\index{grammatical function!oblique}
theme\index{semantic role!theme} about which the experiencing subject becomes
happy. This, however, should not be conflated with a possessor\index{semantic
role!possessor}, \Possr{}, but should be labeled separately as an
oblique\index{grammatical function!oblique} complement,
\Oblq{theme}\index{semantic role!theme}. Similarly, the recipient\index{semantic
role!recipient} of the subject's happiness appears as an NP\index{phrase
types!noun phrase} complement in the (ethical) dative\index{case!dative} in
(\ref{ex:adjmod_dp}). Instrumental and causative NP\index{phrase types!noun
phrase} complements instead of PPs may be found as well (compare
\autoref{subsubsec:valincr}, p.~\pageref{subsubsec:valincr}). Moreover,
according to \citet{carnie2013}, quantifiers\index{quantifiers} or
intensifiers\index{intensifiers} of adjectives are adverbs\index{adverbs}, so
they should find themselves in \Adjc{}\index{grammatical function!adjunct}. An
...
% quantifiers\index{quantifiers} like \xayr{AMkYu}{ankyu}{really} cause a
% complement of an adjective to be extraposed\index{constituent order}, due to
% syntactic weight \citep{wechsler2009}. Example (\ref{ex:intrusivequant_cstruct})
% attempts to illustrate the c-structure for a displaced CP\index{phrase
% types!complementizer phrase}. The corresponding f-structure in
...
% feature annotation as with NPs is not possible here, since CPs\index{phrase
% types!complementizer phrase} cannot be marked for case\index{case}.

Further complications arise with regards to complementation in that non-clitic
quantifiers\index{quantifiers} like \xayr{AMkYu}{ankyu}{really} cause itself and
the complement of the adjective to swap places\index{constituent order},
possibly due to due to syntactic weight \citep{wechsler2009}. We have already
encountered this effect with nouns which are jointly modified by an adjective
and a nominal complement (\autoref{npcompinv}, p.~\pageref{npcompinv}). The
difference here is that there is no functional equivalent of AP, so I will
assume AP as the governing category for the extended head as well. The rules for
extended heads devised in \citet{bresnan2016} do not expressly require the
extended head of a lexical category to be of its associated functional category,
though \citep[135--138]{bresnan2016}. Example
(\ref{ex:intrusivequant_cstruct}) attempts to illustrate the c-structure for an
extended adjective head. The corresponding f-structure in
(\ref{ex:intrusivequant_fstruct}) shows that even though \xbar{A} is generated
in a position different from where it should normally occur, the f-structure
remains the same: the extended-head \xhead{A} predicates the f-structure $f$ and
the CP $g$ is a complement of \textit{f}'s predicator; the original AP's head
position is empty.
...
that descriptive adverbs\index{adverbs} at least cannot serve as
\Plink{}\index{grammatical function!predicative complement} in equative
statements; they also can only be modified by other adverbs, and they cannot
take complements.\footnote{For adjectives\index{adjectives}, compare
(\ref{ex:adjpstruct}), (\ref{ex:adjpcstruct}), and (\ref{ex:adjmorphlex}) in
\autoref{subsec:adjps}.} On the other hand, adjectives\index{adjectives} are
restricted to nominal contexts, whereas adverbs may modify any other lexical
category: verbs\index{verbs}, adjectives\index{adjectives},
prepositions\index{adpositions!prepositions}, as well as other adverbs.
...
Clitic\index{clitics} quantifiers\index{quantifiers}, as in
...
treats all modifiers of adjectives\index{adjectives} and adverbs as adverbs.
Even though these usually refer to the extent of the adjective\index{adjectives}
or adverb, they differ from quantifiers\index{quantifiers} of nouns, which were
analyzed above as determiners encoding the \Quant{} feature rather than being
plain adjectives\index{adjectives}. Quantifiers\index{quantifiers} of
adjectives\index{adjectives} and adverbs are also able to be modified in turn,
...
abbreviated. \xayr{/IknF}{ikan}{much, many, very} is modified in this case by
...
is possible insofar as the complement of a postposition precedes\index{constituent order} its head. The
...
adpositions in Ayeri usually take adpositional objects\index{grammatical
function!adpositional object} in the locative\index{case!locative} case.
Free nominal adjuncts in the dative case\index{case!dative} and genitive cases
with a directional meaning may also occur.

\begin{description}
	\item[Locative:] Standard case\index{case} for adpositional
	objects\index{grammatical function!adpositional object}, indicates a
	\textsc{location}. It usually corresponds to English `at', `in'. It is also
	used for the \textsc{goal}\index{semantic role!goal} of verbs of motion when
	they are directed, such as \xayr{sr/}{sara-}{go}, and for the addressee of
	verbs of speaking like \xayr{nr/}{nara}{speak}. Thus, very limitedly, it may
	also express `to'.

	\item[Dative:] Indicates motion along a path towards the direction the
	adposition indicates (\textsc{goal}\index{semantic role!goal},
	\textsc{direction}). It usually corresponds to English `to', `for'.
	NPs\index{phrase types!noun phrase} may be marked with dative
	case\index{case!dative} freely to indicate direction without being goverened
	by an adposition. Adpositional objects in the dative case are limited to the
	prepositions \xayr{AvnF}{avan}{at the bottom of} and \xayr{liNF}{ling}{on
	top of}.

	\item[Genitive:] Indicates motion along a path from somewhere
	(\textsc{source}\index{semantic role!source}). NPs\index{phrase types!noun
	phrase} may be marked with genitive case\index{case!genitive} freely to
	indicate direction without being goverened by an adposition. Genitive
	case\index{case!genitive} usually corresponds to English `from' or `of' in
	those cases\index{case}. Genitive case\index{case!genitive} also marks
	secondary themes\index{semantic role!theme}, corresponding to English
	`about'.
\end{description}

Where English uses a preposition together with the verb to mark an oblique\index{grammatical function!oblique}
...
preposition to indicate the relation of the complement to the verb because case\index{case}
...
\autoref{subsec:comptr}). Since dative case\index{case!dative} is also used for the
...
In Ayeri, PPs proper may either be locative\index{case!locative} complements of
the verb\index{verbs}, as in (\ref{ex:naracstruct}), or free locative
adverbials, ungoverned by the verb\index{verbs}. The number of
verbs\index{verbs} taking PP complements is smaller than in English due to
case\index{case} marking, though, as described above. As mentioned initially,
Ayeri possesses prepositions as well as
postpositions\index{adpositions!postpositions}. With regards to word
order\index{word order} typology\index{typology}, we can generalize therefore:
...
postpositions\index{adpositions!postpositions} is also reflected in the phrase
...
adpositions in the form of NPs\index{phrase types!noun phrase} and
DPs\index{phrase types!determiner phrase}, but especially the
postposition\index{adpositions!postpositions} \xayr{pesnF}{pesan}{until} may
also have a CP\index{phrase types!complementizer phrase} complement, that is, a
whole complement clause\index{complement clause}. These complements are governed
by the adposition.

The same as in (\ref{ex:pppstruct}) is spelled out in c-tree form in
(\ref{ex:ppcstruct}). PPs, if not subcategorized for by the verb\index{verbs},
are optional information and thus not governed by the verb\index{verbs}; the PP
is part of the set of adjuncts\index{grammatical function!adjunct}, then. Some
verbs, like \xayr{tpY/}{tapy-}{put}, may take PP complements headed by an
adposition, for instance, in cases like \fw{Mary puts the book {\normalfont
[\tsub{PP}~[\tsub{P}} on {\normalfont]~[\tsub{NP}} the pile {\normalfont ]]}}.
The PP \fw{on the pile} is not an adjunct here because \fw{She does so on the
pile} makes no sense: the PP must be an argument of the verb here, not
...
\Oblique{}\index{grammatical function!oblique} with $\theta$ replaced by the
proper semantic role (\textit{loc}\index{semantic role!location},
\textit{goal}\index{semantic role!goal}, or \textit{src}\index{semantic
role!source}).
...
postposition\index{adpositions!postpositions} is meaningless, so the
morpholexical definitions in (\ref{ex:adpmorphlex}) do not distinguish formally
between pre- and postpositions\index{adpositions!postpositions}. The
\Tel{}\textsc{icity}\index{telicity} feature only actually matters for the
prepositions \xayr{AvnF}{avan}{bottom of} and \xayr{liNF}{ling}{top of}, and
will be discussed below. Suffice it to say, position does not imply a goal,
hence adpositions are atelic\index{telicity} by default. This default is
overridden by the proclitic \rayr{mN}{manga}. This particle indicates that a PP
...
German\index{German}, for one, encodes the difference between locational and
directional uses of a group of prepositions as well, but with an alternation
in the prepositional object's case\index{case} between \Dat{} (locational) and
\Acc{} (directional). Thus, \fw{auf dem tisch} (on \Def{}.\Dat{}.\M{}.\Sg{}
table) means `on the table', whereas \fw{auf den tisch} (on
\Def{}.\Acc{}.\M{}.\Sg{} table) means `onto the table'. \citet{butt2005}
defines this alternation (albeit for \fw{in} `in' and \fw{an} `at') as in
(\ref{ex:gercasealt}).
...
a requirement that its case\index{case} be either \Acc{} or \Dat{},
respectively. Since nouns in German\index{German} always carry
case\index{case}, the \PSem{} attribute needs to be present in the lexical
...
% \fw{zwischen}%
% }
In Ayeri, however, the particle \rayr{mN}{manga} alternates with nothing, so the
absence of marking $dir$ can be interpreted as indicating a locational reading
$loc$\index{semantic role!location} as the default\index{default} for
adpositional objects in the locative. Different than in German\index{German},
the presence or absence of directionality marking also does not influence the
case\index{case} of the adpositional object\index{grammatical
function!adpositional object}.

Example (\ref{ex:mangaaltern}) illustrates the alternation in annotation between
a bare adposition and one modified by \rayr{mN}{manga}. In an attempt to model
the difference between locational `in' and directional `into', \rayr{mN}{manga}
is analyzed there as changing the value of the \PSem{} feature of the
f-structure predicated by the adposition to $dir$ and the \Tel{}\index{telicity}
feature to $+$, as illustrated in (\ref{ex:mangaaltern_marked}). The
case\index{case} of the prepositional object\index{grammatical
function!adpositional object} is \Loc{} in both versions of the sentence, which
specifies that its superior f-structure's \PCase{} value is \Oblq{loc}.
...
bottom of} there is another alternation, based on case\index{case}, for
verbs\index{verbs} which do not encode direction. This is rooted in the
etymology of these words: \rayr{liNF}{ling} as a noun means `top',
\rayr{AvnF}{avan} means `ground, bottom'. The directional variants of these
prepositions mean `to the top, onto' and `to the bottom'. These readings are
telic\index{telicity} in that they express the possibility of arriving at the
destination specified by the adpositional object\index{grammatical
function!adpositional object}. However, Ayeri does not possess separate
adpositions to express `up' and `down' as atelic\index{telicity} concepts.
Instead, \rayr{liNF}{ling} and \rayr{AvnF}{avan} double for `up' and `down' with
dative\index{case!dative} complements, respectively, to mark the difference,
...
few verbs\index{verbs} where the adposition is a lexicalized part of the
expression, for instance, \xayr{tpYF/ djrinF}{tapy- dayrin}{save (assets)}, with
...
uses as in \fw{up the stairs} and \fw{down the hill}, respectively. Example
...
These examples show that there is an alternation in case\index{case} similar to
the one described above for German\index{German}. The distinction in Ayeri is
not between location\index{semantic role!location} and direction, however, but
rather between emphasis on a location\index{semantic role!location} or
destination as a resting or end point (\Oblq{loc}) and the path towards there
(\Oblq{goal}). \citet{butt2005} interprets prepositions in German\index{German}
as defining \PSem{} (encoding directedness or its lack), and thereby governing
the case of their complement. In contrast, it is easier in Ayeri to assume that
case marking on the prepositional object determines \PSem{}, and thus also
\PCase{}, for its superior f-structure. \rayr{mN}{manga} takes precedence over
case marking with regards to the \PSem{} feature. An attempt to model this
analysis in terms of lexical rules is presented in (\ref{ex:adpobjcaserule}).
...
opposite way in mostly using case\index{case} for marking verbal complements,
...
prepositions as in \fw{crawl out from under the table} or \fw{get out from
inside the room}. Instead, it uses nouns, which is no surprise, as most basic
prepositions are derived from nouns (compare \autoref{tab:prepos},
p.~\pageref{tab:prepos}). A phrase like \fw{out from under} may thus be rendered
as in (\ref{ex:nostackprep}). In this particular example,
\xayr{AgonnF} {agonan}{outside} is homonymous with the preposition
\xayr{AgonnF}{agonan}{outside of}, however, the topic marker at the beginning of
...
similar to that of \fw{inside of the X} to
\fw{inside the X} may be a logical next step. What would be possible moreover is
the functionalization of the triad \Loc{}--\Dat{}--\Gen{} to indicate
$loc$\index{semantic role!location}, $goal$\index{semantic role!goal}, and
$src$\index{semantic role!source} also with adpositions in general, either with
...
around, or with \rayr{mN}{manga} becoming zero, since the cases\index{case} are
...
the PP or as an adjective\index{adjectives} modifying the prepositional object\index{grammatical function!adpositional object}.
...
clausal complements\index{complement clause}. This applies especially when
...
\rayr{gmrFyNF}{gamaryang} `I manage (it), I get (it) done' and
...
fashion of (\ref{ex:adpadv}) would attach in the adjunct\index{grammatical function!adjunct} position, following\index{constituent order}
...
\a\label{ex:engeqstmt_1} \fw{John is happy.}
\a\label{ex:engeqstmt_2} \fw{John is a man.}
\a\label{ex:engeqstmt_3} \fw{John is at work.}
\xe
...
(\ref{ex:copemph}). Apparently, \rayr{maaj}{māy} does not fulfill the role
of linking subject\index{grammatical function!subject} and predicate, so (\ref{ex:copemph_2}) is nonsensical.
Instead, it may be fronted\index{constituent order} together with the predicate
...
that \rayr{maaj}{māy} is a discourse particle\index{discourse particles} and as such does not
perform the role of a copula\index{copula}. It is rather more similar to a clitic\index{clitics} in
...
adverb\index{adverbs} usually appears between\index{constituent order} the subject and the predicative NP, as
...
VSO language---the pattern for transitive\index{verbs!transitive} clauses is such that there is an inflectional phrase (IP)
which governs the verb as an extended head of verb phrase (VP), and a small clause S\index{phrase types!small clause} which
...
\adjustbox{valign=t}{%
	...
	...
		...
		& \begin{tabu}[t]{l @{ } l l X[l] @{ } l}
			...
			& \ups{\Top} & = & ↓ \\
			& \quad\downs{\Case{}} & = & \{\Aarg{}, \Parg{}, \Dat{}, \Gen{}, 
				\Loc{}, \Ins{}, \Caus{}\} \\
			& \quad\downs{\Anim{}} & = & $\pm$\bigskip \\
			
			  & \ups{\Subj} & = & ↓ \\
			( & \quad\downs{\Pred} & = & `$pro$' & ) \\
			  & \quad\downs{\Anim} & = & $\pm$ \\
			  & \quad\downs{\Gend} & = & \{\M, \F, \N, \Inan\} \\
			  & \quad\downs{\Num} & = & \{\Sg, \Pl\} \\
			  & \quad\downs{\Pers} & = & \{\First, \Second, \Third\} \\
		\end{tabu}
	\end{tabu}%
}
\xe
...
In (\ref{ex:ipcstruct}a), we can see that the first node branching off of IP on
...
AdvP,\index{phrase types!adverb phrase} but also APs\index{phrase types!adjective phrase}, and even NPs\index{phrase types!noun phrase} may serve as adjuncts\index{grammatical function!adjunct} of the verb. As discussed previously, Ayeri
generally places modifiers right after the head, before complements. This means
that here as well, when adjuncts\index{grammatical function!adjunct} are involved, S\index{phrase types!small clause} actually shifts\index{constituent order} to the right
...
Regarding phrase structure, the explanation about YP in the definition of
S\index{phrase types!small clause} given in (\ref{ex:copstruct}) stated that
there may also be a VP\index{phrase types!verb phrase} complement of a nominal
fulfilling the role of a predicate. Since VP\index{phrase types!verb phrase}
carries the non-\Subj{} arguments of a verb, making a clause
transitive\index{verbs!transitive}, the discussion of VP's\index{phrase
types!verb phrase} setup is deferred to the next section, \ref{subsec:vps}.
Presently, we mainly deal with intransitive clauses. Besides the VP\index{phrase
types!verb phrase} in S\index{phrase types!small clause} which is not listed in
the chart in (\ref{ex:ipcstruct}), IP may also carry a second VP\index{phrase
types!verb phrase} as a sister of \xhead{I}, functioning as an
\XCompl{}\index{grammatical function!open complement}. This VP\index{phrase
types!verb phrase} exists to accommodate control\index{verbs!control} and
raising verbs\index{verbs!raising}, whose syntax will be discussed in
\autoref{subsubsec:ctrlvb} (p.~\pageref{subsubsec:ctrlvb}\,ff.). A
secondary-predicative AP\index{phrase types!adjective phrase} or nominal may as
...
Welsh\index{Welsh} does according to existing analyses in the
\Lfg{}\index{Lexical-functional grammar} framework, compare
(\ref{ex:welshcstruct2}). According to \citet[130]{bresnan2016}, S\index{phrase
types!small clause} is chosen as a governing category for the
subject\index{grammatical function!subject} NP and the VP\index{phrase
types!verb phrase}. In place of VP\index{phrase types!verb phrase}, one may also
put a range of other categories---NP\index{phrase types!noun phrase},
AP\index{phrase types!adjective phrase}, or PP\index{phrase types!prepositional
phrase}. As illustrated in (\ref{ex:ipcstruct}), Ayeri is thought to follow the
...
NP\index{phrase types!noun phrase} or expletive \xayr{sitNF}{sitang}{self}.
...
\begin{forest} shorter edges,
[IP
	[\anno{\mysn{welshcstruct2_IP} I}
		[{\mysn{welshcstruct2_I} \textit{gwelodd}\\ `see-\Tsg{}.\Pst{}'}]
	]
	[\anno{S}
		[{\anno[\pass{\Subj}]{\mysn{welshcstruct2_S} NP}}
			[{\textit{Siôn}\\ `John'}]
		]
		[\anno{\mysn{welshcstruct2_VP} VP}
			[{\anno[\pass{\Obj}]{\mysn{welshcstruct2_O} NP}}
				[{\textit{ddraig}\\ `dragon'}]
			]
		]
	]
...
Fronting\index{constituent order} things this way is not possible in Ayeri, however, it is possible to
...
As previously mentioned, the adverb\index{adverbs} `usurps'\index{word order} the position of the
...
Quantifier\index{quantifiers} suffixes work with verbs as well, except that they have a grading or
...
with case\index{case} marking on the marked-for NP, which receives zero-marking
for case\index{case}, compare (\ref{ex:topmkg}).\footnote{Topic marking on the verb is
\textcquote[20]{corbett2006}{displaced information}, since the
morphological category encoded by topic marking---case\index{case}---is not a category of
the verb. It may therefore be treated as an agreement\index{agreement} relationship where
the verb agrees in case\index{case} with the topicalized NP\index{phrase types!noun phrase}: on morphological
...
occurs in the VP\index{phrase types!verb phrase} complement after\index{constituent order} the subject\index{grammatical function!subject} NP\index{phrase types!noun phrase}. Raising\index{verbs!raising} is required to make
...
According to \posscite{bresnan2016} annotations, possessees are realized
...
headed by an infinite verb\index{verbs!infinite}, if there is a head: since Ayeri is verb-intial,
...
pruned from c-structure. Nevertheless, there are cases where infinite verbs\index{verbs!infinite}
...
adjuncts\index{grammatical function!adjunct} actually follow\index{constituent order} the verb so that the complement shifts to the right,
...
Since \xhead{V} is an infinite\index{verbs!infinite} category in Ayeri, VPs cannot form complete
...
shows that infinite verbs\index{verbs!infinite} may nonetheless be marked for aspect\index{aspect}; they can also
...
semantic features an infinite verb\index{verbs!infinite} marks. Subordinate, infinite verbs\index{verbs!infinite} are
...
subcategorizes for three arguments: a subject\index{grammatical function!subject}, an object\index{grammatical function!primary object}, and a secondary object\index{grammatical function!secondary object},
where the primary object\index{grammatical function!primary object} expresses the recipient\index{semantic role!recipient} and the secondary object\index{grammatical function!secondary object} expresses the
...
verbs\index{verbs!intransitive} marks the theme\index{semantic role!theme} (T) of a ditransitive verb (P\,=\,T). Likewise,
the same case\index{case} is used to mark the donor (D) of ditransitive verbs as marks the agent\index{semantic role!agent} of
...
canonical cases\index{case} (S\,=\,A\,=\,D). The recipient\index{semantic role!recipient} (R) receives extra marking by a third case.
...
where the recipient\index{semantic role!recipient} appears as a PP headed by \fw{to},
except that it is not expressed as a PP, but as an NP/DP.
Since the secondary object\index{grammatical function!secondary object} is is an argument of the verb, it
...
just as it is not possible to have multiple patients\index{semantic role!patient}
with transitive verbs\index{verbs!transitive}.

Moreover, it is not possible to join either the theme\index{semantic role!theme}
...
Patient\index{semantic role!patient}, recipient\index{semantic role!recipient}, and adjuncts\index{grammatical function!adjunct}, like 
\xayr{krFdNFy}{kardangya}{at school} in (\ref{ex:doubleobj}), also cannot randomly switch
...
of the verb. The recipient\index{semantic role!recipient} is more readily expendable than the
theme\index{semantic role!theme}, however. Example (\ref{ex:doubleobjcstruct}) attempts to chart
this analysis as a c-structure tree. % \vfill
...
to compare Ayeri to Tagalog\index{Tagalog} in terms of syntactic alignment. In
this section, I want to elaborate on their structural and functional properties.
Since \Lfg{}\index{Lexical-functional grammar} does not assume empty nodes to
...
\XCompl{}s,\index{grammatical function!open complement} that is, open
complements\index{grammatical function!open complement}. These
\XCompl{}s\index{grammatical function!open complement} are dependent on a matrix
predicate for the subject\index{grammatical function!subject} function:
control verbs share their semantic subject\index{grammatical function!subject}
or object\index{grammatical function!primary object} with the semantic
subject\index{grammatical function!subject} of a subordinate verb
\citep[289\psqq]{bresnan2016}.% , also compare the English examples in (\ref{ex:engctrlstruct})
...
[IP$_f$
	...
	[S
		[NP \mysn{ctrlstruct1_mic}
			[{ang Mican}, roof]
		]
		[VP
			[VP$_g$ \mysn{ctrlstruct1_sid}
				[\xhead{V}
					[sidejam]
				]
				[NP \mysn{ctrlstruct1_nay}
					[nayingley]
				]
			]
		]
...
[IP$_f$
	...
	[S
		[NP \mysn{ctrlstruct2_pih}
			[Piha]
		]
		[VP
			[NP \mysn{ctrlstruct2_mic}
				[{sa Mican}, roof]
			]
			[VP$_g$ \mysn{ctrlstruct2_sid}
				[\xhead{V}
					[sidejam]
				]
				[NP \mysn{ctrlstruct2_nay}
					[nayingley]
				]
			]
		]
...
Topicalization\index{grammatical function!topic} of subordinate VPs' arguments
by matrix verbs is not possible if the subordinate verb stands in
between\index{word order} the matrix verb's subject NP and its own arguments.
Thus, the \xayr{nyiNsF}{nayingas}{roof} in both (\ref{ex:ctrlstruct}ab) cannot
be the topic\index{grammatical function!topic} of the verb in the respective
matrix clauses, \xayr{liMky}{linkaya}{(he) tries} and \xayr{nelFye}{nelye}{(she)
helps}. Since topicalization\index{grammatical function!topic} does not apply to
infinite verbs\index{verbs!infinite}, the subordinate verb in both sentences,
\xayr{sidegYmF}{sidejam}{repairing}, cannot be marked for
topic\index{grammatical function!topic} within its own f-structure core either.
...
% 			[kept]
% 		]
% 		[VP$_{f2}$ \mysn{engctrlstruct1_eat}
% 			[V
% 				[eating]
% 			]
% 			[DP \mysn{engctrlstruct1_mar}
% 				[marshmallows]
% 			]
% 		]
% 	]
...
% 			[kept]
% 		]
% 		[DP \mysn{engctrlstruct2_joh}
% 			[John]
% 		]
% 		[VP$_{f2}$ \mysn{engctrlstruct2_dou}
% 			[V
% 				[doubting]
% 			]
% 			[DP \mysn{engctrlstruct2_him}
% 				[himself]
% 			]
% 		]
% 	]
...
The rule by which the subordinate verb appears as a sister of \xhead{I} seems to
resemble that which places the matrix verb in \xhead{I}. However, there is the
...
clause. That is, there must not be two patient\index{semantic role!patient}
arguments after the verb, even if they are part of different f-structures. This
means that fronting\index{word order} the verb in order to be able to
topicalize\index{grammatical function!topic} NPs\index{phrase types!noun phrase}
...
topic\index{grammatical function!topic} particle, as usual, appears as a
proclitic\index{clitics} before the verb, which here encodes an inanimate
patient topic, referring to an argument of the subordinate verb,
\xayr{nyiNF}{naying}{roof}. In order to address the \Top{} function of the
matrix verb in this case, we have to use inside-out functional uncertainty and
annotate the topicalized\index{grammatical function!topic} NP\index{phrase
types!noun phrase} with \uncertain{\XCompl}{\Top}~=~↓ to signal that \Top{} is
an attribute of the f-structure containing \XCompl{}\index{grammatical
function!open complement}. This is an extension to the rules stated in
(\ref{ex:topmorphlex}).
...
[IP$_f$
	...
	[S
		[NP \mysn{raisestruct1_aja}
			[{ang Ajān}, roof]
		]
		[VP
			[VP$_g$ \mysn{raisestruct1_val}
				[\xhead{V}
					[valyyam]
				]
				[NP \mysn{raisestruct1_uma}
					[umangley]
				]
			]
		]
...
[IP$_f$
	...
	[S
		[NP \mysn{raisestruct2_niv}
			[Niva]
		]
		[VP
			[NP \mysn{raisestruct2_aja}
				[{sa Ajān}, roof]
			]
			[VP$_g$ \mysn{raisestruct2_val}
				[\xhead{V}
					[valyyam]
				]
				[NP \mysn{raisestruct2_uma}
					[umangley]
				]
			]
		]
...
Just as with control verbs, it is possible to front\index{word order} the subordinate verb,
...
the subordinate verb is infinite\index{verbs!infinite} and thus cannot carry topic\index{grammatical function!topic} marking.
...
Here, the VP which would normally carry the subordinate \xhead{V}, \xayr{vlYFymF}{valyyam}{enjoying}, is
...
It has been mentioned before that \xayr{sitNF}{sitang}{self} can be used
as an expletive pronoun so that quantifiers\index{quantifiers} can be attributed indirectly to
enclitic\index{clitics} subject\index{grammatical function!subject} pronouns, compare 
...
as dummy pronouns, but these encode a third-person\index{person} reference
...
pronouns\index{pronouns!personal} of persons\index{person} other than the third. Hence, \rayr{sitNF}{sitang} is used in
this context as a dummy pronoun since ordinarily, it does not encode person\index{person},
but reflexivity. It is therefore neutral to person\index{person} features while still
establishing an anaphoric relationship to its binder. It also gives a clitic\index{clitics} quantifier\index{quantifiers}
...
[IP
	[\xhead{I} % \anno{\xhead{I}}
		...
		[Cl \mysn{expsitang_nan} % \anno{Cl}
			[-nang$_i$]
		]
	]
	[S % \anno{S}
		[DP\mysn{expsitang_DP} \mysn{expsitang_sit}
			% {\anno[\pass{\Subj}]DP}
			[\xhead{D} % \anno{\xhead{D}}
				[\xhead{D} % \anno{\xhead{D}}
					[sitang$_i$]
				]
				[Cl \mysn{expsitang_ika} % {\anno[\elem{\Adjc}]{Cl}}
					[-ikan]
				]
			]
		]
...
Going by classic, structuralist binding\index{binding} theory, \rayr{sitNF}{sitang} should be
...
functionally oriented binding\index{binding} theory, both the subject\index{grammatical function!subject} pronoun and
...
comparison\index{comparison} verbs \xayr{km/}{kama-}{be as} \xayr{ENF/}{eng-}{be more} and
\xayr{v/}{va-}{be most}. Obviously, the comparison\index{comparison} verbs are related to the
enclitics\index{clitics} described in \autoref{subsec:adjcomp}. By extension, the verb
meaning `give', \rayr{IlF/}{il-}, can also be used to mean `be less'.
Theoretically, there is also \xayr{vrY/}{varya-}{be least},\footnote{From
...
In order to express `there is', Ayeri uses \rayr{yom/}{yoma-} with a dummy
subject\index{grammatical function!subject} pronoun: \xayr{yomreNF}{yomareng}{there is/are}, which is a set
expression---literally, `it exists'. \rayr{yomreNF}{yomareng} can be inflected for the usual morphological
features of verbs, as shown in (\ref{ex:yomareng}), where the verb carries
negation\index{negation}. Notably, the entity said to exist is treated as its object rather than its subject.
Apart from this, \rayr{yom/}{yoma-} is usually used with locations\index{semantic role!location},
...
comparison\index{comparison} as listed initially. Ayeri behaves differently in this from what
...
Since the functional analysis of \Lfg{}\index{Lexical-functional grammar} is
...
encode \Deg{} and \Degdim{}, and the adjective\index{adjectives} seems to
appear in the place an adverb\index{adverbs} would normally inhabit? In fact,
...
fronted\index{word order}, treating the adjective\index{adjectives} in the way
of a verbal complement of \xhead{I}? This hypothesis neatly coincides with
Ayeri's fronting\index{word order} subordinate verbs in order to enable
topicalization of their dependents by making the embedded NPs\index{phrase
types!noun phrase} look like regular arguments of the matrix clause's verb.
...
of the adjective\index{adjectives} is generated in its canonical position\index{constituent order} as a daughter of the AP\index{phrase types!adjective phrase}
...
[IP
	[\anno{\xbar{I}}
		...
		[{\anno[\pass{\Plink}]{AP}}% \mysn{compcstruct_par}
			[para]
		]
	]
	[\anno{S}
		[{\anno[\pass{\Subj}]{NP}}% \mysn{compcstruct_cis}
			[Cisu]
		]
		[\anno{VP}
			[{\anno[\pass{\Plink}]{AP}}% \mysn{compcstruct_ap}
				[{\anno[\pass{\Compl}]{NP}}% \mysn{compcstruct_kam}
					[{sa Kaman}, roof]
				]
			]
		]
...
complement, \rayr{s hiro}{sa Hiro}, there are two successive patient\index{case!patient} arguments, 
...
\index{grammatical function!predicative complement|(}
...
before that finite verbs in \xhead{I} may have a sister node\index{constituent
order} which is a complement. This is not only the position raised and
...
\[
	...
	\Top	&	\[
		\avmspan{``Prano''} \\
	\]\tikzmark{semicopred2_top} \\
	\Subj	& \tikzmark{semicopred2_subj} \\
	\Plink	&	\[
		\avmspan{``teacher''} \\
	\] \\
\]
...
\draw [rounded corners=1ex]
	([yshift=1ex]{pic cs:semicopred2_top})
	-- ++(east:1em) |-
	([yshift=1ex]{pic cs:semicopred2_subj});
\end{tikzpicture}
...
constituent order\index{constituent order}. This also means that as with
predicative nominals in copula clauses, complements of semi-copula verbs appear
in the patient case\index{case!patient}. Example (\ref{ex:semicoppred_2})
illustrates the first possibility, where a predicative NP appears between the
finite verb and the subject NP.

How do we know, however, that in (\ref{ex:semicoppred_2}), the subject NP and
the VP carrying the object have not simply been inverted?\index{constituent
order} While this is a grammatically valid possibility, another possible
...
predicative complement and the adjunct: \xayr{sobyaasF perikYnFy sris}{sobayās
pericanya sarisa}{a teacher next year} as a whole precedes the subject,
\rayr{pFrno}{Prano}. In (\ref{ex:semicopvp_2}), on the other hand, the
predicative nominal, \rayr{sobyaasF}{sobayās}, has been fronted to appear right
after the finite verb, \xayr{ANF tvFy}{ang tavya}{(he) becomes}, while the
adjunct, \rayr{perikYnFy sris}{pericanya sarisa}, still follows the subject.
...
predicates. A depictive\index{adjectives!depictive} secondary predicate, on the
one hand, \textcquote[173]{mueller2002}{provides information about the state of
the entity it refers to. This state holds at the time of the event described by
the verb}. A resultative\index{adjectives!resultative} secondary predicate, on
the other hand, refers to \textcquote[173]{mueller2002}{the result of an event
[...]\ specified by the adjective\index{adjectives}}. This difference is
illustrated in (\ref{ex:engsecpred}).

\begin{figure}
\pex\label{ex:engsecpred}
\a\label{ex:engsecpred1_subj}%
	\fw{Suzy came to work \textbf{sick}.} (depictive, S)

\a\label{ex:engsecpred1_obj}%
	\fw{Jack eats the apple \textbf{unwashed}.} (depictive, O)

\a\label{ex:engsecpred2_obj}%
	\fw{Bill wipes the table \textbf{clean}.} (resultative)
\xe
\end{figure}
...
apple to be unwashed. In contrast to these two examples, \fw{clean} in
...
\posscite{mueller2002} analysis, \textcquote[196]{mueller2002}{the subject of
the depictive secondary predicate is coindexed with an element of the argument
structure of the primary predicate}.\footnote{According to
\citet{wechslerzlatic2003}, as an adjunct, the depictive should inherit
\xhead{N}'s \Concord{} rather than its \Index{} features if it showed agreement;
I suppose we may still use $i$ to indicate referential restriction of the
adjective to the noun it modifies.} He suggests for \textsc{hpsg} \textquote{a
...
\textcquote[196]{mueller2002}{capture the adjunct\index{grammatical
function!adjunct} properties of depictive secondary predicates}. I tried to cast
this in (\ref{ex:depictfstruct}) as an f-structure in which the depictive
secondary predicate is an adjunct\index{grammatical function!adjunct} of the
...
In English\index{English}, a variety of phrase types can form resultative
...
p.~\pageref{manga}). Examples with transitive\index{verbs!transitive}
adpositions where the PP\index{phrase types!prepositional phrase} is not an
adjunct\index{grammatical function!adjunct} should also be hard to find. An
example of each phrase type complementing the object\index{grammatical
function!primary object} of a transitive verb\index{verbs!transitive} to
...
status of the PP\index{phrase types!prepositional phrase} as an argument of the
verb is not entirely clear, probably because of the added-argument status of
\XCompl{}s\index{grammatical function!open complement} which she asserts.
Moreover, in (\ref{ex:restrns_np}), we can see the dative\index{case!dative}
used to mark resultative NPs\index{phrase types!noun phrase}. A verb may thus
occur exceptionally with more than one complement in the dative
case\index{case!dative}. However, different from a regular recipient or a goal
NP, a resultative dative\index{case!dative} NP\index{phrase types!noun phrase}
also normally occurs after\index{constituent order} the verb.
...
[IP$_f$
	[\xbar{I}
		[\xhead{I}]
		[XP\mysn{restrnsstr_XP1}]
	]
	[S
		[NP]
		[VP$_g$
			[\mysn{restrnsstr_NP}NP]
%			[\mysn{restrnsstr_S}S
				[(XP)\mysn{restrnsstr_XP2}]
%			]
		]
	]
]
...
\textcquote[405]{needhamtoivonen2011}{[t]ime and place expressions [...]\ can be
...
function. The object of eating, \fw{a sandwich}, is assigned [–\,r], and
...
(\ref{ex:comptr}) which can take PPs---specifically \xayr{sr/}{sara-}{go},
\xayr{mitF/}{mit-}{live}, and \xayr{tpYF/}{tapy-}{put}---do not require a
...
As mentioned above, \rayr{nr/}{nara-} may include an NP in the genitive case,
...
locative adverbial. In both cases, a combination with \xayr{nj}{nay}{and} is
...
instance of such coordination\index{coordination} where both adverbials clearly are adjuncts\index{grammatical function!adjunct}. As
...
others, it behaves as would be expected from an adjunct\index{grammatical
function!adjunct}. \citet{needhamtoivonen2011} argue that these optional or
...
\xhead{V}' in \autoref{tab:drvargres}---%
...
definite difference between arguments and adjuncts\index{grammatical
function!adjunct}}.
...
with typical adjuncts, \xhead{P} provides contentful information about the
...
the \fw{do-so} test, which is typical of them as well. Like a typical
complement, the PP also has to move with its \xhead{V} in a pseudocleft
...
the English\index{English} example (\ref{ex:engditrpass_pass1}),
...
argument as a subject\index{grammatical function!subject}. Parallel to how Ayeri forms passives of monotransitive
...
such---Ayeri cannot rephrase the recipient\index{semantic role!recipient} as a PP\index{phrase types!prepositional phrase}.
...
German\index{German}.\footnote{Preferring this strategy may be
native-language interference, as a native German speaker. However, I made a
rule that only agents\index{semantic role!agent} or patients\index{semantic role!patient} can be
...
apply intransitivization to either the active ditransitive argument structure or
the passive version, it will fail. Suppressions may apply only to unmarked
...
of the objects in active voice\index{voice!active} (\ref{ex:intrnzn_act}) and in
passive voice\index{voice!passive} (\ref{ex:intrnzn_pass}). Suppressing the
recipient\index{semantic role!recipient} as a [+\,o] argument produces a
...
(\ref{ex:intrnzn_pass_1}) is due to the rule against recipient\index{semantic
role!recipient} subjects\index{grammatical function!subject}.
...
permit dative\index{case!dative} NPs\index{phrase types!noun phrase} to be subjects\index{grammatical function!subject} of passive verbs, this is not possible 
...
so it would seem odd for it to take a patient subject\index{grammatical function!subject} that makes it look as
...
Various head types, verbs especially, can take complements or adjuncts\index{grammatical function!adjunct} which
...
CP is formed by a conjunction\index{conjunctions}, \xhead{C}, which also can be
...
\xbar{C} to attach an adjunct\index{grammatical function!adjunct} to. The complement of \xhead{C} is formed by a
...
This means that the complement clause may be finite\index{verbs!finite} or infinite\index{verbs!infinite}. The CP itself
...
it acts as a complement clause, as well as an adjunct\index{grammatical function!adjunct} when it acts as a relative
clause.
...
see below. Ayeri is rather sparse about different conjunction\index{conjunctions} types,
...
adjunct\index{grammatical function!adjunct} of the verb in $f$---the purpose is not required information here. The
...
The infinite\index{verbs!infinite} complement clause in (\ref{ex:complcls_2}) is special in that
...
\autoref{subsubsec:ctrlvb}, p.~\pageref{subsubsec:ctrlvb}\,ff.), this
...
however, is an intransitive\index{verbs!intransitive} infinite\index{verbs!infinite} form and hence there is neither a
...
$null$ in this particular case. Infinite verbs\index{verbs!infinite} are not precluded from having
...
of relative clauses.} This topic\index{grammatical function!topic} is not marked on the verb as such, though, but
...
...
	...
	& \begin{tabular}[t]{l @{ } l l l @{ } l} 
		...
		( & \uncertain{\Adjc}{\Case} & \req & \{\Aarg{}, \Parg{}, 
			\Dat{}, \Gen{}, \Loc{}, \Ins{}, \Caus{}\} & ) \\
		( & \uncertain{\Adjc}{\Anim} & \req & $\pm$ & ) \\
		( & (\GF{} \Adjc{}~↑) & & & )\smallskip \\
...
\rayr{sinaa}{sinā} to mark the controller of the relativizer as
the relative clause's \Oblq{theme}. Accordingly, the f-structure holding
information about the relativizer\index{pronouns!relative} has gained a \Case{} feature with the
...
with a resumptive pronoun\index{pronouns!resumptive} which is topicalized\index{grammatical function!topic}. As discussed
...
obliterated by using \rayr{sinaa}{sinā}.
...
\ljudge\ques\begingl
	\gla Si ang @ sungyan prihinya, bituayley disari. //
	\glb si ang= sung=yan.Ø prihin-ya bituay-ley disa-ri //
...
expressed by negation of the verb\index{negation} 
and the juxtaposition of clauses. \rayr{bt}{bata} may also be used together
with a verb in negative mood\index{mood!negative}.
