...
similarities to a serial-verb construction:
...
subcategorizing for a complement. So, what if rather than treating the quality
in the way of an adverb, Ayeri actually generalized the way subordinate verbs
can be fronted in order to enable topicalization of the subordinate verb's
dependents, treating the adjective in the way of a verbal complement of
\xhead{I}, so that the embedded object appears superficially like a complement
of the matrix verb?
