...
More important to \Lfg{} than c-structure trees, however, is f-structure to
...
a quantifier which  be further specified by an intensifier. \xhead{D} may also
...
all grammatical categories of nouns---number, gender, animacy, and case\index{cases}; they
...
proclitic\index{clitics} essentially acts as a nominalizer for the adjective\index{adjectives}. This could also
explain why the adjective\index{adjectives} forfeits its ability to undergo comparison:
...
encode person and number, though at least \rayr{sinY}{sinya} inflects for case\index{cases}
...
\fw{how} in terms of \Lfg{}, so I am assuming here that \fw{which}'s function,
...
declines for case\index{cases}, so number and gender do not have to be accounted for. Thus,
...
AdvP.\footnote{Since in \Lfg{}, non-branching \xbar{X} nodes are omitted for
...
for synthetic comparison of adjectives are grammaticalized clitics\index{clitics} literally
...
\ref{subsec:persnumagr}). Absence of tense, mood, and aspect\index{aspect} marking specifies
that the verb is in the contextually appropriate tense (compare
\autoref{subsec:tense}), indicative mood, and simple aspect\index{aspect}.
...
negation. Apart from this, \rayr{yom/}{yoma-} is usually used with locations,
...
An alternative to the comparison strategy by enclitics\index{clitics} is to use a verb of
...
The way \Lfg{} handles comparison of adjectives\index{adjectives} in predicative contexts is
...
term under comparison, being a \xayr{kromyaasF}{karomayās}{doctor}, is
constructed as a copula clause while the comparison in quality between
