...
the series of deictic suffixes \xayr{Ed/}{eda-}{this}, \xayr{Ad/}{ada-}{that},
and \xayr{d/}{da-}{such}. In section \autoref{nounprefixes}
...
that we require postposed \rayr{/ku}{-ku} to fill in not the AP's \Adjc{}, but
its superseding NP's. Example (\ref{ex:postkuconst}) demonstrates how the
positioning variants of \rayr{/ku}{-ku} differ in meaning and grammaticality.
