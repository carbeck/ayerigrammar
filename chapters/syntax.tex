...
pronoun/adjective\index{adjectives} in Ayeri mark case, while they do in German\index{German}. The case marker
...
default. Different than in German\index{German}, the presence or absence of directionality
...
from both English and German\index{German}, Ayeri puts recipients\index{semantic role!recipient} after\index{word order} themes\index{semantic role!theme}\index{word order}, irrespective
...
especially apparent in comparing English to German\index{German}---and Ayeri. As
...
German\index{German}, as mentioned above, works a little different from English. This is
