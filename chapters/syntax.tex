...
modification of pronominal suffixes by quantifiers is not possible, as
described in \autoref{subsec:reflrec}---a reflexive particle is needed here to
attach the quantifier to. The examples in (\ref{ex:nonounmods})
show what is not possible as compared to nouns.
...
\autoref{subsec:dempro}. Suffice it to say that demonstrative pronouns are
similar to personal pronouns, except that they do not mark person (a third
person reference is implied), but deixis more generally as location in space.
...
why (\ref{ex:dempromorphlex}) is listed with a
\Deix {} feature encoding $this$, $that$, and $such$, rather than a binary
\Prox{} or \Dist{} feature.
...
Regarding their ability to be modified, demonstrative pronouns share the same
distribution as personal pronouns: they may only be modified by relative
clauses, but not by phrases projected by lexical heads such as adjectives or
nouns.
