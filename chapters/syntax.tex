...
features as personal pronouns: person, number\index{number}, gender\index{gender}, animacy, and
...
pronouns distinguish gender in the plural\index{plural} as well as in the singular, however,
...
in the plural\index{plural}, and demonstrative pronouns. A clitic\index{clitics} quantifier can also still
be recognized in the interrogative pronoun \xayr{siknF}{sikan}{how many},
...
exception of \xayr{sinY}{sinya}{who}. With indefinite pronouns, quantifiers are
...
The relativizer \rayr{si}{si} and its forms inflected for agreement\index{agreement} cannot be
quantified. The simple and most common form of the relativizer, \rayr{si}{si},
is unstressed, which makes it a bad host for a clitic\index{clitics}. A relativizer marked for
...
certain kinds of DPs\index{phrase types!determiner phrase} (demonstratives, notably), where they describe properties
...
demonstratives \xayr{AdnY}{adanya}{that one} or \xayr{dnY}{danya}{(such) one}
...
reflexives' \citep[145]{simpson1983} by which the subject NP\index{phrase types!noun phrase} is basically
...
agreement\index{agreement}, the f-structure would not change if the relativizer were \rayr{ssF}
...
attribute \Gen{} to reflect internal case\index{cases} marking of the relativizer.
...
may mark both possessors and oblique \xayr{ly/}{laya-}{read}, the construction
