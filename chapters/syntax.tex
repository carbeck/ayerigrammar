...
The terms `subject', `topic', and `focus' were used above, but it seems
advisable to sketch out working definitions. First things first, the
\textbf{subject} can be defined in a variety of ways, and maybe especially
because the notion of a subject is so fundamental, \citet{comrie1989} notes
that if
...
A basic definition is given by the chart in (\ref{ex:subject}). It shows the
definition of the notion of `subject' for both nominative--accusative languages
(like English) and ergative--absolutive languages (like Basque). The subject is
here understood to be the single nominal relation of an intransitive verb (S).
Languages then differ based on their treatment of the two nominal relations of
a transitive verb in relation to intransitive verbs: they may either treat the
actor (A) or the patient/undergoer (P) the same as S. In the former case, the
language is said to have nominative--accusative alignment
...
nominative--accusative alignment (S\tsub{A}---P):\medskip
...
ergative--absolutive alignment (S \tsub{P}---A):\medskip
...
From the point of view of constituent structure, it is normally understood to
be a \textcquote[221]{carnie2013}{DP that has the property indicated by the
predicate phrase. What the sentence is about. In most sentences, this surfaces
in the specifier of TP [the Tense Phrase]}.
