...
unaccusative verb is patient-like \mbox{[–\,r]}---the same goes for the
subject of a passive. Other semantic roles are annotated [–\,o] as well. The roles in (\ref{ex:argfunctfeat}) map to the closest available role
in the thematic hierarchy (\ref{ex:themhier}) \citep[329]{bresnan2016}.
