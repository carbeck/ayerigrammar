...
of \xayr{silFvF/}{silv-}{look} and \xayr{nr/}{nara-}{speak}, which in Ayeri
appear in the locative case, or even the theme of \rayr{nr/}{nara-}, which is
...
Ditransitive verbs add a third role to the argument structure of a verb. Since
...
\ljudge*\fw{The news are told Mary.}\medskip \\
\begin{tabular}[t]{@{} >{\itshape}l l c c c r}
tell₂
	& ⟨
	& \textsc{agent}
...
argument. The verb \xayr{vlYymF}{valyyam}{enjoying} in (\ref{ex:passraise_2})
at least is thus not readily recognizable as a passive form. Both sentences are
odd in that \xayr{surFpF/}{surp-}{seem} is complemented by a patient subject.
This is comparable to *\fw{The beach is seemed to be enjoyed} in English.
...
\subsubsection{Passivization of adjuncts}

% FIXME: THIS NEEDS TO BE REWRITTEN. THESE VERBS ARE MAYBE RATHER INTRANSITIVE
% VARIANTS TAKING AN ADJUNCT IN SOME OBLIQUE CASE RATHER THAN COMPLEMENTS IN A
% NON-CORE CASE.
%
% Most transitive verbs in Ayeri take a patient-marked object, however, there
% are a few verbs which have complements realizing a different function which
% also reflect Ayeri's more semantic approach to case marking. Among these are
% \rayr{silFvF/}{silv-} when it means `look at', \rayr{nr/} {nara-} when it
% means `speak to', or \xayr{tpY/}{tapy-}{put}. Their respective argument
% structures are listed in (\ref{ex:comptrastruct}).

% \begin{figure}
% \pex\label{ex:comptrastruct}
% \a\label{ex:comptrastruct_look}%
% \begin{minipage}[t]{.4\remaining}
% \begingl
% 	\gla Ang @ silvya yan suranya. //
% 	\glb ang= silv-ya yan-Ø suran-ya  //
% 	\glc \AgtT{}= look-\TsgM{} boy-\Top{} ball-\Loc{} //
% 	\glft `The boy looks at the ball.' //
% \endgl
% \end{minipage}
% ~
% \begin{tabular}[t]{>{\itshape}l l c c r}
...
% \a\label{ex:comptrastruct_speak}%
% \begin{minipage}[t]{.4\remaining}
% \begingl
% 	\gla Ang naraya badan yanya. //
% 	\glb ang= nara-ya badan-Ø yan-ya //
% 	\glc \AgtT{}= speak-\TsgM{} father-\Top{} son-\Loc{} //
% 	\glft `The father speaks to the son.' //
% \endgl
% \end{minipage}
% ~
% \begin{tabular}[t]{>{\itshape}l l c c r}
...
% \a\label{ex:comptrastruct_put}%
% \begin{minipage}[t]{.4\remaining}
% \begingl
% 	\gla Ang @ tapyya yan suranley kong hinya. //
% 	\glb ang= tapy-ya yan-Ø suran-ley kong hin-ya //
% 	\glc \AgtT{}= put-\TsgM{} boy-\Top{} ball-\PargI{} into box-\Loc{} //
% 	\glft `The boy puts the ball into the box.' //
% \endgl
% \end{minipage}
% ~
% \begin{tabular}[t]{>{\itshape}l l c c c r}
...
% The verb in (\ref{ex:comptrastruct_look}), \rayr{silFvF/}{silv-}, normally
% means `see' when it appears with a patient object or no object. There is also
% the possibility of it taking a complement in either the locative or the
% dative case, however, changing the meaning of the verb. In terms of \Lfg{} it
% may be reasonable to assume that these are, in fact, three different lexical
% items:
% \fw{see}, \fw{look-at}, and \fw{watch}. This alternation also extends to the
% verb associated with hearing, \rayr{tNF/}{tang-}. I annotated the
% \textsc{goal} role with [–\,r] because \rayr{surnY}{suranya} acts like an
% object of
% \rayr{silFvF/}{silv-} regardless of its case marking. When the object is
% dropped, the verb may be assumed to simply be underspecified for the kind of
% seeing, that is, whether the subject is an experiencer or an agent of seeing.
% This is also reflected in the imperative form, \rayr{silFvu}{silvu}, which
% usually means `look!'.

% It is similar for the verb \rayr{nr/}{nara-} in
% (\ref{ex:comptrastruct_speak}), which usually means `speak, say' and may have
% a complement in the patient case expressing what is spoken. This verb also
% exists as taking an addressee
