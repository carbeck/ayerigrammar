...
kind of construction and instead uses generic nouns or a dummy pronoun as
heads, at least in more formal registers. An example is given in
(\ref{ex:relcheadless}). The sentence in this example is given as questionable;
what is preferred in Ayeri is to introduce this sentence with
...
\ljudge\ques\begingl
	\gla Si ang @ sungyan prinhinya, bituayley disaeri. //
