...
marked on the verb or the actor, since certain syntactic constructions apply to
either. However, while these ambiguities lead \citet{schachter1976} to the
conclusion that Tagalog all but lacks syntactic subjects, which is reaffirmed
again by \citet[1675--1676]{schachter2015},\footnote{Curiously,
\citet{schachter2015} does not acknowledge \citet{kroeger1991} at all, nor does
he refer to any other research more recent than 1985. One reason may be that
Schachter presumably retired in the early 1990s, as the UCLA linguistics
department's \citet{uclalingdepthist} would suggest.} \citet{kroeger1991}
reaches the opposite conclusion by performing more tests and taking a
functional rather than structural perspective into account:
...
relation, which he calls the `nominative relation' according to his hypothesis
that it is the syntactic subject, is neither especially salient in terms of
pragmatic topichood, nor does it show signs of carrying pragmatic focus
specifically. He finds that rather, nominative marking works independent of
discourse functions \citep[56\psqq]{kroeger1991}.
...
Kroeger rather than Schachter in the following. Either way, we will have to
test quantifier float, relativization, number agreement, reflexive binding,
raising and control verbs, control of secondary predicates, and the termhood of
the agent NP in transitive sentences with what was called `patient topic' so
far. First of all, it will be helpful, however, to define some terms which will
