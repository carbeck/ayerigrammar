...
\a NP → \anno*{\xbar{N}}
\a \xbar{N} → \anno*{\xhead{N}} $\left(\anno*[{\elem{\Adjc}}]{XP}\right)$
\xe
...
(\ref{ex:pppstruct}). Here, the \xhead{P}s in brackets are supposed to mean
that such an element can appear in either position. Since there are no
