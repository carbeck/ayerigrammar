...
\citet{kroeger1991}, together with the loss of person marking on the verb.}
...
introduced by a conjunction. The conditional meaning has to be inferred from
context in these cases, as there is not even word order inversion to mark the
construction as conditional. The two conjunctions found with conditional
...
apodosis may also appear in the opposite order in these example. Generally,
either conjunction may be dropped, though it is most common to drop the one of
the first clause. In more formal language, neither clause may be introduced by
a conjunction.
...
\a\label{ex:condcs_3}\begingl
	...
	\glc \PatT{}= pay=\Second{}.\Aarg{} \Aarg{}= work=\Fsg{}.\Aarg{}
		\Second{}.\Ben{} //
...
conditional moods; irrealis mood covers both.
