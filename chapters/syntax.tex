...
rather than adjuncts? X-bar theory posits that complements and adjuncts are on
different \xbar{X} branches---a complement is a sister to the head whereas an
adjunct is its aunt, so to speak; compare (\ref{ex:xbartree}).
