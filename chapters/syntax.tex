...
without semantic content. As a pro-form, the anaphoric prefix is able to
...
to the referred-to NP's \Anim{} feature. Verbs agree in number, gender, and
...
Note, however, that in predicative statements, if a possessive pronoun is in 
predicative position, it can take \rayr{d/}{da-}, but it acts like a regular 
adjective (without the possibility to undergo comparison). This means that in
this exceptional case, there is no patient case marking, which would otherwise
be required of predicative NP complements. This is the reason why in 
\autoref{fig:da-s}, the \Pers{} and \Def{} values are in parenthesis---these 
features are not encoded by adjectives.

\pex
\a\begingl
	\gla Adanyāng nangās nā. //
