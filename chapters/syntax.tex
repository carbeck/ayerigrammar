...
case\index{case} marking and grammatical functions\index{grammatical function}, which are not always unambiguous\index{ambiguity}. As
...
units.\footnote{Essentially, c-structure is similar to the tree hierarchy\index{hierarchy} of
...
for synthetic\index{synthesis} comparison\index{comparison} of adjectives are grammaticalized clitics\index{clitics} literally
...
in (\ref{ex:ayreqstmt_2}) since this makes it unambiguous\index{ambiguity} that the adjective\index{adjectives} is
