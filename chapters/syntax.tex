...
itself untypically inflects for case, at least not on a functional level. The
case marker just happens to be stuck to it for convenience, which is
represented in the accompanying c-structure.
