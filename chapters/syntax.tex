...
also indicates motion towards them. Likewise, the genitive case\index{case!genitive} does
...
of a clause is spread over two discontinuous sites this way. This issue does
...
only one NP among the arguments of a verb may be the topic\index{grammatical function!topic} of the clause.
