...
is a sister to the head whereas an adjunct is, so to speak, its niece:
...
produced are ungrammatical (\ref{ex:soreplacement_2}).
...
A further complication with regards to complementation is that free-morpheme
quanitfiers like \xayr{AMkYu}{ankyu}{really} may usurp the complement position
so that the complement XP appears as an adjunct. This is due to Ayeri having
modifiers very consistently follow their heads, and also possibly the fuzzy
notion of syntactic weight \citep{wechsler2009}. Thus, as it looks like for
(\ref{ex:adjmod_dp_comp2adj}) and (\ref{ex:adjmod_cp_comp2adj}), the DP and
CP, respectively, have been kicked out of the complement position they would
usually occupy by the quantifier \xayr{AMkYu}{ankyu}{really} and moved to the
end of the phrase:

\pex\label{ex:intrusivequant}
\a\label{ex:adjmod_dp_comp2adj} \begin{minipage}[t]{\remaining}
	\textit{Yang mino \_\tikzmark{intrusivequant1_1} ankyu 
...
\a\label{ex:adjmod_cp_comp2adj} \begin{minipage}[t]{\remaining}
	\textit{Yang valuy \_\tikzmark{intrusivequant2_1} ankyu, 
	$[$yomavāng edaya\tikzmark{intrusivequant2_2}$]$.}\medskip
	
	\begin{tikzpicture}[remember picture, overlay]
	\draw [-latex] ([xshift=-.25em,yshift=-.75ex]{pic cs:intrusivequant2_1}) 
	|- ++ (south:.75em) -| ([xshift=-.5*width("yomavāng
	edaya"),yshift=-.75ex]{pic cs:intrusivequant2_2});
	\end{tikzpicture}
...
\a\label{ex:soreplacement_3_3}\ljudge*\begingl
