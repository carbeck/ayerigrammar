...
indicates the reversed order\index{constituent order}. Furthermore, the c-structure tree indicates that
relative clauses\index{relative clause} precede\index{constituent order} DPs\index{phrase types!determiner phrase} embedding the NP, like possessive NPs and DPs\index{phrase types!determiner phrase}.
