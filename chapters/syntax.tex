...
\Index{}; (\ref{ex:nucbind_2}) states that there is not. For pronominal
f-structures, there is also a condition which states that the pronoun must be
outranked by its antecedent on the functional hierarchy; the DomainPath is
required to have a top attribute \GF{} which is \textcquote[248--249]
{bresnan2016}{which is dominated on the functional hierarchy [...] by the
antecedent}:
