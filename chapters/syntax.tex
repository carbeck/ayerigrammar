...
`configurational' in spite of VSO constituent order\index{constituent order}. The present chapter, in
...
(\ref{ex:germandetdist}g) appears to be an exception in permitting two
...
modern Standard German\index{German}, this construction is strongly marked,
however. It is probably a remnant of earlier stages of German\index{German}
where there was no such restriction on the co-ocurrence of demonstrative and
...
is also present as a modifier or not. The demonstrative clitic\index{clitics} merges with the head
...
case. The same is also true of common nouns, as shown in
(\ref{ex:suffixcase}).
...
see XP instead of NP as in example (\ref{ex:engqcstruct}), which is an
...
NP\index{phrase types!noun phrase}, adpositional phrase (PP)\index{phrase types!prepositional phrase}, adverb phrase (AdvP)\index{phrase types!adverb phrase}, and AP\index{phrase types!adjective phrase} \citep[407] {dalrymple2001}. The rather intricate
...
Ayeri does not front\index{constituent order} interrogative pronouns\index{pronouns!interrogative} like English does, the functional
...
annotations which encode the lexical content, but simply like
