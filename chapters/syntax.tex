...
this grammar---lexical-functional grammar\index{Lexical-functional grammar} (\Lfg{})---and discussed various
...
counterpart, fulfill the functions of subject\index{subject} (\Subj{}), object\index{object!primary} (\Obj{}),
secondary object\index{object!secondary} (\SObj{}), as well as various oblique\index{oblique} constituents (\Oblique;
see (\ref{ex:dpnpcasemap})). They can also form adjuncts (\Adjc{}), as well as
constitute topic\index{topic} and focus\index{focus} (\Top{}, \Foc{}). Which DP\index{phrase types!determiner phrase} or NP\index{phrase types!noun phrase} receives which
function is controlled by the a-structure of the verb\index{verbs}---this also has
repercussions on case-\index{cases} and topic\index{topic} marking, compare \autoref{subsec:comptr}. Even
though Ayeri is configurational\index{configurationality} and case\index{cases} is in part
assigned on the grounds of constituent structure, semantics also play a part in
case\index{cases} assignment. Taking the opposite perspective, we may also say that case\index{cases}
...
case\index{cases} marking and grammatical functions, which are not always unambiguous. As
explained above (compare \autoref{subsec:case}), the dative case\index{cases!dative} does not only
indicate that something is given to this referent or done to their benefit, but
also indicates motion towards this referent. Likewise, the genitive case\index{cases!genitive} does
not only indicate possession, but also origin, and motion from this referent.
Nominal adjuncts of nouns which specify what the noun consists of appear in the
instrumental case\index{cases!instrumental}, besides the instrumental\index{cases!instrumental} being used to indicate the means or
the circumstance by which an action comes about. Nominals may also lack case\index{cases}
marking, which indicates that the respective phrase is (a part of) the topic\index{topic}
function of the verb\index{verbs}, which is what (\ref{ex:topicrule}) describes.
...
Instead of case\index{cases} marking on the DP\index{phrase types!determiner phrase} or NP, there is a marker before the verb\index{verbs}
which provides information on the case\index{cases} and, if \AgtT{} or \PatT{}, also about
the animacy of the topicalized\index{topic} phrase. Grammatical information about the topic\index{topic}
...
mostly be using the annotation `\pass{\Top}' for topics\index{topic} in the following;
`\elem{\Top}' only finds application with relative clauses\index{relative clause}, since these may
have secondary topics\index{topic} in addition to the relativized NP. Note that otherwise,
only one NP among the arguments of a verb\index{verbs} may be the topic\index{topic} of the clause.
Moreover, a topic\index{topic} can only be marked if the verb\index{verbs} is finite and the number of
case-marked\index{cases} arguments of the verb\index{verbs} is greater than one.
...
number of other free elements, as we have seen previously---adjectives\index{adjectives},
possessive determiners, as well as relative clauses\index{relative clause} and nominal adjuncts. These
typically follow nouns. It was also described before that Ayeri's nouns may
host a number of clitics\index{clitics}, among which are deictic prefixes\index{prefixes!on nouns} and quantifiers\index{quantifiers}, as
well as proclitic\index{clitics} case\index{cases} markers with proper nouns. These clitics\index{clitics}, however, will
...
relationships to the noun: complement (instrumental\index{cases!instrumental} nominal, NP/DP\index{phrase types!determiner phrase}; complement
clause, CP\index{phrase types!complementizer phrase}), and adjunct (adjective\index{adjectives} phrase, AP\index{phrase types!adjective phrase}; relative clause\index{relative clause}, CP\index{phrase types!complementizer phrase};
quantifier\index{quantifiers}, DP\index{phrase types!determiner phrase}). Furthermore, there can be a possessor expressed as a the
...
\begin{enumerate}[noitemsep]
	...
	\item complementary NPs and CPs\index{phrase types!complementizer phrase}
	\item quantifiers\index{quantifiers} and cardinal numerals
	\item possessive genitive NPs and DPs\index{phrase types!determiner phrase}
...
relative clauses\index{relative clause} precede DPs\index{phrase types!determiner phrase} embedding the NP, like possessive NPs and DPs\index{phrase types!determiner phrase}.
...
head, \rayr{limu}{limu} as well as its adjunct adjective\index{adjectives}, \rayr{hiro}{hiro}.
...
Due to Ayeri's consistent use of case\index{cases} marking, I see no problem to invoke a
...
certain number of postpositions\index{postpositions} form an exception to this classification
...
\a Order of noun and genitive\index{cases!genitive}: N Gen
...
\a %
	\begin{minipage}[t]{.5\remaining}
	\begingl
		\glpreamble noun + deictic prefix\index{prefixes!on nouns}: //
		\gla eda- @ nanga //
		\glb eda= nanga //
		\glc this= house //
		\glft `this house' //
...
imply a third-person reference; they distinguish number\index{number}, gender\index{gender} and animacy, as
well as case\index{cases}. Clitics\index{clitics}, however, may also add information about deixis
...
repercussions in the choice of case\index{cases} markers of the agent\index{cases!agent} and patient cases\index{cases!patient},
...
\xayr{gnF}{gan}{child}, is animate, hence the case\index{cases} marker also needs to be 
animate---the case\index{cases} marker must thus be \rayr{/ANF}{-ang} to be coherent. In
contrast to this, example (\ref{ex:animcaseagr}b) is not well-formed in that
the noun is animate but the case\index{cases} marker, \rayr{/reNF}{-reng}, signals that it
...
case-marking\index{cases} proclitic\index{clitics}, as illustrated by (\ref{ex:animcaseagrname}).
...
cases, plural marking\index{plural} on the noun is suppressed by the presence of the modifier
which supplies the information by itself so that further morphological plural\index{plural}
...
there are very limited occasions where a noun may be marked for plurality\index{plural} in
...
Here, the noun \xayr{kejnmF}{keynam}{people} is marked additionally for plural\index{plural}
by the nominal plural\index{plural} suffix \rayr{/ye}{-ye} in spite of being a \fw{plurale
tantum} and in spite of the presence of the numeral\index{numerals} \xayr{menNF}{menang}
{hundred}. Without plural\index{plural} morphology, the meaning of \rayr{kejnmF menNF}{keynam
...
by topicalization\index{topic} and thus also interacts with definiteness (compare
...
deictic/demonstrative prefixes\index{prefixes!on nouns} in Ayeri are clitics\index{clitics}; superficial similarity
between possessive pronouns and adjectives\index{adjectives} has also been noted in
...
`weak' (\Wk) adjective\index{adjectives} declension regularly, since a determiner with strong
...
only be one of them in an NP\index{phrase types!noun phrase}}, at least in English (and German).
...
marker is always present for untopicalized\index{topic} NPs\index{phrase types!noun phrase}, whether a demonstrative clitic\index{clitics}
...
already an inflectional prefix\index{prefixes!on nouns} (\autoref{clitics_prenoun_dem}), that is, they
...
and marks the NP\index{phrase types!noun phrase} simply for agent case\index{cases!agent}, irrespective of other elements.
Characteristically, neither the demonstrative prefixes\index{prefixes!on nouns}, nor the possessive
pronoun/adjective\index{adjectives} in Ayeri mark case, while they do in German. The case marker
...
topicalized\index{topic} and it is required, then, that the verb\index{verbs} mark the topicalized\index{topic} NP's\index{phrase types!noun phrase}
...
distribution with NPs\index{phrase types!noun phrase}. Since they encode morphosyntactic functions rather than
...
a quantifier\index{quantifiers} which  be further specified by an intensifier\index{intensifiers}. \xhead{D} may also
be complemented by an NP\index{phrase types!noun phrase} or another DP, however, since the determiner is a
modifier in this case, the embedded nominal phrase precedes \xhead{D} rather
...
all grammatical categories of nouns\index{nouns}---number\index{number}, gender\index{gender}, animacy, and case\index{cases}; they
agree with their antecedents in number\index{number}, gender\index{gender}, and animacy. In addition to
...
The whole paradigm of possessive prononouns is listed in the genitive\index{cases!genitive} column of
\autoref{tab:perspro}. Possessive pronouns distinguish the same morphological
features as personal pronouns\index{pronouns!personal}: person, number\index{number}, gender\index{gender}, animacy, and
reflexivity. Their case\index{cases} is fixed to gentive, however. Possessors are
...
this appears incorrect in that if they were adjectives\index{adjectives}, they should coordinate
...
\citet{bresnan2016}, \textcquote[100]{bresnan2016}{[s]ubjects and possessors
...
here that possessors are specifiers of NP\index{phrase types!noun phrase}.
...
like adjectives\index{adjectives}, possessive pronouns cannot stand by themselves if treated as
...
such as \fw{mine} or \fw{yours}, except if used as initial predicative
...
is no need to mark them with genitive case\index{cases!genitive} additionally. As
(\ref{ex:nomzposs}) shows, these forms may be case\index{cases} marked---\xayr{d/naa}
{da-nā}{mine} is the nominal corresponding to the topic marker\index{topic} \rayr{le}{le}.
This parallels the use of \rayr{d/}{da-} with adjectives\index{adjectives}, compare
...
Nominalized\index{nominalization} possessive pronouns are anaphora to a third person form, while they
additionally refer to a possessor: \rayr{da/naa}{da-nā} in (\ref{ex:nomzposs})
...
the anaphoric reference is indicated by a $pro$ requiring a genitive\index{cases!genitive} complement
...
inflectable for case\index{cases}. How to represent this in terms of a feature matrix,
though? For one, the adjective loses its ability to carry comparison\index{comparison!of adjectives} morphology
...
explain why the adjective\index{adjectives} forfeits its ability to undergo comparison\index{comparison!of adjectives}:
comparison\index{comparison!of adjectives} is not a morphological operation available to nouns, and the
comparison\index{comparison!of adjectives} morphemes are still loose enough to not jointly undergo derivation
...
\xhead{D}. Since there is no other word material for nominal case\index{cases} marking to
...
gives an example from Warlpiri which contains a noun with double case\index{cases} marking.
...
feature, compare (\ref{ex:warldblcase}). She explains that the stacked case\index{cases}
...
\Loc{} case\index{cases} marking in $g$ that the value of the \Oblq{loc} function is $g$
...
is, $f$) is the value of its \Subj{} function, since ergative case\index{cases} identifies
the NP\index{phrase types!noun phrase} as the subject\index{subject}.
...
is marked for patient case\index{cases!patient}, which identifies it as an object\index{object!primary}. Thus, I propose
...
inflects for case\index{cases}, at least not at a functional level. The case\index{cases} marker just
...
only inflect for case\index{cases} and distinguish animacy in agreement\index{agreement} with their
...
how many} is only used for quantity questions\index{questions!open} and cannot combine with
adjectives\index{adjectives} either. Instead, questions\index{questions!open} like `how large' or `how common' must be
phrased using (generic) nouns; see (\ref{ex:hownoun}). What the question word\index{pronouns!interrogative}
queries for is both the implied object\index{object!primary} of the question and also new
information. That is, what it asks for is the sentence's focus\index{focus} (compare
...
further down the tree. The annotation basically says that XP is the focus\index{focus} of
...
Ayeri does not front interrogative pronouns\index{pronouns!interrogative} like English does, the functional
...
pronoun is marked for case\index{cases}, and thus also encodes animacy for agents and
...
we are asking for the subject\index{subject}/agent in this case, not for the object\index{object!primary}/patient as
...
encode person and number\index{number}, though at least \rayr{sinY}{sinya} inflects for case\index{cases}
...
described in \autoref{subsec:interpro}. If case\index{cases} is not specified, the correct
...
\footnote{I could not find any information about how to analyze \fw{which} and
...
feature here, I am simply connecting the focus\index{focus} NP\index{phrase types!noun phrase} with the \Q{} attribute to
mark that the clause is supposed to be a question\index{questions!open}. The problem then is,
...
various oblique\index{oblique} arguments (\Possr, \Oblq{loc}, \Oblq{ins}, \Oblq{caus}).
...
\xayr{rnY}{ranya} {nobody/\mbox{-thing}} can be declined for all cases\index{cases}, while
...
with the respective marking on the verb\index{verbs} with which the subject\index{subject} NP\index{phrase types!noun phrase} proper
...
decline for case\index{cases}, and thus also for animacy with agent and patient antecedents;
...
declines for case\index{cases}, so number\index{number} and gender\index{gender} do not have to be accounted for. Thus,
...
It is notable that \rayr{sitnY}{sitanya} cannot appear in agent case\index{cases!agent}, since
...
In (\ref{ex:eachotheravm}), the two coordinated subject\index{subject} NPs\index{phrase types!noun phrase} do not share the
...
number\index{number} is resolved to plural\index{plural} from two singular entities being combined.
...
not distinguish gender in plural\index{plural}, so both `John' and `Mary' in
...
pronouns\index{pronouns!personal} distinguish gender in the plural\index{plural} as well as in the singular, however,
...
agreement, it is to be expected that the person features of whatever the verb\index{verbs}
...
masculine, though not in all cases\index{cases}. The rules which operate are the following:
...
least ambiguously marks plural\index{plural}. Both strategies are described as a general
tendency in gender resolution \citep[205]{corbett1983}. Since there is almost
no syncretism in Ayeri's third-person plural\index{plural} pronouns which would render
...
\TplF{}.\Gen{} and \TplI{}.\Gen{}. They all unambiguously indicate plural\index{plural}.}
...
While coordinated NPs\index{phrase types!noun phrase} may be a very obvious case in which resolution occurs,
...
\fw{committee} may trigger both singular and plural\index{plural} forms in agreement, with
American English preferring singular agreement (\fw{the committee \textbf{has}
decided}), British English preferring plural\index{plural} agreement (\fw{the committee
...
hierarchy, especially so for personal pronouns\index{pronouns!personal}, which we have discussed in this
...
subject\index{subject} pronoun \xayr{tNF}{tang}{they} as well as the pronominal suffix of the
verb \xayr{gireMdFtNF}{girendtang}{they arrive}---switch to animate masculine
plural\index{plural}; semantic agreement has been triggered, and gender\index{gender} and number resolution\index{resolution!gender}\index{resolution!number}
thus occur. The pronoun of choice is masculine, since this is the default
gender\index{gender} for mixed-gender\index{gender} groups of living beings, and plural\index{plural}, since
...
quantifiers were adjectives\index{adjectives}, they would also have to coordinate with them.
...
account is that nouns modified by quantifiers do not additionally mark plural\index{plural},
...
adjectives\index{adjectives}, they have been analyzed here as adjuncts of NP\index{phrase types!noun phrase}, since modifiers of
...
being a co-head of \xhead{N}, both adjectives\index{adjectives} pertaining to \xhead{N} and
adverbs\index{adverbs} pertaining to \xhead{D} would write into the \Adjc{} list of the
...
in the plural\index{plural}, and demonstrative pronouns\index{pronouns!demonstrative}. A clitic\index{clitics} quantifier can also still
...
The relativizer\index{pronouns!relative} \rayr{si}{si} and its forms inflected for agreement\index{agreement} cannot be
...
relative-clause internal case\index{cases}, however, may be modified by a quantifier:
...
pronoun carrying the quantifier may occur in the relative clause\index{relative clause}.
...
For nominal clitics, we have already seen how preposed case\index{cases} markers work; some
...
if no overt case\index{cases} marker is present and follows them if there is. At least in
...
In cases like (\ref{ex:likeavmpropercase}), if there are adjectives\index{adjectives} following
the noun, the clitic actually follows the whole NP\index{phrase types!noun phrase} like the \fw{'s} possessive
...
Adjectives\index{adjectives} and adverbs\index{adverbs} in Ayeri are largely similar in that they can both be
...
As described in the previous section, APs usually constitute adjuncts of NPs\index{phrase types!noun phrase} or
...
predicative complements (\Plink{}) in copula clauses\index{copula clause}, compare
...
\a\label{ex:adjmod_adv}%
	\begin{minipage}[t]{.5\remaining}%
	\begingl
		\glpreamble adjective + AdvP\index{phrase types!adverb phrase} adjunct: //
...
(\ref{ex:adjmod_dp}) we can see Ayeri's propensity for using cases\index{cases} with
...
the genitive case\index{cases!genitive}: the NP\index{phrase types!noun phrase} complement expresses an oblique\index{oblique} theme about which the
experiencing subject\index{subject} becomes happy. This, however, should not be conflated with
a possessor, \Possr{}, but should be labeled separately as an oblique\index{oblique}
complement, \Oblq{theme}. Similarly, the recipient of the subject's\index{subject} happiness
appears as an NP\index{phrase types!noun phrase} complement in the (ethical) dative\index{cases!dative} in (\ref{ex:adjmod_dp}).
Instrumental\index{cases!instrumental} and causative\index{cases!causative} NP\index{phrase types!noun phrase} complements instead of PPs\index{phrase types!prepositional phrase} may be found as well
...
adjectives are adverbs\index{adverbs}, so they should find themselves in \Adjc{}. An example
...
With regards to complements and adjuncts to NP\index{phrase types!noun phrase}, \citet{carnie2013} explains,
...
Further complications arise with regards to complementation in that non-clitic\index{clitics}
...
not possible here, since CPs\index{phrase types!complementizer phrase} cannot be marked for case\index{cases}.
...
morphological means of comparison\index{comparison!of adjectives} or negation\index{negation!of adjectives}. This is reflected in the
...
comparison\index{comparison!of adjectives} and polarity, and are morphologically unmarked in these cases.
\Degdim{} also does not play a role here, since there are only clitics\index{clitics} for
positive comparison\index{comparison!of adjectives}, and negative comparison\index{comparison!of adjectives} is achieved by negating the
...
for synthetic comparison\index{comparison!of adjectives} of adjectives are grammaticalized clitics\index{clitics} literally
...
\fw{-ly} or French \fw{-ment}. Since adverbs and adjectives\index{adjectives} are functionally
...
attributive adverbs take in Ayeri is comparison\index{comparison!of adverbs} morphology and negation\index{negation!of adverbs}. This
...
adverbs may modify any other lexical category: verbs\index{verbs}, adjectives\index{adjectives}, prepositions\index{prepositions},
...
\Lfg{}\index{Lexical-functional grammar} categorizes the object\index{object!primary} of an adposition as an oblique\index{oblique} argument 
...
adpositions in Ayeri usually allow adpositional objects\index{object!primary} to be either marked for
locative\index{cases!locative} or dative case\index{cases!dative}:

\begin{description}
	\item[Locative:] Standard case\index{cases} for adpositional objects\index{object!primary}, indicates a
	location (\textsc{location}). It usually corresponds to English `at', `in'.
	It is also used for the goal (\textsc{goal}) of verbs\index{verbs} of motion when they
	...
	corresponds to English `to', `for'. NPs\index{phrase types!noun phrase} may be marked with dative case\index{cases!dative}
	...
	(\textsc{source}). NPs\index{phrase types!noun phrase} may be marked with genitive case\index{cases!genitive} freely to indicate
	direction without being goverened by an adposition. Genitive case\index{cases!genitive} usually
	corresponds to English `from' or `of' in those cases\index{cases}. Genitive case\index{cases!genitive} also
...
Where English uses a preposition together with the verb\index{verbs} to mark an oblique\index{oblique}
argument, Ayeri usually uses case\index{cases}. The case\index{cases}
for English is illustrated by (\ref{ex:talkcstruct}). Ayeri, in contrast to
English, often uses an NP\index{phrase types!noun phrase} complement marked with one of the cases\index{cases} in the list
above, compare (\ref{ex:naracstruct}). In the case of \xayr{nr/}{nara-}{speak,
talk}, the complement appears in the locative case\index{cases!locative}, but as an NP\index{phrase types!noun phrase}, not as a PP.
Thus, there is no \PCase{} attribute necessary here, since there is no
preposition to indicate the relation of the complement to the verb\index{verbs} because case\index{cases}
marking accomplishes this function.

Which oblique\index{oblique} case\index{cases} the complement appears in is determined by the a-structure
of the verb\index{verbs}, not by the semantics of the complement (compare 
\autoref{subsec:comptr}). Since the dative\index{cases!dative} is also used for the
\textsc{beneficiary} role, the argument expressing the direction of the talking
appears exceptionally in the locative\index{cases!locative} here. In (\ref{ex:naracstruct}) it may
...
case\index{cases} markers are proclitics\index{clitics} (see \autoref{clitics_prenoun_case}, 
p.~\pageref{clitics_prenoun_case}). \rayr{y}{ya} is a case\index{cases} marker, not a
preposition; `at/to Pila' is thus \rayr{y pil}{ya Pila}, not *\rayr{y pily}{*ya
Pilaya} with additional locative\index{cases!locative} marking on the noun.
...
In Ayeri, PPs proper may either be locative\index{cases!locative} complements of the verb\index{verbs} as in
...
to case\index{cases} marking, as described above. As mentioned initially, Ayeri possesses
prepositions as well as postpositions\index{postpositions}. With regards to word order typology, we
can thus note:
...
The fact that Ayeri has both prepositions and postpositions\index{postpositions} is also reflected
...
postposition\index{postpositions} \xayr{pesnF}{pesan}{until} may also have a CP\index{phrase types!complementizer phrase} complement, that is,
a whole complement clause\index{complement clause}. The nominal complements are objects\index{object!primary} governed by the
adposition.
...
respective PP is thus part of the set of adjuncts. Some verbs\index{verbs}, like
...
as \Oblique{}\index{oblique} with $\theta$ replaced by the proper semantic macrorole
...
postposition\index{postpositions} is meaningless, so the morpholexical definitions in
(\ref{ex:adpmorphlex}) do not distinguish formally between pre- and
postpositions\index{postpositions}. As described in \autoref{clitics_prep_dyn}
...
adpositional object's\index{object!primary} case\index{cases} in (\ref{ex:adpmorphlex_1}) excludes
\rayr{liNF}{ling} and \rayr{AvnF}{avan}, which require special treatment with
regards to case\index{cases} marking, as described below.
...
German, for one, encodes the difference between locational and directional uses
of a group of prepositions as well, but by an alternation in the prepositional
object's case\index{cases} between \Dat{} (locational) and \Acc{} (directional). Thus,
...
a requirement that its case\index{cases} be either \Acc{} or \Dat{}, respectively.
Since nouns in German always carry case\index{cases}, the \PSem{} attribute needs to be
...
marking also does not influence the case\index{cases} of the adpositional object\index{object!primary}.
...
predicated by the adposition to $dir$ and the \PCase{} feature to \Oblq{goal},
as illustrated in (\ref{ex:mangaaltern_marked}). This is how the difference
between locational `in' and directioanl `into' is represented here. The case\index{cases} of
the prepositional object\index{object!primary} is \Loc{} in both versions of the sentence.
...
bottom of} there is another alternation, based on case\index{cases}, for verbs\index{verbs} which do not
...
object\index{object!primary}. However, Ayeri does not possess separate adpositions to express `up'
...
and `down' with dative\index{cases!dative} complements, respectively, to mark the difference,
...
As we can see from these examples, there is an alternation in case\index{cases} similar to
...
context, and an accompanying rule which determines the case\index{cases} of the complement
...
prepositional object\index{object!primary} is to be put in the dative case\index{cases!dative}.
...
opposite way in mostly using case\index{cases} for marking verbal complements, and having
...
\xayr{AgonnF}{agonan}{outside of}, however, the topic marker\index{topic} at the beginning
of the clause shows that there is a corresponding dative\index{cases!dative} NP\index{phrase types!noun phrase}. Strictly speaking,
...
around, or with \rayr{mN}{manga} becoming zero, since the cases\index{cases} are already
...
Since with prepositions the adverb\index{adverbs} comes after the nominal complement as in
...
the adpositional phrase or as an adjective\index{adjectives} modifying the prepositional object\index{object!primary}.
...
statement in which a property is attributed to a subject\index{subject} in the fashion of 
(\ref{ex:engeqstmt}).
...
subject\index{subject} and quality are simply juxtaposed, as (\ref{ex:ayreqstmt}) illustrates.
...
Regarding predicative adjectives\index{adjectives}, Ayeri permits them to either follow or to
precede the subject\index{subject} NP\index{phrase types!noun phrase} with proper names, as in (\ref{ex:ayreqstmt_1}) and (b),
respectively. With common nouns, however, there is a preference for the pattern
in (\ref{ex:ayreqstmt_2}) since this makes it unambiguous that the adjective\index{adjectives} is
a predicate rather than attributive of the noun it refers to. Furthermore,
Ayeri marks predicative NPs\index{phrase types!noun phrase} with the patient case\index{cases!patient} as a further quirk, as shown
...
copula, presence vs.\ absence of agreement\index{agreement} features on the predicate are all
...
variation to create a generalized way of describing copula clauses\index{copula clause}
independent of how individual languages deal with them. \citet{attia2008}, in
reference to \citet{dalrymple2004}, describes the structure of a copula clause\index{copula clause}
...
copula clause\index{copula clause} in (\ref{ex:copcompl}).
...
Another question related to copula clauses\index{copula clause} is how to treat adverbs\index{adverbs}, since there
...
after verbs like adverbs\index{adverbs}, and may also appear between the two parts of a copula
clause\index{copula clause}. This means that we will have to test whether they are copulaic elements
...
subject\index{subject} and the predicate of a simple copula clause\index{copula clause} to be reversed, for
instance, for contrastive focus\index{focus}, as in (\ref{ex:copnoemph_2}). The predicate
...
of linking subject\index{subject} and predicate, so (\ref{ex:copemph_2}) is nonsensical.
...
proclitic\index{clitics} in the context of copula clauses\index{copula clause}. The same applies, \fw{mutatis
...
adverb\index{adverbs} usually appears between the subject\index{subject} and the predicative NP\index{phrase types!noun phrase}, as
...
Since copula clauses\index{copula clause} form a small clause constituent, S may govern more than
two elements. Case\index{cases} marking ensures that the different phrases map on their
...
Copula clauses\index{copula clause} are probably the most basic kind of sentence possible to form in
...
contains the subject\index{subject} and a headless VP\index{phrase types!verb phrase} which in turn carries the verb's
objects\index{object!primary}; compare \autoref{subsec:eqs} for a discussion of S\index{phrase types!small clause}. The phrase
...
In (\ref{ex:ippstruct}a), we can see that the first node branching off IP on
...
The subject\index{subject} NP\index{phrase types!noun phrase} is instead treated as a daughter of S\index{phrase types!small clause}. As we will see, not only
adverb\index{adverbs} phrases (AdvP),\index{phrase types!adverb phrase} but also adjective\index{adjectives} phrases (AP)\index{phrase types!adjective phrase}, and even noun phrases
(NP\index{phrase types!noun phrase}) may serve as adjuncts of the verb. As discussed previously, Ayeri
generally places modifiers right after the head, before complements. This means
that here as well, when adjuncts are involved, S\index{phrase types!small clause} actually shifts to the right
...
Furthermore, it marks a range of grammatical aspects\index{aspect}, that is, progressive\index{aspect!progressive},
habitual\index{aspect!habitual}, and iterative\index{aspect!iterative} aspect\index{aspect} (\autoref{subsec:aspect}), as well as various
moods, namely, irrealis\index{mood!irrealis}, negative, imperative\index{mood!imperative}, and hortative mood\index{mood!hortative}
...
transitive\index{verbs!transitive} finite verbs\index{verbs!finite} are obligatorily marked for the case\index{cases} and animacy of the
clause's topic\index{topic}. Ayeri's system of verb agreement\index{agreement} moreover alternates between
...
\ref{subsec:persnumagr}). Absence of tense, mood\index{mood}, and aspect\index{aspect} marking specifies
that the verb is in the contextually appropriate tense (compare
\autoref{subsec:tense}), indicative mood\index{mood!indicative}, and simple aspect\index{aspect}.
...
of \xhead{I}, functioning as an \XCompl{}. This VP\index{phrase types!verb phrase} exists for the purpose of
...
Welsh does according to existing analyses in the \Lfg{}\index{Lexical-functional grammar} framework, compare
(\ref{ex:welshcstruct2}). According to \citet[130]{bresnan2016}, S\index{phrase types!small clause} is chosen as
a governing category for the subject\index{subject} NP\index{phrase types!noun phrase} and VP\index{phrase types!verb phrase}, since in place of VP\index{phrase types!verb phrase}, one may
...
full NP\index{phrase types!noun phrase} (then the subject\index{subject} NP\index{phrase types!noun phrase} will take this place) or with transitive verbs\index{verbs!transitive} if
...
\citet{bresnan2016} note that in Welsh, the VP\index{phrase types!verb phrase} in S\index{phrase types!small clause} may be fronted as a unit.
%, as in (\ref{ex:welshvpfr}).
Fronting things this way is not possible in Ayeri, however, it is possible to
reverse the order of the subject\index{subject} and its complement, for instance, when a
relative clause\index{relative clause} modifies the subject\index{subject}, as in (\ref{ex:ayrsinv}). Here, the
subject\index{subject}, \rayr{runj si petigojnNF tml}{runay si petigoynang tamala} follows the
object\index{object!primary} \rayr{Agu\_asF}{aguas}.
...
As previously mentioned, the adverb\index{adverbs} `usurps' the structural position of the
...
adverb\index{adverbs} to be interpreted as an adjective\index{adjectives} modifying \rayr{ANF AmaanF}{ang Amān},
since adverbs\index{adverbs} and adjectives\index{adjectives} are not strictly distinguished by means of
...
\Adjc{} function at clause level in the way regular adverbs\index{adverbs} do 
(\ref{ex:verbintfstr}).
...
clause's topic by a clitic\index{clitics} corresponding to the NP's\index{phrase types!noun phrase} case\index{cases} marker in its clitic\index{clitics}
form (see \autoref{subsec:case}). Topic marking on the verb works in tandem
with case\index{cases} marking on the marked-for noun phrase, which receives zero-marking
for case\index{cases}, compare (\ref{ex:topmkg}).\footnote{Topic marking on the verb is
essentially \textcquote[20]{corbett2006}{displaced information}, since the
morphological category encoded by topic marking---case\index{cases}---is not a category of
the verb, so one may want to treat it as a kind of agreement\index{agreement} relationship where
the verb agrees in case\index{cases} with the topicalized NP\index{phrase types!noun phrase}. Thus, on morphological
...
(\Aarg{}), topic can be marked. This is because the causative\index{cases!causative} NP\index{phrase types!noun phrase}, even though
...
occurs in the VP\index{phrase types!verb phrase} complement after the subject\index{subject} NP\index{phrase types!noun phrase}. Raising\index{verbs!raising} is required to make
an embedded argument part of the matrix verb's argument structure. However, as
described in \autoref{subsec:raising}, only to-subject\index{subject} raising\index{verbs!raising} is permitted in
Ayeri.
...
\rayr{ANF}{ang} in (\ref{ex:topmkg_dp})---provides information about the case\index{cases}
of the topicalized NP\index{phrase types!noun phrase} and thus signals which argument of the verb is the topic
as shown in (\ref{ex:topmorphlex}). Unmarkedness for case\index{cases} of a nominal head
...
embedded NP\index{phrase types!noun phrase} marked for genitive case\index{cases!genitive}. Presumably, we want instrumental\index{cases!instrumental}
...
case\index{cases} marking: instrumental\index{cases!instrumental} instead of genitive\index{cases!genitive}. An example is given in
(\ref{ex:transnoun}).
...
NPs\index{phrase types!noun phrase} with a genitive\index{cases!genitive} attribute and with a nominal complement, respectively, have
...
the verb. In (\ref{ex:npembedfull}), the object\index{object!primary} NP\index{phrase types!noun phrase} has been topicalized and
...
have person agreement\index{agreement} and also do not regularly mark topic\index{topic}, except for emphatic
imperatives. They imply a second person singular or plural\index{plural} subject\index{subject} (number\index{number} is
...
do occur, namely, in clausal complements\index{complement clause} from which a subject\index{subject} has been raised\index{verbs!raising}
or in which a subject\index{subject} or object\index{object!primary} slot is controlled from without\index{verbs!control}. It is also the
verb phrase which carries the arguments subcategorized for by the verb apart
from the subject\index{subject} in transitive\index{verbs!transitive} clauses. Here as well, if there is an adverbial
modifier in the VP, it follows the head, and \xhead{V}'s complement and other
...
be negated. However, they do not mark person and topic\index{topic}, and they do not encode
a subject\index{subject} by inflection or clitics\index{clitics} either. \rayr{IlF/IlFymF} {il-ilyam} in
(\ref{ex:vpsent_2}) rather receives its subject\index{subject} from the matrix verb,
\xayr{shyNF}{sahayang}{I went}; the example is thus an instance of subject\index{subject}
...
verb. For simplicity, all examples have agent topics\index{topic} where it is relevant, and
...
for instance, Ayeri uses the dative case\index{cases!dative} to mark recipients. However, different
...
(\ref{ex:doubleobj}) illustrates such a double-object\index{object!primary} construction.
...
In (\ref{ex:doubleobj}), the object\index{object!primary}/recipient is \rayr{diy}{Diya}, and the
secondary object\index{object!secondary}/theme is \rayr{koyaasF}{koyās}. Functionally, the verb
subcategorizes three arguments: a subject\index{subject}, an object\index{object!primary}, and a secondary object\index{object!secondary},
where the object\index{object!primary} expresses the recipient and the secondary object\index{object!secondary} expresses the
...
Ayeri maps case\index{cases} to the complements of ditransitive verbs in relation to
transitive verbs\index{verbs!transitive}: the same case\index{cases} which marks the patients (P) of monotransitive
verbs\index{verbs!intransitive} marks the theme (T) of a ditransitive verb (P\,=\,T). Furthermore,
another case\index{cases} is used to mark the donor (D) of ditransitive verbs, the agent of
monotransitive verbs\index{verbs!intransitive} (A), and the subject\index{subject} (S) of intransitive verbs\index{verbs!intransitive} in
canonical cases\index{cases} (S\,=\,A\,=\,D). The recipient (R) receives extra marking.
...
is not possible to have multiple recipient NPs\index{phrase types!noun phrase} (unless one coordinates them
with \xayr{nj}{nay}{and}), just as it is not possible to have multiple patients
with transitive verbs\index{verbs!transitive}. Furthermore, it is not possible to link either the theme
...
dependent on the superordinate verb for the subject\index{subject} function: control verbs
share their semantic subject\index{subject} or object\index{object!primary} with the semantic subject\index{subject} of a
...
\xayr{Ep/}{epa-}{refuse},
\xayr{liMk/}{linka-}{try},
\xayr{no/}{no-}{plan},\footnote{This is the same stem as the modal\index{modals} particle 
\rayr{no}{no}, but as the related content verb.}
\xayr{pebuk/}{pebuka-}{promise},
\xayr{sr/}{sara-}{go}, and
\xayr{vtYF/}{vac-}{like},\footnote{This verb also exists as a modal\index{modals} particle
...
Topicalization\index{topic} of NPs\index{phrase types!noun phrase} in subordinate VPs by matrix verbs is not possible in
...
(\ref{ex:ctrlstruct}ab) cannot be the topic\index{topic} of the verb in the respective
matrix clauses, \xayr{liMky}{linkaya}{(he) tries} and
\xayr{nelFye}{nelye}{(she) helps}. Since topicalization\index{topic} does not apply to
non-finite verbs\index{verbs!non-finite}, the subordinate verb in both sentences,
\xayr{sidegYmF}{sidejam}{repairing}, cannot be marked for topic\index{topic} within its own
...
complement of \xhead{I} in order to be able to topicalize\index{topic} NPs\index{phrase types!noun phrase} subcategorized by
...
the raising\index{verbs!raising} of a subordinate verb. The topic\index{topic} particle, as usual, appears as a
proclitic\index{clitics} before the verb, which here encodes an inanimate patient topic\index{topic},
...
to use inside-out functional uncertainty and annotate the topicalized\index{topic} NP\index{phrase types!noun phrase} with
...
subject\index{subject} is shared with the subject\index{subject} or the object\index{object!primary} of the matrix verb. They as
...
syntactic subject\index{subject} of the matrix verb is not semantically an argument of it, but
of the subordinate verb. The subject\index{subject} of the matrix verb may thus also be a
...
express causative relationships by case\index{cases} marking, though (see
...
take an object\index{object!primary} and a verbal complement, but whose syntactic object\index{object!primary} is the
semantic subject\index{subject} of the subordinate verb. Ayeri, however, lacks the
raising-to-object\index{object!primary} mechanism and instead requires a complement clause\index{complement clause}.
...
subjects\index{subject} and objects\index{object!primary} as arguments, the verbs in (\ref{ex:raisestruct}) do not.
Instead, (\ref{ex:raisestruct_1}) defines only an \XCompl{} as an argument, and
its \Subj{} is defined as an athematic subject\index{subject} \citep[304--308]{bresnan2016}.
...
well, the object\index{object!primary} is not strictly an argument of the matrix verb. In the
...
While \fw{help} subcategorizes for a thematic object\index{object!primary}, \fw{believe} does not.
Its syntactic object\index{object!primary} is not actually its semantic object\index{object!primary} here: the status of
...
thematic object\index{object!primary} with the subject\index{subject} of a subordinate verb, in spite of
discrepancies in case\index{cases} marking between agent\index{cases!agent} and patient. On the other hand, an
athematic object\index{object!primary} cannot be unified with the subject\index{subject} of a subordinate verb.
...
Hence, Ayeri allows \xayr{nelF/}{nel-}{help} to be an object\index{object!primary}-control verb\index{verbs!control}, but
it does not allow \xayr{pronF/}{paron-}{believe} to be a raising-to-object\index{object!primary}
verb. Note again, however, that even raising-to-subject\index{subject} is only common in Ayeri
...
exception of \rayr{surFpF/}{surp-}. Instead of an \XCompl{} and an athematic
...
Just as with control verbs\index{verbs!control}, it is possible to front the subordinate verb,
...
well, it is possible to topicalize\index{topic} arguments of the subordinate verb, the
...
\pass{\XCompl}, and the topicalized\index{topic} NP\index{phrase types!noun phrase} has to be marked with
\uncertain{\XCompl}{\Top}~=~↓ in accordance with the position of the topic\index{topic}
marker as adjoined to the left edge of the matrix verb's f-structure. Again,
the subordinate verb is non-finite\index{verbs!non-finite} and thus cannot carry topic\index{topic} marking.
...
daughter of the VP sister of the subject\index{subject} NP\index{phrase types!noun phrase}, \rayr{ANF AgYaanF}{ang Ajān}. This
VP, in turn, has an NP\index{phrase types!noun phrase} complement carrying the object\index{object!primary} of the subordinate verb,
\xayr{UmNF}{umang}{beach}. The subordinate VP is discontinuous here as well, so
both parts are marked \XCompl{}. The subordinate verb's object\index{object!primary} is also the
topic\index{topic} which the matrix verb is marked for by \rayr{le}{le}. In order to place
...
subject\index{subject} pronouns which are realized as pronominal clitics\index{clitics}, compare 
\autoref{subsec:reflrec} and \autoref{subsec:quantfloat}. The quantifier\index{quantifiers} cannot
follow the pronominal clitic\index{clitics} directly due to the double function of many
...
pronouns\index{pronouns!personal} of persons other than the third. Thus, \rayr{sitNF}{sitang} is used in
...
something to lean on which is not the verb or an adverb\index{adverbs}.
...
declined either, all person features rest in the pronominal clitic\index{clitics}, \xayr{/nNF}
{nang}{we}. Distributed exponence maps both the pronominal clitic's\index{clitics} semantic
content and that of the subject\index{subject} DP\index{phrase types!determiner phrase}, \rayr{sitNF/IknF}{sitang-ikan}, onto the
\Subj{} function in the partial f-structure diagram. The only lexical content
which the subject\index{subject} DP\index{phrase types!determiner phrase} contains is that of the quantifier\index{quantifiers} clitic\index{clitics},
...
scattered over \xhead{I} and the subject\index{subject} DP\index{phrase types!determiner phrase}.

Going by classic, structuralist binding theory, \rayr{sitNF}{sitang} should be
able to bind the subject\index{subject} clitic\index{clitics} because \rayr{tYaanFnNF}{cānnang} as a unit
c-commands \rayr{sitNF/IknF}{sitang-ikan}, among others. In terms of \Lfg{}'s\index{Lexical-functional grammar}
functionally oriented binding theory, both the subject\index{subject} pronoun and
...
comparison\index{comparison!of adjectives} verbs \xayr{km/}{kama-}{be as} \xayr{ENF/}{eng-}{be more} and
\xayr{v/}{va-}{be most}. Obviously, the comparison\index{comparison!of adjectives} verbs are related to the
...
\xayr{v/}{va-}{be most} + \rayr{/ArY}{-arya} (categorial negation\index{negation!of verbs}).} but that
...
subject\index{subject} pronoun: \xayr{yomreNF}{yomareng}{there is/are}, which is a set
expression---literally, `it exists'. That is, \rayr{yomreNF}{yomareng} is even
used with plural\index{plural} complements, and can be inflected for the usual morphological
features of verbs, as shown in (\ref{ex:yomareng}), where the verb carries
negation\index{negation!of verbs}. Apart from this, \rayr{yom/}{yoma-} is usually used with locations,
that is, it frequently comes with a locative\index{cases!locative} complement to express that someone
...
(\ref{ex:yomaplace}). The copula-clause\index{copula clause} strategy comes at the slight
...
An alternative to the comparison\index{comparison!of adjectives} strategy by enclitics\index{clitics} is to use a verb of
comparison\index{comparison!of adjectives} as listed initially. Ayeri behaves differently in this from what
...
standard NP\index{phrase types!noun phrase} is constructed as the direct object\index{object!primary} of a transitive verb\index{verbs!transitive} with the
...
a modifier, essentially in the way of an adverb\index{adverbs}. Nonetheless, the subject\index{subject} forms
the comparee, and the object\index{object!primary} the standard. An example is given in
...
The way \Lfg{}\index{Lexical-functional grammar} handles comparison\index{comparison!of adjectives} of adjectives\index{adjectives} in predicative contexts is
sketched out in \citet[122]{butt1999}, see (\ref{ex:lfgpredcomp}). As expected,
the predicative complement is contained within a \Plink{} function. Comparison\index{comparison!of adjectives}
...
the standard of comparison\index{comparison!of adjectives}.
...
the way of an adverb\index{adverbs}, Ayeri actually generalized the way subordinate verbs can
be fronted, treating the adjective\index{adjectives} in the way of a verbal complement of
\xhead{I}? This hypothesis neatly coincides with Ayeri's strategy of fronting
subordinate verbs in order to enable topicalization\index{topic} of their dependents by
...
annotations for all comparative verbs, \xayr{km/}{kama-}{be as},
...
information on the comparison\index{comparison!of adjectives} status of the predicative complement as well as
...
in parallel to (\ref{ex:ctrlinc}), even though the subject\index{subject} of the comparative
...
of the adjective\index{adjectives} is generated in its canonical position as a daughter of the AP\index{phrase types!adjective phrase}
...
leads to ambiguity in that an adjective\index{adjectives}, then, directly follows a noun, so
...
allows for \xhead{A} to be fronted if it does not modify a predicative nominal.
The sentence in (\ref{ex:comppredn_1}) is thus ungrammatical because the
adjective\index{adjectives}, \xayr{bnF}{ban}{good}, modifies a predicative noun,
\xayr{kromyaasF}{karomayās}{doctor}. Since the adjective\index{adjectives} itself has a
complement, \rayr{s hiro}{sa Hiro}, there are two patient arguments following
each other, which is not permissible. Example (\ref{ex:comppredn_2}), on the
other hand, shows the grammatical solution with the relative clause\index{relative clause}. Here, the
term under comparison\index{comparison!of adjectives}, being a \xayr{kromyaasF}{karomayās}{doctor}, is
constructed as a copula clause\index{copula clause} while the comparison\index{comparison!of adjectives} in quality between
...
predicative adjectives\index{adjectives} and nominals over the subject\index{subject} in order to illustrate a
...
possible to interpret the adjective\index{adjectives} as referring to Jack, but let us assume
...
(\ref{ex:engsecpred2_obj}) does not refer to the state of the subject\index{subject} or the
object\index{object!primary} at the moment of wiping, but the state of the table as a result of being
wiped.

Unfortunately, \citet[347]{bresnan2016}, while mentioning resultatives, do not
go into detail about an \Lfg{}\index{Lexical-functional grammar} analysis of them, and do not say anything at all
about depictives. While they give a few references about \Lfg{}-based\index{Lexical-functional grammar} surveys
of resultatives in English, a cursory web search does not bring up papers on
depictive predicates in terms of \Lfg{}\index{Lexical-functional grammar}. One has to assume that this topic
...
resultatives. As far as \Lfg{}\index{Lexical-functional grammar} analyses of resultatives go, \citet{simpson1983}
...
English examples of depictive adjectives\index{adjectives} were given in (\ref{ex:engsecpred}ab).
...
\citet{mueller2002}'s analysis, \textcquote[196]{mueller2002}{the subject\index{subject} of
...
lexical rule that recategorizes predicative adjectives\index{adjectives} and prepositions\index{prepositions} so that
they can modify verbal elements} as a way to
\textcquote[196]{mueller2002}{capture the adjunct properties of depictive
...
verb. The anaphoric relationship between \Subj{} and the adjective\index{adjectives} is expressed
...
In Ayeri, the depictive adjective\index{adjectives}, whether it refers to the subject\index{subject} or the
object\index{object!primary}, follows the verb. This nicely fits the analysis fashioned after
...
distinction between adjectives\index{adjectives} and adverbs\index{adverbs}, but context should clarify under
normal circumstances. An example of depictive secondary predicates in Ayeri is
given in (\ref{ex:depict}). In (\ref{ex:depict_subj}), there is only a subject\index{subject},
\rayr{gd}{Gada} to be described by the adjective\index{adjectives}, \xayr{pisu}{pisu}{tired}. In
(\ref{ex:depict_obj}), the adjective\index{adjectives}, \xayr{tuvo}{tuvo}{red} (here in the
meaning `raw') can describe either the subject\index{subject} or the object\index{object!primary}, but semantically,
it makes most sense for it to refer to the object\index{object!primary}, \xayr{InunF}{inun}{fish}. It
may be noted again here that topicalization\index{topic} has no impact on the argument of
...
does not assign case\index{cases} to these NPs\index{phrase types!noun phrase}.\footnote{One might be tempted to analyze
\rayr{ku/}{ku-} as a case\index{cases} marker used for essive and equative functions.
NPs\index{phrase types!noun phrase} marked with \rayr{ku/}{ku-} may be regularly case-marked\index{cases} in other contexts,
though, and Ayeri does not make use of multiple case\index{cases} marking or
...
distribution of \rayr{ku/}{ku-} is thus different from that of typical case\index{cases}
...
objects\index{object!primary}, whether they are surface objects\index{object!primary} or `underlying objects\index{object!primary}' (like the
subjects\index{subject} of passives\index{passive voice} or of verbs like \fw{shatter} when used intransitively).
...
subcategorization frame whose subject\index{subject} is the verb's logical object\index{object!primary}. This
observation is squared with the argument structure of verbs in terms of the
semantic role of the subject\index{subject} function: according to \citet{perlmutter1978},
intransitive verbs\index{verbs!intransitive} can be grouped into unergative and unaccusative depending on
whether their syntactic subject\index{subject} is also their logical subject\index{subject}, or their logical
object\index{object!primary}, compare (\ref{ex:verbtyp}).\footnote{The terms \citet{perlmutter1978}
...
prepositions\index{prepositions} as constituent parts of verbs such as \fw{knock out}, \fw{lock
...
complementing the object\index{object!primary} of a transitive verb\index{verbs!transitive} to express a result is given in
...
(\ref{ex:restrns_np}) we can see another use of the dative\index{cases!dative}, that is, to mark
resultative NPs\index{phrase types!noun phrase}. A verb may thus occur exceptionally with more than one
complement in the dative case\index{cases!dative}. However, different from a regular recipient or
a goal NP\index{phrase types!noun phrase}, a resultative dative\index{cases!dative} NP\index{phrase types!noun phrase} also normally occurs after the verb.

\begin{figure}
\pex\label{ex:restrns}
\a\label{ex:restrns_ap}%
	\begingl
		\glpreamble object\index{object!primary} NP\index{phrase types!noun phrase} + resultative AP\index{phrase types!adjective phrase}: //
...
\a\label{ex:restrns_np}%
	\begingl
		\glpreamble object\index{object!primary} NP\index{phrase types!noun phrase} + resultative NP\index{phrase types!noun phrase}: //
...
\a\label{ex:restrns_pp1}%
	\begingl
		\glpreamble object\index{object!primary} NP\index{phrase types!noun phrase} + resultative PP\index{phrase types!prepositional phrase} (intransitive\index{verbs!intransitive}): //
...
\a\label{ex:restrns_pp2}%
	\begingl
		\glpreamble object\index{object!primary} NP\index{phrase types!noun phrase} + resultative PP\index{phrase types!prepositional phrase} (transitive\index{verbs!transitive}): //
...
position makes the connection between the verb and its subject\index{subject} hard to grasp,
...
words, the modifier is not an argument but an adjunct. The NP\index{phrase types!noun phrase} with an adjective\index{adjectives}
...
the a-structure of transitive\index{verbs!transitive} clauses with unergative verbs to that of
control verbs\index{verbs!control}---she analyzes resultative secondary predicates in terms of
functional control by interpreting the object\index{object!primary} of the verb as the subject\index{subject} of the
resultative.

My interpretation is that this suggests a structure as described for copula
clauses\index{copula clause} (\autoref{subsec:eqs}), so there should be a \fw{null-be} predicator
requiring a subject\index{subject} and a predicative element as its arguments here as
...
not want it to be included inside an S\index{phrase types!small clause} sister of the object\index{object!primary} NP\index{phrase types!noun phrase} if there is
...
secondary predicates refer to objects\index{object!primary}, however, the restriction is that the
subject\index{subject} of the intransitive verb\index{verbs!intransitive} be semantically a patient, that is, not in
...
treats it as an agent\index{cases!agent} in terms of case\index{cases} marking, it is more typically a patient
in terms of semantics. Likewise, it is possible for the patient-subject\index{subject} of a
passive\index{passive voice} verb to be complemented by a resultative, as in (\ref{ex:respass}). The
status of the subject\index{subject} as corresponding to the object\index{object!primary} of a detransitivized verb
is more apparent here: unlike with unaccusative verbs, Ayeri retains the
patient case\index{cases!patient} marking for subjects\index{subject} of passive\index{passive voice} verbs. The [–\,r] marking on the
passive\index{passive voice} subject\index{subject} refers to its role in the argument structure as thematically
...
reflexives'\index{pronouns!reflexive} \citep[145]{simpson1983} by which the subject\index{subject} NP\index{phrase types!noun phrase} is basically
doubled as an object\index{object!primary} to which a result state can be attributed. This typically
...
this object\index{object!primary}---the fake reflexive---does not receive its syntactic role from the
...
intransitive\index{verbs!intransitive} and thus does not subcategorize for an object\index{object!primary} in its argument
structure; compare (\ref{ex:runtranswrong}). Adding the reflexive\index{pronouns!reflexive} as an object\index{object!primary}
has the advantage of being able to serve as a subject\index{subject} for the resultative
adjective\index{adjectives} \rayr{pisu}{pisu} in the \XCompl{} function, however. This way, the
state achieved by running---being tired---can be attributed indirectly to the
controller of the reflexive\index{pronouns!reflexive}, the subject\index{subject} \rayr{tiplF}{Tipal}.
...
Most transitive\index{verbs!transitive} verbs in Ayeri take a complement in the patient case\index{cases!patient}, and
possibly also a second complement in the dative case\index{cases!dative}. However, there are a
number of verbs as well which take arguments marked for different cases\index{cases} and
...
The verbs in (\ref{ex:comptr}a--d) permit a locative\index{cases!locative} argument;
(\ref{ex:comptr_4}) may also take an argument in the genitive\index{cases!genitive} to express the
...
(\ref{ex:argfunctfeat_1}). Here, [±\,o] stands for `(non-)objective'\index{object!primary}, and
...
syntactic subject\index{subject} of an unergative verb is non-objective\index{object!primary} [–\,o] since it acts
like a typical logical subject\index{subject}, whereas the syntactic subject\index{subject} of an
unaccusative verb is patient-like \mbox{[–\,r]}; the same goes for the subject\index{subject}
of a passive\index{passive voice}. Semantic roles other than \Subj{}, \Obj{}, and \SObj{} are
...
\begin{description}
	...
	agent and a destination. This verb may be used intransitively\index{verbs!intransitive} as
	\xayr{sryaaNF}{sarayāng}{I go}, but the destination may \emph{optionally}
	be included as either an NP\index{phrase types!noun phrase} in the locative case\index{cases!locative} or a PP\index{phrase types!prepositional phrase}.
	...
	entails that an object\index{object!primary} is transferred from one location or position to
	...
	\emph{optionally} with the addressee NP\index{phrase types!noun phrase} in the locative case\index{cases!locative} and the theme
	in the genitive case\index{cases!genitive}.
	...
	material may be \emph{optionally} stated as an instrumental\index{cases!instrumental} NP\index{phrase types!noun phrase}. Especially
...
{[t]he more semantically contentful the preposition\index{prepositions} is in the PP\index{phrase types!prepositional phrase} accompanying a
certain verb, the more likely it is to mark an adjunct}. All of the verbs in
(\ref{ex:comptr}) which can take PPs\index{phrase types!prepositional phrase}---specifically (\ref{ex:comptr}a--c)---do
not require a certain adposition for the locational argument. The prepositions\index{prepositions}
or locative\index{cases!locative} marking are thus semantically contentful, while case\index{cases} marking for
...
case\index{cases!genitive} expressing what is spoken about. Two examples are given in
...
optional genitive\index{cases!genitive} NPs\index{phrase types!noun phrase}, one for the theme and another as a locative adverbial.
...
attempts to coordinate an instrumental\index{cases!instrumental} DP\index{phrase types!determiner phrase} with an instrumental\index{cases!instrumental} NP\index{phrase types!noun phrase} to express
both authorship and material use. These phrases can be coordinated with each
other, and coordination with an adverb\index{adverbs} as in (\ref{ex:multiins_2}) is possible
as well.
...
the menu is pick} is not: \fw{at the restaurant} is an adjunct, whereas
...
the order of the focused\index{focus} VP and the rest of the sentence is inverted to match
...
PP\index{phrase types!prepositional phrase} is part of the verb's semantics, so it is core information, which makes it
...
the action. I thus decided to cautiously rule out iterability of the PP\index{phrase types!prepositional phrase} for
this verb---another trait typical of complements. Furthermore, the PP\index{phrase types!prepositional phrase} is
captured by the \fw{do-so} test, which is also typical of complements. Like a
typical complement, the PP\index{phrase types!prepositional phrase} also has to move with its
\xhead{V} in a pseudocleft structure. Unlike a typical complement, however, a
question word\index{pronouns!interrogative} relating to the PP\index{phrase types!prepositional phrase} is conjoinable with the question word\index{pronouns!interrogative} for
...
similar, except that the PP\index{phrase types!prepositional phrase} is required in the way of a typical complement.
Moreover, the question word\index{pronouns!interrogative} for the PP\index{phrase types!prepositional phrase} expressing the locative adverbial cannot
...
locative\index{cases!locative} and an instrumental\index{cases!instrumental} NP\index{phrase types!noun phrase}, respectively. This means that there are no
prepositions\index{prepositions} involved which could provide any contentful information, however,
the case\index{cases} markers for these adverbials themselves are to be taken literally as
expressing a location and a material or means. There is no free choice about
these case\index{cases} markers, even though the degree of grammaticalization of these
adverbial cases\index{cases} is possibly not as high as with the core cases\index{cases}---although it
was noted before how Ayeri's core cases\index{cases} do not just express function, but that
semantics still need to be factored in. The degree of grammaticalization is
definitely higher than that of a free PP\index{phrase types!prepositional phrase} adjunct. The score is also 6 to 2 in
favor of complementhood.

If we treat the PPs\index{phrase types!prepositional phrase}, locative\index{cases!locative} NPs\index{phrase types!noun phrase}, and instrumental\index{cases!instrumental} NPs\index{phrase types!noun phrase} of the surveyed verbs
as complements, we need to categorize them as oblique\index{oblique} functions \Oblique{},
with the `θ' subscript replaced by the respective thematic role: \textit{goal}
or \textit{source} for PPs\index{phrase types!prepositional phrase} and locative\index{cases!locative} NPs\index{phrase types!noun phrase}, and \mbox{\textit{instr}} for the
instrumental\index{cases!instrumental}. According to \textcites[331]{bresnan2016}[414]
{needhamtoivonen2011}, roles which encode neither patientlike\index{object!primary} nor secondary
patientlike\index{object!secondary} roles are mapped to [–\,o], thus embody the \Oblique{}\index{oblique} function.
...
its agent argument. In English, passivization is a way to keep a topic\index{topic} in the
subject\index{subject} slot, for one. This function is acted out by Ayeri's topic\index{topic} marking,
...
fares regarding passivizing the objects\index{object!primary} of subordinate verbs. Lastly, we need
to check whether Ayeri can passivize\index{passive voice} derived arguments of complex transitive
...
the verb is suppressed to form its passive\index{passive voice} counterpart. The \Subj{} function is
...
statement in active voice,\footnote{The topicalized\index{topic} argument is marked with an
...
which the verb \xayr{koMdF/}{kond-}{eat} subcategorizes for. The agent argument
qualifies for [–\,o], so this is also our subject\index{subject}. The banana,
\rayr{disu}{disu}, then, is identified as corresponding to the patient argument
and is thus mapped to [–\,r], forming the object\index{object!primary}. Since \rayr{niysF}{Niyas} is
...
subject\index{subject} function to, the subject\index{subject} is mapped onto [–\,r] instead. While in
languages like English the former object\index{object!primary} appears in the nominative case\index{cases}, Ayeri
...
patient subject\index{subject} and to reintroduce the agent as an oblique\index{oblique} in either the agent\index{cases!agent}
or the instrumental case\index{cases!instrumental}, as illustrated in (\ref{ex:passzn2_inst}) \parencite
[for English, compare][416]{needhamtoivonen2011}. Instead, one may rather keep
the active phrasing and choose to topicalize\index{topic} the patient argument as
...
means that the direct object\index{object!primary}---marked with the patient case\index{cases!patient} since it is a
patient or a theme---is mapped to [–\,r], while the indirect/secondary
object\index{object!secondary}---marked with the dative case\index{cases!dative} since it is a recipient or
beneficiary---is mapped to [+\,o]. As in English ditransitive clauses with
dative movement (\fw{x gives y the z}), object\index{object!primary} and secondary object\index{object!secondary} appear in
...
passivized. According to \citet{bresnan2016}, in English, the subject\index{subject} function,
as the syntactic equivalent of [–\,o], may be dropped. The [–\,r] role, that
is, the recipient or beneficiary, becomes the new subject\index{subject} while the patient or
...
conflating accusative and dative case\index{cases!dative} into one objective case. This will be
...
(\ref{ex:gerditrpass_act}), the agent is marked with the nominative case\index{cases}, the
recipient with the dative case\index{cases!dative}, and the theme with the accusative case\index{cases}. As in
...
\SObj{} function to the recipient. The primary object\index{object!primary} thus maps onto [–\,r] and
the secondary object\index{object!secondary} onto [+\,o]. This is the reverse of what English does. If
we assign the subject\index{subject}---and thus nominative case\index{cases}---to the recipient and let the
...
argument serves as the subject\index{subject} in both languages but is associated with
different functions.
...
receives the subject\index{subject} role with nominative case, while the recipient remains in
the dative and appears at the front of the clause as a topic\index{topic}. Names in
...
As we have seen in the previous section, subjects\index{subject} of monotransitive\index{verbs!intransitive} passive
verbs in Ayeri retain their patient case\index{cases!patient} marking. The question is, thus, what
happens to the subject\index{subject} of ditransitive passive verbs. As we have already seen
in (\ref{ex:ditrorder}) above, the recipient receives dative case\index{cases!dative} marking and
is classified as [–\,r]. Considering English's strategy of making the [–\,r]
argument the subject\index{subject} of the passive clause, this theoretically opens a
possibility of having a recipient subject\index{subject} in the dative case\index{cases!dative}. As we will see,
...
argument as a subject\index{subject}. Parallel to how Ayeri forms passives of monotransitive\index{verbs!intransitive}
verbs, this example sentence keeps the dative case\index{cases!dative} marking on the purported
subject\index{subject}: the verb shows agreement\index{agreement} with a third person masculine referent, which
...
since dative\index{cases!dative} marking is the only available strategy to mark the recipient as
such---Ayeri cannot rephrase the recipient as a PP\index{phrase types!prepositional phrase} like English does.

Reversing verb agreement\index{agreement} to mark the theme as a subject\index{subject} in
...
verbs: make the patient-marked argument the subject\index{subject}. Ayeri can then mark the
recipient as a topic\index{topic} instead. Essentially, Ayeri works like German in this
regard, except that case\index{cases} marking on the theme/patient NP\index{phrase types!noun phrase} does not change to
agent\index{cases!agent}, since this makes no sense semantically---the agent case\index{cases!agent} in Ayeri is not
fully equivalent to the nominative case\index{cases} of languages such as English or
...
subjects\index{subject} in Ayeri. This precludes recipients from acting as subjects\index{subject} even if
...
of the objects\index{object!primary} in active voice (\ref{ex:intrnzn_act}) and in passive voice
...
recipient subjects\index{subject}.
...
syntactic subject\index{subject} of \fw{seem} is not its logical subject\index{subject}, hence this argument
is given as [–\,r] instead of [–\,o]. This annotation is instead chosen for the
experiencer as an oblique\index{oblique} function, which is realized in English as a PP\index{phrase types!prepositional phrase}, and
as a dative\index{cases!dative} NP\index{phrase types!noun phrase} in Ayeri. Since open complements (labeled \textsc{proposition})
...
experiencer becoming the subject\index{subject} (*\fw{I am seemed}). Since Ayeri does not
permit dative\index{cases!dative} NPs\index{phrase types!noun phrase} to be subjects\index{subject} of passive verbs, this is not possible in
Ayeri either. The question is, however, whether it is possible to passivize the
subordinate verb in order to raise its passive subject\index{subject}. An attempt to construct
...
to be in passive voice, raising the patient subject\index{subject} in (\ref{ex:passraise}bc)
...
case\index{cases} marking of the subject\index{subject} argument. The verb \rayr{vlYFymF}{valyyam} in
...
patient subject\index{subject}. This is comparable to *\fw{The beach is seemed to be enjoyed}
in English.

Moreover, \rayr{surFpF/}{surp-} does not subcategorize for a patient argument,
so it would seem odd for it to take a patient subject\index{subject} that makes it look as
...
p.~\pageref{subsubsec:res}). Here, the subject\index{subject} is specified as [–\,r] as well,
but yet it appears in the agent case\index{cases!agent}. The closest grammatically permissible way
to express the intended statement in (\ref{ex:passraise}bc) is to topicalize\index{topic}
...
Since derived arguments, as oblique\index{oblique} functions, are mapped to \mbox{[–\,o]} and
\Subj{} as a [–\,o] function is eligible for passivization, the question is
whether oblique\index{oblique} arguments can also become subjects\index{subject} of passive sentences. As
(\ref{ex:derargpass_2}) shows, this is not possible. Following the way Ayeri
keeps the case\index{cases} marking of patient subjects\index{subject} of passive verbs intact for semantic
reasons, the subject\index{subject} in this example has genitive\index{cases!genitive} marking. We know form verb
agreement\index{agreement} with a singular third person that \xayr{selesF}{seles} {shelf} is
supposed to be the subject\index{subject} here. However, as we have seen above, Ayeri only
permits agent and patient subjects\index{subject}. Hence, in contrast, (\ref{ex:derargpass_3})
is correct in that in absence of the agent, the patient is assigned the \Subj{}
function \citep[334]{bresnan2016}. Verb agreement\index{agreement} is here with a plural\index{plural}
subject\index{subject}, which \xayr{tehsFyelej}{tehasyeley}{cups} satisfies. If both NPs\index{phrase types!noun phrase} were
...
behaves in an untypical way in not making causers subjects\index{subject}
(\autoref{subsubsec:causative}, p.~\pageref{subsubsec:causative}).
\citet[342]{bresnan2016} give the annotation for causers as
Ø~→~\thetaroof\tsub{causer}: a primary causer-subject\index{subject} is added to the argument
structure. Causers are given as mapping to [–\,o] and to the \Subj{}\index{subject} function.
In Ayeri, causers are also mapped to [–\,o], but to the \Oblique{}\index{oblique} function
rather than to \Subj{}\index{subject}, that is, basically like a derived argument which is
added to the a-structure of a verb. The agent remains the logical subject\index{subject},
\thetaroof{}, and is not demoted to an object\index{object!primary} or oblique\index{oblique} function, and neither
is the patient demoted to a secondary object\index{object!secondary}. Ayeri instead topicalize\index{topic}s causers
...
{miles} are marked as patient. The verb in both cases has agreement\index{agreement} with an
animate masculine plural\index{plural} NP\index{phrase types!noun phrase}, which refers to \rayr{pFrlnFye}{pralanye}. This
also means that the agent NP\index{phrase types!noun phrase} in both cases is the syntactic subject\index{subject}. In
(\ref{ex:causstruct_2}), a causer, \xayr{nosaay}{nosāya}{chief} is added as an
argument and topicalized\index{topic}, basically for the reason of being the logical
subject\index{subject}. A weaker kind of causation may be expressed by putting the causer in
the instrumental case\index{cases!instrumental}, as in (\ref{ex:causinst}), essentially as a secondary
...
Various phrase types, verbs\index{verbs} especially, can take complements or adjuncts which
...
\xbar{C} to attach an adjunct to. The complement of a \xhead{C} is formed by a
verbal phrase type---IP\index{phrase types!inflectional phrase} or VP\index{phrase types!verb phrase}, but also plain S\index{phrase types!small clause} in the case of a copula clause\index{copula clause}.
...
occurring clausal complements\index{complement clause} or adjuncts of verbs\index{verbs}. The respective c- and
...
adjunct of the verb\index{verbs} in $f$---the purpose is not required information here. The
...
subject\index{subject} nor an object\index{object!primary}. The a-structure of the verb\index{verbs} is thus simply indicated as
...
headed by a relative pronoun which may agree with its head in case\index{cases} and animacy
...
control. Functionally, the relative pronoun constitutes a topic\index{topic} which is
...
of relative clauses.} This topic\index{topic} is not marked on the verb\index{verbs} as such, though, but
a different argument of the verb\index{verbs} often is.\footnote{Compare \citet[70--71]
{bresnan2016} for an example of set-valued topics\index{topic} in Russian.} In order to
...
\Anim{} features. Internal additional case\index{cases} marking is limited to those
grammatical functions which are not subject\index{subject} or object\index{object!primary}.
...
no external or internal case\index{cases} marking, since the relative clause is directly
adjacent to its head and the relative pronoun has the role of a patient within
the relative clause. The agent forms the secondary topic\index{topic} of the relative
clause. Since we defined case\index{cases} marking for the external head as an effect of
...
attribute \Gen{} to reflect internal case\index{cases} marking of the relativizer\index{pronouns!relative}.
Essentially, the relative pronoun reflects the role of the internal grammatical
function it links to as a topic\index{topic}.
...
complements. This is the case with a copula clause\index{copula clause} complementing the relative
pronoun, as in (\ref{ex:relc_cop}). Here, the relativizer\index{pronouns!relative} substitutes its
external controller \xayr{koyaasF}{koyās}{book}, which is a patient\index{cases!patient} form, as
the copula clause's\index{copula clause} subject\index{subject} to which the quality \xayr{hginF}{hagin}{heavy} is
attributed. Since there is no other NP\index{phrase types!noun phrase} which could be a secondary topic\index{topic}, the
topic\index{topic} in (\ref{ex:relc_cop}) is not given as a list of attributes.
...
a resumptive pronoun in a relative clause. The relativizer's\index{pronouns!relative} controller is
\xayr{AyonsF}{ayonas}{man}, which is a possessor in the relative clause. The
position which the possessor would usually occupy is redundantly filled here
with a resumptive pronoun which appears as topicalized\index{topic}. As discussed
previously, it is grammatical in Ayeri to make a possessor the topic\index{topic} of its
superior f-structure, so a construction using \xayr{sinaa}{sinā}{whose} as in
(\ref{ex:relc_siintcase}) should not be a problem. However, since genitive case\index{cases!genitive}
may mark both possessors and oblique\index{oblique} themes, the construction
...
find use, for instance, in subject\index{subject} clauses, such as in \fw{What they found on
...
conditions containing a copula clause\index{copula clause}. An adverb\index{adverbs} expressing a potential action
...
as a general-purpose negative conjunction\index{conjunctions}. It may also use negation\index{negation!of verbs} as a
...
expressed by negation of the verb\index{verbs}\index{negation!of verbs} and the juxtaposition of clauses. \rayr{bt}
