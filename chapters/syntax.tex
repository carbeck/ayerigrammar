...
comparison\index{comparison!of adjectives} morphemes are still loose enough to not jointly undergo derivation\index{derivation}
...
\Loc{} case\index{cases} marking in $g$ that the value of the \Oblq{loc}\index{semantic role!location} function is $g$
...
pronoun is marked for case\index{cases}, and thus also encodes animacy\index{animacy} for agents\index{semantic role!agent} and
...
we are asking for the subject\index{grammatical function!subject}/agent\index{semantic role!agent} in this case, not for the object\index{grammatical function!primary object}/patient\index{semantic role!patient} as
...
various oblique\index{grammatical function!oblique} arguments (\Possr, \Oblq{loc}\index{semantic role!location}, \Oblq{ins}\index{semantic role!instrument}, \Oblq{caus}\index{semantic role!causer}).
...
decline for case\index{cases}, and thus also for animacy\index{animacy} with agent\index{cases!agent} and patient\index{cases!patient} antecedents;
...
the genitive case\index{cases!genitive}: the NP\index{phrase types!noun phrase} complement expresses an oblique\index{grammatical function!oblique} theme\index{semantic role!theme} about which the
...
complement, \Oblq{theme}\index{semantic role!theme}. Similarly, the recipient\index{semantic role!recipient} of the subject's\index{grammatical function!subject} happiness
...
\begin{description}
	...
	(\textsc{source}\index{semantic role!source}). NPs\index{phrase types!noun phrase} may be marked with genitive case\index{cases!genitive} freely to indicate
...
for instance, Ayeri uses the dative case\index{cases!dative} to mark recipients\index{semantic role!recipient}. However, different
from both English and German, Ayeri puts recipients\index{semantic role!recipient} after themes\index{semantic role!theme}\index{word order}, irrespective
...
In (\ref{ex:doubleobj}), the object\index{grammatical function!primary object}/recipient\index{semantic role!recipient} is \rayr{diy}{Diya}, and the
...
transitive verbs\index{verbs!transitive}: the same case\index{cases} which marks the patients\index{semantic role!patient} (P) of monotransitive
verbs\index{verbs!intransitive} marks the theme\index{semantic role!theme} (T) of a ditransitive verb (P\,=\,T). Furthermore,
another case\index{cases} is used to mark the donor (D) of ditransitive verbs, the agent\index{semantic role!agent} of
...
canonical cases\index{cases} (S\,=\,A\,=\,D). The recipient\index{semantic role!recipient} (R) receives extra marking.
...
is not possible to have multiple recipient\index{semantic role!recipient} NPs\index{phrase types!noun phrase} (unless one coordinates them
...
proclitic\index{clitics} before the verb, which here encodes an inanimate\index{animacy} patient\index{semantic role!patient} topic\index{grammatical function!topic},
...
discrepancies in case\index{cases} marking between agent\index{cases!agent} and patient\index{cases!patient}. On the other hand, an
...
negation\index{negation!of verbs}. Apart from this, \rayr{yom/}{yoma-} is usually used with locations\index{semantic role!location},
...
complement, \rayr{s hiro}{sa Hiro}, there are two patient\index{semantic role!patient} arguments following
...
complement in the dative case\index{cases!dative}. However, different from a regular recipient\index{semantic role!recipient} or
a goal\index{semantic role!goal} NP\index{phrase types!noun phrase}, a resultative dative\index{cases!dative} NP\index{phrase types!noun phrase} also normally occurs after the verb.
...
treats it as an agent\index{cases!agent} in terms of case\index{cases} marking, it is more typically a patient\index{semantic role!patient}
...
unaccusative verb is patient\index{semantic role!patient}-like \mbox{[–\,r]}; the same goes for the subject\index{grammatical function!subject}
...
\begin{description}
	...
	\emph{optionally} with the addressee NP\index{phrase types!noun phrase} in the locative case\index{cases!locative} and the theme\index{semantic role!theme}
...
not require a certain adposition for the locational\index{semantic role!location} argument. The prepositions\index{prepositions}
...
optional genitive\index{cases!genitive} NPs\index{phrase types!noun phrase}, one for the theme\index{semantic role!theme} and another as a locative adverbial.
...
the location\index{semantic role!location} and is not fixed. It is hard to construct a sentence where
multiple locations\index{semantic role!location} can be interpreted as adding incidental information about
...
expressing a location\index{semantic role!location} and a material or means. There is no free choice about
...
or \textit{source}\index{semantic role!source} for PPs\index{phrase types!prepositional phrase} and locative\index{cases!locative} NPs\index{phrase types!noun phrase}, and \mbox{\textit{instr}} for the
instrumental\index{cases!instrumental}. According to \textcites[331]{bresnan2016}[414]
{needhamtoivonen2011}, roles which encode neither patientlike\index{grammatical function!primary object}\index{semantic role!patient} nor secondary
patientlike\index{grammatical function!secondary object}\index{semantic role!patient} roles are mapped to [–\,o], thus embody the \Oblique{}\index{grammatical function!oblique} function.
...
nonetheless keeps the patient\index{cases!patient} marking and the verb agrees with the patient\index{semantic role!patient}
subject\index{grammatical function!subject}.

Also unlike in English, it is not possible to have the verb agree with the
patient\index{semantic role!patient} subject\index{grammatical function!subject} and to reintroduce the agent\index{semantic role!agent} as an oblique\index{grammatical function!oblique} in either the agent\index{cases!agent}
...
object\index{grammatical function!secondary object}---marked with the dative case\index{cases!dative} since it is a recipient\index{semantic role!recipient} or
...
As we have seen in the previous section, subjects\index{grammatical function!subject} of monotransitive\index{verbs!intransitive} passive\index{voice!passive}
...
in (\ref{ex:ditrorder}) above, the recipient\index{semantic role!recipient} receives dative case\index{cases!dative} marking and
...
possibility of having a recipient\index{semantic role!recipient} subject\index{grammatical function!subject} in the dative case\index{cases!dative}. As we will see,
...
since dative\index{cases!dative} marking is the only available strategy to mark the recipient\index{semantic role!recipient} as
...
verbs: make the patient-marked\index{cases!patient} argument the subject\index{grammatical function!subject}. Ayeri can then mark the
recipient\index{semantic role!recipient} as a topic\index{grammatical function!topic} instead. Essentially, Ayeri works like German in this
regard, except that case\index{cases} marking on the theme\index{semantic role!theme}/patient\index{semantic role!patient} NP\index{phrase types!noun phrase} does not change to
...
keeps the case\index{cases} marking of patient\index{semantic role!patient} subjects\index{grammatical function!subject} of passive verbs intact for semantic
...
marked as agent\index{semantic role!agent} in both (a) and (b) versions, and the \xayr{hksFlej}{hakasley}
{miles} are marked as patient\index{semantic role!patient}. The verb in both cases has agreement\index{agreement} with an
...
also means that the agent\index{semantic role!agent} NP\index{phrase types!noun phrase} in both cases is the syntactic subject\index{grammatical function!subject}. In
...
subject\index{grammatical function!subject}. A weaker kind of causation may be expressed by putting the causer\index{semantic role!causer} in
