...
\a\ljudge*\begingl
\gla Tahanya ang Yan tamanley. //
\glb tahan-ya ang Yan taman-ley //
\glc write-\TsgM{} \Aarg{} Yan letter-\PargI{} //
\endgl
...
\pex
\a\begingl
\glpreamble \textit{Ang linkaye lingyam Banvā merengley.} \\
	/aŋ liŋˈkaje ˈliŋjam | banˈvaː | mereŋˈleɪ/ //
...
\a\ljudge\#\begingl
\gla Linkaye ang Banvā lingyam {merengley.\fnhackB} //
...
\footnotehacktext{This pattern is attested, but it's a minority variant. As (\ref{ex:rightsideptcp}) shows, the subordinate verb's arguments can't be topicalized in this case.}
...
\pex
\a\begingl
\glpreamble \textit{Ang linkaye tapyyam Pitu vengānas ya Tipal.} \\
	/aŋ liŋˈkaje ˈtapjam | ˈpitu | veŋˈaːnas | ja ˈtipal/ //
