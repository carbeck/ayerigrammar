...
\footnotetext{The modification of the main verb or of the whole verb complex by an adverb makes (b) and (c) sound awkward to me for some reason.}

\pex
\a\begingl
\glpreamble \textit{Linkaya ang Ajān telbisayam ledo yayam.}\footnotemark \\
	/liŋˈkaja | aŋ‿aˈdʒaːn | telbiˈsajam ˈledo | ˈjajam/ //

\gla Linkaya ang Ajān telbisayam ledo yayam. //
\glb linka-ya ang Ajān telbisa-yam ledo yayam //
\glc try-\TsgM{} \Aarg{} Ajān point.out-\Ptcp{} friendly \TsgM{}.\Dat{} //
\glft `Ajān tries to point it out to him in a friendly way.' //
\endgl

\a\ljudge?\begingl
\gla Ang linkaya telbisayam ledo Ajān yayam. //
\glb ang linka-ya telbisa-yam ledo Ajān yayam //
\glc \AgtT{} try-\TsgM{} point.out-\Ptcp{} friendly Ajān \TsgM{}.\Dat{} //
\endgl
\xe

\footnotetext{Here as well (b) sounds awkward.}

\ex S-control and adverb placement \xe
