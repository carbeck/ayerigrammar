...
\usepackage[
	...
	english=american,
	autopunct,
]{csquotes} % Put quotations in \enquote{}!
...
% Things for tables
% Needs to be loaded *before* hyperref if footnotes in tables are supposed to 
% work
...
\newcommand{\thafterdot}{\raisebox{.25em}{\zwsp F}{\rmfamily }}
