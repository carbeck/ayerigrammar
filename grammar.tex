...
\centering
\vspace*{\drop}
{\large Carsten Becker}\\[\baselineskip]
...
% \index{inanimate|see{animacy}}
% \index{indefinite pronouns|see{pronouns}}
\index{indicative|see{mood}}
\index{instrumental|see{case}}
\index{instrument|see{semantic role}}
% \index{interrogative pronouns|see{pronouns}}
% \index{intransitive|see{verbs}}
...
% \index{reciprocal pronouns|see{pronouns}}
% \index{reflexive pronouns|see{pronouns}}
\index{resultative|see{adjectives}}
% \index{resumptive pronouns|see{pronouns}}
...
% \index{transitive|see{verbs}}
\index{trigger@`trigger'|see{grammatical function}}
% \index{unaccusative|see{verbs}}
% \index{unergative|see{verbs}}
\index{VP|see{phrase types}}

% Index: see also ...
% \index{adjectives!predicative|seealso{grammatical function}}
\index{case!agent|seealso{semantic role}}
\index{case!patient|seealso{semantic role}}
\index{comparison|seealso{verbs}}
% \index{grammatical function!predicative complement|seealso{adjectives}}
...
\ayr{\larger ANF sryo tdoj thnYmnF/IknF koyyen, nj ri tvYo pisu
	bitu\_ayNF sobisymnF/IknF.}\\
\fw{Ang sarayo tadoy tahanyaman-ikan koyayena, nay ri tavyo pisu
	bituayang sobisayaman-ikan.}\\
`Of making many books there is no end, and much study wearies the body.'\\
--- Ecclesiastes 12:12 (\textsc{niv})
\end{flushright}
