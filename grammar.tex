...
\newcommand{\mkd}{\fakesuperscript{\#}} % raised pound
...
*		& marks items as ungrammatical or undocumented \\
\ques	& marks items of questionable quality \\
\excl	& marks items as running counter to expectation \\
\mkd	& marks items as marked \\
\end{tabular}
