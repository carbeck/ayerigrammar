...
% \setlrmarginsandblock{*}{0.75in}{0.75}
...
% \newleipzig{Comp}{comp}{complement}
...
% \newleipzig{Oblq}{obl}{oblique}
% \newleipzig{Pers}{pers}{person}
% \newleipzig{Pred}{pred}{predicate}
% \newleipzig{Subj}{subj}{subject}
% \newleipzig{Tense}{tense}{tense}
% \newleipzig{Xcomp}{xcomp}{open complement}
...
% \newcommand{\Obl}[1]{\Oblq\fakesubscript{\normalfont\itshape #1}
...
% \newcommand{\downfeat}[2]{(↓~\textsc{#1})~=~\textsc{#2}}
% \newcommand{\downs}[1]{(↓~\textsc{#1})}
% \newcommand{\elem}[1]{↓~$$~(↑~\textsc{#1})}
% \newcommand{\pass}[1]{(↑~\textsc{#1})~=~↓}
% \newcommand{\uncertain}[1]{((x~↑)~\textsc{#1})~=~↑}
% \newcommand{\updown}{↑~=~↓}
% \newcommand{\upfeat}[2]{(↑~\textsc{#1})~=~\textsc{#2}}
% \newcommand{\ups}[1]{(↑~\textsc{#1})}
% \newcommand{\xbar}[1]{#1ʹ}
% \newcommand{\xhead}[1]{#1⁰}
% 
