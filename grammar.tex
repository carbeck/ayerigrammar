...
\documentclass[
	a4paper,
	% (b5paper would yield a more textbook-like format, though then you 
	% will also have to reformat like half the tables. Printing at 80% the 
	% original size also makes things about textbook-sized, but then the 
	% font size is a bit too small. For 12 pt at 80%, it needs to be 15 pt 
	% at 100%, so tables and everything will be off again.)
	12pt,
	openany,
	twoside,
	final,
